...
unsafe extern "C" fn FileName(mut path: *mut libc::c_char) -> *mut libc::c_char {
    ...
    if !separator_position.is_null() {
        path= separator_position.offset(1 as libc::c_int as isize) as *mut _;
    }else { (); }
                        ...
                        == 0 as libc::c_int
                    {
                        ...
                        ) == 0 as libc::c_int
                        {
                            ...
                            ) == 0 as libc::c_int
                            {
                                ...
                                (*params.as_deref_mut().unwrap()).output_path= value as *mut _;
                            } else if strncmp(
                            ...
                            ) == 0 as libc::c_int
                            {
                                ...
                                suffix_set= 1 as libc::c_int;
                                (*params.as_deref_mut().unwrap()).suffix= value as *mut _;
                            } else {
                                fprintf(
                                    stderr,
...
unsafe extern "C" fn NextFile(mut context: Option<&mut Context>) -> libc::c_int {
    ...
    if (*context.as_deref().unwrap()).input_count == 0 as libc::c_int as libc::c_ulong {
        ...
        (*context.as_deref_mut().unwrap()).current_input_path= 0 as *mut libc::c_char;
    ...
    (*context.as_deref_mut().unwrap()).current_input_path= arg as *mut _;
...
unsafe extern "C" fn OpenFiles(mut context: Option<&mut Context>) -> libc::c_int {
    ...
    if (*context.as_deref().unwrap()).test_integrity == 0 && is_ok != 0 {
        let force_overwrite = (*context.as_deref().unwrap()).force_overwrite;
...
unsafe fn main_0(
    ...
    let mut context = Context {
        ...
        decompress: 0,
        large_window: 0,
        output_path: 0 as *mut libc::c_char,
        ...
        current_input_path: 0 as *mut libc::c_char,
        current_output_path: 0 as *mut libc::c_char,
        input_file_length: 0,
        fin: 0 as *mut FILE,
        fout: 0 as *mut FILE,
        available_in: 0,
    ...
    context.output_path= 0 as *mut libc::c_char;
    context.suffix= b".br\0" as *const u8 as *mut libc::c_char;
    i= 0 as libc::c_int;
    ...
    context.current_input_path= 0 as *mut libc::c_char;
    context.current_output_path= 0 as *mut libc::c_char;
