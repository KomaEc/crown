...
pub unsafe extern "C" fn BrotliBuildHuffmanTable(
    ...
    while total_size != table_size {
        memcpy(
            &raw mut *table.offset(table_size as isize) as *mut crate::src::dec::decode::HuffmanCode
                as *mut libc::c_void,
            &raw mut *table.offset(0 as libc::c_int as isize) as *mut crate::src::dec::decode::HuffmanCode
