...
struct ErasedByPreprocessor75;
// #[derive(Copy, Clone)]
#[repr(C)]
pub union C2RustUnnamed_0 {
    pub _H2: crate::src::enc::backward_references::H2,
    pub _H3: crate::src::enc::backward_references::H3,
    pub _H4: crate::src::enc::backward_references::H4,
    pub _H5: crate::src::enc::backward_references::H5,
    pub _H6: crate::src::enc::backward_references::H6,
    pub _H40: crate::src::enc::backward_references::H40,
    pub _H41: crate::src::enc::backward_references::H41,
    pub _H42: crate::src::enc::backward_references::H42,
    pub _H54: crate::src::enc::backward_references::H54,
    pub _H35: crate::src::enc::backward_references::H35,
    pub _H55: crate::src::enc::backward_references::H55,
    pub _H65: crate::src::enc::backward_references::H65,
    pub _H10: crate::src::enc::backward_references::H10,
}
#[derive(Copy, Clone)]

struct ErasedByPreprocessor76;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor77;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor78;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor79;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor80;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor81;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor82;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor83;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor84;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor85;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor86;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor87;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor88;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor89;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor90;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor91;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor92;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor93;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor94;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor95;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor96;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor97;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor98;
#[derive(Copy, Clone)]
#[repr(C)]
...
struct ErasedByPreprocessor100;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor101;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor102;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor103;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor104;
pub type ContextLut = *const uint8_t;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor105;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor106;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor107;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor108;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor109;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor110;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor111;
...
struct ErasedByPreprocessor112;
#[derive(Copy, Clone)]
#[repr(C)]
...
unsafe extern "C" fn StitchToPreviousBlockH4(
    mut self_0: Option<&mut crate::src::enc::backward_references::H4>,
...
unsafe extern "C" fn ChooseHasher(
    mut params: *const crate::src::enc::backward_references::BrotliEncoderParams,
    mut hparams: Option<&mut crate::src::enc::backward_references::BrotliHasherParams>,
) {
    if (*params).quality > 9 as libc::c_int {
        (*hparams.as_deref_mut().unwrap()).type_0= 10 as libc::c_int;
    } else if (*params).quality == 4 as libc::c_int
        && (*params).size_hint
            >= ((1 as libc::c_int) << 20 as libc::c_int) as libc::c_ulong
    {
        (*hparams.as_deref_mut().unwrap()).type_0= 54 as libc::c_int;
    } else if (*params).quality < 5 as libc::c_int {
        (*hparams.as_deref_mut().unwrap()).type_0= (*params).quality;
    } else if (*params).lgwin <= 16 as libc::c_int {
        (*hparams.as_deref_mut().unwrap()).type_0= if (*params).quality < 7 as libc::c_int {
            40 as libc::c_int
    ...
    {
        (*hparams.as_deref_mut().unwrap()).type_0= 6 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).block_bits= (*params).quality - 1 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).bucket_bits= 15 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).hash_len= 5 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).num_last_distances_to_check= if (*params).quality < 7 as libc::c_int {
            4 as libc::c_int
        } else if (*params).quality < 9 as libc::c_int {
            10 as libc::c_int
        } else {
        ...
        (*hparams.as_deref_mut().unwrap()).type_0= 5 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).block_bits= (*params).quality - 1 as libc::c_int;
        (*hparams.as_deref_mut().unwrap()).bucket_bits= if (*params).quality < 7 as libc::c_int {
            14 as libc::c_int
        } else {
            15 as libc::c_int
        };
    ...
    if (*params).lgwin > 24 as libc::c_int {
        if (*hparams.as_deref().unwrap()).type_0 == 3 as libc::c_int {
            (*hparams.as_deref_mut().unwrap()).type_0= 35 as libc::c_int;
        }
        if (*hparams.as_deref().unwrap()).type_0 == 54 as libc::c_int {
            (*hparams.as_deref_mut().unwrap()).type_0= 55 as libc::c_int;
        }
        if (*hparams.as_deref().unwrap()).type_0 == 6 as libc::c_int {
            (*hparams.as_deref_mut().unwrap()).type_0= 65 as libc::c_int;
        }
    }
}
#[inline(always)]
...
unsafe extern "C" fn InitializeH5(
    ...
    (*self_0).buckets_= &raw mut *(*self_0).num_.offset((*self_0).bucket_size_ as isize)
...
unsafe extern "C" fn InitializeH10(
    ...
    (*self_0).buckets_= (*common).extra as *mut uint32_t;
    (*self_0).forest_= &raw mut *(*self_0).buckets_
...
unsafe extern "C" fn PrepareH35(
    ...
    PrepareHROLLING_FAST(Some(&mut (*self_0).hb), one_shot, input_size, data);
}
...
unsafe extern "C" fn PrepareH65(
    ...
    PrepareHROLLING(Some(&mut (*self_0).hb), one_shot, input_size, data);
}
...
unsafe extern "C" fn HasherSetup(
    ...
    if (*hasher).common.extra.is_null() {();
        ...
        ChooseHasher(params, Some(&mut (*params).hasher));
...
unsafe extern "C" fn StitchToPreviousBlockH2(
    mut self_0: Option<&mut crate::src::enc::backward_references::H2>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
    ...
    {
        StoreH2(
            self_0.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()),
            ringbuffer,
            ringbuffer_mask,
            position.wrapping_sub(3 as libc::c_int as libc::c_ulong),
        );
...
unsafe extern "C" fn StoreH4(
    ...
    if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
        *((*self_0.as_deref_mut().unwrap()).buckets_).offset(key as isize) = ix as uint32_t;
    } else {
        let off = (ix
            & ((((1 as libc::c_int) << 2 as libc::c_int) - 1 as libc::c_int)
                << 3 as libc::c_int) as libc::c_ulong) as uint32_t;
        *(*self_0.as_deref().unwrap()).buckets_
            .offset(
                (key.wrapping_add(off)
...
unsafe extern "C" fn StitchToPreviousBlockH5(
    mut self_0: Option<&mut crate::src::enc::backward_references::H5>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
...
unsafe extern "C" fn StitchToPreviousBlockH40(
    mut self_0: Option<&mut crate::src::enc::backward_references::H40>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
...
unsafe extern "C" fn StitchToPreviousBlockH41(
    mut self_0: Option<&mut crate::src::enc::backward_references::H41>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ring_buffer_mask: size_t,
...
unsafe extern "C" fn StitchToPreviousBlockH42(
    mut self_0: Option<&mut crate::src::enc::backward_references::H42>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ring_buffer_mask: size_t,
...
unsafe extern "C" fn StitchToPreviousBlockH3(
    mut self_0: Option<&mut crate::src::enc::backward_references::H3>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
...
unsafe extern "C" fn StitchToPreviousBlockH35(
    mut self_0: Option<&mut crate::src::enc::backward_references::H35>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ring_buffer_mask: size_t,
    ...
    StitchToPreviousBlockH3(
        Some(&mut (*self_0.as_deref_mut().unwrap()).ha),
        num_bytes,
        position,
        ringbuffer,
        ring_buffer_mask,
    ...
    StitchToPreviousBlockHROLLING_FAST(
        Some(&mut (*self_0.as_deref_mut().unwrap()).hb),
        num_bytes,
        position,
        ringbuffer,
        ring_buffer_mask,
...
unsafe extern "C" fn StitchToPreviousBlockH54(
    mut self_0: Option<&mut crate::src::enc::backward_references::H54>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
...
unsafe extern "C" fn PrepareHROLLING_FAST(
    mut self_0: Option<&mut crate::src::enc::backward_references::HROLLING_FAST>,
    mut one_shot: libc::c_int,
    mut input_size: size_t,
    mut data: *const uint8_t,
) {
    ...
    (*self_0.as_deref_mut().unwrap()).state= 0 as libc::c_int as uint32_t;
    i= 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as libc::c_ulong {
        (*self_0.as_deref_mut().unwrap()).state= HashRollingFunctionInitialHROLLING_FAST(
            (*self_0.as_deref().unwrap()).state,
            *data.offset(i as isize),
            (*self_0.as_deref().unwrap()).factor,
        );
        i= (i as libc::c_ulong).wrapping_add(4 as libc::c_int as libc::c_ulong)
            as size_t as size_t;
    }
...
unsafe extern "C" fn StitchToPreviousBlockHROLLING_FAST(
    ...
    (*self_0.as_deref_mut().unwrap()).next_ix= position;
}
#[inline(always)]
unsafe extern "C" fn StitchToPreviousBlockH55(
    mut self_0: Option<&mut crate::src::enc::backward_references::H55>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ring_buffer_mask: size_t,
...
unsafe extern "C" fn StitchToPreviousBlockH6(
    mut self_0: Option<&mut crate::src::enc::backward_references::H6>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
...
unsafe extern "C" fn PrepareHROLLING(
    mut self_0: Option<&mut crate::src::enc::backward_references::HROLLING>,
    mut one_shot: libc::c_int,
    mut input_size: size_t,
    mut data: *const uint8_t,
) {
    ...
    i= 0 as libc::c_int as size_t;
    while i < 32 as libc::c_int as libc::c_ulong {
        (*self_0.as_deref_mut().unwrap()).state= HashRollingFunctionInitialHROLLING(
            (*self_0.as_deref().unwrap()).state,
            *data.offset(i as isize),
            (*self_0.as_deref().unwrap()).factor,
        );
...
unsafe extern "C" fn StitchToPreviousBlockH65(
    mut self_0: Option<&mut crate::src::enc::backward_references::H65>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ring_buffer_mask: size_t,
...
#[inline(always)]
unsafe extern "C" fn LeftChildIndexH10(mut self_0: *mut crate::src::enc::backward_references::H10, pos: size_t) -> size_t {
...
#[inline(always)]
unsafe extern "C" fn RightChildIndexH10(mut self_0: *mut crate::src::enc::backward_references::H10, pos: size_t) -> size_t {
    return (2 as libc::c_int as libc::c_ulong)
        .wrapping_mul(pos & (*self_0).window_mask_)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
}
...
unsafe extern "C" fn StitchToPreviousBlockH10(
    mut self_0: Option<&mut crate::src::enc::backward_references::H10>,
    mut num_bytes: size_t,
    mut position: size_t,
    mut ringbuffer: *const uint8_t,
    mut ringbuffer_mask: size_t,
        ...
        && position >= 128 as libc::c_int as libc::c_ulong
    {
        ...
        i= i_start;
        while i < i_end {
            let max_backward = (*self_0.as_deref().unwrap()).window_mask_
                .wrapping_sub(
                    brotli_max_size_t(
...
unsafe extern "C" fn RingBufferWriteTail(
        ...
        != 0
    {
        ...
        memcpy(
            &raw mut *(*rb).buffer_.offset(p as isize) as *mut uint8_t
                as *mut libc::c_void,
...
unsafe extern "C" fn RingBufferWrite(
    ...
    {
        memcpy(
            &raw mut *(*rb).buffer_.offset(masked_pos as isize) as *mut uint8_t
                as *mut libc::c_void,
            bytes as *const libc::c_void,
            n,
        );
        ...
        memcpy(
            &raw mut *(*rb).buffer_.offset(0 as libc::c_int as isize) as *mut uint8_t
                as *mut libc::c_void,
            bytes
...
unsafe extern "C" fn BrotliWriteBits(
    ...
    let mut p: *mut uint8_t = &raw mut *array.offset(((*pos) >> 3 as libc::c_int) as isize)
        as *mut uint8_t;
    ...
    if size_hint < ((1 as libc::c_int) << 20 as libc::c_int) as libc::c_ulong {
        ...
        while i < 13 as libc::c_int as libc::c_ulong {
            entropy[2 as libc::c_int as usize]+= ShannonEntropy(
                    &raw mut *(*context_histo.as_mut_ptr().offset(i as isize))
                        .as_mut_ptr()
...
unsafe extern "C" fn DecideOverLiteralContextModeling(
    ...
    if quality < 5 as libc::c_int || length < 64 as libc::c_int as libc::c_ulong {
        ...
        ) != 0)
        {
            ...
            ChooseContextMap(
                quality,
                &raw mut *bigram_prefix_histo.as_mut_ptr().offset(0 as libc::c_int as isize),
                num_literal_contexts.as_deref_mut(),
                literal_context_map.as_deref_mut(),
            );
        }
...
unsafe extern "C" fn ChooseContextMode(
    ...
    if (*params).quality >= 10 as libc::c_int
        && crate::src::enc::utf8_util::BrotliIsMostlyUTF8(data, pos, mask, length, kMinUTF8Ratio) == 0
    {
...
unsafe extern "C" fn ExtendLastCommand(
    ...
    let mut last_command: *mut crate::src::enc::backward_references::Command = &raw mut *(*s).commands_
        .offset(
...
unsafe extern "C" fn EncodeData(
    ...
    if (*s).params.quality == 0 as libc::c_int || (*s).params.quality == 1 as libc::c_int
    {
        ...
        *storage
        ...
        if (*s).params.quality == 0 as libc::c_int {
            crate::src::enc::compress_fragment::BrotliCompressFragmentFast(
                m,
                &raw mut *data.offset((wrapped_last_processed_pos & mask) as isize),
                bytes as size_t,
                is_last,
                table,
                table_size,
        ...
        *output= &raw mut *storage.offset(0 as libc::c_int as isize) as *mut uint8_t;
    ...
    if (*s).params.quality == 10 as libc::c_int {
        crate::src::enc::backward_references_hq::BrotliCreateZopfliBackwardReferences(
            ...
            &raw mut *(*s).commands_.offset((*s).num_commands_ as isize),
    ...
    *output= &raw mut *storage_0.offset(0 as libc::c_int as isize) as *mut uint8_t;
                ...
                if ok != 0 && metablock_start < input_size {
                    ...
                    while block_start < metablock_end {
                        ...
                        crate::src::enc::backward_references_hq::BrotliZopfliCreateCommands(
                            block_size,
                            block_start,
                            &raw mut *nodes.offset(0 as libc::c_int as isize),
                            dist_cache.as_mut_ptr(),
                            core::ptr::addr_of_mut!(last_insert_len),
                            core::ptr::addr_of!(params),
                            &raw mut *commands.offset(num_commands as isize),
    ...
    *output.offset(fresh96 as isize) = 0x3 as libc::c_int as uint8_t;
    while size > 0 as libc::c_int as libc::c_ulong {
        ...
        *output.offset(fresh99 as isize) = (bits >> 16 as libc::c_int) as uint8_t;
        ...
        memcpy(
            &raw mut *output.offset(result as isize) as *mut uint8_t as *mut libc::c_void,
