...
extern "C" {
    ...
    #[no_mangle]
    fn genann_act_threshold(a: std::os::raw::c_double) -> std::os::raw::c_double;
    #[no_mangle]
    fn genann_act_sigmoid_cached(a: std::os::raw::c_double) -> std::os::raw::c_double;
    #[no_mangle]
    ...
    #[no_mangle]
    fn genann_act_sigmoid(a: std::os::raw::c_double) -> std::os::raw::c_double;
    #[no_mangle]
