...
pub struct _xmlBuf {
    ...
    pub compat_use: std::os::raw::c_uint,
    pub compat_size: std::os::raw::c_uint,
 ...
 * To be improved...
 */
unsafe extern "C" fn xmlBufMemoryError(mut buf: xmlBufPtr,
                                       mut extra: *const std::os::raw::c_char) {
    __xmlSimpleError(XML_FROM_BUFFER as std::os::raw::c_int,
                     XML_ERR_NO_MEMORY as std::os::raw::c_int, 0 as xmlNodePtr,
                     0 as *const std::os::raw::c_char, extra);
    if !buf.is_null() && (*buf).error == 0 as std::os::raw::c_int {
        (*buf).error = XML_ERR_NO_MEMORY as std::os::raw::c_int
    };
}
/* *
 * xmlBufOverflowError:
 ...
 * To be improved...
 */
unsafe extern "C" fn xmlBufOverflowError(mut buf: xmlBufPtr,
                                         mut extra: *const std::os::raw::c_char) {
    __xmlSimpleError(XML_FROM_BUFFER as std::os::raw::c_int,
                     XML_BUF_OVERFLOW as std::os::raw::c_int, 0 as xmlNodePtr,
                     0 as *const std::os::raw::c_char, extra);
    if !buf.is_null() && (*buf).error == 0 as std::os::raw::c_int {
        (*buf).error = XML_BUF_OVERFLOW as std::os::raw::c_int
    };
}
/*
...
pub unsafe extern "C" fn xmlBufCreate() -> xmlBufPtr {
    ...
    ret =
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlBuf>()
                                                          as std::os::raw::c_ulong) as
            xmlBufPtr;
    if ret.is_null() {
        xmlBufMemoryError(0 as xmlBufPtr,
                          b"creating buffer\x00" as *const u8 as
                              *const std::os::raw::c_char);
        return 0 as xmlBufPtr
    }
    (*ret).compat_use = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*ret).use_0 = 0 as std::os::raw::c_int as size_t;
    (*ret).error = 0 as std::os::raw::c_int;
    (*ret).buffer = 0 as xmlBufferPtr;
    (*ret).size = *__xmlDefaultBufferSize() as size_t;
    (*ret).compat_size = *__xmlDefaultBufferSize() as std::os::raw::c_uint;
    (*ret).alloc = *__xmlBufferAllocScheme();
    (*ret).content =
        xmlMallocAtomic.expect("non-null function pointer")((*ret).size.wrapping_mul(::std::mem::size_of::<xmlChar>()
                                                                                         as
                                                                                         std::os::raw::c_ulong))
            as *mut xmlChar;
...
pub unsafe extern "C" fn xmlBufCreateSize(mut size: size_t) -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf; /* +1 for ending null */
    ret =
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlBuf>()
                                                          as std::os::raw::c_ulong) as
            xmlBufPtr;
    ...
    (*ret).compat_size = (*ret).size as std::os::raw::c_int as std::os::raw::c_uint;
    if (*ret).size != 0 {
        (*ret).content =
            xmlMallocAtomic.expect("non-null function pointer")((*ret).size.wrapping_mul(::std::mem::size_of::<xmlChar>()
                                                                                             as
...
pub unsafe extern "C" fn xmlBufDetach(mut buf: xmlBufPtr) -> *mut xmlChar {
    ...
    if !(*buf).buffer.is_null() { return 0 as *mut xmlChar }
    if (*buf).error != 0 { return 0 as *mut xmlChar }
    ret = (*buf).content;
    (*buf).content = 0 as *mut xmlChar;
    (*buf).size = 0 as std::os::raw::c_int as size_t;
    (*buf).use_0 = 0 as std::os::raw::c_int as size_t;
    (*buf).compat_use = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*buf).compat_size = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    return ret;
}
/* *
 * xmlBufCreateStatic:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufCreateStatic(mut mem: *mut std::os::raw::c_void,
                                            mut size: size_t) -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf;
    if mem.is_null() { return 0 as xmlBufPtr }
    ret =
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlBuf>()
                                                          as std::os::raw::c_ulong) as
            xmlBufPtr;
    ...
    if size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        (*ret).compat_use = size as std::os::raw::c_uint;
        (*ret).compat_size = size as std::os::raw::c_uint
    } else {
        (*ret).compat_use = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint;
        (*ret).compat_size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint
    }
    (*ret).use_0 = size;
    (*ret).size = size;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufGetAllocationScheme(mut buf: xmlBufPtr)
 -> std::os::raw::c_int {
    if buf.is_null() { return -(1 as std::os::raw::c_int) }
    return (*buf).alloc as std::os::raw::c_int;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufSetAllocationScheme(mut buf: xmlBufPtr,
                                                   mut scheme:
 ...
 -> std::os::raw::c_int {
    ...
    if scheme as std::os::raw::c_uint ==
           ...
           scheme as std::os::raw::c_uint ==
               XML_BUFFER_ALLOC_IMMUTABLE as std::os::raw::c_int as std::os::raw::c_uint ||
           scheme as std::os::raw::c_uint ==
               XML_BUFFER_ALLOC_BOUNDED as std::os::raw::c_int as std::os::raw::c_uint {
        (*buf).alloc = scheme;
        if !(*buf).buffer.is_null() { (*(*buf).buffer).alloc = scheme }
...
pub unsafe extern "C" fn xmlBufEmpty(mut buf: xmlBufPtr) {
    if buf.is_null() || (*buf).error != 0 as std::os::raw::c_int { return }
    if (*buf).content.is_null() { return }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
        }
    }
    if (*buf).use_0 != (*buf).compat_use as size_t {
        if (*buf).compat_use < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
    ...
    if (*buf).alloc as std::os::raw::c_uint ==
        ...
        (*buf).size =
            ((*buf).size as std::os::raw::c_ulong).wrapping_add(start_buf) as size_t
                as size_t;
    ...
    if (*buf).size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        (*buf).compat_size = (*buf).size as std::os::raw::c_uint
    } else { (*buf).compat_size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint }
    if (*buf).use_0 < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        (*buf).compat_use = (*buf).use_0 as std::os::raw::c_uint
    } else { (*buf).compat_use = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint };
}
/* *
 * xmlBufShrink:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufShrink(mut buf: xmlBufPtr, mut len: size_t)
 -> size_t {
    if buf.is_null() || (*buf).error != 0 as std::os::raw::c_int {
    ...
    if len > (*buf).use_0 { return 0 as std::os::raw::c_int as size_t }
    (*buf).use_0 =
        ((*buf).use_0 as std::os::raw::c_ulong).wrapping_sub(len) as size_t as size_t;
    if (*buf).alloc as std::os::raw::c_uint ==
           XML_BUFFER_ALLOC_IMMUTABLE as std::os::raw::c_int as std::os::raw::c_uint ||
           (*buf).alloc as std::os::raw::c_uint ==
               XML_BUFFER_ALLOC_IO as std::os::raw::c_int as std::os::raw::c_uint &&
	 ...
	 */
        ...
        (*buf).size =
            ((*buf).size as std::os::raw::c_ulong).wrapping_sub(len) as size_t as
                size_t;
        /*
	 ...
	 */
        ...
        memmove((*buf).content as *mut std::os::raw::c_void,
                &mut *(*buf).content.offset(len as isize) as *mut xmlChar as
                    *const std::os::raw::c_void, (*buf).use_0);
        *(*buf).content.offset((*buf).use_0 as isize) =
            0 as std::os::raw::c_int as xmlChar
    }
    if (*buf).size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
 ...
 */
unsafe extern "C" fn xmlBufGrowInternal(mut buf: xmlBufPtr, mut len: size_t)
 -> size_t {
     ...
     */
    if (*buf).size > len {
        size = (*buf).size.wrapping_mul(2 as std::os::raw::c_int as std::os::raw::c_ulong)
    } else {
        size =
	 ...
	 */
        if (*buf).use_0.wrapping_add(len) >=
               10000000 as std::os::raw::c_int as std::os::raw::c_ulong ||
               (*buf).size >= 10000000 as std::os::raw::c_int as std::os::raw::c_ulong {
            xmlBufMemoryError(buf,
                              b"buffer error: text too long\n\x00" as
                                  *const u8 as *const std::os::raw::c_char);
            return 0 as std::os::raw::c_int as size_t
        }
        if size >= 10000000 as std::os::raw::c_int as std::os::raw::c_ulong {
            size = 10000000 as std::os::raw::c_int as size_t
        }
    }
    if (*buf).alloc as std::os::raw::c_uint ==
           XML_BUFFER_ALLOC_IO as std::os::raw::c_int as std::os::raw::c_uint &&
        ...
        if newbuf.is_null() {
            xmlBufMemoryError(buf,
                              b"growing buffer\x00" as *const u8 as
                                  *const std::os::raw::c_char);
            return 0 as std::os::raw::c_int as size_t
        }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufGrow(mut buf: xmlBufPtr, mut len: std::os::raw::c_int)
 -> std::os::raw::c_int {
    let mut ret: size_t = 0;
    if buf.is_null() || len < 0 as std::os::raw::c_int { return -(1 as std::os::raw::c_int) }
    if len == 0 as std::os::raw::c_int { return 0 as std::os::raw::c_int }
    ret = xmlBufGrowInternal(buf, len as size_t);
    if (*buf).error != 0 as std::os::raw::c_int { return -(1 as std::os::raw::c_int) }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufInflate(mut buf: xmlBufPtr, mut len: size_t)
 -> std::os::raw::c_int {
    if buf.is_null() { return -(1 as std::os::raw::c_int) }
    xmlBufGrowInternal(buf, len.wrapping_add((*buf).size));
    if (*buf).error != 0 { return -(1 as std::os::raw::c_int) }
    return 0 as std::os::raw::c_int;
}
/* *
 * xmlBufDump:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufDump(mut file: *mut FILE, mut buf: xmlBufPtr)
 -> size_t {
    let mut ret: size_t = 0;
    if buf.is_null() || (*buf).error != 0 as std::os::raw::c_int {
        return 0 as std::os::raw::c_int as size_t
    }
    if (*buf).content.is_null() { return 0 as std::os::raw::c_int as size_t }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
        }
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufContent(mut buf: *const xmlBuf)
 -> *mut xmlChar {
    if buf.is_null() || (*buf).error != 0 { return 0 as *mut xmlChar }
    return (*buf).content;
}
/* *
 * xmlBufEnd:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufAddLen(mut buf: xmlBufPtr, mut len: size_t)
 -> std::os::raw::c_int {
    if buf.is_null() || (*buf).error != 0 { return -(1 as std::os::raw::c_int) }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
        }
    ...
    (*buf).use_0 =
        ((*buf).use_0 as std::os::raw::c_ulong).wrapping_add(len) as size_t as size_t;
    if (*buf).size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        (*buf).compat_size = (*buf).size as std::os::raw::c_uint
    } else { (*buf).compat_size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint }
    if (*buf).use_0 < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufErase(mut buf: xmlBufPtr, mut len: size_t)
 -> std::os::raw::c_int {
    if buf.is_null() || (*buf).error != 0 { return -(1 as std::os::raw::c_int) }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufIsEmpty(buf: xmlBufPtr) -> std::os::raw::c_int {
    if buf.is_null() || (*buf).error != 0 { return -(1 as std::os::raw::c_int) }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
    ...
    return ((*buf).use_0 == 0 as std::os::raw::c_int as std::os::raw::c_ulong) as std::os::raw::c_int;
}
/* *
 * xmlBufResize:
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufResize(mut buf: xmlBufPtr, mut size: size_t)
 -> std::os::raw::c_int {
    let mut newSize: std::os::raw::c_uint = 0;
    let mut rebuf: *mut xmlChar = 0 as *mut xmlChar;
    let mut start_buf: size_t = 0;
    if buf.is_null() || (*buf).error != 0 { return 0 as std::os::raw::c_int }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
        }
    ...
    match (*buf).alloc as std::os::raw::c_uint {
        3 | 0 => {
            ...
            newSize =
                if (*buf).size != 0 {
                    ...
                    size.wrapping_add(10 as std::os::raw::c_int as std::os::raw::c_ulong)
                } as std::os::raw::c_uint;
            while size > newSize as std::os::raw::c_ulong {
                if newSize >
        ...
        1 => {
            newSize =
                size.wrapping_add(10 as std::os::raw::c_int as std::os::raw::c_ulong) as
                    std::os::raw::c_uint
        }
        4 => {
            if (*buf).use_0 < 4096 as std::os::raw::c_int as std::os::raw::c_ulong {
                newSize = size as std::os::raw::c_uint
            } else {
                newSize =
                    (*buf).size.wrapping_mul(2 as std::os::raw::c_int as
                ...
                while size > newSize as std::os::raw::c_ulong {
                    if newSize >
                       ...
                       {
                        xmlBufMemoryError(buf,
                                          b"growing buffer\x00" as *const u8
    ...
    if (*buf).alloc as std::os::raw::c_uint ==
        ...
        if start_buf > newSize as std::os::raw::c_ulong {
            ...
            memmove((*buf).contentIO as *mut std::os::raw::c_void,
                    (*buf).content as *const std::os::raw::c_void, (*buf).use_0);
            (*buf).content = (*buf).contentIO;
            *(*buf).content.offset((*buf).use_0 as isize) =
                0 as std::os::raw::c_int as xmlChar;
            (*buf).size =
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufAdd(mut buf: xmlBufPtr,
    ...
    needSize =
        (*buf).use_0.wrapping_add(len as
                                      std::os::raw::c_ulong).wrapping_add(2 as
                                                                      ...
                                                                      std::os::raw::c_ulong)
            as std::os::raw::c_uint;
    if needSize as std::os::raw::c_ulong > (*buf).size {
        if (*buf).alloc as std::os::raw::c_uint ==
               XML_BUFFER_ALLOC_BOUNDED as std::os::raw::c_int as std::os::raw::c_uint {
            /*
	     * Used to provide parsing limits
	     */
            if needSize >= 10000000 as std::os::raw::c_int as std::os::raw::c_uint {
                xmlBufMemoryError(buf,
                                  b"buffer error: text too long\n\x00" as
                                      *const u8 as *const std::os::raw::c_char);
                return -(1 as std::os::raw::c_int)
    ...
    (*buf).use_0 =
        ((*buf).use_0 as std::os::raw::c_ulong).wrapping_add(len as std::os::raw::c_ulong) as
            size_t as size_t;
    *(*buf).content.offset((*buf).use_0 as isize) =
        0 as std::os::raw::c_int as xmlChar;
    if (*buf).size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufAddHead(mut buf: xmlBufPtr,
                                       mut str: *const xmlChar,
                                       mut len: std::os::raw::c_int) -> std::os::raw::c_int {
    let mut needSize: std::os::raw::c_uint = 0;
    if buf.is_null() || (*buf).error != 0 { return -(1 as std::os::raw::c_int) }
    ...
    if (*buf).alloc as std::os::raw::c_uint ==
	     ...
	     */
            ...
            if (*buf).size < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
                ...
                (*buf).compat_size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint
            }
            if (*buf).use_0 < 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
                (*buf).compat_use = (*buf).use_0 as std::os::raw::c_uint
            } else {
                (*buf).compat_use = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint
            }
            return 0 as std::os::raw::c_int
        }
    }
    ...
    memmove(&mut *(*buf).content.offset(len as isize) as *mut xmlChar as
            ...
            &mut *(*buf).content.offset(0 as std::os::raw::c_int as isize) as
                *mut xmlChar as *const std::os::raw::c_void, (*buf).use_0);
    memmove(&mut *(*buf).content.offset(0 as std::os::raw::c_int as isize) as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufCat(mut buf: xmlBufPtr,
    ...
    if str.is_null() { return -(1 as std::os::raw::c_int) }
    return xmlBufAdd(buf, str, -(1 as std::os::raw::c_int));
}
/* *
 * xmlBufCCat:
 * @buf:  the buffer to dump
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufCCat(mut buf: xmlBufPtr,
 ...
 -> std::os::raw::c_int {
    ...
    while *cur as std::os::raw::c_int != 0 as std::os::raw::c_int {
        if (*buf).use_0.wrapping_add(10 as std::os::raw::c_int as std::os::raw::c_ulong) >=
               (*buf).size {
            if xmlBufResize(buf,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufWriteCHAR(mut buf: xmlBufPtr,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufWriteQuotedString(mut buf: xmlBufPtr,
                                                 mut string: *const xmlChar)
 -> std::os::raw::c_int {
    ...
    if !xmlStrchr(string, '\"' as i32 as xmlChar).is_null() {
        if !xmlStrchr(string, '\'' as i32 as xmlChar).is_null() {
            xmlBufCCat(buf, b"\"\x00" as *const u8 as *const std::os::raw::c_char);
            cur = string;
            base = cur;
            while *cur as std::os::raw::c_int != 0 as std::os::raw::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufFromBuffer(mut buffer: xmlBufferPtr)
 -> xmlBufPtr {
    let mut ret: xmlBufPtr = 0 as *mut xmlBuf;
    if buffer.is_null() { return 0 as xmlBufPtr }
    ret =
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlBuf>()
                                                          as std::os::raw::c_ulong) as
            xmlBufPtr;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufBackToBuffer(mut buf: xmlBufPtr)
 -> xmlBufferPtr {
    let mut ret: xmlBufferPtr = 0 as *mut xmlBuffer;
    if buf.is_null() || (*buf).error != 0 { return 0 as xmlBufferPtr }
    if (*buf).size != (*buf).compat_size as size_t {
        if (*buf).compat_size < 2147483647 as std::os::raw::c_int as std::os::raw::c_uint {
            (*buf).size = (*buf).compat_size as size_t
        }
    ...
    if (*buf).buffer.is_null() { xmlBufFree(buf); return 0 as xmlBufferPtr }
    ret = (*buf).buffer;
    /*
    ...
    if (*buf).use_0 > 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        ...
        xmlBufOverflowError(buf,
                            b"Used size too big for xmlBuffer\x00" as
                                *const u8 as *const std::os::raw::c_char);
        (*ret).use_0 = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint;
        (*ret).size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint
    } else if (*buf).size > 2147483647 as std::os::raw::c_int as std::os::raw::c_ulong {
        /*
         ...
         */
        xmlBufOverflowError(buf,
                            b"Allocated size too big for xmlBuffer\x00" as
                                *const u8 as *const std::os::raw::c_char);
        (*ret).size = 2147483647 as std::os::raw::c_int as std::os::raw::c_uint
    }
    (*ret).use_0 = (*buf).use_0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*ret).size = (*buf).size as std::os::raw::c_int as std::os::raw::c_uint;
    (*ret).alloc = (*buf).alloc;
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufMergeBuffer(mut buf: xmlBufPtr,
 ...
 -> std::os::raw::c_int {
    ...
    if !buffer.is_null() && !(*buffer).content.is_null() &&
           (*buffer).use_0 > 0 as std::os::raw::c_int as std::os::raw::c_uint {
        ret =
            xmlBufAdd(buf, (*buffer).content, (*buffer).use_0 as std::os::raw::c_int)
    }
    xmlBufferFree(buffer);
    return ret;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufResetInput(mut buf: xmlBufPtr,
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufGetInputBase(mut buf: xmlBufPtr,
                                            mut input: xmlParserInputPtr)
 -> size_t {
    ...
    base =
        (*input).base.offset_from((*buf).content) as std::os::raw::c_long as
            size_t;
    /*
    ...
    if base > (*buf).size {
        xmlBufOverflowError(buf,
                            b"Input reference outside of the buffer\x00" as
                                *const u8 as *const std::os::raw::c_char);
        base = 0 as std::os::raw::c_int as size_t
    }
    return base;
}
/* *
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlBufSetInputBaseCur(mut buf: xmlBufPtr,
                                               mut input: xmlParserInputPtr,
                                               mut base: size_t,
                                               mut cur: size_t)
 -> std::os::raw::c_int {
    ...
    (*input).base =
        &mut *(*buf).content.offset(base as isize) as *mut xmlChar;
