 ...
 */
    ...
    #[no_mangle]
    fn dlopen(__file: *const std::os::raw::c_char, __mode: std::os::raw::c_int)
     -> *mut std::os::raw::c_void;
    #[no_mangle]
    fn dlclose(__handle: *mut std::os::raw::c_void) -> std::os::raw::c_int;
    #[no_mangle]
    fn dlsym(__handle: *mut std::os::raw::c_void, __name: *const std::os::raw::c_char)
     -> *mut std::os::raw::c_void;
    #[no_mangle]
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlModuleOpen(mut name: *const std::os::raw::c_char,
                                       mut options: std::os::raw::c_int)
 -> xmlModulePtr {
    let mut module: xmlModulePtr = 0 as *mut xmlModule;
    module =
        xmlMalloc.expect("non-null function pointer")(::std::mem::size_of::<xmlModule>()
                                                          as std::os::raw::c_ulong) as
            xmlModulePtr;
    if module.is_null() {
        xmlModuleErrMemory(0 as xmlModulePtr,
                           b"creating module\x00" as *const u8 as
                               *const std::os::raw::c_char);
        return 0 as xmlModulePtr
    }
    memset(module as *mut std::os::raw::c_void, 0 as std::os::raw::c_int,
           ::std::mem::size_of::<xmlModule>() as std::os::raw::c_ulong);
    (*module).handle = xmlModulePlatformOpen(name);
    if (*module).handle.is_null() {
        xmlFree.expect("non-null function pointer")(module as
                                                        *mut std::os::raw::c_void);
        __xmlRaiseError(None, None, 0 as *mut std::os::raw::c_void,
                        0 as *mut std::os::raw::c_void, 0 as *mut std::os::raw::c_void,
                        XML_FROM_MODULE as std::os::raw::c_int,
                        XML_MODULE_OPEN as std::os::raw::c_int, XML_ERR_FATAL,
                        0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int,
                        0 as *const std::os::raw::c_char, name,
                        0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int,
                        0 as std::os::raw::c_int,
                        b"failed to open %s\n\x00" as *const u8 as
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlModuleSymbol(mut module: xmlModulePtr,
                                         mut name: *const std::os::raw::c_char,
                                         mut symbol: *mut *mut std::os::raw::c_void)
 -> std::os::raw::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlModuleClose(mut module: xmlModulePtr)
 -> std::os::raw::c_int {
    ...
    if module.is_null() {
        __xmlRaiseError(None, None, 0 as *mut std::os::raw::c_void,
                        0 as *mut std::os::raw::c_void, 0 as *mut std::os::raw::c_void,
                        XML_FROM_MODULE as std::os::raw::c_int,
                        XML_MODULE_CLOSE as std::os::raw::c_int, XML_ERR_FATAL,
                        0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int,
                        0 as *const std::os::raw::c_char, 0 as *const std::os::raw::c_char,
                        0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int,
                        0 as std::os::raw::c_int,
    ...
    if rc != 0 as std::os::raw::c_int {
        __xmlRaiseError(None, None, 0 as *mut std::os::raw::c_void,
                        ...
                        (*module).name as *const std::os::raw::c_char,
                        0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int,
                        0 as std::os::raw::c_int,
                        b"failed to close: %s\n\x00" as *const u8 as
                            *const std::os::raw::c_char, (*module).name);
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn xmlModuleFree(mut module: xmlModulePtr)
 -> std::os::raw::c_int {
    if module.is_null() {
        __xmlRaiseError(None, None, 0 as *mut std::os::raw::c_void,
                        0 as *mut std::os::raw::c_void, 0 as *mut std::os::raw::c_void,
    ...
    xmlFree.expect("non-null function pointer")((*module).name as
                                                    *mut std::os::raw::c_void);
    xmlFree.expect("non-null function pointer")(module as *mut std::os::raw::c_void);
 ...
 */
unsafe extern "C" fn xmlModulePlatformOpen(mut name: *const std::os::raw::c_char)
 -> *mut std::os::raw::c_void {
    return dlopen(name, 0x100 as std::os::raw::c_int | 0x2 as std::os::raw::c_int);
}
/*
 ...
 */
unsafe extern "C" fn xmlModulePlatformClose(mut handle: *mut std::os::raw::c_void)
 -> std::os::raw::c_int {
 ...
 */
unsafe extern "C" fn xmlModulePlatformSymbol(mut handle: *mut std::os::raw::c_void,
                                             mut name: *const std::os::raw::c_char,
                                             mut symbol:
                                                 *mut *mut std::os::raw::c_void)
 -> std::os::raw::c_int {
    *symbol = dlsym(handle, name);
    if !dlerror().is_null() { return -(1 as std::os::raw::c_int) }
    return 0 as std::os::raw::c_int;
}
