 ...
 * copy: see Copyright for the status of this software.
 */
static mut document: *const std::os::raw::c_char =
    b"<doc/>\x00" as *const u8 as *const std::os::raw::c_char;
/* *
 * example3Func:
 ...
 */
unsafe extern "C" fn example3Func(mut content: *const std::os::raw::c_char,
                                  mut length: std::os::raw::c_int) {
     ...
     */
    doc =
        xmlReadMemory(content, length,
                      b"noname.xml\x00" as *const u8 as *const std::os::raw::c_char,
                      0 as *const std::os::raw::c_char, 0 as std::os::raw::c_int);
    if doc.is_null() {
        fprintf(stderr,
                b"Failed to parse document\n\x00" as *const u8 as
...
unsafe fn main_0() -> std::os::raw::c_int {
    ...
    example3Func(document, 6 as std::os::raw::c_int);
    /*
