...
pub unsafe extern "C" fn BZ2_decompress(mut s: *mut crate::bzlib::DState) -> Int32 {
    ...
    match (*s).state {
        10 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    let mut v: UInt32 = 0;
                    v = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                ...
                } else if (*(*s).strm).avail_in == 0 as std::os::raw::c_int as std::os::raw::c_uint
                {
                    ...
                    (*s).bsBuff = (*s).bsBuff << 8 as std::os::raw::c_int
        ...
        12 => {
            current_block = 15146946972525368609;
        }
        13 => {
            current_block = 13504760517129887221;
        }
        14 => {
            current_block = 7948568793456312728;
        }
        15 => {
            current_block = 16703841960874917807;
        }
        16 => {
        ...
        12259750428863723923 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_0 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        15146946972525368609 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_1 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        13504760517129887221 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_2 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
            ...
            match current_block {
                15885526978618306830 => {}
                _ => {
                    if (*s).blockSize100k < 0x30 as std::os::raw::c_int + 1 as std::os::raw::c_int
                        || (*s).blockSize100k
                            > 0x30 as std::os::raw::c_int + 9 as std::os::raw::c_int
                    {
                        ...
                        if (*s).smallDecompress != 0 {
                            (*s).ll16 = (*strm).bzalloc.expect("non-null function pointer")(
                                (*strm).opaque,
                                (((*s).blockSize100k * 100000 as std::os::raw::c_int)
                            ...
                            (*s).tt = (*strm).bzalloc.expect("non-null function pointer")(
                                ...
                                (((*s).blockSize100k * 100000 as std::os::raw::c_int)
                                    as std::os::raw::c_ulong)
                                    .wrapping_mul(
                                        ::std::mem::size_of::<Int32>() as std::os::raw::c_ulong
                                    ) as std::os::raw::c_int,
                                1 as std::os::raw::c_int,
                            ) as *mut UInt32;
                            if (*s).tt.is_null() {
        ...
        7948568793456312728 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_3 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        10200488719709598753 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_32 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        16703841960874917807 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_4 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        9864403379770423142 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_33 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        12231332282017165356 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_5 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        8489059574810375089 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_34 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        7286555771988341860 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_6 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        12998570369541158573 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_35 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        6656868271313165664 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_7 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        10541196509243133637 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_36 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        15902903523132075486 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_8 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        8760950161942609538 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_37 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
            ...
            match current_block {
                ...
                _ => {
                    (*s).storedCombinedCRC =
                        (*s).storedCombinedCRC << 8 as std::os::raw::c_int | uc as UInt32;
                    current_block = 3131443096645543054;
                }
            }
        }
        16204949703499709801 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_9 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
            ...
            match current_block {
                ...
                _ => {
                    (*s).storedBlockCRC =
                        (*s).storedBlockCRC << 8 as std::os::raw::c_int | uc as UInt32;
                    current_block = 5505795673017046993;
                }
            }
        }
        ...
        3131443096645543054 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_38 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        5505795673017046993 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_10 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        1975408140333322065 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_39 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        14563596112884461881 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_11 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        12051594319698232578 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_12 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        15818179691129344165 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_40 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        14315698657705028467 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 1 as std::os::raw::c_int {
                    ...
                    v_13 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
        ...
        640681092829779800 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_14 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
            ...
            match current_block {
                15885526978618306830 => {}
                _ => {
                    (*s).origPtr = (*s).origPtr << 8 as std::os::raw::c_int | uc as Int32;
                    current_block = 588075840077989673;
                }
            }
        }
        ...
        588075840077989673 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_15 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
        ...
        34749046854646975 => {
            ...
            loop {
                ...
                if (*s).bsLive >= 8 as std::os::raw::c_int {
                    ...
                    v_16 = (*s).bsBuff >> (*s).bsLive - 8 as std::os::raw::c_int
                        & (((1 as std::os::raw::c_int) << 8 as std::os::raw::c_int)
                            - 1 as std::os::raw::c_int)
                            as std::os::raw::c_uint;
                    (*s).bsLive -= 8 as std::os::raw::c_int;
                ...
                _ => {
                    ...
                    if (*s).origPtr < 0 as std::os::raw::c_int {
                        ...
                        > 10 as std::os::raw::c_int
                            + 100000 as std::os::raw::c_int * (*s).blockSize100k
                    {
                        retVal = -(4 as std::os::raw::c_int);
                        current_block = 15885526978618306830;
                    } else {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= zn {
                        ...
                        v_30 = (*s).bsBuff >> (*s).bsLive - zn
                            & (((1 as std::os::raw::c_int) << zn) - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= zn;
                        zvec = v_30 as Int32;
                        break;
            ...
            13999925517074022731 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_29 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            14744029255125744966 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_27 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            5008197131544113214 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_25 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            1736021991379636935 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_24 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            10945178116989557996 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 5 as std::os::raw::c_int {
                        ...
                        v_23 = (*s).bsBuff >> (*s).bsLive - 5 as std::os::raw::c_int
            ...
            4874723077730206021 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_21 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            5769007513321684282 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 15 as std::os::raw::c_int {
                        ...
                        v_20 = (*s).bsBuff >> (*s).bsLive - 15 as std::os::raw::c_int
            ...
            /*--- Now the selectors ---*/
            {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 3 as std::os::raw::c_int {
                        ...
                        v_19 = (*s).bsBuff >> (*s).bsLive - 3 as std::os::raw::c_int
                ...
                if !(nGroups < 2 as std::os::raw::c_int || nGroups > 6 as std::os::raw::c_int) {
                    current_block = 5769007513321684282;
                    continue;
                }
                retVal = -(4 as std::os::raw::c_int);
            ...
            1422779171932145779 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_18 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            16487873541482693172 => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_17 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
            ...
            _ => {
                ...
                while 1 as std::os::raw::c_int as Bool != 0 {
                    if (*s).bsLive >= 1 as std::os::raw::c_int {
                        ...
                        v_31 = (*s).bsBuff >> (*s).bsLive - 1 as std::os::raw::c_int
                            & (((1 as std::os::raw::c_int) << 1 as std::os::raw::c_int)
                                - 1 as std::os::raw::c_int)
                                as std::os::raw::c_uint;
                        (*s).bsLive -= 1 as std::os::raw::c_int;
        ...
        match current_block {
            9078889872071895942 => {
                if zn > 20 as std::os::raw::c_int {
                    ...
                    if zvec - *gBase.offset(zn as isize) < 0 as std::os::raw::c_int
                        || zvec - *gBase.offset(zn as isize) >= 258 as std::os::raw::c_int
                    {
                        retVal = -(4 as std::os::raw::c_int);
                        current_block = 15885526978618306830;
                        continue;
                        ...
                        || zvec - *gBase.offset(zn as isize) >= 258 as std::os::raw::c_int
                    {
                            ...
                            || nextSym == 1 as std::os::raw::c_int
                        {
                            ...
                            uc = (*s).seqToUnseq[(*s).mtfa
                                [(*s).mtfbase[0 as std::os::raw::c_int as usize] as usize]
                                as usize];
        ...
        match current_block {
            15093386068129942558 => {
                    ...
                    if nextSym == EOB {
                            ...
                            || nextSym == 1 as std::os::raw::c_int
                        {
                            ...
                            if nn < 16 as std::os::raw::c_int as std::os::raw::c_uint {
                                ...
                                pp = (*s).mtfbase[0 as std::os::raw::c_int as usize];
                                uc = (*s).mtfa
                                    [(pp as std::os::raw::c_uint).wrapping_add(nn) as usize];
                                while nn > 3 as std::os::raw::c_int as std::os::raw::c_uint {
                                    let mut z: Int32 =
                                        (pp as std::os::raw::c_uint).wrapping_add(nn) as Int32;
                                    (*s).mtfa[z as usize] =
                                        (*s).mtfa[(z - 1 as std::os::raw::c_int) as usize];
                                    (*s).mtfa[(z - 1 as std::os::raw::c_int) as usize] =
                                        (*s).mtfa[(z - 2 as std::os::raw::c_int) as usize];
                                    (*s).mtfa[(z - 2 as std::os::raw::c_int) as usize] =
                                        (*s).mtfa[(z - 3 as std::os::raw::c_int) as usize];
                                    (*s).mtfa[(z - 3 as std::os::raw::c_int) as usize] =
                                        (*s).mtfa[(z - 4 as std::os::raw::c_int) as usize];
                                    nn = (nn as std::os::raw::c_uint).wrapping_sub(
                                        4 as std::os::raw::c_int as std::os::raw::c_uint,
                                    ) as UInt32 as UInt32
                                }
                                while nn > 0 as std::os::raw::c_int as std::os::raw::c_uint {
                                    (*s).mtfa
                                        [(pp as std::os::raw::c_uint).wrapping_add(nn) as usize] =
                                        (*s).mtfa[(pp as std::os::raw::c_uint)
                                            .wrapping_add(nn)
                                            .wrapping_sub(
                                ...
                                /* general case */
                                lno = nn
                                    .wrapping_div(16 as std::os::raw::c_int as std::os::raw::c_uint)
                                    as Int32;
                                off = nn
                                    .wrapping_rem(16 as std::os::raw::c_int as std::os::raw::c_uint)
                                    as Int32;
                                pp = (*s).mtfbase[lno as usize] + off;
                                uc = (*s).mtfa[pp as usize];
                                while pp > (*s).mtfbase[lno as usize] {
                                    (*s).mtfa[pp as usize] =
                                        (*s).mtfa[(pp - 1 as std::os::raw::c_int) as usize];
                                    pp -= 1
                                }
                                (*s).mtfbase[lno as usize] += 1;
                                while lno > 0 as std::os::raw::c_int {
                                    (*s).mtfbase[lno as usize] -= 1;
                                    (*s).mtfa[(*s).mtfbase[lno as usize] as usize] = (*s).mtfa[((*s)
                                        .mtfbase
                                        [(lno - 1 as std::os::raw::c_int) as usize]
                                        + 16 as std::os::raw::c_int
                                        - 1 as std::os::raw::c_int)
                                        as usize];
                                    lno -= 1
                                }
                                (*s).mtfbase[0 as std::os::raw::c_int as usize] -= 1;
                                (*s).mtfa
                                    [(*s).mtfbase[0 as std::os::raw::c_int as usize] as usize] = uc;
                                if (*s).mtfbase[0 as std::os::raw::c_int as usize]
                                    == 0 as std::os::raw::c_int
                                {
                                    kk_0 = 4096 as std::os::raw::c_int - 1 as std::os::raw::c_int;
                                    ii_0 = 256 as std::os::raw::c_int / 16 as std::os::raw::c_int
                                        - 1 as std::os::raw::c_int;
                                    while ii_0 >= 0 as std::os::raw::c_int {
                                        jj_0 = 16 as std::os::raw::c_int - 1 as std::os::raw::c_int;
                ...
                match current_block {
                    ...
                    */
                    {
                        if (*s).origPtr < 0 as std::os::raw::c_int || (*s).origPtr >= nblock {
                            retVal = -(4 as std::os::raw::c_int);
                            current_block = 15885526978618306830;
                            continue;
                        } else {
                            ...
                            while i <= 255 as std::os::raw::c_int {
                                if (*s).unzftab[i as usize] < 0 as std::os::raw::c_int
                            ...
                            while i <= 256 as std::os::raw::c_int {
                                (*s).cftab[i as usize] =
                                    (*s).unzftab[(i - 1 as std::os::raw::c_int) as usize];
                                i += 1
                            }
                            i = 1 as std::os::raw::c_int;
                            while i <= 256 as std::os::raw::c_int {
                                (*s).cftab[i as usize] +=
                                    (*s).cftab[(i - 1 as std::os::raw::c_int) as usize];
                                i += 1
                            }
                            /* Check: cftab entries in range. */
                            i = 0 as std::os::raw::c_int;
                            while i <= 256 as std::os::raw::c_int {
                                if (*s).cftab[i as usize] < 0 as std::os::raw::c_int
                            ...
                            i = 1 as std::os::raw::c_int;
                            while i <= 256 as std::os::raw::c_int {
                                if (*s).cftab[(i - 1 as std::os::raw::c_int) as usize]
                                    > (*s).cftab[i as usize]
                                {
                                    retVal = -(4 as std::os::raw::c_int);
                                    current_block = 15885526978618306830;
                            ...
                            (*s).calculatedBlockCRC = 0xffffffff as std::os::raw::c_long as UInt32;
                            (*s).state = 2 as std::os::raw::c_int;
                            if (*s).verbosity >= 2 as std::os::raw::c_int {
                                fprintf(
                                    __stderrp,
                                    b"rt+rld\x00" as *const u8 as *const std::os::raw::c_char,
                                );
                            }
                            if (*s).smallDecompress != 0 {
                                ...
                                while i < nblock {
                                    ...
                                    *(*s).ll16.offset(i as isize) = ((*s).cftabCopy[uc as usize]
                                        ...
                                        as UInt16;
                                    if i & 0x1 as std::os::raw::c_int == 0 as std::os::raw::c_int {
                                        *(*s).ll4.offset((i >> 1 as std::os::raw::c_int) as isize) =
                                            (*(*s)
                                                .ll4
                                ...
                                loop {
                                    let mut tmp_0: Int32 = (*(*s).ll16.offset(j as isize) as UInt32
                                        | (*(*s)
                                            .ll4
                                            .offset((j >> 1 as std::os::raw::c_int) as isize)
                                            as UInt32
                                    ...
                                    *(*s).ll16.offset(j as isize) =
                                        (i & 0xffff as std::os::raw::c_int) as UInt16;
                                    if j & 0x1 as std::os::raw::c_int == 0 as std::os::raw::c_int {
                                        *(*s).ll4.offset((j >> 1 as std::os::raw::c_int) as isize) =
                                            (*(*s)
                                                .ll4
                                                .offset((j >> 1 as std::os::raw::c_int) as isize)
                                                as std::os::raw::c_int
                                ...
                                if (*s).blockRandomised != 0 {
                                    ...
                                    if (*s).tPos
                                        >= (100000 as std::os::raw::c_int as UInt32)
                                            .wrapping_mul((*s).blockSize100k as UInt32)
                                    {
                                        return 1 as std::os::raw::c_int as Bool as Int32;
                                    }
                                    (*s).k0 = crate::bzlib::BZ2_indexIntoF(
                                        (*s).tPos as Int32,
                                        (*s).cftab.as_mut_ptr(),
                                    );
                                    (*s).tPos = *(*s).ll16.offset((*s).tPos as isize) as UInt32
                                        | (*(*s).ll4.offset(
                                            ((*s).tPos >> 1 as std::os::raw::c_int) as isize,
                                        ) as UInt32
                                    ...
                                    (*s).rNToGo -= 1;
                                    (*s).k0 ^= if (*s).rNToGo == 1 as std::os::raw::c_int {
                                        1 as std::os::raw::c_int
                                    } else {
                                        0 as std::os::raw::c_int
                                    }
                                ...
                                while i < nblock {
                                    ...
                                    *(*s).tt.offset((*s).cftab[uc as usize] as isize) =
                                        (i << 8 as std::os::raw::c_int) as std::os::raw::c_uint;
        ...
        match current_block {
            ...
            rejecting any legitimate inputs. */
            {
                    ...
                    * 1024 as std::os::raw::c_int
                {
                    ...
                    if nextSym == 0 as std::os::raw::c_int {
                        es = es + (0 as std::os::raw::c_int + 1 as std::os::raw::c_int) * N
                    } else if nextSym == 1 as std::os::raw::c_int {
                        es = es + (1 as std::os::raw::c_int + 1 as std::os::raw::c_int) * N
                    }
            ...
            match current_block {
                ...
                6591141407893725683 => {
                    if i < nSelectors {
                        ...
                        {
                            nSelectors = 2 as std::os::raw::c_int
                                + 900000 as std::os::raw::c_int / 50 as std::os::raw::c_int
                        }
                        ...
                        while i < nSelectors {
                            ...
                            while v_22 as std::os::raw::c_int > 0 as std::os::raw::c_int {
                                pos[v_22 as usize] = pos[(v_22 as std::os::raw::c_int
                                    - 1 as std::os::raw::c_int)
                                    as usize];
                ...
                _ => {
                    ...
                    if !(curr < 1 as std::os::raw::c_int || curr > 20 as std::os::raw::c_int) {
                        current_block = 1736021991379636935;
                        continue 'c_10532;
                    }
                    retVal = -(4 as std::os::raw::c_int);
        ...
        match current_block {
            ...
            _ => {
                ...
                while t < nGroups {
                    ...
                    crate::huffman::BZ2_hbCreateDecodeTables(
