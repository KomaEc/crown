...
pub static mut BZ2_crc32Table: [UInt32; 256] = [
    0 as std::os::raw::c_long as UInt32,
    0x4c11db7 as std::os::raw::c_long as UInt32,
    0x9823b6e as std::os::raw::c_long as UInt32,
    0xd4326d9 as std::os::raw::c_long as UInt32,
    ...
    0x18aeb13 as std::os::raw::c_long as UInt32,
    0x54bf6a4 as std::os::raw::c_long as UInt32,
    0x808d07d as std::os::raw::c_long as UInt32,
    0xcc9cdca as std::os::raw::c_long as UInt32,
    ...
    0x315d626 as std::os::raw::c_long as UInt32,
    0x7d4cb91 as std::os::raw::c_long as UInt32,
    0xa97ed48 as std::os::raw::c_long as UInt32,
    0xe56f0ff as std::os::raw::c_long as UInt32,
    ...
    0x29f3d35 as std::os::raw::c_long as UInt32,
    0x65e2082 as std::os::raw::c_long as UInt32,
    0xb1d065b as std::os::raw::c_long as UInt32,
    0xfdc1bec as std::os::raw::c_long as UInt32,
