                        ...
                        if (*s).smallDecompress != 0 {
                            (*s).ll16 = (*strm).bzalloc.expect("non-null function pointer")(
                                ...
                                (((*s).blockSize100k * 100000 as libc::c_int) as libc::c_ulong)
                                    .wrapping_mul(::std::mem::size_of::<UInt16>() as libc::c_ulong)
                                    as libc::c_int,
                                1 as libc::c_int,
                            ) as *mut UInt16;
                            (*s).ll4 = (*strm).bzalloc.expect("non-null function pointer")(
                                ...
                                ((1 as libc::c_int + (*s).blockSize100k * 100000 as libc::c_int
                                    >> 1 as libc::c_int)
                                    as libc::c_ulong)
                                    .wrapping_mul(::std::mem::size_of::<UChar>() as libc::c_ulong)
                                    as libc::c_int,
                                1 as libc::c_int,
                            ) as *mut UChar;
                        ...
                        if nextSym == 0 as libc::c_int || nextSym == 1 as libc::c_int {
                            ...
                            if nn < 16 as libc::c_int as libc::c_uint {
                                ...
                                if (*s).mtfbase[0 as libc::c_int as usize] == 0 as libc::c_int {
                                    ...
                                    ii_0 =
                                        256 as libc::c_int / 16 as libc::c_int - 1 as libc::c_int;
                            ...
                            if groupPos == 0 as libc::c_int {
                                ...
                                if groupNo >= nSelectors {
                                    ...
                                    gLimit =
                                        &raw mut *(*(*s).limit.as_mut_ptr().offset(gSel as isize))
                                            .as_mut_ptr()
                                            .offset(0 as libc::c_int as isize)
                                            as *mut Int32;
                                    gPerm =
                                        &raw mut *(*(*s).perm.as_mut_ptr().offset(gSel as isize))
                                            .as_mut_ptr()
                                            .offset(0 as libc::c_int as isize)
                                            as *mut Int32;
                                    gBase =
                                        &raw mut *(*(*s).base.as_mut_ptr().offset(gSel as isize))
                                            .as_mut_ptr()
                                            .offset(0 as libc::c_int as isize)
                                            as *mut Int32;
                                }
                ...
                match current_block {
                    ...
                    _ => {
                        if (*s).origPtr < 0 as libc::c_int || (*s).origPtr >= nblock {
                            ...
                            while i <= 256 as libc::c_int {
                                (*s).cftab[i as usize] =
                                    (*s).unzftab[(i - 1 as libc::c_int) as usize];
                                i += 1;
                            }
                            i = 1 as libc::c_int;
                            while i <= 256 as libc::c_int {
                            ...
                            if (*s).smallDecompress != 0 {
                                ...
                                while i < nblock {
                                    ...
                                    *(*s).ll16.offset(i as isize) = ((*s).cftabCopy[uc as usize]
                                    ...
                                    if i & 0x1 as libc::c_int == 0 as libc::c_int {
                                        ...
                                        *(*s).ll4.offset((i >> 1 as libc::c_int) as isize) = (*(*s)
                                            .ll4
                                ...
                                if (*s).blockRandomised != 0 {
                                    ...
                                    (*s).tPos = *(*s).ll16.offset((*s).tPos as isize) as UInt32
                                        | (*(*s)
                                            .ll4
                                            .offset(((*s).tPos >> 1 as libc::c_int) as isize)
                                            as UInt32
