...
unsafe extern "C" fn generateMTFValues(mut s: *mut crate::src::blocksort::EState) {
    ...
    while i < (*s).nblock {
        ...
        if yy[0 as libc::c_int as usize] as libc::c_int == ll_i as libc::c_int {
            ...
            ryy_j = &raw mut *yy.as_mut_ptr().offset(1 as libc::c_int as isize) as *mut UChar;
            rll_i = ll_i;
...
unsafe extern "C" fn sendMTFValues(mut s: *mut crate::src::blocksort::EState) {
    ...
    while 1 as libc::c_int as Bool != 0 {
        ...
        if nGroups == 6 as libc::c_int && 50 as libc::c_int == ge - gs + 1 as libc::c_int {
            ...
            let mut s_len_sel_selCtr: *mut UChar = &raw mut *(*(*s)
                .len
                .as_mut_ptr()
            ...
            .offset(0 as libc::c_int as isize)
                as *mut UChar;
            let mut s_code_sel_selCtr: *mut Int32 = &raw mut *(*(*s)
                .code
                .as_mut_ptr()
                .offset(*(*s).selector.as_mut_ptr().offset(selCtr as isize) as isize))
            .as_mut_ptr()
...
pub unsafe extern "C" fn BZ2_compressBlock(
    mut s: *mut crate::src::blocksort::EState,
    ...
    (*s).zbits = &raw mut *((*s).arr2 as *mut UChar).offset((*s).nblock as isize) as *mut UChar;
    if (*s).blockNo == 1 as libc::c_int {
        ...
        bsPutUChar(
            s.as_mut(),
            (0x30 as libc::c_int + (*s).blockSize100k) as UChar,
        );
    }
    if (*s).nblock > 0 as libc::c_int {
