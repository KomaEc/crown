...
pub struct _IO_FILE {
    ...
    pub _markers: *mut crate::src::bzlib::_IO_marker,
    ...
    pub _codecvt: *mut crate::src::compress::_IO_codecvt,
    pub _wide_data: *mut crate::src::bzlib::_IO_wide_data,
...
unsafe extern "C" fn fallbackSort(
    ...
    while i < 256 as libc::c_int {
        *bhtab
            .offset((ftab[i as usize] >> 5 as libc::c_int) as isize) = (1 as libc::c_int as UInt32) << (ftab[i as usize] & 31 as libc::c_int);
        i+= 1;
    }
    i= 0 as libc::c_int;
    while i < 32 as libc::c_int {
        *bhtab
            .offset((nblock + 2 as libc::c_int * i >> 5 as libc::c_int) as isize) = (1 as libc::c_int as UInt32)
        ...
        loop {
            ...
            if r > l {
                ...
                while i <= r {
                    ...
                    if cc != cc1 {
                        *bhtab
                            .offset((i >> 5 as libc::c_int) as isize) = (1 as libc::c_int as UInt32) << (i & 31 as libc::c_int);
                        cc= cc1;
                    }
                    i+= 1;
                }
        ...
        while j <= 255 as libc::c_int {
            if j != ss {
                ...
                if *ftab.offset(sb as isize)
                    & ((1 as libc::c_int) << 21 as libc::c_int) as libc::c_uint == 0
                {
                ...
                *ftab.offset(sb as isize) = ((1 as libc::c_int) << 21 as libc::c_int) as libc::c_uint;
            }
            j+= 1;
        }
