...
pub unsafe extern "C" fn heman_ops_step(
    ...
    if (*hmap).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_step(heman_image *, float)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_max(
    ...
    if (*imga).width == (*imgb).width {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_max(heman_image *, heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_sweep(
    ...
    if (*hmap).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_sweep(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_stitch_horizontal(
    ...
    if count > 0 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_stitch_horizontal(heman_image **, int)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_stitch_vertical(
    ...
    if count > 0 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_stitch_vertical(heman_image **, int)\0" as *const u8 as *const i8,
        );
    }
    let mut width = (**images.offset(0 as libc::c_int as isize)).width;
    let mut height = (**images.offset(0 as libc::c_int as isize)).height;
...
pub unsafe extern "C" fn heman_ops_laplacian(
    ...
    if (*heightmap).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_laplacian(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_accumulate(
    ...
    if (*dst.as_deref().unwrap()).nbands == (*src).nbands {} else {
        __assert_fail(
            ...
            b"void heman_ops_accumulate(heman_image *, heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_sobel(
    ...
    if (*img).nbands == 3 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_sobel(heman_image *, heman_color)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_extract_mask(
    ...
    if (*source).nbands == 3 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_extract_mask(heman_image *, heman_color, int)\0" as *const u8 as *const i8,
        );
    }
    let mut inv = 1.0f32 / 255.0f32;
...
pub unsafe extern "C" fn heman_ops_replace_color(
    ...
    if (*source).nbands == 3 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_replace_color(heman_image *, heman_color, heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_percentiles(
    ...
    if (*hmap.as_deref().unwrap()).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_percentiles(heman_image *, int, heman_image *, heman_color, int, float)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_stairstep(
    ...
    if (*hmap.as_deref().unwrap()).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_stairstep(heman_image *, int, heman_image *, heman_color, int, float)\0" as *const u8 as *const i8,
        );
    }
    if mask.is_null() || (*mask).nbands == 3 as libc::c_int {} else {
        __assert_fail(
...
pub unsafe extern "C" fn heman_ops_merge_political(
    ...
    if (*hmap).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_merge_political(heman_image *, heman_image *, heman_color)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_ops_emboss(
    ...
    if (*img).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_ops_emboss(heman_image *, int)\0" as *const u8 as *const i8,
        );
    }
    let mut result = crate::src::src::image::heman_image_create(width, height, 1 as libc::c_int);
    let mut invw = (1.0f64 / width as libc::c_double) as libc::c_float;
