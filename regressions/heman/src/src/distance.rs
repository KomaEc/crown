...
unsafe extern "C" fn transform_to_distance(mut sdf: Option<&mut heman_image>) {
...
pub unsafe extern "C" fn heman_distance_create_sdf(
    ...
    {} else {
        __assert_fail(
            ...
            b"heman_image *heman_distance_create_sdf(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_distance_create_df(
    ...
    {} else {
        __assert_fail(
            ...
            b"heman_image *heman_distance_create_df(heman_image *)\0" as *const u8 as *const i8,
        );
    }
    let mut positive = crate::src::src::image::heman_image_create((*src).width, (*src).height, 1 as libc::c_int);
    let mut size = (*src).height * (*src).width;
...
pub unsafe extern "C" fn heman_distance_from_cpcf(
    ...
    {} else {
        __assert_fail(
            ...
            b"heman_image *heman_distance_from_cpcf(heman_image *)\0" as *const u8 as *const i8,
        );
    }
