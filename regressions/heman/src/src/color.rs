...
impl Default for heman_image_s {fn default() -> Self {Self {
width: Default::default(),
height: Default::default(),
nbands: Default::default(),
data: std::ptr::null_mut(),
}}}
impl heman_image_s {pub fn take(&mut self) -> Self {core::mem::take(self)}}
...
pub unsafe extern "C" fn heman_color_create_gradient(
    ...
    if width > 0 as libc::c_int && num_colors >= 2 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_color_create_gradient(int, int, const int *, const heman_color *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_color_apply_gradient(
    ...
    if (*heightmap).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_color_apply_gradient(heman_image *, float, float, heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_color_from_grayscale(
    ...
    if (*grayscale).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_color_from_grayscale(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_color_to_grayscale(
    ...
    if (*colorimg).nbands == 3 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_color_to_grayscale(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_internal_rg(
    ...
    if (*cfield).nbands == 2 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_internal_rg(heman_image *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_color_from_cpcf(
    ...
    if (*cfield).nbands == 2 as libc::c_int {} else {
        __assert_fail(
            ...
            b"heman_image *heman_color_from_cpcf(heman_image *, heman_image *)\0" as *const u8 as *const i8,
        );
    }
