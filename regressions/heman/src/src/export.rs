...
pub unsafe extern "C" fn heman_export_ply(
    ...
    if (*img.as_deref().unwrap()).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"void heman_export_ply(heman_image *, const char *)\0" as *const u8 as *const i8,
        );
    }
...
pub unsafe extern "C" fn heman_export_with_colors_ply(
    ...
    if (*hmap.as_deref().unwrap()).nbands == 1 as libc::c_int {} else {
        __assert_fail(
            ...
            b"void heman_export_with_colors_ply(heman_image *, heman_image *, const char *)\0" as *const u8 as *const i8,
        );
    }
