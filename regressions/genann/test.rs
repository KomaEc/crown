    ...
    *(*ann).weight.offset(1 as std::os::raw::c_int as isize) =
    ...
    if fabs(0.5f64 - *crate::genann::genann_run(ann.as_mut(), &mut a)) > 0.001f64 {
        ...
        printf(
            ...
            0.5f64,
            *crate::genann::genann_run(ann.as_mut(), &mut a),
        );
    }
...
pub unsafe extern "C" fn xor() {
    ...
    (*ann).activation_hidden = Some(
        crate::genann::genann_act_threshold
    ...
    *(*ann).weight.offset(8 as std::os::raw::c_int as isize) =
    ...
    if fabs(
        output[0 as std::os::raw::c_int as usize]
            - *crate::genann::genann_run(ann.as_mut(), input[索引].as_mut_ptr()),
    ) > 0.001f64
    {
        lfails += 1;
        printf(
...
pub unsafe extern "C" fn backprop() {
    ...
    let mut first_try: std::os::raw::c_double =
        *crate::genann::genann_run(ann.as_mut(), &mut input);
    crate::genann::genann_train(ann, &mut input, &mut output, 0.5f64);
    let mut second_try: std::os::raw::c_double =
        *crate::genann::genann_run(ann.as_mut(), &mut input);
    ltests += 1;
...
pub unsafe extern "C" fn persist() {
    let mut first: *mut crate::example1::genann = crate::genann::genann_init(
    ...
    let mut out: *mut FILE = fopen(
        b"persist.txt\x00" as *const u8 as *const std::os::raw::c_char,
        b"w\x00" as *const u8 as *const std::os::raw::c_char,
    );
    crate::genann::genann_write(
        first
            .as_deref()
            .map(|r| r as *const _)
...
pub unsafe extern "C" fn copy() {
    ...
    let mut second: *mut crate::example1::genann =
        crate::genann::genann_copy(first as *const crate::example1::genann);
    ltests += 1;
    ...
    while i < max {
            ...
            > 0.001f64
        {
            ...
            printf(
                ...
                crate::genann::genann_act_sigmoid(i),
...
unsafe fn main_0(
    ...
    printf(
        b"\t%-14s\x00" as *const u8 as *const std::os::raw::c_char,
    ...
    printf(
        ...
        clock()
            .wrapping_sub(start)
            .wrapping_mul(1000 as std::os::raw::c_int as std::os::raw::c_ulong)
            .wrapping_div(1000000 as std::os::raw::c_int as std::os::raw::c_ulong)
            as std::os::raw::c_int,
    );
