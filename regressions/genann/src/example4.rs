...
pub unsafe extern "C" fn load_data() {
    ...
    while i < samples {
        ...
        *c.offset(2 as libc::c_int as isize) = 0.0f64;
        *c.offset(1 as libc::c_int as isize) = *c.offset(2 as libc::c_int as isize);
        *c.offset(0 as libc::c_int as isize) = *c.offset(1 as libc::c_int as isize);
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *const *const libc::c_char) -> libc::c_int {
    ...
    j = 0 as libc::c_int;
    while j < samples {
        let mut guess = crate::src::genann::genann_run(
            ann.as_mut(),
            input.offset((j * 4 as libc::c_int) as isize),
        );
