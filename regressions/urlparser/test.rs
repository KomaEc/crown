...
#[no_mangle]
pub unsafe extern "C" fn strdup(mut str: *const std::os::raw::c_char) -> *mut std::os::raw::c_char {
    let mut n: std::os::raw::c_int = strlen(str)
...
pub static mut URL_SCHEMES: [*mut std::os::raw::c_char; 177] = [
    ...
    b"adiumxtra\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"attachment\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"crome-extension\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"com-evenbrite-attendee\x00" as *const u8 as *const std::os::raw::c_char
    ...
    b"lna-playsingle\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"dln-playcontainer\x00" as *const u8 as *const std::os::raw::c_char
        as *mut std::os::raw::c_char,
    ...
    b"gizmoproject\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"iris.beep\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"iris.xpc\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"iris.xpcs\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"mailserver\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"mssettings-power\x00" as *const u8 as *const std::os::raw::c_char
        as *mut std::os::raw::c_char,
    ...
    b"paquelocktoken\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"paparazzi\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"secondlife\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"soap.beep\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"soap.beeps\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"teamspeak\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"thismessage\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"view-source\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"xcon-userid\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"xfire\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"xmlrpc.beep\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    b"xmlrpc.beeps\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
    ...
    b"javascript\x00" as *const u8 as *const std::os::raw::c_char as *mut std::os::raw::c_char,
...
#[no_mangle]
pub unsafe extern "C" fn url_parse(mut url: *mut std::os::raw::c_char) -> *mut url_data_t {
    let mut data: *mut url_data_t =
        malloc(::std::mem::size_of::<url_data_t>() as std::os::raw::c_ulong) as *mut url_data_t;
    if data.is_null() {
        ();
    ...
    let mut auth: *mut std::os::raw::c_char =
        malloc(::std::mem::size_of::<std::os::raw::c_char>() as std::os::raw::c_ulong)
            as *mut std::os::raw::c_char;
    ...
    hostname = if is_ssh as std::os::raw::c_int != 0 {
        get_part(
            tmp_url,
            b"%[^:]\x00" as *const u8 as *const std::os::raw::c_char,
    ...
    let mut host: *mut std::os::raw::c_char = malloc(
        strlen(tmp_hostname)
    ...
    tmp_path = if is_ssh as std::os::raw::c_int != 0 {
        get_part(
            tmp_url,
    ...
    let mut path: *mut std::os::raw::c_char = malloc(
        strlen(tmp_path)
            .wrapping_mul(::std::mem::size_of::<std::os::raw::c_char>() as std::os::raw::c_ulong),
    ) as *mut std::os::raw::c_char;
    if path.is_null() {
    ...
    let mut fmt: *mut std::os::raw::c_char = if is_ssh as std::os::raw::c_int != 0 {
        b"%s\x00" as *const u8 as *const std::os::raw::c_char
    } else {
        b"/%s\x00" as *const u8 as *const std::os::raw::c_char
    } as *mut std::os::raw::c_char;
    ...
    let mut search: *mut std::os::raw::c_char =
        malloc(::std::mem::size_of::<*mut std::os::raw::c_char>() as std::os::raw::c_ulong)
            as *mut std::os::raw::c_char;
    if search.is_null() {
        ();
        return 0 as *mut url_data_t;
...
pub unsafe extern "C" fn url_get_protocol(
    mut url: *mut std::os::raw::c_char,
) -> *mut std::os::raw::c_char {
    let mut protocol: *mut std::os::raw::c_char = malloc(
...
pub unsafe extern "C" fn url_is_protocol(mut str: *const std::os::raw::c_char) -> bool {
    let mut count: std::os::raw::c_int = (::std::mem::size_of::<[*mut std::os::raw::c_char; 177]>()
...
unsafe extern "C" fn get_part(
    ...
    return if has as std::os::raw::c_int != 0 {
        ret
    } else {
...
pub unsafe extern "C" fn url_get_hostname(
    ...
    if !auth.is_null() {
        l = (l as std::os::raw::c_ulong).wrapping_add(
            strlen(auth).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_ulong),
...
pub unsafe extern "C" fn url_get_path(
    ...
    if !auth.is_null() {
        l += strlen(auth) as std::os::raw::c_int + 1 as std::os::raw::c_int
    } else {
        ();
    }
    tmp_path = if is_ssh as std::os::raw::c_int != 0 {
...
pub unsafe extern "C" fn url_get_hash(
    ...
    let mut pathname_len: std::os::raw::c_int = strlen(pathname) as std::os::raw::c_int;
    let mut search_len: std::os::raw::c_int = strlen(search) as std::os::raw::c_int;
    let mut tmp_path: *mut std::os::raw::c_char = strff(path, pathname_len + search_len);
    strcat(hash, b"\x00" as *const u8 as *const std::os::raw::c_char);
    sscanf(
        tmp_path,
        b"%s\x00" as *const u8 as *const std::os::raw::c_char,
...
pub unsafe extern "C" fn url_get_port(
    ...
    let mut tmp_hostname: *mut std::os::raw::c_char = strff(
        hostname,
        strlen(host).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_ulong)
            as std::os::raw::c_int,
    );
    sscanf(
        tmp_hostname,
...
unsafe fn main_0() -> std::os::raw::c_int {
    ...
    let mut gh_url: *mut std::os::raw::c_char = b"git://git@github.com:jwerle/url.h.git\x00"
        as *const u8 as *const std::os::raw::c_char
        as *mut std::os::raw::c_char;
    let mut url: *mut std::os::raw::c_char =
        b"http://user:pass@subdomain.host.com:8080/p/a/t/h?query=string#hash\x00" as *const u8
    ...
    if (*parsed).protocol.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"parsed->protocol\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    ...
    if (*parsed).hostname.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"parsed->hostname\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    ...
    if (*parsed).pathname.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"parsed->pathname\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    ...
    if (*parsed).search.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"parsed->search\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*parsed).query.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"parsed->query\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).href.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->href\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).protocol.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->protocol\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).host.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->host\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).auth.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->auth\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).hostname.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->hostname\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).pathname.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->pathname\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if (*gh_parsed).path.is_null() as std::os::raw::c_int as std::os::raw::c_long != 0 {
        __assert_rtn(
            ...
            b"gh_parsed->path\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"http\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"https\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"git\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"ssh\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"sftp\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"ftp\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !url_is_protocol(
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"url_is_protocol(\"javascript\")\x00" as *const u8 as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"http\", url_get_protocol(url))\x00" as *const u8
    ...
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"user:pass\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_auth(url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"user:pass\", url_get_auth(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"subdomain.host.com:8080\x00" as *const u8 as *const std::os::raw::c_char,
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"subdomain.host.com:8080\", url_get_hostname(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"subdomain.host.com\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_host(url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"subdomain.host.com\", url_get_host(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"/p/a/t/h\x00" as *const u8 as *const std::os::raw::c_char,
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"/p/a/t/h\", url_get_pathname(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"/p/a/t/h?query=string#hash\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_path(url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"/p/a/t/h?query=string#hash\", url_get_path(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"?query=string\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_search(url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"?query=string\", url_get_search(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"query=string\", url_get_query(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"#hash\", url_get_hash(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"8080\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_port(url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"8080\", url_get_port(url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"git\", url_get_protocol(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"github.com\x00" as *const u8 as *const std::os::raw::c_char,
            url_get_host(gh_url),
        )) as std::os::raw::c_int as std::os::raw::c_long
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"github.com\", url_get_host(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"github.com\", url_get_hostname(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"git\", url_get_auth(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
    if !(0 as std::os::raw::c_int
        == strcmp(
            b"jwerle/url.h.git\x00" as *const u8 as *const std::os::raw::c_char,
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"jwerle/url.h.git\", url_get_pathname(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
        ...
        != 0
    {
        __assert_rtn(
            ...
            b"0 == strcmp(\"jwerle/url.h.git\", url_get_path(gh_url))\x00" as *const u8
                as *const std::os::raw::c_char,
        );
    } else {
    };
