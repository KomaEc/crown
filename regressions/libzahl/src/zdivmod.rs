...
impl Default for OrcGeneratedXXX11 {
    fn default() -> Self {
        Self {}
    }
}
...
impl Default for OrcGeneratedXXX12 {
    fn default() -> Self {
        Self {}
    }
}
...
impl Default for OrcGeneratedXXX13 {
    fn default() -> Self {
        Self {}
    }
}
...
pub unsafe extern "C" fn zdivmod(
    ...
    if crate::src::zcmpmag::zcmpmag(libzahl_tmp_divmod_d.as_mut_ptr(), c) > 0 as libc::c_int {
        ...
        bit = (bit as libc::c_ulong).wrapping_sub(1 as libc::c_int as libc::c_ulong) as size_t
            as size_t;
    }
