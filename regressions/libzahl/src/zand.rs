...
impl Default for OrcGeneratedXXX2 {
    fn default() -> Self {
        Self {}
    }
}
        ...
        _ => {
                ...
                == b
            {
                loop {
                    ...
                    *(*a.as_deref().unwrap()).chars.offset(n as isize) &=
            ...
            (*a.as_deref_mut().unwrap()).sign =
                (zsignum(b) > 0 as libc::c_int || zsignum(c) > 0 as libc::c_int) as libc::c_int
                    * 2 as libc::c_int
                    - 1 as libc::c_int;
            return;
        }
