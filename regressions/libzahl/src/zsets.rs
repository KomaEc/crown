...
impl Default for ErasedByPreprocessor46 {
    fn default() -> Self {
        Self {}
    }
}
...
pub unsafe extern "C" fn zsets(
    ...
    str = str.offset((neg != 0 || (*str) as libc::c_int == '+' as i32) as libc::c_int as isize);
    if (*str) == 0 {
    ...
    crate::src::zset::zset(
        libzahl_tmp_str_num.as_mut_ptr().as_mut(),
        libzahl_const_1e19.as_mut_ptr(),
    );
    's_234: {
        let mut current_block_39: u64;
        match str_end.offset_from(str) as libc::c_long % 19 as libc::c_int as libc::c_long {
            0 => {
            ...
            match current_block_39 {
                ...
                2009900886467833939 => {
                    ...
                    temp = temp.wrapping_add(
                        ((*fresh0) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 15121320231496893747;
                }
                15121320231496893747 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh1) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 16368488404610608819;
                }
                16368488404610608819 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh2) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 2817806250783016588;
                }
                2817806250783016588 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh3) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 8436272415664805267;
                }
                8436272415664805267 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh4) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 17260602820350443736;
                }
                17260602820350443736 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh5) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 13506216435796342560;
                }
                13506216435796342560 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh6) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 3798081891250826146;
                }
                3798081891250826146 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh7) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 3337010891255527766;
                }
                3337010891255527766 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh8) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 14701426646074699728;
                }
                14701426646074699728 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh9) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 7675967895758458727;
                }
                7675967895758458727 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh10) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 17228944538289729950;
                }
                17228944538289729950 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh11) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 16906717074776190969;
                }
                16906717074776190969 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh12) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 5148048065308018341;
                }
                5148048065308018341 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh13) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 18210558662916816231;
                }
                18210558662916816231 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh14) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 13503438682059240994;
                }
                13503438682059240994 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh15) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 5618369753603485945;
                }
                5618369753603485945 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh16) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 12749676338018479376;
                }
                12749676338018479376 => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh17) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    current_block_39 = 13992101357592761495;
                }
                _ => {
                    ...
                    str = str.offset(1);
                    temp = temp.wrapping_add(
                        ((*fresh18) as libc::c_int & 15 as libc::c_int) as libc::c_ulonglong,
                    );
                    if !(temp == 0) {
                        ...
                        *((*libzahl_tmp_str_num.as_mut_ptr()).chars)
                        ...
                        (*libzahl_tmp_str_num.as_mut_ptr()).used =
                            (1 as libc::c_int + (temp != 0) as libc::c_int) as size_t;
