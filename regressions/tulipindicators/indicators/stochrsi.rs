...
pub unsafe extern "C" fn ti_stochrsi(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let mut rsi: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(period);
    ...
    *(*rsi).vals.as_mut_ptr().offset((*rsi).index as isize) = r;
    ...
    crate::utils::buffer::ti_buffer_free(rsi);
    if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_stochrsi\x00" as *const u8 as *const i8,
