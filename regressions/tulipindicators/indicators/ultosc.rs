...
pub unsafe extern "C" fn ti_ultosc(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let mut bp_buf: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(long_period);
    let mut r_buf: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(long_period);
    ...
    crate::utils::buffer::ti_buffer_free(bp_buf);
    crate::utils::buffer::ti_buffer_free(r_buf);
    if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_ultosc\x00" as *const u8 as *const i8,
