...
pub unsafe extern "C" fn ti_adxr(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    adx+= dx;
    let mut adxr: *mut ti_buffer = crate::utils::buffer::ti_buffer_new(period - 1 as std::os::raw::c_int);
    ...
    crate::utils::buffer::ti_buffer_free(adxr);
    if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_adxr\x00" as *const u8 as *const i8,
