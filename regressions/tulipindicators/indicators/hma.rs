...
pub unsafe extern "C" fn ti_hma(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let mut buff: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(periodsqrt);
    ...
    crate::utils::buffer::ti_buffer_free(buff);
    if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_hma\x00" as *const u8 as *const i8,
