...
pub unsafe extern "C" fn ti_mfi(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let mut up: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(period);
    let mut down: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(period);
    ...
    crate::utils::buffer::ti_buffer_free(up);
    crate::utils::buffer::ti_buffer_free(down);
    if !(output.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_mfi\x00" as *const u8 as *const i8,
