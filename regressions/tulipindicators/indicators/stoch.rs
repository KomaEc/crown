...
pub unsafe extern "C" fn ti_stoch(mut size: std::os::raw::c_int,
 ...
 -> std::os::raw::c_int {
    ...
    let mut k_sum: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(kslow);
    let mut d_sum: *mut crate::indicators::adxr::ti_buffer = crate::utils::buffer::ti_buffer_new(dperiod);
    ...
    crate::utils::buffer::ti_buffer_free(k_sum);
    crate::utils::buffer::ti_buffer_free(d_sum);
    if !(stoch.offset_from(*outputs.offset(0 as std::os::raw::c_int as
        ...
        __assert_rtn(b"ti_stoch\x00" as *const u8 as *const i8,
