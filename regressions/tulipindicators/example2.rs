...
pub struct ti_indicator_info {
    ...
    pub input_names: [*const std::os::raw::c_char; 10],
    pub option_names: [*const std::os::raw::c_char; 10],
    pub output_names: [*const std::os::raw::c_char; 10],
}
/*
 * Tulip Indicators
...
unsafe fn main_0() -> std::os::raw::c_int {
    ...
    let mut info: *const ti_indicator_info = crate::example2::ti_indicators.as_mut_ptr();
