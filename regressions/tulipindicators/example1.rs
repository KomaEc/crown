...
unsafe fn main_0() -> std::os::raw::c_int {
    ...
    print_array(options.as_ptr(),
                (::std::mem::size_of::<[std::os::raw::c_double; 1]>() as
                    ...
                    std::os::raw::c_int);
    let start: std::os::raw::c_int = crate::indicators::sma::ti_sma_start(options.as_ptr());
    ...
    let mut error: std::os::raw::c_int =
        crate::indicators::sma::ti_sma(input_length, all_inputs.as_mut_ptr(), options.as_ptr(),
    ...
    print_array(data_out as *const f64, output_length);
