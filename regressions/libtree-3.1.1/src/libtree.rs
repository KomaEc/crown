...
impl string_table_t {pub fn take(&mut self) -> Self {core::mem::take(self)}}
...
impl visited_file_array_t {pub fn take(&mut self) -> Self {core::mem::take(self)}}
...
rpath_offsets: [Default::default(); 32],
ld_library_path_offset: Default::default(),
default_paths_offset: Default::default(),
ld_so_conf_offset: Default::default(),
found_all_needed: [Default::default(); 32],
}}}
impl libtree_state_t {pub fn take(&mut self) -> Self {core::mem::take(self)}}
