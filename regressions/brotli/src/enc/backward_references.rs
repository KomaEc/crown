...
unsafe extern "C" fn HashBytesH2(mut data: *const uint8_t) -> uint32_t {
    let h = (BrotliUnalignedRead64(data as *const libc::c_void)
        ...
        .wrapping_mul(crate::src::enc::backward_references::kHashMul64);
...
unsafe extern "C" fn HashBytesH6(
    ...
    let h = (BrotliUnalignedRead64(data as *const libc::c_void) & mask)
        .wrapping_mul(crate::src::enc::backward_references::kHashMul64Long);
...
unsafe extern "C" fn FindLongestMatchHROLLING_FAST(
    ...
    while pos <= cur_ix {
        ...
        let mut found_ix = crate::src::enc::backward_references::kInvalidPosHROLLING_FAST as size_t;
        ...
        if code < 16777216 as libc::c_int as libc::c_uint {
            ...
            *(*self_0).table.offset(code as isize) = pos as uint32_t;
            if pos == cur_ix && found_ix != crate::src::enc::backward_references::kInvalidPosHROLLING_FAST as libc::c_ulong {
...
unsafe extern "C" fn FindLongestMatchHROLLING(
    ...
    while pos <= cur_ix {
        ...
        let mut found_ix = crate::src::enc::backward_references::kInvalidPosHROLLING as size_t;
        ...
        if code < 16777216 as libc::c_int as libc::c_uint {
            found_ix= *(*self_0).table.offset(code as isize) as size_t;
            *(*self_0).table.offset(code as isize) = pos as uint32_t;
            if pos == cur_ix && found_ix != crate::src::enc::backward_references::kInvalidPosHROLLING as libc::c_ulong {
                let mut backward = cur_ix.wrapping_sub(found_ix) as uint32_t as size_t;
                if backward <= max_backward {
                    let found_ix_masked = found_ix & ring_buffer_mask;
                    let len = FindMatchLengthWithLimit(
...
unsafe extern "C" fn StoreH35(
    ...
    StoreH3(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix);
    StoreHROLLING_FAST(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix);
}
#[inline(always)]
unsafe extern "C" fn StoreRangeH35(
    ...
    StoreRangeH3(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix_start, ix_end);
    StoreRangeHROLLING_FAST(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix_start, ix_end);
}
#[inline(always)]
...
unsafe extern "C" fn StoreH55(
    ...
    StoreH54(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix);
    StoreHROLLING_FAST(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix);
}
#[inline(always)]
unsafe extern "C" fn StoreRangeH55(
    ...
    StoreRangeH54(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix_start, ix_end);
    StoreRangeHROLLING_FAST(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix_start, ix_end);
}
#[inline(always)]
...
unsafe extern "C" fn StoreH65(
    ...
    StoreH6(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix);
    StoreHROLLING(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix);
}
#[inline(always)]
unsafe extern "C" fn StoreRangeH65(
    ...
    StoreRangeH6(core::ptr::addr_of_mut!((*self_0).ha), data, mask, ix_start, ix_end);
    StoreRangeHROLLING(core::ptr::addr_of_mut!((*self_0).hb), data, mask, ix_start, ix_end);
}
#[inline(always)]
