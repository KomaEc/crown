...
pub unsafe extern "C" fn test_named() {
    ...
    let mut val = crate::src::src::rgba::rgba_from_string(
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_named()\0" as *const u8 as *const i8,
        );
    };
...
pub unsafe extern "C" fn test_rgb() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_rgb()\0" as *const u8 as *const i8,
        );
    };
    ...
    val= crate::src::src::rgba::rgba_from_string(b"rgb(0,0,0)\0" as *const u8 as *const libc::c_char, Some(&mut ok))
        as int32_t;
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn test_rgba() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_rgba()\0" as *const u8 as *const i8,
        );
    };
    ...
    val= crate::src::src::rgba::rgba_from_string(
...
pub unsafe extern "C" fn test_hex() {
    ...
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            ...
            b"void test_hex()\0" as *const u8 as *const i8,
        );
    };
    if 0xff1e00ff as libc::c_uint == val as libc::c_uint {} else {
        __assert_fail(
    ...
    val= crate::src::src::rgba::rgba_from_string(b"#ffffff\0" as *const u8 as *const libc::c_char, Some(&mut ok))
        as int32_t;
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const libc::c_char,
    ...
    val= crate::src::src::rgba::rgba_from_string(b"#ffcc00\0" as *const u8 as *const libc::c_char, Some(&mut ok))
        as int32_t;
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const libc::c_char,
    ...
    val= crate::src::src::rgba::rgba_from_string(b"#fco\0" as *const u8 as *const libc::c_char, Some(&mut ok))
        as int32_t;
    if ok as libc::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn test_to_string() {
    ...
    let mut color = crate::src::src::rgba::rgba_new(0xffcc00ff as libc::c_uint);
    crate::src::src::rgba::rgba_to_string(color, buf.as_mut_ptr(), 256 as libc::c_int as size_t);
    if 0 as libc::c_int
    ...
    {} else {
        __assert_fail(
            ...
            b"void test_to_string()\0" as *const u8 as *const i8,
        );
    };
    color= crate::src::src::rgba::rgba_new(0xffcc0050 as libc::c_uint);
    crate::src::src::rgba::rgba_to_string(color, buf.as_mut_ptr(), 256 as libc::c_int as size_t);
    if 0 as libc::c_int
        == strcmp(
