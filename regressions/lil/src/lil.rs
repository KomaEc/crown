...
pub struct _IO_FILE {
    ...
    pub _codecvt: *const crate::src::main::_IO_codecvt,
    pub _wide_data: *const crate::src::main::_IO_wide_data,
...
impl Default for _lil_func_t {
    fn default() -> Self {
        Self {
            name: std::ptr::null_mut(),
            code: std::ptr::null_mut(),
            argnames: std::ptr::null_mut(),
            proc_0: Default::default(),
        }
    }
}
...
pub struct _lil_var_t {
    ...
    pub env: *const _lil_env_t,
    pub v: lil_value_t,
}
impl Default for _lil_var_t {
    fn default() -> Self {
        Self {
            n: std::ptr::null_mut(),
            env: std::ptr::null_mut(),
...
pub type lil_write_callback_proc_t = Option<unsafe extern "C" fn(lil_t, *const libc::c_char) -> ()>;
pub type lil_read_callback_proc_t =
    Option<unsafe extern "C" fn(lil_t, *const libc::c_char) -> *mut libc::c_char>;
pub type lil_source_callback_proc_t =
    Option<unsafe extern "C" fn(lil_t, *const libc::c_char) -> *mut libc::c_char>;
pub type lil_store_callback_proc_t =
    Option<unsafe extern "C" fn(lil_t, *const libc::c_char, *const libc::c_char) -> ()>;
pub type lil_error_callback_proc_t =
    Option<unsafe extern "C" fn(lil_t, size_t, *const libc::c_char) -> ()>;
pub type lil_setvar_callback_proc_t =
    Option<unsafe extern "C" fn(lil_t, *const libc::c_char, *mut lil_value_t) -> libc::c_int>;
...
impl Default for _expreval_t {
    fn default() -> Self {
        Self {
            code: std::ptr::null(),
            len: Default::default(),
            head: Default::default(),
            ival: Default::default(),
...
unsafe extern "C" fn alloc_value(mut str: *const libc::c_char) -> lil_value_t {
    ...
    if val.as_deref().is_none() {
        ();
        return None;
    }
    if !str.is_null() {
        (*val.as_deref_mut().unwrap()).l = strlen(str);
        (*val.as_deref_mut().unwrap()).d = malloc(
            (*val.as_deref().unwrap())
                .l
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        ) as *mut libc::c_char;
        if (*val.as_deref().unwrap()).d.is_null() {
            ();
            ();
            return None;
        }
        ...
        ();
        (*val.as_deref_mut().unwrap()).l = 0 as libc::c_int as size_t;
        (*val.as_deref_mut().unwrap()).d = 0 as *mut libc::c_char;
    }
    return val;
}
#[no_mangle]
pub unsafe extern "C" fn lil_clone_value(mut src: lil_value_t) -> lil_value_t {
    ...
    (*val.as_deref_mut().unwrap()).l = (*src).l;
    if (*src).l != 0 {
        (*val.as_deref_mut().unwrap()).d = malloc(
            (*val.as_deref().unwrap())
                .l
...
pub unsafe extern "C" fn lil_append_string(
    ...
    (*val.as_deref_mut().unwrap()).l =
        ((*val.as_deref().unwrap()).l as libc::c_ulong).wrapping_add(len) as size_t as size_t;
    (*val.as_deref_mut().unwrap()).d = new;
    return 1 as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn lil_append_val(mut val: lil_value_t, mut v: lil_value_t) -> libc::c_int {
    let mut new = 0 as *mut libc::c_char;
    if v.is_null() || (*v).l == 0 {
        return 1 as libc::c_int;
    }
...
pub unsafe extern "C" fn lil_free_value(mut val: lil_value_t) {
    ...
    free((*val.as_deref().unwrap()).d as *mut libc::c_void);
    ();
}
#[no_mangle]
pub unsafe extern "C" fn lil_alloc_list() -> lil_list_t {
    ...
    (*list.as_deref_mut().unwrap()).v = 0 as *mut lil_value_t;
    (*list.as_deref_mut().unwrap()).c = 0 as libc::c_int as size_t;
    return list;
}
#[no_mangle]
pub unsafe extern "C" fn lil_free_list(mut list: lil_list_t) {
    let mut i: size_t = 0;
    if list.as_deref().is_none() {
        ();
        return;
    }
    i = 0 as libc::c_int as size_t;
    while i < (*list.as_deref().unwrap()).c {
        lil_free_value(*(*list.as_deref().unwrap()).v.offset(i as isize));
        i = i.wrapping_add(1);
    }
    free((*list.as_deref().unwrap()).v as *mut libc::c_void);
    ();
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn lil_list_get(mut list: lil_list_t, mut index: size_t) -> lil_value_t {
...
pub unsafe extern "C" fn lil_alloc_env(mut parent: lil_env_t) -> lil_env_t {
    ...
    (*env.as_deref_mut().unwrap()).parent = parent
...
pub unsafe extern "C" fn lil_free_env(mut env: lil_env_t) {
    let mut i: size_t = 0;
    if env.as_deref().is_none() {
        ();
        return;
    }
    lil_free_value(Some(Box::from_raw((*env.as_deref().unwrap()).retval)));
    i = 0 as libc::c_int as size_t;
    while i < (*env.as_deref().unwrap()).vars {
        free((**(*env.as_deref().unwrap()).var.offset(i as isize)).n as *mut libc::c_void);
        lil_free_value((**(*env.as_deref().unwrap()).var.offset(i as isize)).v);
        ();
        i = i.wrapping_add(1);
    }
    free((*env.as_deref().unwrap()).var as *mut libc::c_void);
    ();
}
...
unsafe extern "C" fn lil_find_var(
    ...
    return if !r.is_null() {
        ...
        .map(|r| r as *const _)
        .unwrap_or(std::ptr::null())
        == (*lil.as_deref().unwrap()).rootenv
    {
        0 as lil_var_t
    } else {
        lil_find_var(
            lil.as_deref_mut(),
            (*lil.as_deref_mut().unwrap()).rootenv.as_mut(),
            name,
        )
    };
}
unsafe extern "C" fn find_cmd(mut lil: lil_t, mut name: *const libc::c_char) -> lil_func_t {
    if (*lil.as_deref().unwrap()).cmds > 0 as libc::c_int as libc::c_ulong {
        let mut i = (*lil.as_deref().unwrap())
            .cmds
            .wrapping_sub(1 as libc::c_int as libc::c_ulong);
        loop {
            if strcmp(
                (**(*lil.as_deref().unwrap()).cmd.offset(i as isize)).name,
                name,
            ) == 0
            {
...
unsafe extern "C" fn add_func(mut lil: lil_t, mut name: *const libc::c_char) -> lil_func_t {
    let mut cmd = None;
    let mut ncmd = 0 as *mut lil_func_t;
    cmd = find_cmd(lil.as_deref_mut(), name);
    if !cmd.as_deref().is_none() {
        return cmd
            .as_deref_mut()
            .map(|r| r as *mut _)
            .unwrap_or(std::ptr::null_mut());
    ...
    (*cmd.as_deref_mut().unwrap()).name = strclone(name);
    ncmd = realloc(
        (*lil.as_deref().unwrap()).cmd as *mut libc::c_void,
        (::std::mem::size_of::<lil_func_t>() as libc::c_ulong).wrapping_mul(
            (*lil.as_deref().unwrap())
                .cmds
                .wrapping_add(1 as libc::c_int as libc::c_ulong),
        ),
    ...
    let fresh20 = (*lil.as_deref().unwrap()).cmds;
    (*lil.as_deref_mut().unwrap()).cmds = (*lil.as_deref().unwrap()).cmds.wrapping_add(1);
...
pub unsafe extern "C" fn lil_set_var(
    ...
    let mut env = if local == 0 as libc::c_int {
        (*lil).rootenv
    } else {
        (*lil).env
    };
    ...
    if local != 2 as libc::c_int {
            ...
            && ((*lil).callback[6 as libc::c_int as usize]).is_some()
        {
            ...
            let mut newval = val;
            let mut r = proc_0.expect("non-null function pointer")(lil, name, &raw mut newval);
        ...
        if !var.is_null() {
            lil_free_value(Some(Box::from_raw((*var).v)));
            (*var).v = if freeval != 0 {
                val
            } else {
                lil_clone_value(val)
    ...
    *nvar.offset((*env).vars as isize) = calloc(
    ...
    (**nvar.offset((*env).vars as isize)).v = if freeval != 0 {
        val
    } else {
        lil_clone_value(val)
    };
    let fresh30 = (*env).vars;
    (*env).vars = (*env).vars.wrapping_add(1);
    return *nvar.offset(fresh30 as isize);
}
#[no_mangle]
pub unsafe extern "C" fn lil_get_var(mut lil: lil_t, mut name: *const libc::c_char) -> lil_value_t {
    return lil_get_var_or(
        lil.as_deref_mut()
            .map(|r| r as *mut _)
            .unwrap_or(std::ptr::null_mut()),
        name,
        (*lil.as_deref().unwrap()).empty,
    );
}
#[no_mangle]
pub unsafe extern "C" fn lil_get_var_or(
        ...
        && (var.is_null() || (*var).env == (*lil).rootenv)
    {
        let mut proc_0: lil_getvar_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_getvar_callback_proc_t>(
...
pub unsafe extern "C" fn lil_push_env(mut lil: lil_t) -> lil_env_t {
    let mut env = lil_alloc_env(Some(Box::from_raw((*lil.as_deref_mut().unwrap()).env)));
...
pub unsafe extern "C" fn lil_pop_env(mut lil: lil_t) {
    if !(*(*lil.as_deref().unwrap()).env).parent.is_null() {
        let mut next = Some(Box::from_raw((*(*lil.as_deref_mut().unwrap()).env).parent));
        lil_free_env(Some(Box::from_raw((*lil.as_deref_mut().unwrap()).env)));
...
pub unsafe extern "C" fn lil_new() -> lil_t {
    ...
    (*lil.as_deref_mut().unwrap()).env = lil_alloc_env(None);
    (*lil.as_deref_mut().unwrap()).rootenv = (*lil.as_deref_mut().unwrap()).env;
    (*lil.as_deref_mut().unwrap()).empty = alloc_value(0 as *const libc::c_char);
    (*lil.as_deref_mut().unwrap()).dollarprefix =
        strclone(b"set \0" as *const u8 as *const libc::c_char);
    register_stdcmds(lil.as_deref_mut());
    return lil;
}
unsafe extern "C" fn islilspecial(mut ch: libc::c_char) -> libc::c_int {
    return (ch as libc::c_int == ';' as i32
        ...
        || ch as libc::c_int == '}' as i32
        || ch as libc::c_int == '"' as i32
        || ch as libc::c_int == '\'' as i32) as libc::c_int;
}
...
unsafe extern "C" fn skip_spaces(mut lil: lil_t) {
    while (*lil.as_deref().unwrap()).head < (*lil.as_deref().unwrap()).clen
        && (*(*lil.as_deref().unwrap())
            .code
            .offset((*lil.as_deref().unwrap()).head as isize) as libc::c_int
            == '\\' as i32
            || *(*lil.as_deref().unwrap())
                .code
                .offset((*lil.as_deref().unwrap()).head as isize) as libc::c_int
            ...
            || *(*__ctype_b_loc()).offset(
                *(*lil.as_deref().unwrap())
                ...
                && ((*lil.as_deref().unwrap()).ignoreeol != 0
                    || !(*(*lil.as_deref().unwrap())
                        .code
                        .offset((*lil.as_deref().unwrap()).head as isize)
                        as libc::c_int
                        == '\r' as i32
                        || *(*lil.as_deref().unwrap())
                            .code
                            ...
                            == '\n' as i32)))
    {
            ...
            == '#' as i32
        {
            ...
            {
                (*lil.as_deref_mut().unwrap()).head =
                    (*lil.as_deref().unwrap()).head.wrapping_add(1);
            }
        } else if *(*lil.as_deref().unwrap())
            .code
            .offset((*lil.as_deref().unwrap()).head as isize) as libc::c_int
            == '\\' as i32
            && (*(*lil.as_deref().unwrap()).code.offset(
                (*lil.as_deref().unwrap())
                    .head
...
unsafe extern "C" fn get_bracketpart(mut lil: lil_t) -> lil_value_t {
    ...
    while (*lil.as_deref().unwrap()).head < (*lil.as_deref().unwrap()).clen {
            ...
            == ']' as i32
        {
            ...
            let fresh45 = (*lil.as_deref().unwrap()).head;
            (*lil.as_deref_mut().unwrap()).head = (*lil.as_deref().unwrap()).head.wrapping_add(1);
            lil_append_char(
                cmd.as_deref_mut()
                    .map(|r| r as *mut _)
                    .unwrap_or(std::ptr::null_mut()),
                *(*lil.as_deref().unwrap()).code.offset(fresh45 as isize),
            );
        }
    }
    val = lil_parse_value(
...
unsafe extern "C" fn next_word(mut lil: lil_t) -> lil_value_t {
        ...
        || *(*lil).code.offset((*lil).head as isize) as libc::c_int == '\'' as i32
    {
        ...
        while (*lil).head < (*lil).clen {
                ...
                || *(*lil).code.offset((*lil).head as isize) as libc::c_int == '$' as i32
            {
                ...
                lil_free_value(Some(Box::from_raw(tmp)));
            ...
            } else if *(*lil).code.offset((*lil).head as isize) as libc::c_int == sc as libc::c_int
            {
                (*lil).head = (*lil).head.wrapping_add(1);
                break;
            } else {
        ...
        while (*lil).head < (*lil).clen
            && *(*__ctype_b_loc())
                .offset(*(*lil).code.offset((*lil).head as isize) as libc::c_int as isize)
                as libc::c_int
                & _ISspace as libc::c_int as libc::c_ushort as libc::c_int
                == 0
            && islilspecial(*(*lil).code.offset((*lil).head as isize)) == 0
        {
            let fresh59 = (*lil).head;
            (*lil).head = (*lil).head.wrapping_add(1);
    ...
    return if !val.is_null() {
        ...
        ();
        alloc_value(0 as *const libc::c_char)
    };
}
unsafe extern "C" fn substitute(mut lil: lil_t) -> lil_list_t {
    ...
    while (*lil).head < (*lil).clen && ateol(lil) == 0 && (*lil).error == 0 {
        ...
        loop {
            ...
            if head == (*lil).head {
                lil_free_value(Some(Box::from_raw(w)));
                lil_free_value(Some(Box::from_raw(wp)));
                lil_free_list(Some(Box::from_raw(words)));
...
#[no_mangle]
pub unsafe extern "C" fn lil_subst_to_list(mut lil: lil_t, mut code: lil_value_t) -> lil_list_t {
...
#[no_mangle]
pub unsafe extern "C" fn lil_subst_to_value(mut lil: lil_t, mut code: lil_value_t) -> lil_value_t {
    let mut words = lil_subst_to_list(lil.as_deref_mut(), code);
    let mut val = None;
    if words.as_deref().is_none() {
        ();
        return lil_clone_value(code);
    }
    val = lil_list_to_value(
        words
            .as_deref_mut()
            .map(|r| r as *mut _)
            .unwrap_or(std::ptr::null_mut()),
...
pub unsafe extern "C" fn lil_parse(
    ...
    while (*lil).head < (*lil).clen && (*lil).error == 0 {
        ...
        if !val.is_null() {
            lil_free_value(Some(Box::from_raw(val)));
        } else {
            ();
        }
                ...
                if (**(*words).v.offset(0 as libc::c_int as isize)).l != 0 {
                    if !(*lil).catcher.is_null() {
                        if (*lil).in_catcher < 16384 as libc::c_int {
                            ...
                            (*(*lil).env).catcher_for =
                                *(*words).v.offset(0 as libc::c_int as isize);
                            ...
                            lil_free_value(Some(Box::from_raw(args)));
                            val = lil_parse(
                                lil,
                                (*lil).catcher,
            ...
            if !cmd.is_null() {
                if ((*cmd).proc_0).is_some() {
                    ...
                    if (*(*cmd).argnames).c == 1 as libc::c_int as libc::c_ulong
                        && strcmp(
                            lil_to_string(*(*(*cmd).argnames).v.offset(0 as libc::c_int as isize)),
                            b"args\0" as *const u8 as *const libc::c_char,
                        ) == 0
                    {
                        ...
                        lil_free_value(Some(Box::from_raw(args_0)));
                    } else {
                        let mut i: size_t = 0;
                        i = 0 as libc::c_int as size_t;
                        while i < (*(*cmd).argnames).c {
                            lil_set_var(
                                ...
                                if i < (*words).c.wrapping_sub(1 as libc::c_int as libc::c_ulong) {
                                    *(*words)
                                        .v
                                        .offset(i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                            as isize)
                                } else {
                                    (*lil).empty
                                },
    ...
    if (*lil).error != 0
        && ((*lil).callback[5 as libc::c_int as usize]).is_some()
        && (*lil).parse_depth == 1 as libc::c_int as libc::c_ulong
    {
        let mut proc_0: lil_error_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_error_callback_proc_t>(
...
pub unsafe extern "C" fn lil_set_error(mut lil: lil_t, mut msg: *const libc::c_char) {
    ...
    (*lil.as_deref_mut().unwrap()).err_msg = strclone(if !msg.is_null() {
        msg
    } else {
        ();
...
unsafe extern "C" fn ee_skip_spaces(mut ee: Option<&mut expreval_t>) {
    while (*ee.as_deref().unwrap()).head < (*ee.as_deref().unwrap()).len
        && *(*__ctype_b_loc()).offset(
            *(*ee.as_deref().unwrap())
                .code
                .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
                as isize,
        ) as libc::c_int
            & _ISspace as libc::c_int as libc::c_ushort as libc::c_int
            != 0
        ...
        if (*ee.as_deref().unwrap()).type_0 == 0 as libc::c_int {
            (*ee.as_deref_mut().unwrap()).ival = (*ee.as_deref().unwrap()).ival
                * 10 as libc::c_int as libc::c_long
                + (*(*ee.as_deref().unwrap())
                    .code
                    .offset((*ee.as_deref().unwrap()).head as isize)
                    as libc::c_int
...
unsafe extern "C" fn ee_element(mut ee: Option<&mut expreval_t>) {
    if *(*__ctype_b_loc()).offset(
        *(*ee.as_deref().unwrap())
            .code
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int as isize,
    ) as libc::c_int
        & _ISdigit as libc::c_int as libc::c_ushort as libc::c_int
        != 0
    {
...
unsafe extern "C" fn ee_unary(mut ee: Option<&mut expreval_t>) {
    ee_skip_spaces(ee.as_deref_mut());
    if (*ee.as_deref().unwrap()).head < (*ee.as_deref().unwrap()).len
        && (*ee.as_deref().unwrap()).error == 0
        && (*(*ee.as_deref().unwrap())
            .code
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
            == '-' as i32
            ...
            || *(*ee.as_deref().unwrap())
                ...
                == '!' as i32)
    {
        let fresh82 = (*ee.as_deref().unwrap()).head;
        (*ee.as_deref_mut().unwrap()).head = (*ee.as_deref().unwrap()).head.wrapping_add(1);
        ...
        match op as libc::c_int {
            45 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
            ...
            126 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).ival =
                        !((*ee.as_deref().unwrap()).dval as lilint_t);
                    (*ee.as_deref_mut().unwrap()).type_0 = 0 as libc::c_int;
                }
                0 => {
                    (*ee.as_deref_mut().unwrap()).ival = !(*ee.as_deref().unwrap()).ival;
            ...
            33 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).dval =
                        ((*ee.as_deref().unwrap()).dval == 0.) as libc::c_int as libc::c_double;
                }
                0 => {
                    (*ee.as_deref_mut().unwrap()).ival =
                        ((*ee.as_deref().unwrap()).ival == 0) as libc::c_int as lilint_t;
                }
                _ => {
                    (*ee.as_deref_mut().unwrap()).error = 2 as libc::c_int;
                }
...
unsafe extern "C" fn ee_muldiv(mut ee: Option<&mut expreval_t>) {
    ...
    while (*ee.as_deref().unwrap()).head < (*ee.as_deref().unwrap()).len
        && (*ee.as_deref().unwrap()).error == 0
        && *(*__ctype_b_loc()).offset(
            *(*ee.as_deref().unwrap()).code.offset(
                (*ee.as_deref().unwrap())
                    .head
                    .wrapping_add(1 as libc::c_int as libc::c_ulong) as isize,
                ...
                == '%' as i32)
    {
        ...
        match *(*ee.as_deref().unwrap())
            .code
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
        {
            42 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_unary(ee.as_deref_mut());
                    if (*ee.as_deref().unwrap()).error != 0 {
                        return;
                    }
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).dval =
                                (*ee.as_deref().unwrap()).dval * odval;
                        }
                        0 => {
                            (*ee.as_deref_mut().unwrap()).dval =
                                (*ee.as_deref().unwrap()).ival as libc::c_double * odval;
                            (*ee.as_deref_mut().unwrap()).type_0 = 1 as libc::c_int;
                        }
                        _ => {
                            (*ee.as_deref_mut().unwrap()).error = 2 as libc::c_int;
                ...
                0 => {
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).dval =
                                (*ee.as_deref().unwrap()).dval * oival as libc::c_double;
                            (*ee.as_deref_mut().unwrap()).type_0 = 1 as libc::c_int;
                        }
                        0 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (*ee.as_deref().unwrap()).ival * oival;
                        }
                        _ => {
                            (*ee.as_deref_mut().unwrap()).error = 2 as libc::c_int;
                        }
            ...
            37 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_unary(ee.as_deref_mut());
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            if (*ee.as_deref().unwrap()).dval == 0.0f64 {
                                ...
                                (*ee.as_deref_mut().unwrap()).dval =
                                    fmod(odval, (*ee.as_deref().unwrap()).dval);
                            }
                        }
                        0 => {
                            if (*ee.as_deref().unwrap()).ival == 0 as libc::c_int as libc::c_long {
                                ...
                                (*ee.as_deref_mut().unwrap()).dval =
                                    fmod(odval, (*ee.as_deref().unwrap()).ival as libc::c_double);
                            }
                            (*ee.as_deref_mut().unwrap()).type_0 = 1 as libc::c_int;
                        }
                        _ => {
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            if (*ee.as_deref().unwrap()).dval == 0.0f64 {
                                ...
                                (*ee.as_deref_mut().unwrap()).dval =
                                    fmod(oival as libc::c_double, (*ee.as_deref().unwrap()).dval);
                            }
                        }
                        0 => {
                            if (*ee.as_deref().unwrap()).ival == 0 as libc::c_int as libc::c_long {
            ...
            47 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_unary(ee.as_deref_mut());
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        ...
                        0 => {
                            if (*ee.as_deref().unwrap()).ival == 0 as libc::c_int as libc::c_long {
                                ...
                                (*ee.as_deref_mut().unwrap()).dval =
                                    odval / (*ee.as_deref().unwrap()).ival as libc::c_double;
                            }
                            (*ee.as_deref_mut().unwrap()).type_0 = 1 as libc::c_int;
                        }
                        _ => {
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            if (*ee.as_deref().unwrap()).dval == 0.0f64 {
                                ...
                                (*ee.as_deref_mut().unwrap()).dval =
                                    oival as libc::c_double / (*ee.as_deref().unwrap()).dval;
                            }
                        }
                        0 => {
                            if (*ee.as_deref().unwrap()).ival == 0 as libc::c_int as libc::c_long {
            ...
            92 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_unary(ee.as_deref_mut());
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            if (*ee.as_deref().unwrap()).dval == 0.0f64 {
                                ...
                                (*ee.as_deref_mut().unwrap()).ival =
                                    (odval / (*ee.as_deref().unwrap()).dval) as lilint_t;
                            }
                            (*ee.as_deref_mut().unwrap()).type_0 = 0 as libc::c_int;
                        }
                        0 => {
                            if (*ee.as_deref().unwrap()).ival == 0 as libc::c_int as libc::c_long {
                                ...
                                (*ee.as_deref_mut().unwrap()).ival = (odval
                                    / (*ee.as_deref().unwrap()).ival as libc::c_double)
                                    as lilint_t;
                            }
                        }
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            if (*ee.as_deref().unwrap()).dval == 0.0f64 {
                                ...
                                (*ee.as_deref_mut().unwrap()).ival = (oival as libc::c_double
                                    / (*ee.as_deref().unwrap()).dval)
                                    as lilint_t;
                            }
                            (*ee.as_deref_mut().unwrap()).type_0 = 0 as libc::c_int;
                        }
...
unsafe extern "C" fn ee_addsub(mut ee: Option<&mut expreval_t>) {
                ...
                == '-' as i32)
    {
        ...
        match *(*ee.as_deref().unwrap())
            ...
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
        {
            43 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_muldiv(ee.as_deref_mut());
...
unsafe extern "C" fn ee_shift(mut ee: Option<&mut expreval_t>) {
                    ...
                    == '>' as i32)
    {
        ...
        match *(*ee.as_deref().unwrap())
            ...
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
        {
            60 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_addsub(ee.as_deref_mut());
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (odval as lilint_t) << (*ee.as_deref().unwrap()).dval as lilint_t;
                            (*ee.as_deref_mut().unwrap()).type_0 = 0 as libc::c_int;
                        }
                        0 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (odval as lilint_t) << (*ee.as_deref().unwrap()).ival;
                        }
                        _ => {
                            (*ee.as_deref_mut().unwrap()).error = 2 as libc::c_int;
                        }
                ...
                0 => {
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                oival << (*ee.as_deref().unwrap()).dval as lilint_t;
                            (*ee.as_deref_mut().unwrap()).type_0 = 0 as libc::c_int;
                        }
                        0 => {
                            (*ee.as_deref_mut().unwrap()).ival =
            ...
            62 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    (*ee.as_deref_mut().unwrap()).head =
                        (*ee.as_deref().unwrap()).head.wrapping_add(1);
                    ee_addsub(ee.as_deref_mut());
...
unsafe extern "C" fn ee_compare(mut ee: Option<&mut expreval_t>) {
                    ...
                    == '=' as i32)
    {
        ...
        match op {
            1 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    ee_shift(ee.as_deref_mut());
                    if (*ee.as_deref().unwrap()).error != 0 {
                        return;
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (if odval < (*ee.as_deref().unwrap()).dval {
                                    1 as libc::c_int
                                } else {
                                    0 as libc::c_int
                                }) as lilint_t;
                        ...
                        0 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (if odval < (*ee.as_deref().unwrap()).ival as libc::c_double {
                                    1 as libc::c_int
                                } else {
                                    0 as libc::c_int
                                }) as lilint_t;
                ...
                0 => {
                    ...
                    match (*ee.as_deref().unwrap()).type_0 {
                        1 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (if (oival as libc::c_double) < (*ee.as_deref().unwrap()).dval {
                                    1 as libc::c_int
                                } else {
                                    0 as libc::c_int
                                }) as lilint_t;
                        ...
                        0 => {
                            (*ee.as_deref_mut().unwrap()).ival =
                                (if oival < (*ee.as_deref().unwrap()).ival {
                                    1 as libc::c_int
                                } else {
                                    0 as libc::c_int
                                }) as lilint_t;
            ...
            2 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    ee_shift(ee.as_deref_mut());
                    if (*ee.as_deref().unwrap()).error != 0 {
                        return;
            ...
            3 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    ee_shift(ee.as_deref_mut());
                    if (*ee.as_deref().unwrap()).error != 0 {
                        return;
            ...
            4 => match (*ee.as_deref().unwrap()).type_0 {
                1 => {
                    ee_shift(ee.as_deref_mut());
                    if (*ee.as_deref().unwrap()).error != 0 {
                        return;
...
unsafe extern "C" fn ee_equals(mut ee: Option<&mut expreval_t>) {
                    ...
                    == '=' as i32)
    {
        let mut odval = (*ee.as_deref().unwrap()).dval;
        let mut oival = (*ee.as_deref().unwrap()).ival;
        let mut op = if *(*ee.as_deref().unwrap())
            .code
            .offset((*ee.as_deref().unwrap()).head as isize) as libc::c_int
            == '=' as i32
        {
        ...
        match (*ee.as_deref().unwrap()).type_0 {
            1 => {
                ...
                match (*ee.as_deref().unwrap()).type_0 {
                    1 => {
                        (*ee.as_deref_mut().unwrap()).ival =
                            (if odval != 0. && (*ee.as_deref().unwrap()).dval != 0. {
                                1 as libc::c_int
                            } else {
                                0 as libc::c_int
                            }) as lilint_t;
                    ...
                    0 => {
                        (*ee.as_deref_mut().unwrap()).ival =
                            (if odval != 0. && (*ee.as_deref().unwrap()).ival != 0 {
                                1 as libc::c_int
                            } else {
                                0 as libc::c_int
                            }) as lilint_t;
            ...
            0 => {
                ...
                match (*ee.as_deref().unwrap()).type_0 {
                    1 => {
                        (*ee.as_deref_mut().unwrap()).ival =
                            (if oival != 0 && (*ee.as_deref().unwrap()).dval != 0. {
                                1 as libc::c_int
                            } else {
                                0 as libc::c_int
                            }) as lilint_t;
                    ...
                    0 => {
                        (*ee.as_deref_mut().unwrap()).ival =
                            (if oival != 0 && (*ee.as_deref().unwrap()).ival != 0 {
                                1 as libc::c_int
                            } else {
                                0 as libc::c_int
                            }) as lilint_t;
...
#[no_mangle]
pub unsafe extern "C" fn lil_eval_expr(mut lil: lil_t, mut code: lil_value_t) -> lil_value_t {
    ...
    if *ee.code.offset(0 as libc::c_int as isize) == 0 {
        lil_free_value(Some(Box::from_raw(code)));
    ...
    if ee.error != 0 {
        match ee.error {
            3 => {
                lil_set_error(
                    lil.as_mut(),
                    b"division by zero in expression\0" as *const u8 as *const libc::c_char,
                );
            }
            2 => {
                lil_set_error(
                    lil.as_mut(),
                    b"mixing invalid types in expression\0" as *const u8 as *const libc::c_char,
                );
            }
            1 => {
                lil_set_error(
...
pub unsafe extern "C" fn lil_unused_name(
    ...
    let mut name = malloc((strlen(part)).wrapping_add(64 as libc::c_int as libc::c_ulong))
        as *mut libc::c_char;
    let mut val = 0 as *mut _lil_value_t;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
...
#[no_mangle]
pub unsafe extern "C" fn lil_arg(mut argv: *const lil_value_t, mut index: size_t) -> lil_value_t {
...
pub unsafe extern "C" fn lil_free(mut lil: lil_t) {
    let mut i: size_t = 0;
    if lil.as_deref().is_none() {
        ();
        return;
    }
    free((*lil.as_deref().unwrap()).err_msg as *mut libc::c_void);
    lil_free_value(Some(Box::from_raw((*lil.as_deref().unwrap()).empty)));
    while !(*lil.as_deref().unwrap()).env.is_null() {
        let mut next = (*(*lil.as_deref().unwrap()).env).parent;
        lil_free_env(Some(Box::from_raw((*lil.as_deref_mut().unwrap()).env)));
        (*lil.as_deref_mut().unwrap()).env = next;
    }
    ();
    ...
    while i < (*lil.as_deref().unwrap()).cmds {
        if !((**(*lil.as_deref().unwrap()).cmd.offset(i as isize)).argnames).is_null() {
            lil_free_list((**(*lil.as_deref().unwrap()).cmd.offset(i as isize)).argnames);
        } else {
            ();
        }
        lil_free_value((**(*lil.as_deref().unwrap()).cmd.offset(i as isize)).code);
        free((**(*lil.as_deref().unwrap()).cmd.offset(i as isize)).name as *mut libc::c_void);
        ();
        i = i.wrapping_add(1);
    }
    free((*lil.as_deref().unwrap()).cmd as *mut libc::c_void);
    free((*lil.as_deref().unwrap()).dollarprefix as *mut libc::c_void);
    free((*lil.as_deref().unwrap()).catcher as *mut libc::c_void);
    ();
}
#[no_mangle]
pub unsafe extern "C" fn lil_set_data(mut lil: lil_t, mut data: *const libc::c_void) {
    (*lil.as_deref_mut().unwrap()).data = data;
}
#[no_mangle]
pub unsafe extern "C" fn lil_get_data(mut lil: lil_t) -> *const libc::c_void {
    return (*lil).data;
}
unsafe extern "C" fn fnc_reflect(
    ...
    if strcmp(type_0, b"funcs\0" as *const u8 as *const libc::c_char) == 0 {
        ...
        lil_free_list(Some(Box::from_raw(funcs)));
        return r;
    }
    if strcmp(type_0, b"vars\0" as *const u8 as *const libc::c_char) == 0 {
        let mut vars = lil_alloc_list();
        let mut env = (*lil).env as *const crate::src::lil::_lil_env_t;
        while !env.is_null() {
            i = 0 as libc::c_int as size_t;
            while i < (*env).vars {
            ...
            env = (*env).parent as *const crate::src::lil::_lil_env_t;
        }
        ();
        r = lil_list_to_value(vars, 1 as libc::c_int);
        lil_free_list(Some(Box::from_raw(vars)));
        return r;
    }
    if strcmp(type_0, b"globals\0" as *const u8 as *const libc::c_char) == 0 {
        ...
        lil_free_list(Some(Box::from_raw(vars_0)));
        return r;
    }
    ...
    if strcmp(type_0, b"has-var\0" as *const u8 as *const libc::c_char) == 0 {
        ...
        let mut env_0 = (*lil).env as *const crate::src::lil::_lil_env_t;
        if argc == 1 as libc::c_int as libc::c_ulong {
            return 0 as lil_value_t;
        }
        ...
        while !env_0.is_null() {
            ...
            env_0 = (*env_0).parent as *const crate::src::lil::_lil_env_t;
        }
        ();
        return 0 as lil_value_t;
    }
    ...
    if strcmp(
        type_0,
        b"dollar-prefix\0" as *const u8 as *const libc::c_char,
    ) == 0
    {
    ...
    if strcmp(type_0, b"this\0" as *const u8 as *const libc::c_char) == 0 {
        let mut env_1 = (*lil).env as *const crate::src::lil::_lil_env_t;
        while env_1 != (*lil).rootenv && (*env_1).catcher_for.is_null() && (*env_1).func.is_null() {
            env_1 = (*env_1).parent as *const crate::src::lil::_lil_env_t;
        }
    ...
    if strcmp(type_0, b"name\0" as *const u8 as *const libc::c_char) == 0 {
        let mut env_2 = (*lil).env as *const crate::src::lil::_lil_env_t;
        while env_2 != (*lil).rootenv && (*env_2).catcher_for.is_null() && (*env_2).func.is_null() {
            env_2 = (*env_2).parent as *const crate::src::lil::_lil_env_t;
        }
...
unsafe extern "C" fn fnc_func(
    ...
    if argc == 3 as libc::c_int as libc::c_ulong {
        ...
        (*cmd).argnames =
            lil_subst_to_list(lil.as_deref_mut(), *argv.offset(1 as libc::c_int as isize));
        ...
        if argc < 2 as libc::c_int as libc::c_ulong {
            let mut tmp = lil_alloc_string(b"args\0" as *const u8 as *const libc::c_char);
            ...
            (*cmd).argnames =
                lil_subst_to_list(lil.as_deref_mut(), *argv.offset(0 as libc::c_int as isize));
...
unsafe extern "C" fn fnc_rename(
    ...
    if func.is_null() {
        ();
        let mut msg = malloc((24 as libc::c_int as libc::c_ulong).wrapping_add(strlen(oldname)))
            as *mut libc::c_char;
        sprintf(
            msg,
            b"unknown function '%s'\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn fnc_set(
    ...
    while i < argc {
        if argc == i.wrapping_add(1 as libc::c_int as libc::c_ulong) {
            return lil_clone_value(lil_get_var(
                lil.as_deref_mut(),
...
unsafe extern "C" fn fnc_local(
    ...
    while i < argc {
        ...
        if (lil_find_local_var(
            lil.as_deref()
                .map(|r| r as *const _)
                .unwrap_or(std::ptr::null()),
            (*lil.as_deref().unwrap()).env,
            varname,
        ))
        .is_null()
        {
...
unsafe extern "C" fn fnc_write(
    ...
    if ((*lil).callback[1 as libc::c_int as usize]).is_some() {
        let mut proc_0: lil_write_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_write_callback_proc_t>(
...
unsafe extern "C" fn fnc_enveval(
    ...
    if argc == 1 as libc::c_int as libc::c_ulong {
        ...
        while i < lil_list_size(invars) {
            *varvalues.offset(i as isize) = lil_clone_value(lil_get_var(
                lil.as_mut(),
    ...
    if !invars.is_null() {
        ...
        lil_free_list(Some(Box::from_raw(invars)));
        if !outvars.is_null() {
            lil_free_list(Some(Box::from_raw(outvars)));
        } else {
            ();
        }
    ...
    if base != 1 as libc::c_int as libc::c_ulong {
        ...
        while i < (*lil.as_deref().unwrap()).cmds {
            ...
            if !((*fnc).proc_0).is_none() {
                lil_register(sublil.as_deref_mut(), (*fnc).name, (*fnc).proc_0);
            }
            i = i.wrapping_add(1);
        }
    }
...
unsafe extern "C" fn fnc_index(
    ...
    if index >= (*list.as_deref().unwrap()).c {
        None;
    } else {
        r = lil_clone_value(*(*list.as_deref().unwrap()).v.offset(index as isize));
    }
    lil_free_list(list);
    return r;
}
unsafe extern "C" fn fnc_indexof(
    ...
    lil_free_list(Some(Box::from_raw(list)));
    return r;
}
    ...
    while i < argc {
        lil_list_append(
            list.as_deref_mut()
                .map(|r| r as *mut _)
                .unwrap_or(std::ptr::null_mut()),
            lil_clone_value(*argv.offset(i as isize)),
        );
        i = i.wrapping_add(1);
    }
    r = lil_list_to_value(
...
unsafe extern "C" fn fnc_slice(
    ...
    if to > (*list.as_deref().unwrap()).c as lilint_t {
        to = (*list.as_deref().unwrap()).c as lilint_t;
    }
    if to < from {
        to = from;
    }
    ...
    while i < to as size_t {
        lil_list_append(
            slice
                ...
                .map(|r| r as *mut _)
                .unwrap_or(std::ptr::null_mut()),
            lil_clone_value(*(*list.as_deref().unwrap()).v.offset(i as isize)),
        );
        i = i.wrapping_add(1);
    }
    lil_free_list(list);
...
unsafe extern "C" fn fnc_filter(
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*list.as_deref().unwrap()).c && (*(*lil.as_deref().unwrap()).env).breakrun == 0 {
        lil_set_var(
            lil.as_deref_mut()
                .map(|r| r as *mut _)
                .unwrap_or(std::ptr::null_mut()),
            varname,
            *(*list.as_deref().unwrap()).v.offset(i as isize),
            3 as libc::c_int,
        );
        r = lil_eval_expr(
            lil.as_deref_mut()
        ...
        if lil_to_boolean(r.as_deref_mut()) != 0 {
            lil_list_append(
                filtered
                    .as_deref_mut()
                    .map(|r| r as *mut _)
...
unsafe extern "C" fn fnc_foreach(
    ...
    while i < (*list).c {
        ...
        if (*rv).l != 0 {
            ...
            lil_free_value(Some(Box::from_raw(rv)));
        }
    ...
    lil_free_list(Some(Box::from_raw(list)));
    lil_free_list(Some(Box::from_raw(rlist)));
    return r;
}
unsafe extern "C" fn fnc_return(
    ...
    lil_free_value(Some(Box::from_raw(
        (*(*lil.as_deref().unwrap()).env).retval,
    )));
...
unsafe extern "C" fn fnc_result(
    ...
    if argc > 0 as libc::c_int as libc::c_ulong {
        ...
        (*(*lil.as_deref_mut().unwrap()).env).retval =
            lil_clone_value(*argv.offset(0 as libc::c_int as isize));
        (*(*lil.as_deref_mut().unwrap()).env).retval_set = 1 as libc::c_int;
    }
...
unsafe extern "C" fn fnc_read(
    ...
    if ((*lil).callback[2 as libc::c_int as usize]).is_some() {
        let mut proc_0: lil_read_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_read_callback_proc_t>(
        ...
        buffer = malloc(size.wrapping_add(1 as libc::c_int as libc::c_ulong)) as *mut libc::c_char;
        fread(
...
unsafe extern "C" fn fnc_store(
    ...
    if ((*lil).callback[3 as libc::c_int as usize]).is_some() {
        let mut proc_0: lil_store_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_store_callback_proc_t>(
...
unsafe extern "C" fn fnc_while(
    ...
    while (*lil).error == 0 && (*(*lil).env).breakrun == 0 {
        ...
        if v == 0 {
            ...
            if !r.is_null() {
                lil_free_value(Some(Box::from_raw(r)));
            } else {
                ();
            }
            r = lil_parse_value(
...
unsafe extern "C" fn real_trim(
    ...
    if left != 0 {
        ...
        if right == 0 {
            r = lil_alloc_string(if *str.offset(base as isize) as libc::c_int != 0 {
...
unsafe extern "C" fn fnc_exit(
    ...
    if ((*lil).callback[0 as libc::c_int as usize]).is_some() {
        let mut proc_0: lil_exit_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_exit_callback_proc_t>(
...
unsafe extern "C" fn fnc_source(
    ...
    if ((*lil).callback[4 as libc::c_int as usize]).is_some() {
        let mut proc_0: lil_source_callback_proc_t =
            ::std::mem::transmute::<lil_callback_proc_t, lil_source_callback_proc_t>(
...
unsafe extern "C" fn fnc_catcher(
    ...
    if argc == 0 as libc::c_int as libc::c_ulong {
        ...
        free((*lil.as_deref().unwrap()).catcher as *mut libc::c_void);
        (*lil.as_deref_mut().unwrap()).catcher =
            if *catcher.offset(0 as libc::c_int as isize) as libc::c_int != 0 {
                strclone(catcher)
            } else {
