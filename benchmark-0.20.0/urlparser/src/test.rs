...
pub unsafe extern "C" fn strdup(
    ...
    let mut n: libc::c_int = (strlen(str))
        ...
        as libc::c_int;
    let mut dup: *mut libc::c_char =
        malloc(n as libc::c_ulong) as *mut libc::c_char;
    if !dup.is_null() {
        strcpy(dup, str);
    }
    return dup;
...
unsafe extern "C" fn get_part(
    ...
    let mut tmp: *mut libc::c_char =
        malloc(::core::mem::size_of::<libc::c_char>() as libc::c_ulong)
            as *mut libc::c_char;
...
pub unsafe extern "C" fn url_parse(
    ...
    let mut data: *mut url_data_t =
        malloc(::core::mem::size_of::<url_data_t>() as libc::c_ulong)
            as *mut url_data_t;
    if data.is_null() {
    ...
    let mut protocol_len: libc::c_int =
        strlen(protocol) as libc::c_int + 3 as libc::c_int;
    ...
    let mut host: *mut libc::c_char = malloc(
        (strlen(tmp_hostname)).wrapping_mul(
    ...
    let mut path: *mut libc::c_char =
        malloc((strlen(tmp_path)).wrapping_mul(::core::mem::size_of::<
            libc::c_char
    ...
    let mut search: *mut libc::c_char =
        malloc(::core::mem::size_of::<*mut libc::c_char>() as libc::c_ulong)
            as *mut libc::c_char;
    if search.is_null() {
        return 0 as *mut url_data_t;
    }
...
pub unsafe extern "C" fn url_is_protocol(mut str: *mut libc::c_char) -> bool {
    let mut count: libc::c_int =
        (::core::mem::size_of::<[*mut libc::c_char; 177]>() as libc::c_ulong)
            .wrapping_div(
...
pub unsafe extern "C" fn url_is_ssh(mut str: *mut libc::c_char) -> bool {
    str = strdup(str);
    if 0 as libc::c_int
        == strcmp(str, b"ssh\0" as *const u8 as *const libc::c_char)
        || 0 as libc::c_int
            == strcmp(str, b"git\0" as *const u8 as *const libc::c_char)
    {
...
pub unsafe extern "C" fn url_get_protocol(
    ...
    let mut protocol: *mut libc::c_char =
        malloc((16 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_char>() as libc::c_ulong
        )) as *mut libc::c_char;
    if protocol.is_null() {
        return 0 as *mut libc::c_char;
...
pub unsafe extern "C" fn url_get_hostname(
    ...
    if !auth.is_null() {
        l = (l as libc::c_ulong).wrapping_add(
            (strlen(auth)).wrapping_add(1 as libc::c_int as libc::c_ulong)
    ...
    let mut hostname: *mut libc::c_char =
        if url_is_ssh(tmp_protocol) as libc::c_int != 0 {
...
pub unsafe extern "C" fn url_get_search(
    ...
    let mut tmp_path: *mut libc::c_char =
        strff(path, strlen(pathname) as libc::c_int);
    strcat(search, b"\0" as *const u8 as *const libc::c_char);
    sscanf(
        tmp_path,
        b"%[^#]\0" as *const u8 as *const libc::c_char,
...
pub unsafe extern "C" fn url_get_port(
    ...
    let mut tmp_hostname: *mut libc::c_char = strff(
        hostname,
        (strlen(host)).wrapping_add(1 as libc::c_int as libc::c_ulong)
            as libc::c_int
    );
    sscanf(
        tmp_hostname,
...
unsafe fn main_0() -> libc::c_int {
    let mut gh_url: *mut libc::c_char =
        b"git://git@github.com:jwerle/url.h.git\0" as *const u8
            as *const libc::c_char as *mut libc::c_char;
    let mut url: *mut libc::c_char =
        b"http://user:pass@subdomain.host.com:8080/p/a/t/h?query=string#hash\0"
        ...
        )
    {
        ...
        __assert_fail(
            b"0 == strcmp(\"subdomain.host.com\", url_get_host(url))\0"
                as *const u8 as *const libc::c_char,
            b"test.c\0" as *const u8 as *const libc::c_char,
        ...
        )
    {
        ...
        __assert_fail(
            b"0 == strcmp(\"?query=string\", url_get_search(url))\0"
                as *const u8 as *const libc::c_char,
            b"test.c\0" as *const u8 as *const libc::c_char,
        ...
        )
    {
        ...
        __assert_fail(
            b"0 == strcmp(\"github.com\", url_get_hostname(gh_url))\0"
                as *const u8 as *const libc::c_char,
            b"test.c\0" as *const u8 as *const libc::c_char,
        ...
        )
    {
        ...
        __assert_fail(
            b"0 == strcmp(\"jwerle/url.h.git\", url_get_path(gh_url))\0"
                as *const u8 as *const libc::c_char,
            b"test.c\0" as *const u8 as *const libc::c_char,
