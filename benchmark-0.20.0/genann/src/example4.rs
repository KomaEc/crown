...
#[no_mangle]
pub static mut iris_data: *const libc::c_char =
    b"example/iris.data\0" as *const u8 as *const libc::c_char;
#[no_mangle]
pub static mut input: *mut libc::c_double = 0 as *const libc::c_double as *mut libc::c_double;
#[no_mangle]
pub static mut class: *mut libc::c_double = 0 as *const libc::c_double as *mut libc::c_double;
#[no_mangle]
...
pub unsafe extern "C" fn load_data() {
    ...
    while feof(in_0) == 0 && !(fgets(line.as_mut_ptr(), 1024 as libc::c_int, in_0)).is_null() {
        samples += 1;
        samples;
    }
    ...
    i = 0 as libc::c_int;
    while i < samples {
        let mut p: *mut libc::c_double = input.offset((i * 4 as libc::c_int) as isize);
        let mut c: *mut libc::c_double = class.offset((i * 3 as libc::c_int) as isize);
        ...
        *c.offset(0 as libc::c_int as isize) = *fresh1;
        ...
        let mut split: *mut libc::c_char = strtok(
            line.as_mut_ptr(),
        ...
        *split.offset((strlen(split)).wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize) =
            0 as libc::c_int as libc::c_char;
        if strcmp(split, class_names[0 as libc::c_int as usize]) == 0 as libc::c_int {
            *c.offset(0 as libc::c_int as isize) = 1.0f64;
        } else if strcmp(split, class_names[1 as libc::c_int as usize]) == 0 as libc::c_int {
            *c.offset(1 as libc::c_int as isize) = 1.0f64;
        } else if strcmp(split, class_names[2 as libc::c_int as usize]) == 0 as libc::c_int {
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    let mut loops: libc::c_int = 5000 as libc::c_int;
    printf(
    ...
    j = 0 as libc::c_int;
    while j < samples {
        let mut guess: *const libc::c_double =
            genann_run(ann, input.offset((j * 4 as libc::c_int) as isize));
        if *class.offset((j * 3 as libc::c_int + 0 as libc::c_int) as isize) == 1.0f64 {
            if *guess.offset(0 as libc::c_int as isize) > *guess.offset(1 as libc::c_int as isize)
        ...
        } else if *class.offset((j * 3 as libc::c_int + 1 as libc::c_int) as isize) == 1.0f64 {
            if *guess.offset(1 as libc::c_int as isize) > *guess.offset(0 as libc::c_int as isize)
        ...
        } else if *class.offset((j * 3 as libc::c_int + 2 as libc::c_int) as isize) == 1.0f64 {
            if *guess.offset(2 as libc::c_int as isize) > *guess.offset(0 as libc::c_int as isize)
                && *guess.offset(2 as libc::c_int as isize)
                    > *guess.offset(1 as libc::c_int as isize)
            {
                correct += 1;
