...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    let mut last_err: libc::c_double = 1000 as libc::c_int as libc::c_double;
    ...
    loop {
        ...
        if count % 1000 as libc::c_int == 0 as libc::c_int {
            ...
            last_err = 1000 as libc::c_int as libc::c_double;
        }
        let mut save: *mut genann = genann_copy(ann);
        i = 0 as libc::c_int;
        while i < (*ann).total_weights {
            *((*ann).weight).offset(i as isize) +=
                rand() as libc::c_double / 2147483647 as libc::c_int as libc::c_double - 0.5f64;
            i += 1;
            i;
        }
