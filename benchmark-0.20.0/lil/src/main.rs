...
extern "C" {
    ...
    fn lil_register(lil: lil_t, name: *const libc::c_char, proc_0: lil_func_proc_t) -> libc::c_int;
    fn lil_parse(
        lil: lil_t,
    ...
    fn lil_error(lil: lil_t, msg: *mut *const libc::c_char, pos: *mut size_t) -> libc::c_int;
...
unsafe extern "C" fn fnc_writechar(
    ...
    printf(
        ...
        lil_to_integer(*argv.offset(0 as libc::c_int as isize)) as libc::c_char as libc::c_int,
    );
    return 0 as lil_value_t;
}
