...
pub unsafe extern "C" fn zsetu(
    ...
    if (*a).alloced
        < (::core::mem::size_of::<libc::c_ulonglong>() as libc::c_ulong)
            .wrapping_add(::core::mem::size_of::<zahl_char_t>() as libc::c_ulong)
            .wrapping_sub(1 as libc::c_int as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<zahl_char_t>() as libc::c_ulong)
    {
        libzahl_realloc(
            a,
            (::core::mem::size_of::<libc::c_ulonglong>() as libc::c_ulong)
    ...
    while b != 0 {
        ...
        *((*a).chars).offset(fresh0 as isize) = b as zahl_char_t;
        b >>= 32 as libc::c_int;
    }
}
