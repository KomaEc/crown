...
unsafe extern "C" fn zrand_get_random_bits(
    ...
    while n != 0 {
        read_just =
            read(fd, buf.offset(read_total as isize) as *mut libc::c_void, n);
        ...
        read_total = (read_total as libc::c_ulong)
            .wrapping_add(read_just as size_t) as size_t
            as size_t;
        n = (n as libc::c_ulong).wrapping_sub(read_just as size_t) as size_t
            as size_t;
    }
