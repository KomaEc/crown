    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            ...
            if bzerr != 0 as libc::c_int {
                current_block = 7064286646042275501;
            } else {
                ...
                loop {
                    ...
                    if ferror(stream) != 0 {
                        current_block = 16981186315855590976;
                        break;
                    }
            ...
            match current_block {
                ...
                _ => {
                    ...
                    match bzerr {
                        -9 => {
                            current_block = 10158063413317357606;
                            match current_block {
                                8758779949906403879 => {
                                    panic(
                        ...
                        -3 => {
                            current_block = 3591356439862972573;
                            match current_block {
                                8758779949906403879 => {
                                    panic(
                                        b"compress:unexpected error\0" as *const u8
...
unsafe extern "C" fn uncompressStream(mut zStream: *mut FILE, mut stream: *mut FILE) -> Bool {
    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            's_37: loop {
                if !(1 as libc::c_int as Bool != 0) {
                    current_block = 3567988737957258575;
                    break;
                }
                bzf = BZ2_bzReadOpen(
                    &mut bzerr,
                ...
                while bzerr == 0 as libc::c_int {
                    ...
                    if bzerr == -(5 as libc::c_int) {
                        current_block = 15290687092698326001;
                        break 's_37;
                    }
                    ...
                    if ferror(stream) != 0 {
                        current_block = 17831017934303675544;
                        break 's_37;
                    }
                }
            ...
            match current_block {
                17831017934303675544 => {}
                _ => {
                    match current_block {
                        15290687092698326001 => {
                            if forceOverwrite != 0 {
                                rewind(zStream);
                                loop {
                                    if !(1 as libc::c_int as Bool != 0) {
                    ...
                    match current_block {
                        ...
                        _ => match current_block {
                            12129979386315422097 => {
                                ...
                                match bzerr {
                                    -9 => {
                                        current_block = 4529415083041204910;
                                        match current_block {
                                    ...
                                    -6 => {}
                                    -4 => {
                                        current_block = 13329547802239652874;
                                        match current_block {
                                            14054180689323133469 => {
                                                panic(
                                                    b"decompress:unexpected error\0" as *const u8
                                    ...
                                    -3 => {
                                        current_block = 2593590531679815969;
                                        match current_block {
                                            14054180689323133469 => {
                                                panic(
                                                    b"decompress:unexpected error\0" as *const u8
                                    ...
                                    -5 => {
                                        current_block = 14971282710685463899;
                                        match current_block {
                                            14054180689323133469 => {
                                                panic(
                                                    b"decompress:unexpected error\0" as *const u8
...
unsafe extern "C" fn testStream(mut zStream: *mut FILE) -> Bool {
    ...
    if !(ferror(zStream) != 0) {
        's_29: loop {
            ...
            if bzf.is_null() || bzerr != 0 as libc::c_int {
                current_block = 5614817423553169969;
                break;
            }
            streamNo += 1;
            streamNo;
        ...
        match current_block {
            ...
            _ => {
                ...
                match bzerr {
                    -9 => {
                        current_block = 11898363343877628413;
                        match current_block {
                            65610975823438809 => {
                                panic(
                    ...
                    -6 => {}
                    -4 => {
                        current_block = 5293649487377342278;
                        match current_block {
                            65610975823438809 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8 as *const libc::c_char,
                    ...
                    -7 => {
                        current_block = 12389328470268529299;
                        match current_block {
                            65610975823438809 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8 as *const libc::c_char,
                    ...
                    -5 => {
                        current_block = 18097633975628083929;
                        match current_block {
                            65610975823438809 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8 as *const libc::c_char,
                    ...
                    _ => {
                        current_block = 65610975823438809;
                        match current_block {
                            65610975823438809 => {
                                panic(
                                    b"test:unexpected error\0" as *const u8 as *const libc::c_char,
    ...
    match srcMode {
        ...
        3 => {
            ...
            loop {
                ...
                {
                    current_block = 12771242728676908681;
                    break;
                }
                i += 1;
                i;
