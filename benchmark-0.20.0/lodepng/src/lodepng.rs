...
#[no_mangle]
pub static mut LODEPNG_VERSION_STRING: *const libc::c_char =
    b"20221108\0" as *const u8 as *const libc::c_char;
...
unsafe extern "C" fn lodepng_strlen(mut a: *const libc::c_char) -> size_t {
    let mut orig: *const libc::c_char = a;
    Some(lodepng_strlen as unsafe extern "C" fn(*const libc::c_char) -> size_t);
    while *a != 0 {
        a = a.offset(1);
        a;
    }
...
unsafe extern "C" fn lodepng_mulofl(
    ...
    *result = a.wrapping_mul(b);
    return (a != 0 as libc::c_int as libc::c_ulong
        && (*result).wrapping_div(a) != b) as libc::c_int;
}
...
unsafe extern "C" fn uivector_init(mut p: *mut uivector) {
    (*p).data = 0 as *mut libc::c_uint;
    (*p).allocsize = 0 as libc::c_int as size_t;
    (*p).size = (*p).allocsize;
}
unsafe extern "C" fn uivector_push_back(
    ...
    if uivector_resize(
        p,
        ((*p).size).wrapping_add(1 as libc::c_int as libc::c_ulong)
    ) == 0
    {
        return 0 as libc::c_int as libc::c_uint;
    }
    *((*p).data)
        .offset(((*p).size).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize) = c;
    return 1 as libc::c_int as libc::c_uint;
}
...
unsafe extern "C" fn alloc_string_sized(
    ...
    let mut out: *mut libc::c_char =
        lodepng_malloc(insize.wrapping_add(1 as libc::c_int as libc::c_ulong))
            as *mut libc::c_char;
    if !out.is_null() {
        lodepng_memcpy(
...
unsafe extern "C" fn lodepng_set32bitInt(
    ...
    *buffer.offset(0 as libc::c_int as isize) = (value >> 24 as libc::c_int
        & 0xff as libc::c_int as libc::c_uint)
        as libc::c_uchar;
    *buffer.offset(1 as libc::c_int as isize) = (value >> 16 as libc::c_int
        & 0xff as libc::c_int as libc::c_uint)
        as libc::c_uchar;
    *buffer.offset(2 as libc::c_int as isize) = (value >> 8 as libc::c_int
        & 0xff as libc::c_int as libc::c_uint)
        as libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_load_file(
    ...
    let mut size: libc::c_long = lodepng_filesize(filename);
...
unsafe extern "C" fn writeBits(
    ...
    if nbits == 1 as libc::c_int as libc::c_ulong {
            ...
            == 0 as libc::c_int as libc::c_uint
        {
            ...
            *((*(*writer).data).data).offset(
                ((*(*writer).data).size)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            ) = 0 as libc::c_int as libc::c_uchar;
        }
        let ref mut fresh2 = *((*(*writer).data).data).offset(
            ((*(*writer).data).size)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                as isize
        );
        *fresh2 = (*fresh2 as libc::c_uint
        ...
        while i != nbits {
            ...
            let ref mut fresh3 = *((*(*writer).data).data).offset(
                ((*(*writer).data).size)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
            *fresh3 = (*fresh3 as libc::c_int
                | ((value >> i & 1 as libc::c_int as libc::c_uint)
...
unsafe extern "C" fn writeBitsReversed(
    ...
    while i != nbits {
        ...
        let ref mut fresh4 = *((*(*writer).data).data).offset(
            ((*(*writer).data).size)
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                as isize
        );
...
unsafe extern "C" fn LodePNGBitReader_init(
    ...
    (*reader).data = data;
    (*reader).size = size;
    if lodepng_mulofl(size, 8 as libc::c_uint as size_t, &mut (*reader).bitsize)
        != 0
    {
...
unsafe extern "C" fn ensureBits9(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    let mut size: size_t = (*reader).size;
    if start.wrapping_add(1 as libc::c_uint as libc::c_ulong) < size {
        (*reader).buffer =
            *((*reader).data)
                .offset(start.wrapping_add(0 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn ensureBits17(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    ...
    if start.wrapping_add(2 as libc::c_uint as libc::c_ulong) < size {
        ...
        if start.wrapping_add(1 as libc::c_uint as libc::c_ulong) < size {
            (*reader).buffer |= (*((*reader).data)
                .offset(start.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 8 as libc::c_uint;
        }
        (*reader).buffer >>= (*reader).bp & 7 as libc::c_uint as libc::c_ulong;
...
unsafe extern "C" fn ensureBits25(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    ...
    if start.wrapping_add(3 as libc::c_uint as libc::c_ulong) < size {
        (*reader).buffer =
            *((*reader).data)
                ...
                | (*((*reader).data).offset(
                    ...
                    << 16 as libc::c_uint
                | (*((*reader).data).offset(
                    start.wrapping_add(3 as libc::c_int as libc::c_ulong)
                        as isize
                ) as libc::c_uint)
                    << 24 as libc::c_uint;
        (*reader).buffer >>= (*reader).bp & 7 as libc::c_uint as libc::c_ulong;
        ...
        if start.wrapping_add(2 as libc::c_uint as libc::c_ulong) < size {
            (*reader).buffer |= (*((*reader).data)
                .offset(start.wrapping_add(2 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 16 as libc::c_uint;
        }
        (*reader).buffer >>= (*reader).bp & 7 as libc::c_uint as libc::c_ulong;
...
unsafe extern "C" fn ensureBits32(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) {
    let mut start: size_t = (*reader).bp >> 3 as libc::c_uint;
    ...
    if start.wrapping_add(4 as libc::c_uint as libc::c_ulong) < size {
        ...
        (*reader).buffer |=
            ((*((*reader).data)
                .offset(start.wrapping_add(4 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 24 as libc::c_uint)
                << (8 as libc::c_uint as libc::c_ulong).wrapping_sub(
                    (*reader).bp & 7 as libc::c_uint as libc::c_ulong
                );
    } else {
        (*reader).buffer = 0 as libc::c_int as libc::c_uint;
        if start.wrapping_add(0 as libc::c_uint as libc::c_ulong) < size {
        ...
        if start.wrapping_add(3 as libc::c_uint as libc::c_ulong) < size {
            (*reader).buffer |= (*((*reader).data)
                .offset(start.wrapping_add(3 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 24 as libc::c_uint;
        }
        (*reader).buffer >>= (*reader).bp & 7 as libc::c_uint as libc::c_ulong;
...
unsafe extern "C" fn advanceBits(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) {
    (*reader).buffer >>= nbits;
    (*reader).bp =
        ((*reader).bp as libc::c_ulong).wrapping_add(nbits) as size_t as size_t;
}
unsafe extern "C" fn readBits(
    mut reader: *mut LodePNGBitReader,
    mut nbits: size_t
) -> libc::c_uint {
    let mut result: libc::c_uint = peekBits(reader, nbits);
...
unsafe extern "C" fn HuffmanTree_init(mut tree: *mut HuffmanTree) {
    (*tree).codes = 0 as *mut libc::c_uint;
    (*tree).lengths = 0 as *mut libc::c_uint;
    (*tree).table_len = 0 as *mut libc::c_uchar;
    (*tree).table_value = 0 as *mut libc::c_ushort;
}
...
unsafe extern "C" fn HuffmanTree_makeTable(
    mut tree: *mut HuffmanTree
) -> libc::c_uint {
    static mut headsize: libc::c_uint =
        (1 as libc::c_uint) << 9 as libc::c_uint;
    let mut i: size_t = 0;
    let mut numpresent: size_t = 0;
    let mut pointer: size_t = 0;
    let mut size: size_t = 0;
    let mut maxlens: *mut libc::c_uint =
        lodepng_malloc((headsize as libc::c_ulong).wrapping_mul(
    ...
    lodepng_memset(
        ...
        0 as libc::c_int,
        (headsize as libc::c_ulong).wrapping_mul(::core::mem::size_of::<
            libc::c_uint
        >() as libc::c_ulong)
    );
    i = 0 as libc::c_int as size_t;
    while i < (*tree).numcodes as libc::c_ulong {
        let mut symbol: libc::c_uint = *((*tree).codes).offset(i as isize);
        let mut l: libc::c_uint = *((*tree).lengths).offset(i as isize);
    ...
    while i < headsize as libc::c_ulong {
        let mut l_0: libc::c_uint = *maxlens.offset(i as isize);
    ...
    (*tree).table_len =
        lodepng_malloc(size.wrapping_mul(
    ...
    i = 0 as libc::c_int as size_t;
    while i < size {
        *((*tree).table_len).offset(i as isize) =
    ...
    i = 0 as libc::c_int as size_t;
    while i < headsize as libc::c_ulong {
        let mut l_1: libc::c_uint = *maxlens.offset(i as isize);
        if !(l_1 <= 9 as libc::c_uint) {
            *((*tree).table_len).offset(i as isize) = l_1 as libc::c_uchar;
            *((*tree).table_value).offset(i as isize) =
                pointer as libc::c_ushort;
            pointer = (pointer as libc::c_ulong).wrapping_add(
    ...
    i = 0 as libc::c_int as size_t;
    while i < (*tree).numcodes as libc::c_ulong {
        let mut l_2: libc::c_uint = *((*tree).lengths).offset(i as isize);
        ...
        if !(l_2 == 0 as libc::c_int as libc::c_uint) {
            ...
            if l_2 <= 9 as libc::c_uint {
                let mut num: libc::c_uint = (1 as libc::c_uint)
                    << (9 as libc::c_uint).wrapping_sub(l_2);
                let mut j: libc::c_uint = 0;
                j = 0 as libc::c_int as libc::c_uint;
                while j < num {
                    let mut index_0: libc::c_uint = reverse | j << l_2;
                    if *((*tree).table_len).offset(index_0 as isize)
                        as libc::c_int
                        != 16 as libc::c_int
                    {
                        return 55 as libc::c_int as libc::c_uint;
                    }
                    *((*tree).table_len).offset(index_0 as isize) =
                        l_2 as libc::c_uchar;
                    *((*tree).table_value).offset(index_0 as isize) =
                        i as libc::c_ushort;
                    j = j.wrapping_add(1);
                    j;
                }
            } else {
                let mut index_1: libc::c_uint = reverse & mask;
                let mut maxlen: libc::c_uint = *((*tree).table_len)
                    .offset(index_1 as isize)
                    as libc::c_uint;
                let mut tablelen: libc::c_uint =
                    maxlen.wrapping_sub(9 as libc::c_uint);
                let mut start: libc::c_uint = *((*tree).table_value)
                    .offset(index_1 as isize)
                    as libc::c_uint;
                let mut num_0: libc::c_uint = (1 as libc::c_uint)
                    << tablelen
                        .wrapping_sub(l_2.wrapping_sub(9 as libc::c_uint));
                ...
                while j_0 < num_0 {
                    let mut reverse2: libc::c_uint =
                        reverse >> 9 as libc::c_uint;
                    let mut index2: libc::c_uint = start.wrapping_add(
                        reverse2 | j_0 << l_2.wrapping_sub(9 as libc::c_uint)
                    );
                    *((*tree).table_len).offset(index2 as isize) =
                        l_2 as libc::c_uchar;
                    *((*tree).table_value).offset(index2 as isize) =
                        i as libc::c_ushort;
    ...
    if numpresent < 2 as libc::c_int as libc::c_ulong {
        ...
        while i < size {
                ...
                == 16 as libc::c_int
            {
                ...
                *((*tree).table_value).offset(i as isize) =
                    65535 as libc::c_uint as libc::c_ushort;
            }
            i = i.wrapping_add(1);
            i;
        }
...
unsafe extern "C" fn HuffmanTree_makeFromLengths2(
    ...
    let mut blcount: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut nextcode: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut bits: libc::c_uint = 0;
    let mut n: libc::c_uint = 0;
    (*tree).codes =
        lodepng_malloc(((*tree).numcodes as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    ...
    if error == 0 {
        ...
        while n
            != ((*tree).maxbitlen)
                .wrapping_add(1 as libc::c_int as libc::c_uint)
        {
            let ref mut fresh5 = *nextcode.offset(n as isize);
            *fresh5 = 0 as libc::c_int as libc::c_uint;
            *blcount.offset(n as isize) = *fresh5;
            n = n.wrapping_add(1);
            n;
        }
        bits = 0 as libc::c_int as libc::c_uint;
        while bits != (*tree).numcodes {
            let ref mut fresh6 = *blcount
        ...
        while bits <= (*tree).maxbitlen {
            *nextcode.offset(bits as isize) = (*nextcode
                .offset(bits.wrapping_sub(1 as libc::c_int as libc::c_uint)
                    as isize))
            .wrapping_add(
                *blcount.offset(
        ...
        while n != (*tree).numcodes {
            if *((*tree).lengths).offset(n as isize)
                != 0 as libc::c_int as libc::c_uint
            {
                let ref mut fresh7 = *nextcode
                    .offset(*((*tree).lengths).offset(n as isize) as isize);
                let fresh8 = *fresh7;
                *fresh7 = (*fresh7).wrapping_add(1);
                *((*tree).codes).offset(n as isize) = fresh8;
                *((*tree).codes).offset(n as isize) &= ((1 as libc::c_uint)
...
unsafe extern "C" fn HuffmanTree_makeFromLengths(
    ...
    let mut i: libc::c_uint = 0;
    (*tree).lengths =
        lodepng_malloc(numcodes.wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
...
unsafe extern "C" fn bpmnode_create(
    ...
    let mut i: libc::c_uint = 0;
    let mut result: *mut BPMNode = 0 as *mut BPMNode;
    if (*lists).nextfree >= (*lists).numfree {
        ...
        while i != (*lists).listsize {
            let mut node: *mut BPMNode = 0 as *mut BPMNode;
        ...
        while i != (*lists).memsize {
            if (*((*lists).memory).offset(i as isize)).in_use == 0 {
                let fresh9 = (*lists).numfree;
                (*lists).numfree = ((*lists).numfree).wrapping_add(1);
                let ref mut fresh10 =
                    *((*lists).freelist).offset(fresh9 as isize);
                *fresh10 =
                    &mut *((*lists).memory).offset(i as isize) as *mut BPMNode;
            }
            i = i.wrapping_add(1);
            i;
        }
    ...
    let fresh11 = (*lists).nextfree;
    (*lists).nextfree = ((*lists).nextfree).wrapping_add(1);
    result = *((*lists).freelist).offset(fresh11 as isize);
...
unsafe extern "C" fn bpmnode_sort(mut leaves: *mut BPMNode, mut num: size_t) {
    ...
    while width < num {
        ...
        while p < num {
            ...
            let mut r: size_t = if p.wrapping_add(
                (2 as libc::c_int as libc::c_ulong).wrapping_mul(width)
            ) > num
            {
                num
            } else {
            ...
            while k < r {
                            ...
                            <= (*a.offset(j as isize)).weight)
                {
                    let fresh12 = i;
                    i = i.wrapping_add(1);
                    *b.offset(k as isize) = *a.offset(fresh12 as isize);
                } else {
                    let fresh13 = j;
                    j = j.wrapping_add(1);
                    *b.offset(k as isize) = *a.offset(fresh13 as isize);
                }
                k = k.wrapping_add(1);
                k;
            }
            p = (p as libc::c_ulong).wrapping_add(
                (2 as libc::c_int as libc::c_ulong).wrapping_mul(width)
            ) as size_t as size_t;
        }
    ...
    if counter & 1 as libc::c_int as libc::c_ulong != 0 {
        lodepng_memcpy(
            ...
            (::core::mem::size_of::<BPMNode>() as libc::c_ulong)
                .wrapping_mul(num)
        );
    }
...
unsafe extern "C" fn boundaryPM(
    ...
    let mut lastindex: libc::c_uint =
        (**((*lists).chains1).offset(c as isize)).index;
    if c == 0 as libc::c_int {
        if lastindex as libc::c_ulong >= numpresent {
            return;
        }
        let ref mut fresh14 = *((*lists).chains0).offset(c as isize);
        *fresh14 = *((*lists).chains1).offset(c as isize);
        let ref mut fresh15 = *((*lists).chains1).offset(c as isize);
        *fresh15 = bpmnode_create(
            lists,
        ...
        let mut sum: libc::c_int = (**((*lists).chains0)
            .offset((c - 1 as libc::c_int) as isize))
        .weight
            + (**((*lists).chains1).offset((c - 1 as libc::c_int) as isize))
                .weight;
        let ref mut fresh16 = *((*lists).chains0).offset(c as isize);
        *fresh16 = *((*lists).chains1).offset(c as isize);
        if (lastindex as libc::c_ulong) < numpresent
            && sum > (*leaves.offset(lastindex as isize)).weight
        {
            let ref mut fresh17 = *((*lists).chains1).offset(c as isize);
            *fresh17 = bpmnode_create(
                lists,
                (*leaves.offset(lastindex as isize)).weight,
                lastindex.wrapping_add(1 as libc::c_int as libc::c_uint),
        ...
        let ref mut fresh18 = *((*lists).chains1).offset(c as isize);
        *fresh18 = bpmnode_create(
            lists,
            sum,
            lastindex,
            *((*lists).chains1).offset((c - 1 as libc::c_int) as isize)
...
pub unsafe extern "C" fn lodepng_huffman_code_lengths(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut i: libc::c_uint = 0;
    let mut numpresent: size_t = 0 as libc::c_int as size_t;
    let mut leaves: *mut BPMNode = 0 as *mut BPMNode;
    ...
    leaves = lodepng_malloc(
        numcodes
            .wrapping_mul(::core::mem::size_of::<BPMNode>() as libc::c_ulong)
    ) as *mut BPMNode;
    if leaves.is_null() {
        return 83 as libc::c_int as libc::c_uint;
    }
    ...
    while i as libc::c_ulong != numcodes {
        if *frequencies.offset(i as isize) > 0 as libc::c_int as libc::c_uint {
            (*leaves.offset(numpresent as isize)).weight =
                *frequencies.offset(i as isize) as libc::c_int;
    ...
    lodepng_memset(
        ...
        0 as libc::c_int,
        numcodes.wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )
    );
    if numpresent == 0 as libc::c_int as libc::c_ulong {
        let ref mut fresh19 = *lengths.offset(1 as libc::c_int as isize);
        *fresh19 = 1 as libc::c_int as libc::c_uint;
        *lengths.offset(0 as libc::c_int as isize) = *fresh19;
        ...
        *lengths.offset(
        ...
        lists.memsize = (2 as libc::c_int as libc::c_uint)
            ...
            .wrapping_mul(
                maxbitlen.wrapping_add(1 as libc::c_int as libc::c_uint)
            );
        lists.nextfree = 0 as libc::c_int as libc::c_uint;
        lists.numfree = lists.memsize;
        lists.memory =
            lodepng_malloc((lists.memsize as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<BPMNode>() as libc::c_ulong
            )) as *mut BPMNode;
        lists.freelist =
            lodepng_malloc((lists.memsize as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<*mut BPMNode>() as libc::c_ulong
            )) as *mut *mut BPMNode;
        lists.chains0 =
            lodepng_malloc((lists.listsize as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<*mut BPMNode>() as libc::c_ulong
            )) as *mut *mut BPMNode;
        lists.chains1 =
            lodepng_malloc((lists.listsize as libc::c_ulong).wrapping_mul(
        ...
        if error == 0 {
            i = 0 as libc::c_int as libc::c_uint;
            while i != lists.memsize {
                let ref mut fresh20 = *(lists.freelist).offset(i as isize);
                *fresh20 =
                    &mut *(lists.memory).offset(i as isize) as *mut BPMNode;
                i = i.wrapping_add(1);
                i;
            ...
            i = 0 as libc::c_int as libc::c_uint;
            while i != lists.listsize {
                let ref mut fresh21 = *(lists.chains0).offset(i as isize);
                *fresh21 = &mut *(lists.memory)
                    .offset(0 as libc::c_int as isize)
                    as *mut BPMNode;
                let ref mut fresh22 = *(lists.chains1).offset(i as isize);
                *fresh22 = &mut *(lists.memory)
            ...
            node = *(lists.chains1).offset(
                maxbitlen.wrapping_sub(1 as libc::c_int as libc::c_uint)
                    as isize
            );
            while !node.is_null() {
                i = 0 as libc::c_int as libc::c_uint;
                while i != (*node).index {
                    let ref mut fresh23 = *lengths
...
unsafe extern "C" fn HuffmanTree_makeFromFrequencies(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    while *frequencies.offset(
        numcodes.wrapping_sub(1 as libc::c_int as libc::c_ulong) as isize
    ) == 0
        && numcodes > mincodes
    {
...
unsafe extern "C" fn generateFixedLitLenTree(
    ...
    let mut i: libc::c_uint = 0;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut bitlen: *mut libc::c_uint =
        lodepng_malloc((288 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    if bitlen.is_null() {
        return 83 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn generateFixedDistanceTree(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut bitlen: *mut libc::c_uint =
        lodepng_malloc((32 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    if bitlen.is_null() {
        return 83 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn huffmanDecodeSymbol(
    ...
    let mut code: libc::c_ushort =
        peekBits(reader, 9 as libc::c_uint as size_t) as libc::c_ushort;
    let mut l: libc::c_ushort =
        *((*codetree).table_len).offset(code as isize) as libc::c_ushort;
    let mut value: libc::c_ushort =
        *((*codetree).table_value).offset(code as isize);
    if l as libc::c_uint <= 9 as libc::c_uint {
        ...
        value = (value as libc::c_uint).wrapping_add(peekBits(
            reader,
        ...
        return *((*codetree).table_value).offset(value as isize)
            as libc::c_uint;
    };
}
unsafe extern "C" fn getTreeInflateFixed(
    ...
    let mut error: libc::c_uint = generateFixedLitLenTree(tree_ll);
    if error != 0 {
        return error;
    }
...
unsafe extern "C" fn getTreeInflateDynamic(
    ...
    let mut i: libc::c_uint = 0;
    let mut bitlen_ll: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut bitlen_d: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut bitlen_cl: *mut libc::c_uint = 0 as *mut libc::c_uint;
    ...
    bitlen_cl =
        lodepng_malloc((19 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    ...
    if error == 0 {
        ...
        ) != 0
        {
            ...
            while i != HCLEN {
                ...
                *bitlen_cl.offset(CLCL_ORDER[i as usize] as isize) =
            ...
            if !(error != 0) {
                ...
                if bitlen_ll.is_null() || bitlen_d.is_null() {
                    ...
                    lodepng_memset(
                        ...
                        0 as libc::c_int,
                        (288 as libc::c_int as libc::c_ulong).wrapping_mul(
                    ...
                    lodepng_memset(
                        ...
                        0 as libc::c_int,
                        (32 as libc::c_int as libc::c_ulong).wrapping_mul(
                            ::core::mem::size_of::<libc::c_uint>()
                                as libc::c_ulong
                        )
                    );
                    ...
                    while i < HLIT.wrapping_add(HDIST) {
                        ...
                        if code <= 15 as libc::c_int as libc::c_uint {
                            if i < HLIT {
                                ...
                                *bitlen_d
                                    .offset(i.wrapping_sub(HLIT) as isize) =
                                    code;
                            }
                            i = i.wrapping_add(1);
                            i;
                        } else if code == 16 as libc::c_int as libc::c_uint {
                            let mut replength: libc::c_uint =
                                3 as libc::c_int as libc::c_uint;
                            ...
                            if i == 0 as libc::c_int as libc::c_uint {
                                ...
                                replength = replength.wrapping_add(readBits(
                                    reader,
                                    2 as libc::c_int as size_t
                                ));
                                if i < HLIT.wrapping_add(
                                    1 as libc::c_int as libc::c_uint
                                ) {
                                    value = *bitlen_ll.offset(i.wrapping_sub(
                                        1 as libc::c_int as libc::c_uint
                                    )
                                        as isize);
                                } else {
                                    value = *bitlen_d.offset(
                                        i.wrapping_sub(HLIT).wrapping_sub(
                                            1 as libc::c_int as libc::c_uint
                                        )
                                            as isize
                                    );
                                ...
                                while n < replength {
                                    if i >= HLIT.wrapping_add(HDIST) {
                                        ...
                                        if i < HLIT {
                                            *bitlen_ll.offset(i as isize) =
                                                value;
                                        } else {
                                            *bitlen_d
                                                .offset(i.wrapping_sub(HLIT)
                                                    as isize) = value;
                                        }
                                        i = i.wrapping_add(1);
                                        i;
                            ...
                            let mut replength_0: libc::c_uint =
                                3 as libc::c_int as libc::c_uint;
                            replength_0 = replength_0.wrapping_add(readBits(
                                reader,
                            ...
                            let mut replength_1: libc::c_uint =
                                11 as libc::c_int as libc::c_uint;
                            replength_1 = replength_1.wrapping_add(readBits(
                                reader,
...
unsafe extern "C" fn inflateHuffmanBlock(
    ...
    let reserved_size: size_t = 260 as libc::c_int as size_t;
    ...
    while error == 0 && done == 0 {
        ...
        if code_ll <= 255 as libc::c_int as libc::c_uint {
            let fresh24 = (*out).size;
            (*out).size = ((*out).size).wrapping_add(1);
            *((*out).data).offset(fresh24 as isize) = code_ll as libc::c_uchar;
            code_ll = huffmanDecodeSymbol(reader, &mut tree_ll);
        }
        if code_ll <= 255 as libc::c_int as libc::c_uint {
            let fresh25 = (*out).size;
            (*out).size = ((*out).size).wrapping_add(1);
            *((*out).data).offset(fresh25 as isize) = code_ll as libc::c_uchar;
            ...
            && code_ll <= 285 as libc::c_int as libc::c_uint
        {
            ...
            length = LENGTHBASE[code_ll
                .wrapping_sub(257 as libc::c_int as libc::c_uint)
                as usize] as size_t;
            ...
            if numextrabits_l != 0 as libc::c_int as libc::c_uint {
                ...
                length = (length as libc::c_ulong).wrapping_add(readBits(
                    reader,
            ...
            if code_d > 29 as libc::c_int as libc::c_uint {
                ...
                if numextrabits_d != 0 as libc::c_int as libc::c_uint {
                    distance = distance.wrapping_add(readBits(
                        reader,
                        numextrabits_d as size_t
                    ));
                }
                start = (*out).size;
                if distance as libc::c_ulong > start {
                    ...
                    (*out).size = ((*out).size as libc::c_ulong)
                        .wrapping_add(length)
                        as size_t as size_t;
                    if (distance as libc::c_ulong) < length {
                        let mut forward: size_t = 0;
                        lodepng_memcpy(
                            ((*out).data).offset(start as isize)
                                as *mut libc::c_void,
                        ...
                        start = (start as libc::c_ulong)
                            .wrapping_add(distance as libc::c_ulong)
                            as size_t as size_t;
                        forward = distance as size_t;
                        while forward < length {
                            let fresh26 = backward;
                            backward = backward.wrapping_add(1);
                            let fresh27 = start;
                            start = start.wrapping_add(1);
                            *((*out).data).offset(fresh27 as isize) =
                                *((*out).data).offset(fresh26 as isize);
        ...
        if ((*out).allocsize).wrapping_sub((*out).size) < reserved_size {
            if ucvector_reserve(out, ((*out).size).wrapping_add(reserved_size))
                == 0
            {
                error = 83 as libc::c_int as libc::c_uint;
                break;
...
unsafe extern "C" fn inflateNoCompression(
    ...
    LEN = (*((*reader).data).offset(bytepos as isize) as libc::c_uint)
        .wrapping_add(
            (*((*reader).data)
                .offset(bytepos.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 8 as libc::c_uint
        );
    bytepos = (bytepos as libc::c_ulong)
    ...
    if ucvector_resize(out, ((*out).size).wrapping_add(LEN as libc::c_ulong))
        == 0
    {
        return 83 as libc::c_int as libc::c_uint;
    }
    ...
    if LEN != 0 {
        ...
        bytepos = (bytepos as libc::c_ulong).wrapping_add(LEN as libc::c_ulong)
            as size_t as size_t;
    }
...
unsafe extern "C" fn lodepng_inflatev(
    ...
    let mut BFINAL: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    let mut error: libc::c_uint =
        LodePNGBitReader_init(&mut reader, in_0, insize);
    if error != 0 {
        return error;
    }
    while BFINAL == 0 {
        ...
        } else if BTYPE == 0 as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn lodepng_inflate(
    ...
    let mut error: libc::c_uint =
        lodepng_inflatev(&mut v, in_0, insize, settings);
    *out = v.data;
    *outsize = v.size;
    return error;
}
unsafe extern "C" fn inflatev(
    ...
    if ((*settings).custom_inflate).is_some() {
        let mut error: libc::c_uint = ((*settings).custom_inflate)
...
unsafe extern "C" fn searchCodeIndex(
    ...
    let mut left: size_t = 1 as libc::c_int as size_t;
    let mut right: size_t =
        array_size.wrapping_sub(1 as libc::c_int as libc::c_ulong);
    while left <= right {
        let mut mid: size_t = left.wrapping_add(right) >> 1 as libc::c_int;
    ...
    if left >= array_size
        || *array.offset(left as isize) as libc::c_ulong > value
    {
...
unsafe extern "C" fn addLengthDistance(
    ...
    let mut length_code: libc::c_uint = searchCodeIndex(
        LENGTHBASE.as_ptr(),
        29 as libc::c_int as size_t,
        length
    ) as libc::c_uint;
    let mut extra_length: libc::c_uint = length
        .wrapping_sub(LENGTHBASE[length_code as usize] as libc::c_ulong)
        as libc::c_uint;
    let mut dist_code: libc::c_uint = searchCodeIndex(
        DISTANCEBASE.as_ptr(),
        30 as libc::c_int as size_t,
        distance
    ) as libc::c_uint;
    let mut extra_distance: libc::c_uint = distance
        .wrapping_sub(DISTANCEBASE[dist_code as usize] as libc::c_ulong)
        as libc::c_uint;
    let mut pos: size_t = (*values).size;
    let mut ok: libc::c_uint = uivector_resize(
        values,
...
unsafe extern "C" fn getHash(
    ...
    if pos.wrapping_add(2 as libc::c_int as libc::c_ulong) < size {
        result ^=
            (*data
                .offset(pos.wrapping_add(0 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 0 as libc::c_uint;
        result ^=
            (*data
        ...
        result ^=
            (*data
                .offset(pos.wrapping_add(2 as libc::c_int as libc::c_ulong)
                    as isize) as libc::c_uint)
                << 8 as libc::c_uint;
    } else {
        ...
        i = 0 as libc::c_int as size_t;
        while i != amount {
            result ^= (*data.offset(pos.wrapping_add(i) as isize)
                as libc::c_uint)
...
unsafe extern "C" fn countZeros(
    ...
    let mut start: *const libc::c_uchar = data.offset(pos as isize);
    let mut end: *const libc::c_uchar =
        start.offset(MAX_SUPPORTED_DEFLATE_LENGTH as isize);
...
unsafe extern "C" fn encodeLZ77(
    ...
    let mut i: libc::c_uint = 0;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut maxchainlength: libc::c_uint =
        if windowsize >= 8192 as libc::c_int as libc::c_uint {
            windowsize
        } else {
            windowsize.wrapping_div(8 as libc::c_uint)
        };
    let mut maxlazymatch: libc::c_uint =
        (if windowsize >= 8192 as libc::c_int as libc::c_uint {
            MAX_SUPPORTED_DEFLATE_LENGTH
        } else {
            64 as libc::c_int as libc::c_ulong
        }) as libc::c_uint;
    let mut usezeros: libc::c_uint = 1 as libc::c_int as libc::c_uint;
    let mut numzeros: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut offset: libc::c_uint = 0;
    let mut length: libc::c_uint = 0;
    let mut lazy: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut lazylength: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut lazyoffset: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    let mut lastptr: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut foreptr: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut backptr: *const libc::c_uchar = 0 as *const libc::c_uchar;
    ...
    pos = inpos;
    while pos < insize {
        let mut wpos: size_t = pos
            & windowsize.wrapping_sub(1 as libc::c_int as libc::c_uint)
                as libc::c_ulong;
        let mut chainlength: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        ...
        if usezeros != 0 && hashval == 0 as libc::c_int as libc::c_uint {
            if numzeros == 0 as libc::c_int as libc::c_uint {
                ...
                || *in_0.offset(
                    pos.wrapping_add(numzeros as libc::c_ulong)
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        as isize
                ) as libc::c_int
                    != 0 as libc::c_int
        ...
        loop {
            let fresh28 = chainlength;
            chainlength = chainlength.wrapping_add(1);
            if fresh28 >= maxchainlength {
                break;
            }
            ...
            if current_offset > 0 as libc::c_int as libc::c_uint {
                ...
                backptr = &*in_0
                    .offset(pos.wrapping_sub(current_offset as libc::c_ulong)
                        as isize)
                    as *const libc::c_uchar;
                if numzeros >= 3 as libc::c_int as libc::c_uint {
                    let mut skip: libc::c_uint = *((*hash).zeros)
                        .offset(hashpos as isize)
                        as libc::c_uint;
                    if skip > numzeros {
                        skip = numzeros;
                    }
                ...
                current_length = foreptr.offset_from(
                    &*in_0.offset(pos as isize) as *const libc::c_uchar
                ) as libc::c_long
                    as libc::c_uint;
            ...
            if hashpos
                == *((*hash).chain).offset(hashpos as isize) as libc::c_uint
            {
                break;
            }
            ...
            {
                hashpos =
                    *((*hash).chainz).offset(hashpos as isize) as libc::c_uint;
                if *((*hash).zeros).offset(hashpos as isize) as libc::c_uint
                    != numzeros
                {
                    break;
                }
                ...
                hashpos =
                    *((*hash).chain).offset(hashpos as isize) as libc::c_uint;
                if *((*hash).val).offset(hashpos as isize)
                    != hashval as libc::c_int
                {
                    break;
                }
            }
        ...
        if lazymatching != 0 {
                ...
                && (length as libc::c_ulong) < MAX_SUPPORTED_DEFLATE_LENGTH
            {
                    ...
                    > lazylength.wrapping_add(1 as libc::c_int as libc::c_uint)
                {
                    ...
                    length = lazylength;
                    offset = lazyoffset;
                    *((*hash).head).offset(hashval as isize) =
                        -(1 as libc::c_int);
                    *((*hash).headz).offset(numzeros as isize) =
                        -(1 as libc::c_int);
...
unsafe extern "C" fn deflateNoCompression(
    ...
    let mut datapos: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn writeLZ77data(
    ...
    while i != (*lz77_encoded).size {
        let mut val: libc::c_uint = *((*lz77_encoded).data).offset(i as isize);
        writeBitsReversed(
            writer,
        ...
        if val > 256 as libc::c_int as libc::c_uint {
            let mut length_index: libc::c_uint =
                val.wrapping_sub(257 as libc::c_int as libc::c_uint);
            let mut n_length_extra_bits: libc::c_uint =
                LENGTHEXTRA[length_index as usize];
            i = i.wrapping_add(1);
            let mut length_extra_bits: libc::c_uint =
                *((*lz77_encoded).data).offset(i as isize);
            i = i.wrapping_add(1);
            let mut distance_code: libc::c_uint =
                *((*lz77_encoded).data).offset(i as isize);
            let mut distance_index: libc::c_uint = distance_code;
            let mut n_distance_extra_bits: libc::c_uint =
                DISTANCEEXTRA[distance_index as usize];
            i = i.wrapping_add(1);
            let mut distance_extra_bits: libc::c_uint =
                *((*lz77_encoded).data).offset(i as isize);
            ...
            writeBits(
                writer,
                distance_extra_bits,
                n_distance_extra_bits as size_t
            );
        }
        i = i.wrapping_add(1);
        i;
...
unsafe extern "C" fn deflateDynamic(
    ...
    let mut frequencies_ll: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut frequencies_d: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut frequencies_cl: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut bitlen_lld: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut bitlen_lld_e: *mut libc::c_uint = 0 as *mut libc::c_uint;
    let mut datasize: size_t = dataend.wrapping_sub(datapos);
    let mut BFINAL: libc::c_uint = final_0;
    let mut i: size_t = 0;
    ...
    HuffmanTree_init(&mut tree_cl);
    frequencies_ll =
        lodepng_malloc((286 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    frequencies_d =
        lodepng_malloc((30 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
        )) as *mut libc::c_uint;
    frequencies_cl =
        lodepng_malloc((19 as libc::c_int as libc::c_ulong).wrapping_mul(
    ...
    if frequencies_ll.is_null()
        || frequencies_d.is_null()
        || frequencies_cl.is_null()
    {
        error = 83 as libc::c_int as libc::c_uint;
    }
    ...
    if error == 0 {
        lodepng_memset(
            ...
            0 as libc::c_int,
            (286 as libc::c_int as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
            )
        );
        lodepng_memset(
            ...
            0 as libc::c_int,
            (30 as libc::c_int as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
            )
        );
        lodepng_memset(
            ...
            0 as libc::c_int,
            (19 as libc::c_int as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<libc::c_uint>() as libc::c_ulong
            )
        );
        ...
        match current_block_113 {
            ...
            _ => {
                i = 0 as libc::c_int as size_t;
                while i != lz77_encoded.size {
                    let mut symbol: libc::c_uint =
                        *(lz77_encoded.data).offset(i as isize);
                    let ref mut fresh29 =
                        *frequencies_ll.offset(symbol as isize);
                    *fresh29 = (*fresh29).wrapping_add(1);
                    *fresh29;
                    if symbol > 256 as libc::c_int as libc::c_uint {
                        let mut dist: libc::c_uint = *(lz77_encoded.data)
                            .offset(
                                i.wrapping_add(
                                    2 as libc::c_int as libc::c_ulong
                                ) as isize
                        ...
                        let ref mut fresh30 =
                            *frequencies_d.offset(dist as isize);
                ...
                *frequencies_ll.offset(256 as libc::c_int as isize) =
                    1 as libc::c_int as libc::c_uint;
                ...
                if !(error != 0) {
                    ...
                    if !(error != 0) {
                        ...
                        bitlen_lld = lodepng_malloc(numcodes_lld.wrapping_mul(
                            ::core::mem::size_of::<libc::c_uint>()
                                as libc::c_ulong
                        ))
                            as *mut libc::c_uint;
                        bitlen_lld_e =
                            lodepng_malloc(numcodes_lld.wrapping_mul(
                                ::core::mem::size_of::<libc::c_uint>()
                                    as libc::c_ulong
                            )) as *mut libc::c_uint;
                        if bitlen_lld.is_null() || bitlen_lld_e.is_null() {
                            ...
                            while i != numcodes_lld {
                                ...
                                while i
                                    ...
                                    < numcodes_lld
                                    && *bitlen_lld.offset(
                                        i.wrapping_add(j as libc::c_ulong)
                                            .wrapping_add(
                                                1 as libc::c_int
                                                    as libc::c_ulong
                                            )
                                    ...
                                    && j >= 2 as libc::c_int as libc::c_uint
                                {
                                    ...
                                    if j <= 10 as libc::c_int as libc::c_uint {
                                        let fresh31 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh31 as isize) =
                                            17 as libc::c_int as libc::c_uint;
                                        let fresh32 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh32 as isize) = j
                                            .wrapping_sub(
                                                3 as libc::c_int
                                                    as libc::c_uint
                                            );
                                    } else {
                                        if j > 138 as libc::c_int
                                            as libc::c_uint
                                        {
                                            j = 138 as libc::c_int
                                                as libc::c_uint;
                                        }
                                        let fresh33 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh33 as isize) =
                                            18 as libc::c_int as libc::c_uint;
                                        let fresh34 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh34 as isize) = j
                                            .wrapping_sub(
                                                11 as libc::c_int
                                                    as libc::c_uint
                                            );
                                ...
                                } else if j >= 3 as libc::c_int as libc::c_uint
                                {
                                    ...
                                    let mut num: libc::c_uint =
                                        j.wrapping_div(6 as libc::c_uint);
                                    let mut rest: libc::c_uint =
                                        j.wrapping_rem(6 as libc::c_uint);
                                    let fresh35 = numcodes_lld_e;
                                    numcodes_lld_e =
                                        numcodes_lld_e.wrapping_add(1);
                                    *bitlen_lld_e.offset(fresh35 as isize) =
                                        *bitlen_lld.offset(i as isize);
                                    k = 0 as libc::c_int as size_t;
                                    while k < num as libc::c_ulong {
                                        let fresh36 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh36 as isize) =
                                            16 as libc::c_int as libc::c_uint;
                                        let fresh37 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh37 as isize) = (6
                                            as libc::c_int
                                            - 3 as libc::c_int)
                                            as libc::c_uint;
                                        k = k.wrapping_add(1);
                                    ...
                                    {
                                        let fresh38 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh38 as isize) =
                                            16 as libc::c_int as libc::c_uint;
                                        let fresh39 = numcodes_lld_e;
                                        numcodes_lld_e =
                                            numcodes_lld_e.wrapping_add(1);
                                        *bitlen_lld_e
                                            .offset(fresh39 as isize) = rest
                                            .wrapping_sub(
                                                3 as libc::c_int
                                                    as libc::c_uint
                                            );
                                    ...
                                    let fresh40 = numcodes_lld_e;
                                    numcodes_lld_e =
                                        numcodes_lld_e.wrapping_add(1);
                                    *bitlen_lld_e.offset(fresh40 as isize) =
                                        *bitlen_lld.offset(i as isize);
                                }
                                i = i.wrapping_add(1);
                                i;
                            ...
                            while i != numcodes_lld_e {
                                let ref mut fresh41 = *frequencies_cl
                                    .offset(*bitlen_lld_e.offset(i as isize)
                                        as isize);
                            ...
                            if !(error != 0) {
                                ...
                                while numcodes_cl
                                    ...
                                    && *(tree_cl.lengths).offset(
                                        CLCL_ORDER[numcodes_cl.wrapping_sub(
                                ...
                                HLIT = numcodes_ll.wrapping_sub(
                                    257 as libc::c_int as libc::c_ulong
                                )
                                    as libc::c_uint;
                                HDIST = numcodes_d.wrapping_sub(
                                    1 as libc::c_int as libc::c_ulong
                                )
                                    as libc::c_uint;
                                HCLEN = numcodes_cl.wrapping_sub(
...
unsafe extern "C" fn deflateFixed(
    ...
    if error == 0 {
        ...
        if (*settings).use_lz77 != 0 {
            ...
            uivector_cleanup(
                &mut lz77_encoded as *mut uivector as *mut libc::c_void
            );
        } else {
            i = datapos;
            while i < dataend {
...
unsafe extern "C" fn lodepng_deflatev(
    ...
    } else if (*settings).btype == 0 as libc::c_int as libc::c_uint {
        return deflateNoCompression(out, in_0, insize);
    } else if (*settings).btype == 1 as libc::c_int as libc::c_uint {
        blocksize = insize;
    } else {
        blocksize = insize
...
pub unsafe extern "C" fn lodepng_deflate(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint =
        lodepng_deflatev(&mut v, in_0, insize, settings);
    *out = v.data;
    *outsize = v.size;
    return error;
}
unsafe extern "C" fn deflate(
    ...
    if ((*settings).custom_deflate).is_some() {
        let mut error: libc::c_uint = ((*settings).custom_deflate)
            .expect("non-null function pointer")(
...
unsafe extern "C" fn update_adler32(
    ...
    let mut s1: libc::c_uint = adler & 0xffff as libc::c_uint;
    let mut s2: libc::c_uint =
        adler >> 16 as libc::c_uint & 0xffff as libc::c_uint;
    while len != 0 as libc::c_uint {
        let mut i: libc::c_uint = 0;
        let mut amount: libc::c_uint = if len > 5552 as libc::c_uint {
            5552 as libc::c_uint
        } else {
            len
        };
        ...
        while i != amount {
            let fresh42 = data;
            data = data.offset(1);
            s1 = s1.wrapping_add(*fresh42 as libc::c_uint);
...
unsafe extern "C" fn lodepng_zlib_decompressv(
    ...
    CM = (*in_0.offset(0 as libc::c_int as isize) as libc::c_int
        & 15 as libc::c_int) as libc::c_uint;
    CINFO = (*in_0.offset(0 as libc::c_int as isize) as libc::c_int
        >> 4 as libc::c_int
        & 15 as libc::c_int) as libc::c_uint;
    FDICT = (*in_0.offset(1 as libc::c_int as isize) as libc::c_int
        >> 5 as libc::c_int
        & 1 as libc::c_int) as libc::c_uint;
    if CM != 8 as libc::c_int as libc::c_uint
        || CINFO > 7 as libc::c_int as libc::c_uint
    {
    ...
    if (*settings).ignore_adler32 == 0 {
        let mut ADLER32: libc::c_uint = lodepng_read32bitInt(&*in_0.offset(
            insize.wrapping_sub(4 as libc::c_int as libc::c_ulong) as isize
        ));
        let mut checksum: libc::c_uint =
            adler32((*out).data, (*out).size as libc::c_uint);
        if checksum != ADLER32 {
...
pub unsafe extern "C" fn lodepng_zlib_decompress(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint =
        lodepng_zlib_decompressv(&mut v, in_0, insize, settings);
    *out = v.data;
    *outsize = v.size;
    return error;
}
...
pub unsafe extern "C" fn lodepng_zlib_compress(
    ...
    let mut i: size_t = 0;
    let mut error: libc::c_uint = 0;
    let mut deflatedata: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut deflatesize: size_t = 0 as libc::c_int as size_t;
    ...
    *outsize = 0 as libc::c_int as size_t;
    ...
    if error == 0 {
        let mut ADLER32: libc::c_uint = adler32(in_0, insize as libc::c_uint);
        let mut CMF: libc::c_uint = 120 as libc::c_int as libc::c_uint;
        let mut FLEVEL: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        ...
        let mut CMFFLG: libc::c_uint = (256 as libc::c_int as libc::c_uint)
            ...
            .wrapping_add(
                FLEVEL.wrapping_mul(64 as libc::c_int as libc::c_uint)
            );
        let mut FCHECK: libc::c_uint = (31 as libc::c_int as libc::c_uint)
            .wrapping_sub(
                CMFFLG.wrapping_rem(31 as libc::c_int as libc::c_uint)
            );
        ...
        *(*out).offset(1 as libc::c_int as isize) =
        ...
        lodepng_set32bitInt(
            &mut *(*out).offset(
                (*outsize).wrapping_sub(4 as libc::c_int as libc::c_ulong)
                    as isize
            ),
            ADLER32
        );
...
unsafe extern "C" fn zlib_compress(
    ...
    if ((*settings).custom_zlib).is_some() {
        let mut error: libc::c_uint = ((*settings).custom_zlib)
            .expect("non-null function pointer")(
            out, outsize, in_0, insize, settings
        );
        return (if error != 0 {
...
pub unsafe extern "C" fn lodepng_compress_settings_init(
    ...
    (*settings).custom_context = 0 as *const libc::c_void;
}
#[no_mangle]
...
pub unsafe extern "C" fn lodepng_crc32(
    ...
    let mut r: libc::c_uint = 0xffffffff as libc::c_uint;
    let mut i: size_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < length {
        r = lodepng_crc32_table[((r ^ *data.offset(i as isize) as libc::c_uint)
            & 0xff as libc::c_uint) as usize]
            ^ r >> 8 as libc::c_uint;
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn readBitFromReversedStream(
    ...
    let mut result: libc::c_uchar = (*bitstream
        .offset((*bitpointer >> 3 as libc::c_int) as isize)
        as libc::c_int
...
unsafe extern "C" fn readBitsFromReversedStream(
    ...
    while i < nbits {
        ...
        result |=
            readBitFromReversedStream(bitpointer, bitstream) as libc::c_uint;
        i = i.wrapping_add(1);
        i;
    }
    return result;
...
unsafe extern "C" fn setBitOfReversedStream(
    ...
    if bit as libc::c_int == 0 as libc::c_int {
        let ref mut fresh43 =
            *bitstream.offset((*bitpointer >> 3 as libc::c_uint) as isize);
        *fresh43 = (*fresh43 as libc::c_int
            & !((1 as libc::c_uint)
                << (7 as libc::c_uint as libc::c_ulong).wrapping_sub(
                    *bitpointer & 7 as libc::c_uint as libc::c_ulong
                )) as libc::c_uchar as libc::c_int)
            as libc::c_uchar;
    } else {
        let ref mut fresh44 =
            *bitstream.offset((*bitpointer >> 3 as libc::c_uint) as isize);
        *fresh44 = (*fresh44 as libc::c_uint
            | (1 as libc::c_uint)
                << (7 as libc::c_uint as libc::c_ulong).wrapping_sub(
                    *bitpointer & 7 as libc::c_uint as libc::c_ulong
                )) as libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_chunk_type(
    ...
    *type_0.offset(4 as libc::c_int as isize) =
...
pub unsafe extern "C" fn lodepng_chunk_type_equals(
    ...
    return (*chunk.offset(4 as libc::c_int as isize) as libc::c_int
        ...
        && *chunk.offset(7 as libc::c_int as isize) as libc::c_int
            == *type_0.offset(3 as libc::c_int as isize) as libc::c_int)
...
pub unsafe extern "C" fn lodepng_chunk_private(
    ...
    return (*chunk.offset(6 as libc::c_int as isize) as libc::c_int
        & 32 as libc::c_int
        != 0 as libc::c_int) as libc::c_int as libc::c_uchar;
}
#[no_mangle]
pub unsafe extern "C" fn lodepng_chunk_safetocopy(
    ...
    return (*chunk.offset(7 as libc::c_int as isize) as libc::c_int
        & 32 as libc::c_int
        != 0 as libc::c_int) as libc::c_int as libc::c_uchar;
}
#[no_mangle]
...
pub unsafe extern "C" fn lodepng_chunk_check_crc(
    ...
    let mut length: libc::c_uint = lodepng_chunk_length(chunk);
    let mut CRC: libc::c_uint =
        lodepng_read32bitInt(&*chunk.offset(
            length.wrapping_add(8 as libc::c_int as libc::c_uint) as isize
        ));
    let mut checksum: libc::c_uint = lodepng_crc32(
...
#[no_mangle]
pub unsafe extern "C" fn lodepng_chunk_generate_crc(
    mut chunk: *mut libc::c_uchar
) {
    let mut length: libc::c_uint = lodepng_chunk_length(chunk);
    let mut CRC: libc::c_uint = lodepng_crc32(
...
pub unsafe extern "C" fn lodepng_chunk_next(
    ...
    let mut available_size: size_t =
        end.offset_from(chunk) as libc::c_long as size_t;
    if chunk >= end || available_size < 12 as libc::c_int as libc::c_ulong {
        return end;
    }
    if *chunk.offset(0 as libc::c_int as isize) as libc::c_int
        == 0x89 as libc::c_int
        && *chunk.offset(1 as libc::c_int as isize) as libc::c_int
            == 0x50 as libc::c_int
        && *chunk.offset(2 as libc::c_int as isize) as libc::c_int
            == 0x4e as libc::c_int
        && *chunk.offset(3 as libc::c_int as isize) as libc::c_int
            == 0x47 as libc::c_int
        && *chunk.offset(4 as libc::c_int as isize) as libc::c_int
            == 0xd as libc::c_int
        && *chunk.offset(5 as libc::c_int as isize) as libc::c_int
            == 0xa as libc::c_int
        && *chunk.offset(6 as libc::c_int as isize) as libc::c_int
...
pub unsafe extern "C" fn lodepng_chunk_append(
    ...
    let mut chunk_start: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut new_buffer: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    if lodepng_addofl(
        lodepng_chunk_length(chunk) as size_t,
        12 as libc::c_int as size_t,
        &mut total_chunk_length
...
unsafe extern "C" fn lodepng_chunk_init(
    ...
    if lodepng_addofl(new_length, 12 as libc::c_int as size_t, &mut new_length)
        != 0
    {
        return 77 as libc::c_int as libc::c_uint;
    }
...
unsafe extern "C" fn lodepng_chunk_createv(
    ...
    let mut chunk: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut error: libc::c_uint =
        lodepng_chunk_init(&mut chunk, out, length, type_0);
    if error != 0 {
        return error;
    }
    lodepng_memcpy(
...
pub unsafe extern "C" fn lodepng_chunk_create(
    ...
    let mut v: ucvector = ucvector_init(*out, *outsize);
    let mut error: libc::c_uint =
        lodepng_chunk_createv(&mut v, length, type_0, data);
    *out = v.data;
    *outsize = v.size;
    return error;
}
...
#[no_mangle]
pub unsafe extern "C" fn lodepng_color_mode_init(
    mut info: *mut LodePNGColorMode
) {
    (*info).key_defined = 0 as libc::c_int as libc::c_uint;
    (*info).key_b = 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn lodepng_color_mode_alloc_palette(
    mut info: *mut LodePNGColorMode
) {
    let mut i: size_t = 0;
    if ((*info).palette).is_null() {
        (*info).palette =
            lodepng_malloc(1024 as libc::c_int as size_t) as *mut libc::c_uchar;
    }
    if ((*info).palette).is_null() {
        return;
    }
    ...
    while i != 256 as libc::c_int as libc::c_ulong {
        *((*info).palette).offset(
            i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
...
#[no_mangle]
pub unsafe extern "C" fn lodepng_color_mode_cleanup(
    mut info: *mut LodePNGColorMode
) {
...
pub unsafe extern "C" fn lodepng_color_mode_copy(
    ...
    lodepng_memcpy(
        ...
        ::core::mem::size_of::<LodePNGColorMode>() as libc::c_ulong
    );
...
unsafe extern "C" fn lodepng_color_mode_equal(
    ...
    i = 0 as libc::c_int as size_t;
    while i
        != ((*a).palettesize).wrapping_mul(4 as libc::c_int as libc::c_ulong)
    {
...
#[no_mangle]
pub unsafe extern "C" fn lodepng_palette_clear(
    mut info: *mut LodePNGColorMode
) {
    if !((*info).palette).is_null() {
...
pub unsafe extern "C" fn lodepng_is_palette_type(
    ...
    return ((*info).colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint) as libc::c_int
        as libc::c_uint;
}
#[no_mangle]
...
pub unsafe extern "C" fn lodepng_can_have_alpha(
    ...
    return ((*info).key_defined != 0
        ...
        || lodepng_has_palette_alpha(info) != 0) as libc::c_int
        as libc::c_uint;
}
...
pub unsafe extern "C" fn lodepng_get_raw_size(
    ...
    return lodepng_get_raw_size_lct(
        w,
        h,
        (*color).colortype,
        (*color).bitdepth
...
unsafe extern "C" fn lodepng_get_raw_size_idat(
    ...
    let mut line: size_t = (w.wrapping_div(8 as libc::c_uint) as size_t)
...
unsafe extern "C" fn lodepng_pixel_overflow(
    ...
    let mut bpp: size_t =
        (if lodepng_get_bpp(pngcolor) > lodepng_get_bpp(rawcolor) {
    ...
    if lodepng_mulofl(
        w.wrapping_div(8 as libc::c_uint) as size_t,
        bpp,
        &mut line
    ) != 0
    {
...
unsafe extern "C" fn LodePNGUnknownChunks_init(mut info: *mut LodePNGInfo) {
    ...
    while i != 3 as libc::c_int as libc::c_uint {
        (*info).unknown_chunks_data[i as usize] = 0 as *mut libc::c_uchar;
        i = i.wrapping_add(1);
        i;
    }
    i = 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn LodePNGUnknownChunks_cleanup(mut info: *mut LodePNGInfo) {
    ...
    while i != 3 as libc::c_int as libc::c_uint {
        lodepng_free(
            (*info).unknown_chunks_data[i as usize] as *mut libc::c_void
        );
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn LodePNGUnknownChunks_copy(
    ...
    while i != 3 as libc::c_int as libc::c_uint {
        let mut j: size_t = 0;
        (*dest).unknown_chunks_size[i as usize] =
            (*src).unknown_chunks_size[i as usize];
        (*dest).unknown_chunks_data[i as usize] =
            lodepng_malloc((*src).unknown_chunks_size[i as usize])
                as *mut libc::c_uchar;
...
unsafe extern "C" fn LodePNGText_init(mut info: *mut LodePNGInfo) {
    ...
    (*info).text_keys = 0 as *mut *mut libc::c_char;
    (*info).text_strings = 0 as *mut *mut libc::c_char;
}
...
unsafe extern "C" fn LodePNGText_copy(
    ...
    while i != (*source).text_num {
        let mut error: libc::c_uint = lodepng_add_text(
            dest,
...
unsafe extern "C" fn lodepng_add_text_sized(
    ...
    let mut new_keys: *mut *mut libc::c_char = lodepng_realloc(
    ...
    let mut new_strings: *mut *mut libc::c_char = lodepng_realloc(
    ...
    (*info).text_num;
    let ref mut fresh45 = *((*info).text_keys).offset(
        ((*info).text_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh45 = alloc_string(key);
    let ref mut fresh46 = *((*info).text_strings).offset(
        ((*info).text_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh46 = alloc_string_sized(str, size);
    if (*((*info).text_keys).offset(
        ((*info).text_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    ))
    .is_null()
        || (*((*info).text_strings).offset(
            ((*info).text_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
                as isize
        ))
        .is_null()
...
unsafe extern "C" fn LodePNGIText_init(mut info: *mut LodePNGInfo) {
    ...
    (*info).itext_keys = 0 as *mut *mut libc::c_char;
    (*info).itext_langtags = 0 as *mut *mut libc::c_char;
    (*info).itext_transkeys = 0 as *mut *mut libc::c_char;
    (*info).itext_strings = 0 as *mut *mut libc::c_char;
}
...
unsafe extern "C" fn LodePNGIText_copy(
    ...
    while i != (*source).itext_num {
        let mut error: libc::c_uint = lodepng_add_itext(
            dest,
...
unsafe extern "C" fn lodepng_add_itext_sized(
    ...
    let mut new_langtags: *mut *mut libc::c_char = lodepng_realloc(
        ...
        as *mut *mut libc::c_char;
    let mut new_transkeys: *mut *mut libc::c_char = lodepng_realloc(
    ...
    (*info).itext_num;
    let ref mut fresh47 = *((*info).itext_keys).offset(
        ((*info).itext_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh47 = alloc_string(key);
    let ref mut fresh48 = *((*info).itext_langtags).offset(
        ((*info).itext_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh48 = alloc_string(langtag);
    let ref mut fresh49 = *((*info).itext_transkeys).offset(
        ((*info).itext_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh49 = alloc_string(transkey);
    let ref mut fresh50 = *((*info).itext_strings).offset(
        ((*info).itext_num).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    );
    *fresh50 = alloc_string_sized(str, size);
    return 0 as libc::c_int as libc::c_uint;
}
#[no_mangle]
...
unsafe extern "C" fn lodepng_assign_icc(
    ...
    (*info).iccp_profile =
        lodepng_malloc(profile_size as size_t) as *mut libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_info_init(mut info: *mut LodePNGInfo) {
    ...
    (*info).background_b = 0 as libc::c_int as libc::c_uint;
    ...
    (*info).iccp_defined = 0 as libc::c_int as libc::c_uint;
    (*info).iccp_name = 0 as *mut libc::c_char;
    (*info).iccp_profile = 0 as *mut libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_info_copy(
    ...
    lodepng_memcpy(
        dest as *mut libc::c_void,
        source as *const libc::c_void,
        ::core::mem::size_of::<LodePNGInfo>() as libc::c_ulong
    );
    lodepng_color_mode_init(&mut (*dest).color);
    let mut error: libc::c_uint =
        lodepng_color_mode_copy(&mut (*dest).color, &(*source).color);
    if error != 0 {
        return error;
    }
    let mut error_0: libc::c_uint = LodePNGText_copy(dest, source);
    if error_0 != 0 {
        return error_0;
    }
    let mut error_1: libc::c_uint = LodePNGIText_copy(dest, source);
    if error_1 != 0 {
        return error_1;
    }
    if (*source).iccp_defined != 0 {
        let mut error_2: libc::c_uint = lodepng_assign_icc(
            dest,
            (*source).iccp_name,
            (*source).iccp_profile,
    ...
    let mut error_3: libc::c_uint = LodePNGUnknownChunks_copy(dest, source);
    if error_3 != 0 {
        return error_3;
    }
    return 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn addColorBits(
    ...
    let mut m: libc::c_uint = (if bits == 1 as libc::c_int as libc::c_uint {
        7 as libc::c_int
    ...
    let mut p: libc::c_uint = (index & m as libc::c_ulong) as libc::c_uint;
    ...
    if p == 0 as libc::c_int as libc::c_uint {
        *out.offset(
        ...
        let ref mut fresh51 = *out.offset(
            index
                .wrapping_mul(bits as libc::c_ulong)
                .wrapping_div(8 as libc::c_uint as libc::c_ulong)
                as isize
        );
        *fresh51 = (*fresh51 as libc::c_uint | in_0) as libc::c_uchar;
    };
}
unsafe extern "C" fn color_tree_init(mut tree: *mut ColorTree) {
    lodepng_memset(
        ...
        (16 as libc::c_int as libc::c_ulong).wrapping_mul(
            ::core::mem::size_of::<*mut ColorTree>() as libc::c_ulong
        )
    );
...
unsafe extern "C" fn color_tree_get(
    ...
    while bit < 8 as libc::c_int {
        let mut i: libc::c_int = 8 as libc::c_int
            * (r as libc::c_int >> bit & 1 as libc::c_int)
...
unsafe extern "C" fn color_tree_has(
    ...
    return (color_tree_get(tree, r, g, b, a) >= 0 as libc::c_int)
        as libc::c_int;
}
    ...
    while bit < 8 as libc::c_int {
        ...
        if ((*tree).children[i as usize]).is_null() {
            (*tree).children[i as usize] = lodepng_malloc(
                ::core::mem::size_of::<ColorTree>() as libc::c_ulong
            ) as *mut ColorTree;
            if ((*tree).children[i as usize]).is_null() {
                return 83 as libc::c_int as libc::c_uint;
            }
...
unsafe extern "C" fn rgba8ToPixel(
    ...
    if (*mode).colortype as libc::c_uint
        == LCT_GREY as libc::c_int as libc::c_uint
    {
        let mut gray: libc::c_uchar = r;
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            *out.offset(i as isize) = gray;
            ...
            let ref mut fresh52 = *out.offset(
        ...
        == LCT_RGB as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            *out.offset(
                i.wrapping_mul(3 as libc::c_int as libc::c_ulong)
                    .wrapping_add(0 as libc::c_int as libc::c_ulong)
                    as isize
            ) = r;
            *out.offset(
            ...
            *out.offset(
            ...
            let ref mut fresh53 = *out.offset(
                i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
            *fresh53 = r;
            *out.offset(
            ...
            let ref mut fresh54 = *out.offset(
                i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                    .wrapping_add(3 as libc::c_int as libc::c_ulong)
                    as isize
            );
            ...
            *out.offset(
            ...
            let ref mut fresh55 = *out.offset(
                i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                    .wrapping_add(5 as libc::c_int as libc::c_ulong)
                    as isize
            );
    ...
    {
        let mut index: libc::c_int = color_tree_get(tree, r, g, b, a);
        ...
        == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        ...
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *out.offset(
            ...
            let ref mut fresh56 = *out.offset(
                i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
            ...
            *out.offset(
            ...
            let ref mut fresh57 = *out.offset(
                i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                    .wrapping_add(3 as libc::c_int as libc::c_ulong)
                    as isize
            );
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *out.offset(
            ...
            let ref mut fresh58 = *out.offset(
                i.wrapping_mul(8 as libc::c_int as libc::c_ulong)
                    .wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
            *fresh58 = r;
            *out.offset(
            ...
            let ref mut fresh59 = *out.offset(
                i.wrapping_mul(8 as libc::c_int as libc::c_ulong)
                    .wrapping_add(3 as libc::c_int as libc::c_ulong)
                    as isize
            );
            ...
            *out.offset(
            ...
            let ref mut fresh60 = *out.offset(
                i.wrapping_mul(8 as libc::c_int as libc::c_ulong)
                    .wrapping_add(5 as libc::c_int as libc::c_ulong)
                    as isize
            );
            ...
            *out.offset(
            ...
            let ref mut fresh61 = *out.offset(
                i.wrapping_mul(8 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn rgba16ToPixel(
        ...
        == LCT_RGB as libc::c_int as libc::c_uint
    {
        ...
        *out.offset(
        ...
        == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        let mut gray_0: libc::c_ushort = r;
        *out.offset(
            i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                .wrapping_add(0 as libc::c_int as libc::c_ulong)
                as isize
        ...
        == LCT_GREY as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            *r = *g;
            ...
            let mut highest: libc::c_uint = ((1 as libc::c_uint)
                << (*mode).bitdepth)
                .wrapping_sub(1 as libc::c_uint);
            let mut j: size_t =
                i.wrapping_mul((*mode).bitdepth as libc::c_ulong);
            let mut value: libc::c_uint = readBitsFromReversedStream(
                &mut j,
                in_0,
...
unsafe extern "C" fn getPixelColorsRGBA8(
    ...
    let mut num_channels: libc::c_uint = 4 as libc::c_int as libc::c_uint;
    let mut i: size_t = 0;
    if (*mode).colortype as libc::c_uint
        == LCT_GREY as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh62 = *buffer.offset(2 as libc::c_int as isize);
                *fresh62 = *in_0.offset(i as isize);
                let ref mut fresh63 = *buffer.offset(1 as libc::c_int as isize);
                *fresh63 = *fresh62;
                *buffer.offset(0 as libc::c_int as isize) = *fresh63;
                *buffer.offset(3 as libc::c_int as isize) =
                    255 as libc::c_int as libc::c_uchar;
                i = i.wrapping_add(1);
                i;
            ...
            if (*mode).key_defined != 0 {
                buffer = buffer.offset(
                    -(numpixels.wrapping_mul(num_channels as libc::c_ulong)
                        as isize)
                );
                i = 0 as libc::c_int as size_t;
                while i != numpixels {
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh64 = *buffer.offset(2 as libc::c_int as isize);
                *fresh64 = *in_0
                    .offset(i.wrapping_mul(2 as libc::c_int as libc::c_ulong)
                        as isize);
                let ref mut fresh65 = *buffer.offset(1 as libc::c_int as isize);
                *fresh65 = *fresh64;
                *buffer.offset(0 as libc::c_int as isize) = *fresh65;
                *buffer.offset(3 as libc::c_int as isize) = (if (*mode)
                    .key_defined
                    != 0
                    && (256 as libc::c_uint)
                        .wrapping_mul(
            ...
            while i != numpixels {
                ...
                let ref mut fresh66 = *buffer.offset(2 as libc::c_int as isize);
                *fresh66 = value
                    .wrapping_mul(255 as libc::c_int as libc::c_uint)
                    .wrapping_div(highest)
                    as libc::c_uchar;
                let ref mut fresh67 = *buffer.offset(1 as libc::c_int as isize);
                *fresh67 = *fresh66;
                *buffer.offset(0 as libc::c_int as isize) = *fresh67;
                *buffer.offset(3 as libc::c_int as isize) =
                    (if (*mode).key_defined != 0 && value == (*mode).key_r {
                        0 as libc::c_int
                    } else {
        ...
        == LCT_RGB as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                *buffer.offset(0 as libc::c_int as isize) = *in_0.offset(
                    i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                        .wrapping_add(0 as libc::c_int as libc::c_ulong)
                        as isize
                );
                *buffer.offset(1 as libc::c_int as isize) = *in_0.offset(
                    i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                        .wrapping_add(2 as libc::c_int as libc::c_ulong)
                        as isize
                );
                *buffer.offset(2 as libc::c_int as isize) = *in_0.offset(
                    i.wrapping_mul(6 as libc::c_int as libc::c_ulong)
                        .wrapping_add(4 as libc::c_int as libc::c_ulong)
                        as isize
                );
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            ...
            while i != numpixels {
                ...
                lodepng_memcpy(
                    buffer as *mut libc::c_void,
                    &mut *((*mode).palette).offset(
                        index.wrapping_mul(4 as libc::c_int as libc::c_uint)
                            as isize
                    ) as *mut libc::c_uchar
                        as *const libc::c_void,
                    4 as libc::c_int as size_t
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let mut index_0: libc::c_uint = readBitsFromReversedStream(
                    &mut j_0,
                    in_0,
                    (*mode).bitdepth as size_t
                );
        ...
        == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh68 = *buffer.offset(2 as libc::c_int as isize);
                *fresh68 = *in_0.offset(
                    i.wrapping_mul(2 as libc::c_int as libc::c_ulong)
                        .wrapping_add(0 as libc::c_int as libc::c_ulong)
                        as isize
                );
                let ref mut fresh69 = *buffer.offset(1 as libc::c_int as isize);
                *fresh69 = *fresh68;
                *buffer.offset(0 as libc::c_int as isize) = *fresh69;
                *buffer.offset(3 as libc::c_int as isize) = *in_0.offset(
                    i.wrapping_mul(2 as libc::c_int as libc::c_ulong)
                        .wrapping_add(1 as libc::c_int as libc::c_ulong)
                        as isize
                );
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh70 = *buffer.offset(2 as libc::c_int as isize);
                *fresh70 = *in_0.offset(
                    i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                        .wrapping_add(0 as libc::c_int as libc::c_ulong)
                        as isize
                );
                let ref mut fresh71 = *buffer.offset(1 as libc::c_int as isize);
                *fresh71 = *fresh70;
                *buffer.offset(0 as libc::c_int as isize) = *fresh71;
                *buffer.offset(3 as libc::c_int as isize) = *in_0.offset(
                    i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                        .wrapping_add(2 as libc::c_int as libc::c_ulong)
                        as isize
...
unsafe extern "C" fn getPixelColorsRGB8(
    ...
    let num_channels: libc::c_uint = 3 as libc::c_int as libc::c_uint;
    let mut i: size_t = 0;
    if (*mode).colortype as libc::c_uint
        == LCT_GREY as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh72 = *buffer.offset(2 as libc::c_int as isize);
                *fresh72 = *in_0.offset(i as isize);
                let ref mut fresh73 = *buffer.offset(1 as libc::c_int as isize);
                *fresh73 = *fresh72;
                *buffer.offset(0 as libc::c_int as isize) = *fresh73;
                i = i.wrapping_add(1);
                i;
                buffer = buffer.offset(num_channels as isize);
            }
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh74 = *buffer.offset(2 as libc::c_int as isize);
                *fresh74 = *in_0
                    .offset(i.wrapping_mul(2 as libc::c_int as libc::c_ulong)
                        as isize);
                let ref mut fresh75 = *buffer.offset(1 as libc::c_int as isize);
                *fresh75 = *fresh74;
                *buffer.offset(0 as libc::c_int as isize) = *fresh75;
                i = i.wrapping_add(1);
                i;
                buffer = buffer.offset(num_channels as isize);
            }
            ...
            while i != numpixels {
                ...
                let ref mut fresh76 = *buffer.offset(2 as libc::c_int as isize);
                *fresh76 = value
                    .wrapping_mul(255 as libc::c_int as libc::c_uint)
                    .wrapping_div(highest)
                    as libc::c_uchar;
                let ref mut fresh77 = *buffer.offset(1 as libc::c_int as isize);
                *fresh77 = *fresh76;
                *buffer.offset(0 as libc::c_int as isize) = *fresh77;
                i = i.wrapping_add(1);
                i;
                buffer = buffer.offset(num_channels as isize);
            }
        ...
        == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        if (*mode).bitdepth == 8 as libc::c_int as libc::c_uint {
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh78 = *buffer.offset(2 as libc::c_int as isize);
                *fresh78 = *in_0.offset(
                    i.wrapping_mul(2 as libc::c_int as libc::c_ulong)
                        .wrapping_add(0 as libc::c_int as libc::c_ulong)
                        as isize
                );
                let ref mut fresh79 = *buffer.offset(1 as libc::c_int as isize);
                *fresh79 = *fresh78;
                *buffer.offset(0 as libc::c_int as isize) = *fresh79;
                i = i.wrapping_add(1);
                i;
                buffer = buffer.offset(num_channels as isize);
            }
            ...
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                let ref mut fresh80 = *buffer.offset(2 as libc::c_int as isize);
                *fresh80 = *in_0.offset(
                    i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                        .wrapping_add(0 as libc::c_int as libc::c_ulong)
                        as isize
                );
                let ref mut fresh81 = *buffer.offset(1 as libc::c_int as isize);
                *fresh81 = *fresh80;
                *buffer.offset(0 as libc::c_int as isize) = *fresh81;
                i = i.wrapping_add(1);
                i;
                buffer = buffer.offset(num_channels as isize);
            }
...
pub unsafe extern "C" fn lodepng_convert(
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        let mut palsize: size_t =
            (1 as libc::c_uint as size_t) << (*mode_out).bitdepth;
        if palettesize == 0 as libc::c_int as libc::c_ulong {
            ...
            {
                let mut numbytes_0: size_t =
                    lodepng_get_raw_size(w, h, mode_in);
                lodepng_memcpy(
                    out as *mut libc::c_void,
                    in_0 as *const libc::c_void,
                    numbytes_0
        ...
        while i != palsize {
            let mut p: *const libc::c_uchar =
                &*palette
                    .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                        as isize) as *const libc::c_uchar;
    ...
    if error == 0 {
            ...
            && (*mode_out).bitdepth == 16 as libc::c_int as libc::c_uint
        {
            ...
            while i != numpixels {
                ...
                let mut g: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                let mut b: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                let mut a: libc::c_ushort = 0 as libc::c_int as libc::c_ushort;
                getPixelColorRGBA16(
                    &mut r, &mut g, &mut b, &mut a, in_0, i, mode_in
                );
                ...
                == LCT_RGB as libc::c_int as libc::c_uint
        {
            ...
            let mut r_0: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
            let mut g_0: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
            let mut b_0: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
            let mut a_0: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
            i = 0 as libc::c_int as size_t;
            while i != numpixels {
                getPixelColorRGBA8(
                ...
                error = rgba8ToPixel(
                    out, i, mode_out, &mut tree, r_0, g_0, b_0, a_0
                );
                if error != 0 {
                    break;
                }
...
pub unsafe extern "C" fn lodepng_convert_rgb(
    ...
    let mut g: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut b: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut mul: libc::c_uint = (65535 as libc::c_int as libc::c_uint)
        .wrapping_div(
            ((1 as libc::c_uint) << (*mode_in).bitdepth)
                .wrapping_sub(1 as libc::c_uint)
        );
    let mut shift: libc::c_uint =
        (16 as libc::c_int as libc::c_uint).wrapping_sub((*mode_out).bitdepth);
    if (*mode_in).colortype as libc::c_uint
        == LCT_GREY as libc::c_int as libc::c_uint
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        r = (*((*mode_in).palette).offset(
            r_in.wrapping_mul(4 as libc::c_int as libc::c_uint)
                .wrapping_add(0 as libc::c_int as libc::c_uint)
                as isize
        ) as libc::c_uint)
        ...
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        while (i as libc::c_ulong) < (*mode_out).palettesize {
            let mut j: libc::c_uint =
                i.wrapping_mul(4 as libc::c_int as libc::c_uint);
            if r >> 8 as libc::c_int
                == *((*mode_out).palette)
                    .offset(j.wrapping_add(0 as libc::c_int as libc::c_uint)
                        as isize) as libc::c_uint
                && g >> 8 as libc::c_int
                    == *((*mode_out).palette).offset(
...
unsafe extern "C" fn getValueRequiredBits(
...
pub unsafe extern "C" fn lodepng_compute_color_stats(
    ...
    let mut numpixels: size_t = (w as size_t).wrapping_mul(h as size_t);
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut colored_done: libc::c_uint =
        (if lodepng_is_greyscale_type(mode_in) != 0 {
            1 as libc::c_int
        } else {
            0 as libc::c_int
        }) as libc::c_uint;
    let mut alpha_done: libc::c_uint = (if lodepng_can_have_alpha(mode_in) != 0
    {
        0 as libc::c_int
    } else {
        1 as libc::c_int
    }) as libc::c_uint;
    let mut numcolors_done: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut bpp: libc::c_uint = lodepng_get_bpp(mode_in);
    let mut bits_done: libc::c_uint = (if (*stats).bits
        == 1 as libc::c_int as libc::c_uint
    ...
    let mut sixteen: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut maxnumcolors: libc::c_uint = 257 as libc::c_int as libc::c_uint;
    ...
    (*stats).numpixels = ((*stats).numpixels as libc::c_ulong)
        .wrapping_add(numpixels) as size_t as size_t;
    ...
    if numcolors_done == 0 {
        ...
        loop {
            ...
            let mut color: *const libc::c_uchar =
                &mut *((*stats).palette)
                    .as_mut_ptr()
                    .offset(i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
            ...
            if error != 0 {
                current_block = 8706819336128748067;
                break;
            }
            i = i.wrapping_add(1);
            i;
    ...
    match current_block {
        14576567515993809846 => {
                ...
                && sixteen == 0
            {
                ...
                while i != numpixels {
                    ...
                    if r as libc::c_int & 255 as libc::c_int
                        != r as libc::c_int >> 8 as libc::c_int
                            & 255 as libc::c_int
                        || g as libc::c_int & 255 as libc::c_int
                            != g as libc::c_int >> 8 as libc::c_int
                                & 255 as libc::c_int
            ...
            if sixteen != 0 {
                let mut r_0: libc::c_ushort =
                    0 as libc::c_int as libc::c_ushort;
                let mut g_0: libc::c_ushort =
                    0 as libc::c_int as libc::c_ushort;
                let mut b_0: libc::c_ushort =
                    0 as libc::c_int as libc::c_ushort;
                let mut a_0: libc::c_ushort =
                    0 as libc::c_int as libc::c_ushort;
                i = 0 as libc::c_int as size_t;
                while i != numpixels {
                    getPixelColorRGBA16(
                        &mut r_0, &mut g_0, &mut b_0, &mut a_0, in_0, i,
                        mode_in
                    );
                    if colored_done == 0
                    ...
                    if alpha_done == 0 {
                        let mut matchkey: libc::c_uint = (r_0 as libc::c_int
                            == (*stats).key_r as libc::c_int
                            && g_0 as libc::c_int
                                == (*stats).key_g as libc::c_int
                            && b_0 as libc::c_int
                                == (*stats).key_b as libc::c_int)
                            as libc::c_int
                            as libc::c_uint;
                ...
                let mut r_1: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
                let mut g_1: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
                let mut b_1: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
                let mut a_1: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
                i = 0 as libc::c_int as size_t;
                loop {
                    if !(i != numpixels) {
                    ...
                    getPixelColorRGBA8(
                        &mut r_1, &mut g_1, &mut b_1, &mut a_1, in_0, i,
                        mode_in
                    );
                    if bits_done == 0
                        && (*stats).bits < 8 as libc::c_int as libc::c_uint
                    {
                        let mut bits: libc::c_uint = getValueRequiredBits(r_1);
                        if bits > (*stats).bits {
                            (*stats).bits = bits;
                        }
                    }
                    bits_done =
                        ((*stats).bits >= bpp) as libc::c_int as libc::c_uint;
                    if colored_done == 0
                    ...
                    if alpha_done == 0 {
                        let mut matchkey_0: libc::c_uint = (r_1 as libc::c_int
                            == (*stats).key_r as libc::c_int
                            && g_1 as libc::c_int
                                == (*stats).key_g as libc::c_int
                            && b_1 as libc::c_int
                        ...
                        if color_tree_has(&mut tree, r_1, g_1, b_1, a_1) == 0 {
                                ...
                                < 256 as libc::c_int as libc::c_uint
                            {
                                let mut p: *mut libc::c_uchar =
                                    ((*stats).palette).as_mut_ptr();
                                let mut n: libc::c_uint = (*stats).numcolors;
                                *p.offset(
                                    n.wrapping_mul(
                                        4 as libc::c_int as libc::c_uint
                                    )
                            ...
                            (*stats).numcolors =
                                ((*stats).numcolors).wrapping_add(1);
                            (*stats).numcolors;
                            numcolors_done = ((*stats).numcolors
                                >= maxnumcolors)
                                as libc::c_int
                                as libc::c_uint;
                        }
                ...
                match current_block {
                    ...
                    _ => {
                        if (*stats).key != 0 && (*stats).alpha == 0 {
                            ...
                            while i != numpixels {
                                getPixelColorRGBA8(
                                    &mut r_1, &mut g_1, &mut b_1, &mut a_1,
                                    in_0, i, mode_in
                                );
...
unsafe extern "C" fn auto_choose_color(
    ...
    let mut alpha: libc::c_uint = (*stats).alpha;
    let mut key: libc::c_uint = (*stats).key;
    let mut bits: libc::c_uint = (*stats).bits;
    ...
    if palette_ok != 0 {
        let mut p: *const libc::c_uchar = ((*stats).palette).as_ptr();
        ...
        if key != 0 {
            let mut mask_0: libc::c_uint = ((1 as libc::c_uint)
                << (*mode_out).bitdepth)
                .wrapping_sub(1 as libc::c_uint);
...
unsafe extern "C" fn paethPredictor(
    ...
    let mut pa: libc::c_short =
        (if (b as libc::c_int - c as libc::c_int) < 0 as libc::c_int {
            -(b as libc::c_int - c as libc::c_int)
        } else {
            b as libc::c_int - c as libc::c_int
        }) as libc::c_short;
    let mut pb: libc::c_short =
        (if (a as libc::c_int - c as libc::c_int) < 0 as libc::c_int {
            -(a as libc::c_int - c as libc::c_int)
        } else {
            a as libc::c_int - c as libc::c_int
        }) as libc::c_short;
    let mut pc: libc::c_short = (if (a as libc::c_int + b as libc::c_int
        - c as libc::c_int
        - c as libc::c_int)
        < 0 as libc::c_int
    {
...
unsafe extern "C" fn Adam7_getpassvalues(
    ...
    let ref mut fresh82 = *passstart.offset(0 as libc::c_int as isize);
    *fresh82 = 0 as libc::c_int as size_t;
    let ref mut fresh83 = *padded_passstart.offset(0 as libc::c_int as isize);
    *fresh83 = *fresh82;
    *filter_passstart.offset(0 as libc::c_int as isize) = *fresh83;
    i = 0 as libc::c_int as libc::c_uint;
    while i != 7 as libc::c_int as libc::c_uint {
        *filter_passstart
            .offset(
...
pub unsafe extern "C" fn lodepng_inspect(
    ...
    (*info).color.bitdepth =
        *in_0.offset(24 as libc::c_int as isize) as libc::c_uint;
    (*info).color.colortype =
        *in_0.offset(25 as libc::c_int as isize) as LodePNGColorType;
    (*info).compression_method =
        *in_0.offset(26 as libc::c_int as isize) as libc::c_uint;
    (*info).filter_method =
        *in_0.offset(27 as libc::c_int as isize) as libc::c_uint;
    (*info).interlace_method =
        *in_0.offset(28 as libc::c_int as isize) as libc::c_uint;
    ...
    if (*state).decoder.ignore_crc == 0 {
        let mut CRC: libc::c_uint =
            lodepng_read32bitInt(&*in_0.offset(29 as libc::c_int as isize));
        let mut checksum: libc::c_uint = lodepng_crc32(
    ...
    match filterType as libc::c_int {
        ...
        1 => {
            ...
            while i != length {
                *recon.offset(i as isize) = (*scanline.offset(i as isize)
                    as libc::c_int
                    + *recon.offset(j as isize) as libc::c_int)
                    as libc::c_uchar;
                i = i.wrapping_add(1);
                i;
                j = j.wrapping_add(1);
        ...
        3 => {
            if !precon.is_null() {
                ...
                if bytewidth >= 4 as libc::c_int as libc::c_ulong {
                    while i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s2: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s3: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r2: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r3: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p2: libc::c_uchar = *precon.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p3: libc::c_uchar = *precon.offset(
                            i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
                    ...
                    while i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0_0: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1_0: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s2_0: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0_0: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1_0: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r2_0: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0_0: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1_0: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p2_0: libc::c_uchar = *precon.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
                    ...
                    while i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0_1: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1_1: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0_1: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1_1: libc::c_uchar = *recon.offset(
                            j_0.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0_1: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1_1: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
        ...
        4 => {
            if !precon.is_null() {
                let mut j_2: size_t = 0 as libc::c_int as size_t;
                i = 0 as libc::c_int as size_t;
                while i != bytewidth {
                    *recon.offset(i as isize) = (*scanline.offset(i as isize)
                        as libc::c_int
                ...
                if bytewidth >= 4 as libc::c_int as libc::c_ulong {
                    while i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0_2: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1_2: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s2_1: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s3_0: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0_2: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1_2: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r2_1: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r3_0: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0_2: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1_2: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p2_1: libc::c_uchar = *precon.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p3_0: libc::c_uchar = *precon.offset(
                            i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q0: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q1: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q2: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q3: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(3 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
                    ...
                    while i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0_3: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1_3: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s2_2: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0_3: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1_3: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r2_2: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0_3: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1_3: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p2_2: libc::c_uchar = *precon.offset(
                            i.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q0_0: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q1_0: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q2_0: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(2 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
                    ...
                    while i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        < length
                    {
                        let mut s0_4: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut s1_4: libc::c_uchar = *scanline.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r0_4: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut r1_4: libc::c_uchar = *recon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p0_4: libc::c_uchar = *precon.offset(
                            i.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut p1_4: libc::c_uchar = *precon.offset(
                            i.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q0_1: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(0 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        let mut q1_1: libc::c_uchar = *precon.offset(
                            j_2.wrapping_add(1 as libc::c_int as libc::c_ulong)
                                as isize
                        );
                        *recon.offset(
                ...
                let mut j_3: size_t = 0 as libc::c_int as size_t;
                i = 0 as libc::c_int as size_t;
                while i != bytewidth {
                    *recon.offset(i as isize) = *scanline.offset(i as isize);
                    i = i.wrapping_add(1);
                ...
                while i != length {
                    *recon.offset(i as isize) = (*scanline.offset(i as isize)
                        as libc::c_int
                        + *recon.offset(j_3 as isize) as libc::c_int)
                        as libc::c_uchar;
                    i = i.wrapping_add(1);
                    i;
...
unsafe extern "C" fn unfilter(
    ...
    let mut prevline: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut bytewidth: size_t =
        bpp.wrapping_add(7 as libc::c_uint)
            .wrapping_div(8 as libc::c_uint) as size_t;
    let mut linebytes: size_t =
        (lodepng_get_raw_size_idat(w, 1 as libc::c_int as libc::c_uint, bpp))
            .wrapping_sub(1 as libc::c_uint as libc::c_ulong);
    y = 0 as libc::c_int as libc::c_uint;
    while y < h {
        let mut outindex: size_t = linebytes.wrapping_mul(y as libc::c_ulong);
        let mut inindex: size_t = (1 as libc::c_int as libc::c_ulong)
            .wrapping_add(linebytes)
            .wrapping_mul(y as libc::c_ulong);
        let mut filterType: libc::c_uchar = *in_0.offset(inindex as isize);
        let mut error: libc::c_uint = unfilterScanline(
            &mut *out.offset(outindex as isize),
            &*in_0.offset(
                inindex.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    as isize
            ),
            prevline,
            bytewidth,
...
unsafe extern "C" fn Adam7_deinterlace(
    ...
    if bpp >= 8 as libc::c_int as libc::c_uint {
        ...
        while i != 7 as libc::c_int as libc::c_uint {
            ...
            let mut bytewidth: size_t =
                bpp.wrapping_div(8 as libc::c_uint) as size_t;
            y = 0 as libc::c_int as libc::c_uint;
            while y < passh[i as usize] {
                x = 0 as libc::c_int as libc::c_uint;
                while x < passw[i as usize] {
                    let mut pixelinstart: size_t = (passstart[i as usize])
                        .wrapping_add(
                            (y.wrapping_mul(passw[i as usize]).wrapping_add(x)
                                as libc::c_ulong)
                                .wrapping_mul(bytewidth)
                        );
                    let mut pixeloutstart: size_t = (ADAM7_IY[i as usize]
                        as libc::c_ulong)
                        .wrapping_add((y as size_t).wrapping_mul(
                            ADAM7_DY[i as usize] as libc::c_ulong
                        ))
                        .wrapping_mul(w as size_t)
                        .wrapping_add(ADAM7_IX[i as usize] as libc::c_ulong)
                        .wrapping_add((x as size_t).wrapping_mul(
                            ADAM7_DX[i as usize] as libc::c_ulong
                        ))
                        .wrapping_mul(bytewidth);
                    b = 0 as libc::c_int as libc::c_uint;
                    while (b as libc::c_ulong) < bytewidth {
                        *out.offset(
                            pixeloutstart.wrapping_add(b as libc::c_ulong)
                                as isize
                        ) = *in_0.offset(
                            pixelinstart.wrapping_add(b as libc::c_ulong)
                                as isize
                        );
                        b = b.wrapping_add(1);
                        b;
        ...
        while i != 7 as libc::c_int as libc::c_uint {
            ...
            let mut ilinebits: libc::c_uint =
                bpp.wrapping_mul(passw[i as usize]);
            let mut olinebits: libc::c_uint = bpp.wrapping_mul(w);
            ...
            while y_0 < passh[i as usize] {
                ...
                while x_0 < passw[i as usize] {
                    ...
                    obp = (ADAM7_IY[i as usize] as libc::c_ulong)
                        .wrapping_add((y_0 as size_t).wrapping_mul(
                            ADAM7_DY[i as usize] as libc::c_ulong
                        ))
                        .wrapping_mul(olinebits as libc::c_ulong)
                        .wrapping_add(
                            (ADAM7_IX[i as usize] as libc::c_ulong)
                                .wrapping_add((x_0 as size_t).wrapping_mul(
                                    ADAM7_DX[i as usize] as libc::c_ulong
                                ))
                                .wrapping_mul(bpp as libc::c_ulong)
                        );
                    ...
                    while b_0 < bpp {
                        let mut bit: libc::c_uchar =
                            readBitFromReversedStream(&mut ibp, in_0);
...
unsafe extern "C" fn removePaddingBits(
    ...
    let mut ibp: size_t = 0 as libc::c_int as size_t;
    let mut obp: size_t = 0 as libc::c_int as size_t;
    y = 0 as libc::c_int as libc::c_uint;
    while y < h {
        let mut x: size_t = 0;
...
unsafe extern "C" fn postProcessScanlines(
    ...
    let mut bpp: libc::c_uint = lodepng_get_bpp(&(*info_png).color);
    ...
    if (*info_png).interlace_method == 0 as libc::c_int as libc::c_uint {
        ...
        {
            let mut error: libc::c_uint = unfilter(in_0, in_0, w, h, bpp);
            if error != 0 {
                return error;
            }
            removePaddingBits(
            ...
            let mut error_0: libc::c_uint = unfilter(out, in_0, w, h, bpp);
            if error_0 != 0 {
                return error_0;
            }
        }
        ...
        i = 0 as libc::c_int as libc::c_uint;
        while i != 7 as libc::c_int as libc::c_uint {
            let mut error_1: libc::c_uint = unfilter(
                &mut *in_0
                    .offset(*padded_passstart.as_mut_ptr().offset(i as isize)
                        as isize),
                &mut *in_0
                    .offset(*filter_passstart.as_mut_ptr().offset(i as isize)
                        as isize),
                passw[i as usize],
                passh[i as usize],
                bpp
            ...
            if bpp < 8 as libc::c_int as libc::c_uint {
                removePaddingBits(
                    ...
                    &mut *in_0.offset(
                        *padded_passstart.as_mut_ptr().offset(i as isize)
                            as isize
                    ),
...
unsafe extern "C" fn readChunk_PLTE(
    ...
    let mut i: libc::c_uint = 0;
    (*color).palettesize =
        chunkLength.wrapping_div(3 as libc::c_uint as libc::c_ulong);
...
unsafe extern "C" fn readChunk_tRNS(
    ...
    let mut i: libc::c_uint = 0;
    if (*color).colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        == LCT_RGB as libc::c_int as libc::c_uint
    {
        ...
        (*color).key_g = (256 as libc::c_uint)
            .wrapping_mul(
                *data.offset(2 as libc::c_int as isize) as libc::c_uint
            )
            .wrapping_add(
                *data.offset(3 as libc::c_int as isize) as libc::c_uint
            );
        (*color).key_b = (256 as libc::c_uint)
            .wrapping_mul(
            ...
            .wrapping_add(
                *data.offset(5 as libc::c_int as isize) as libc::c_uint
            );
    } else {
...
unsafe extern "C" fn readChunk_zTXt(
    ...
    if error == 0 {
        ...
        if length.wrapping_add(2 as libc::c_int as libc::c_uint)
            as libc::c_ulong
            >= chunkLength
        {
...
unsafe extern "C" fn readChunk_iTXt(
    ...
    let mut key: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut langtag: *mut libc::c_char = 0 as *mut libc::c_char;
    let mut transkey: *mut libc::c_char = 0 as *mut libc::c_char;
    if error == 0 {
        if chunkLength < 5 as libc::c_int as libc::c_ulong {
            ...
            length = 0 as libc::c_int as libc::c_uint;
            while (length as libc::c_ulong) < chunkLength
                && *data.offset(length as isize) as libc::c_int
                    != 0 as libc::c_int
            {
                length = length.wrapping_add(1);
                length;
            }
            if length.wrapping_add(3 as libc::c_int as libc::c_uint)
                as libc::c_ulong
                >= chunkLength
            {
                error = 75 as libc::c_int as libc::c_uint;
                    ...
                    *key.offset(length as isize) =
                        ...
                        != 0 as libc::c_int
                    {
                        ...
                        if langtag.is_null() {
                            ...
                            *langtag.offset(length as isize) =
                                0 as libc::c_int as libc::c_char;
                            begin = begin.wrapping_add(length.wrapping_add(
                                1 as libc::c_int as libc::c_uint
                            ));
                            length = 0 as libc::c_int as libc::c_uint;
                            i = begin;
                            ...
                            if transkey.is_null() {
                                ...
                                *transkey.offset(length as isize) =
                                    0 as libc::c_int as libc::c_char;
                                begin =
                                    begin.wrapping_add(length.wrapping_add(
                                        1 as libc::c_int as libc::c_uint
                                    ));
                                length =
                                    if (chunkLength as libc::c_uint) < begin {
                                        0 as libc::c_int as libc::c_uint
                                    } else {
                                        (chunkLength as libc::c_uint)
                                            .wrapping_sub(begin)
                                    };
                                if compressed != 0 {
                                    let mut str: *mut libc::c_uchar =
                                        0 as *mut libc::c_uchar;
                                    let mut size: size_t =
                                        0 as libc::c_int as size_t;
                                    zlibsettings.max_output_size =
                                        (*decoder).max_text_size;
                                    error = zlib_decompress(
                                        &mut str,
                                        &mut size,
                                        0 as libc::c_int as size_t,
                                    ...
                                    if error != 0
                                        && size > zlibsettings.max_output_size
                                    {
                                        error =
...
unsafe extern "C" fn readChunk_tIME(
    ...
    (*info).time.minute =
        *data.offset(5 as libc::c_int as isize) as libc::c_uint;
    (*info).time.second =
        *data.offset(6 as libc::c_int as isize) as libc::c_uint;
    return 0 as libc::c_int as libc::c_uint;
}
unsafe extern "C" fn readChunk_pHYs(
    ...
    (*info).phys_x = (16777216 as libc::c_uint)
        .wrapping_mul(*data.offset(0 as libc::c_int as isize) as libc::c_uint)
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(1 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(2 as libc::c_int as isize) as libc::c_uint
        ))
...
unsafe extern "C" fn readChunk_cHRM(
    ...
    (*info).chrm_red_x = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(9 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(10 as libc::c_int as isize) as libc::c_uint
        ))
    ...
    (*info).chrm_red_y = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(13 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(14 as libc::c_int as isize) as libc::c_uint
        ))
    ...
    (*info).chrm_green_x = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(17 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(18 as libc::c_int as isize) as libc::c_uint
        ))
    ...
    (*info).chrm_green_y = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(21 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(22 as libc::c_int as isize) as libc::c_uint
        ))
    ...
    (*info).chrm_blue_x = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(25 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(26 as libc::c_int as isize) as libc::c_uint
        ))
    ...
    (*info).chrm_blue_y = (16777216 as libc::c_uint)
        ...
        .wrapping_add((65536 as libc::c_uint).wrapping_mul(
            *data.offset(29 as libc::c_int as isize) as libc::c_uint
        ))
        .wrapping_add((256 as libc::c_uint).wrapping_mul(
            *data.offset(30 as libc::c_int as isize) as libc::c_uint
        ))
...
unsafe extern "C" fn readChunk_iCCP(
    ...
    *((*info).iccp_name).offset(length as isize) =
        0 as libc::c_int as libc::c_char;
    i = 0 as libc::c_int as libc::c_uint;
    while i != length {
        *((*info).iccp_name).offset(i as isize) =
            *data.offset(i as isize) as libc::c_char;
        i = i.wrapping_add(1);
        i;
    }
    if *data
        .offset(length.wrapping_add(1 as libc::c_int as libc::c_uint) as isize)
        as libc::c_int
        != 0 as libc::c_int
    {
...
unsafe extern "C" fn readChunk_sBIT(
    ...
    let mut bitdepth: libc::c_uint = if (*info).color.colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        8 as libc::c_int as libc::c_uint
    } else {
...
pub unsafe extern "C" fn lodepng_inspect_chunk(
    ...
    let mut chunk: *const libc::c_uchar = in_0.offset(pos as isize);
    let mut chunkLength: libc::c_uint = 0;
    let mut data: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut unhandled: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    if chunkLength.wrapping_add(12 as libc::c_int as libc::c_uint)
        as libc::c_ulong
    ...
    {
        error =
            readChunk_bKGD(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_tEXt(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_tIME(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_pHYs(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_gAMA(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_cHRM(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_sRGB(&mut (*state).info_png, data, chunkLength as size_t);
    } else if lodepng_chunk_type_equals(
        chunk,
    ...
    {
        error =
            readChunk_sBIT(&mut (*state).info_png, data, chunkLength as size_t);
    } else {
...
unsafe extern "C" fn decodeGeneric(
    ...
    let mut IEND: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
    let mut chunk: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut idat: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut idatsize: size_t = 0 as libc::c_int as size_t;
    let mut scanlines: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut scanlines_size: size_t = 0 as libc::c_int as size_t;
    let mut expected_size: size_t = 0 as libc::c_int as size_t;
    let mut outsize: size_t = 0 as libc::c_int as size_t;
    let mut unknown: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut critical_pos: libc::c_uint = 1 as libc::c_int as libc::c_uint;
    *out = 0 as *mut libc::c_uchar;
    ...
    *w = *h;
    ...
    while IEND == 0 && (*state).error == 0 {
        let mut chunkLength: libc::c_uint = 0;
        let mut data: *const libc::c_uchar = 0 as *const libc::c_uchar;
        let mut pos: size_t = chunk.offset_from(in_0) as libc::c_long as size_t;
        if chunk < in_0
            || pos.wrapping_add(12 as libc::c_int as libc::c_ulong) > insize
        {
                ...
                ) != 0
                {
                    ...
                    ) != 0
                    {
                        ...
                        idatsize = (idatsize as libc::c_ulong)
                            .wrapping_add(chunkLength as libc::c_ulong)
                            as size_t
                            as size_t;
                    ...
                    if (*state).decoder.remember_unknown_chunks != 0 {
                        (*state).error = lodepng_chunk_append(
                            &mut *((*state).info_png.unknown_chunks_data)
                                .as_mut_ptr()
                                .offset(critical_pos.wrapping_sub(
                                    1 as libc::c_int as libc::c_uint
                                )
                                    as isize),
    ...
    if (*state).error == 0 {
        if (*state).info_png.interlace_method
            == 0 as libc::c_int as libc::c_uint
        {
            let mut bpp: size_t =
                lodepng_get_bpp(&mut (*state).info_png.color) as size_t;
            expected_size =
                lodepng_get_raw_size_idat(*w, *h, bpp as libc::c_uint);
        } else {
            let mut bpp_0: size_t =
                lodepng_get_bpp(&mut (*state).info_png.color) as size_t;
            expected_size = 0 as libc::c_int as size_t;
            expected_size = (expected_size as libc::c_ulong).wrapping_add(
...
pub unsafe extern "C" fn lodepng_decode(
    ...
    *out = 0 as *mut libc::c_uchar;
        ...
        ) != 0
    {
        ...
        let mut data: *mut libc::c_uchar = *out;
...
pub unsafe extern "C" fn lodepng_state_copy(
    ...
    *dest = *source;
    ...
    (*dest).error =
        lodepng_color_mode_copy(&mut (*dest).info_raw, &(*source).info_raw);
    if (*dest).error != 0 {
        return;
    }
    (*dest).error =
        lodepng_info_copy(&mut (*dest).info_png, &(*source).info_png);
    if (*dest).error != 0 {
        return;
    }
}
...
unsafe extern "C" fn addChunk_IHDR(
    ...
    let mut error: libc::c_uint = lodepng_chunk_init(
        &mut chunk,
        out,
        13 as libc::c_int as libc::c_uint,
        b"IHDR\0" as *const u8 as *const libc::c_char
...
unsafe extern "C" fn addChunk_PLTE(
    ...
    let mut chunk: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut i: size_t = 0;
    let mut j: size_t = 8 as libc::c_int as size_t;
    ...
    while i != (*info).palettesize {
        let fresh87 = j;
        j = j.wrapping_add(1);
        *chunk.offset(fresh87 as isize) = *((*info).palette).offset(
            i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                .wrapping_add(0 as libc::c_int as libc::c_ulong)
                as isize
        );
        let fresh88 = j;
        j = j.wrapping_add(1);
        *chunk.offset(fresh88 as isize) = *((*info).palette).offset(
            i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
                as isize
        );
        let fresh89 = j;
        j = j.wrapping_add(1);
        *chunk.offset(fresh89 as isize) = *((*info).palette).offset(
            i.wrapping_mul(4 as libc::c_int as libc::c_ulong)
                .wrapping_add(2 as libc::c_int as libc::c_ulong)
                as isize
        );
...
unsafe extern "C" fn addChunk_tRNS(
    ...
    let mut chunk: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    if (*info).colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        let mut i: size_t = 0;
        ...
        if amount != 0 {
            ...
            while i != amount {
                *chunk.offset(
                    (8 as libc::c_int as libc::c_ulong).wrapping_add(i)
                        as isize
                ) = *((*info).palette).offset(
                    (4 as libc::c_int as libc::c_ulong)
                        .wrapping_mul(i)
        ...
        == LCT_GREY as libc::c_int as libc::c_uint
    {
        if (*info).key_defined != 0 {
            let mut error_0: libc::c_uint = lodepng_chunk_init(
                &mut chunk,
                out,
                2 as libc::c_int as libc::c_uint,
                b"tRNS\0" as *const u8 as *const libc::c_char
            ...
            *chunk.offset(8 as libc::c_int as isize) =
                ((*info).key_r >> 8 as libc::c_int) as libc::c_uchar;
            *chunk.offset(9 as libc::c_int as isize) = ((*info).key_r
    ...
    {
        if (*info).key_defined != 0 {
            let mut error_1: libc::c_uint = lodepng_chunk_init(
                &mut chunk,
                out,
                6 as libc::c_int as libc::c_uint,
                b"tRNS\0" as *const u8 as *const libc::c_char
            ...
            *chunk.offset(9 as libc::c_int as isize) = ((*info).key_r
                & 255 as libc::c_int as libc::c_uint)
                as libc::c_uchar;
            *chunk.offset(10 as libc::c_int as isize) =
                ((*info).key_g >> 8 as libc::c_int) as libc::c_uchar;
            *chunk.offset(11 as libc::c_int as isize) = ((*info).key_g
                & 255 as libc::c_int as libc::c_uint)
                as libc::c_uchar;
            *chunk.offset(12 as libc::c_int as isize) =
                ((*info).key_b >> 8 as libc::c_int) as libc::c_uchar;
            *chunk.offset(13 as libc::c_int as isize) = ((*info).key_b
                & 255 as libc::c_int as libc::c_uint)
                as libc::c_uchar;
        }
    }
...
unsafe extern "C" fn addChunk_IDAT(
    ...
    let mut zlibsize: size_t = 0 as libc::c_int as size_t;
    error =
        zlib_compress(&mut zlib, &mut zlibsize, data, datasize, zlibsettings);
    if error == 0 {
    ...
    *chunk.offset(
    ...
    lodepng_memcpy(
        chunk
            ...
            .offset(keysize as isize) as *mut libc::c_void,
...
unsafe extern "C" fn addChunk_zTXt(
    ...
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut chunk: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut compressed: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut compressedsize: size_t = 0 as libc::c_int as size_t;
    let mut textsize: size_t = lodepng_strlen(textstring);
    let mut keysize: size_t = lodepng_strlen(keyword);
    if keysize < 1 as libc::c_int as libc::c_ulong
        || keysize > 79 as libc::c_int as libc::c_ulong
...
unsafe extern "C" fn addChunk_iTXt(
    ...
    if error == 0 {
        let mut pos: size_t = 8 as libc::c_int as size_t;
        lodepng_memcpy(
        ...
        let fresh90 = pos;
        pos = pos.wrapping_add(1);
        *chunk.offset(fresh90 as isize) = 0 as libc::c_int as libc::c_uchar;
        let fresh91 = pos;
        pos = pos.wrapping_add(1);
        *chunk.offset(fresh91 as isize) = (if compress != 0 {
            1 as libc::c_int
        } else {
            0 as libc::c_int
        }) as libc::c_uchar;
        let fresh92 = pos;
        pos = pos.wrapping_add(1);
        *chunk.offset(fresh92 as isize) = 0 as libc::c_int as libc::c_uchar;
        lodepng_memcpy(
            chunk.offset(pos as isize) as *mut libc::c_void,
        ...
        let fresh93 = pos;
        pos = pos.wrapping_add(1);
        *chunk.offset(fresh93 as isize) = 0 as libc::c_int as libc::c_uchar;
        lodepng_memcpy(
            chunk.offset(pos as isize) as *mut libc::c_void,
        ...
        pos =
            (pos as libc::c_ulong).wrapping_add(transsize) as size_t as size_t;
        let fresh94 = pos;
        pos = pos.wrapping_add(1);
        *chunk.offset(fresh94 as isize) = 0 as libc::c_int as libc::c_uchar;
        if compress != 0 {
            lodepng_memcpy(
                chunk.offset(pos as isize) as *mut libc::c_void,
                compressed as *const libc::c_void,
...
unsafe extern "C" fn addChunk_bKGD(
            ...
            == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        ...
        *chunk.offset(9 as libc::c_int as isize) = ((*info).background_r
            & 255 as libc::c_int as libc::c_uint)
            as libc::c_uchar;
    } else if (*info).color.colortype as libc::c_uint
        == LCT_RGB as libc::c_int as libc::c_uint
            ...
            == LCT_RGBA as libc::c_int as libc::c_uint
    {
        ...
        *chunk.offset(11 as libc::c_int as isize) = ((*info).background_g
            & 255 as libc::c_int as libc::c_uint)
            as libc::c_uchar;
        *chunk.offset(12 as libc::c_int as isize) =
            ((*info).background_b >> 8 as libc::c_int) as libc::c_uchar;
        *chunk.offset(13 as libc::c_int as isize) = ((*info).background_b
            & 255 as libc::c_int as libc::c_uint)
            as libc::c_uchar;
    } else if (*info).color.colortype as libc::c_uint
        == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        *chunk.offset(8 as libc::c_int as isize) = ((*info).background_r
            & 255 as libc::c_int as libc::c_uint)
            as libc::c_uchar;
    }
    if !chunk.is_null() {
...
unsafe extern "C" fn addChunk_tIME(
    ...
    *chunk.offset(9 as libc::c_int as isize) =
...
unsafe extern "C" fn addChunk_pHYs(
    ...
    *chunk.offset(16 as libc::c_int as isize) =
        (*info).phys_unit as libc::c_uchar;
    lodepng_chunk_generate_crc(chunk);
    return 0 as libc::c_int as libc::c_uint;
}
...
unsafe extern "C" fn addChunk_cHRM(
    ...
    lodepng_set32bitInt(
        chunk.offset(20 as libc::c_int as isize),
        (*info).chrm_red_y
    );
    lodepng_set32bitInt(
        chunk.offset(24 as libc::c_int as isize),
        (*info).chrm_green_x
    );
    lodepng_set32bitInt(
        chunk.offset(28 as libc::c_int as isize),
        (*info).chrm_green_y
    );
    lodepng_set32bitInt(
        chunk.offset(32 as libc::c_int as isize),
        (*info).chrm_blue_x
    );
    lodepng_set32bitInt(
        chunk.offset(36 as libc::c_int as isize),
        (*info).chrm_blue_y
    );
    lodepng_chunk_generate_crc(chunk);
    return 0 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn addChunk_sRGB(
    ...
    let mut data: libc::c_uchar = (*info).srgb_intent as libc::c_uchar;
    return lodepng_chunk_createv(
        out,
        1 as libc::c_int as libc::c_uint,
        b"sRGB\0" as *const u8 as *const libc::c_char,
...
unsafe extern "C" fn addChunk_sBIT(
            ...
            == LCT_PALETTE as libc::c_int as libc::c_uint
    {
        ...
        *chunk.offset(8 as libc::c_int as isize) =
            (*info).sbit_r as libc::c_uchar;
        *chunk.offset(9 as libc::c_int as isize) =
            (*info).sbit_g as libc::c_uchar;
        *chunk.offset(10 as libc::c_int as isize) =
            (*info).sbit_b as libc::c_uchar;
    } else if (*info).color.colortype as libc::c_uint
        == LCT_GREY_ALPHA as libc::c_int as libc::c_uint
    {
        if (*info).sbit_r == 0 as libc::c_int as libc::c_uint
        ...
        == LCT_RGBA as libc::c_int as libc::c_uint
    {
        ...
        let mut error_2: libc::c_uint = lodepng_chunk_init(
            &mut chunk,
            out,
            4 as libc::c_int as libc::c_uint,
            b"sBIT\0" as *const u8 as *const libc::c_char
        ...
        *chunk.offset(10 as libc::c_int as isize) =
            (*info).sbit_b as libc::c_uchar;
        *chunk.offset(11 as libc::c_int as isize) =
            (*info).sbit_a as libc::c_uchar;
    }
    if !chunk.is_null() {
        lodepng_chunk_generate_crc(chunk);
...
unsafe extern "C" fn filter(
    ...
    let mut bpp: libc::c_uint = lodepng_get_bpp(color);
    let mut linebytes: size_t =
        (lodepng_get_raw_size_idat(w, 1 as libc::c_int as libc::c_uint, bpp))
            .wrapping_sub(1 as libc::c_uint as libc::c_ulong);
    let mut bytewidth: size_t =
        bpp.wrapping_add(7 as libc::c_uint)
            .wrapping_div(8 as libc::c_uint) as size_t;
    let mut prevline: *const libc::c_uchar = 0 as *const libc::c_uchar;
    let mut x: libc::c_uint = 0;
    let mut y: libc::c_uint = 0;
    let mut error: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    ...
    {
        let mut type_0: libc::c_uchar = strategy as libc::c_uchar;
        y = 0 as libc::c_int as libc::c_uint;
        while y != h {
            let mut outindex: size_t = (1 as libc::c_int as libc::c_ulong)
                .wrapping_add(linebytes)
                .wrapping_mul(y as libc::c_ulong);
            let mut inindex: size_t =
                linebytes.wrapping_mul(y as libc::c_ulong);
            *out.offset(outindex as isize) = type_0;
            filterScanline(
                &mut *out.offset(
                    outindex.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        as isize
                ),
    ...
    } else if strategy as libc::c_uint
        == LFS_MINSUM as libc::c_int as libc::c_uint
    {
        let mut attempt: [*mut libc::c_uchar; 5] = [0 as *mut libc::c_uchar; 5];
        let mut smallest: size_t = 0 as libc::c_int as size_t;
        let mut type_1: libc::c_uchar = 0;
        let mut bestType: libc::c_uchar = 0 as libc::c_int as libc::c_uchar;
        type_1 = 0 as libc::c_int as libc::c_uchar;
        while type_1 as libc::c_int != 5 as libc::c_int {
            attempt[type_1 as usize] =
                lodepng_malloc(linebytes) as *mut libc::c_uchar;
            ...
            while y != h {
                ...
                while type_1 as libc::c_int != 5 as libc::c_int {
                    ...
                    filterScanline(
                        attempt[type_1 as usize],
                        &*in_0.offset(
                            (y as libc::c_ulong).wrapping_mul(linebytes)
                                as isize
                        ),
                        prevline,
                        linebytes,
                    ...
                    if type_1 as libc::c_int == 0 as libc::c_int {
                        ...
                        while x as libc::c_ulong != linebytes {
                            sum = (sum as libc::c_ulong).wrapping_add(
                ...
                prevline =
                    &*in_0
                        .offset((y as libc::c_ulong).wrapping_mul(linebytes)
                            as isize)
                        as *const libc::c_uchar;
                *out.offset((y as libc::c_ulong).wrapping_mul(
                ...
                while x as libc::c_ulong != linebytes {
                    *out.offset(
                        (y as libc::c_ulong)
                            .wrapping_mul(linebytes.wrapping_add(
                                1 as libc::c_int as libc::c_ulong
                            ))
                            .wrapping_add(1 as libc::c_int as libc::c_ulong)
                            .wrapping_add(x as libc::c_ulong)
                            as isize
        ...
        == LFS_ENTROPY as libc::c_int as libc::c_uint
    {
        let mut attempt_0: [*mut libc::c_uchar; 5] =
            [0 as *mut libc::c_uchar; 5];
        let mut bestSum: size_t = 0 as libc::c_int as size_t;
        let mut type_2: libc::c_uint = 0;
        let mut bestType_0: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        ...
        if error == 0 {
            ...
            while y != h {
                type_2 = 0 as libc::c_int as libc::c_uint;
                while type_2 != 5 as libc::c_int as libc::c_uint {
                    let mut sum_0: size_t = 0 as libc::c_int as size_t;
                    filterScanline(
                        attempt_0[type_2 as usize],
                        &*in_0.offset(
                            (y as libc::c_ulong).wrapping_mul(linebytes)
                    ...
                    lodepng_memset(
                        ...
                        0 as libc::c_int,
                        (256 as libc::c_int as libc::c_ulong).wrapping_mul(
                            ::core::mem::size_of::<libc::c_uint>()
                                as libc::c_ulong
                        )
                    );
                    ...
                    count[type_2 as usize] =
                        (count[type_2 as usize]).wrapping_add(1);
                    count[type_2 as usize];
                    x = 0 as libc::c_int as libc::c_uint;
                    while x != 256 as libc::c_int as libc::c_uint {
                        sum_0 = (sum_0 as libc::c_ulong)
                            .wrapping_add(ilog2i(count[x as usize] as size_t))
                            as size_t as size_t;
                        x = x.wrapping_add(1);
                        x;
                    }
                    if type_2 == 0 as libc::c_int as libc::c_uint
                        || sum_0 > bestSum
                    {
                        bestType_0 = type_2;
                        bestSum = sum_0;
                ...
                *out.offset((y as libc::c_ulong).wrapping_mul(
                    linebytes.wrapping_add(1 as libc::c_int as libc::c_ulong)
                ) as isize) = bestType_0 as libc::c_uchar;
                x = 0 as libc::c_int as libc::c_uint;
                while x as libc::c_ulong != linebytes {
                    *out.offset(
                        (y as libc::c_ulong)
        ...
        == LFS_PREDEFINED as libc::c_int as libc::c_uint
    {
        y = 0 as libc::c_int as libc::c_uint;
        while y != h {
            let mut outindex_0: size_t = (1 as libc::c_int as libc::c_ulong)
                .wrapping_add(linebytes)
                .wrapping_mul(y as libc::c_ulong);
            let mut inindex_0: size_t =
                linebytes.wrapping_mul(y as libc::c_ulong);
            let mut type_3: libc::c_uchar =
            ...
            *out.offset(outindex_0 as isize) = type_3;
            ...
            prevline =
                &*in_0.offset(inindex_0 as isize) as *const libc::c_uchar;
            y = y.wrapping_add(1);
            y;
        }
    } else if strategy as libc::c_uint
        == LFS_BRUTE_FORCE as libc::c_int as libc::c_uint
    {
        let mut size: [size_t; 5] = [0; 5];
        let mut attempt_1: [*mut libc::c_uchar; 5] =
            [0 as *mut libc::c_uchar; 5];
        let mut smallest_0: size_t = 0 as libc::c_int as size_t;
        let mut type_4: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        let mut bestType_1: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        let mut dummy: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
        ...
        lodepng_memcpy(
            &mut zlibsettings as *mut LodePNGCompressSettings
                as *mut libc::c_void,
            &(*settings).zlibsettings as *const LodePNGCompressSettings
                as *const libc::c_void,
            ::core::mem::size_of::<LodePNGCompressSettings>() as libc::c_ulong
        );
        ...
        if error == 0 {
            ...
            while y != h {
                type_4 = 0 as libc::c_int as libc::c_uint;
                while type_4 != 5 as libc::c_int as libc::c_uint {
                    let mut testsize: libc::c_uint = linebytes as libc::c_uint;
                    filterScanline(
                        attempt_1[type_4 as usize],
                        &*in_0.offset(
                            (y as libc::c_ulong).wrapping_mul(linebytes)
                ...
                *out.offset((y as libc::c_ulong).wrapping_mul(
                    linebytes.wrapping_add(1 as libc::c_int as libc::c_ulong)
                ) as isize) = bestType_1 as libc::c_uchar;
                x = 0 as libc::c_int as libc::c_uint;
                while x as libc::c_ulong != linebytes {
                    *out.offset(
                        (y as libc::c_ulong)
            ...
            while y < passh[i as usize] {
                ...
                while x < passw[i as usize] {
                    let mut pixelinstart: size_t = ((ADAM7_IY[i as usize])
                        ...
                        as libc::c_ulong)
                        .wrapping_mul(bytewidth);
                    let mut pixeloutstart: size_t = (passstart[i as usize])
                        .wrapping_add(
                            (y.wrapping_mul(passw[i as usize]).wrapping_add(x)
                                as libc::c_ulong)
                                .wrapping_mul(bytewidth)
                ...
                while x_0 < passw[i as usize] {
                    ibp = (ADAM7_IY[i as usize])
                        ...
                        .wrapping_add(
                            (ADAM7_IX[i as usize])
                                .wrapping_add(
                                    x_0.wrapping_mul(ADAM7_DX[i as usize])
                                )
                                .wrapping_mul(bpp)
                        ) as size_t;
...
unsafe extern "C" fn preProcessScanlines(
    ...
    if (*info_png).interlace_method == 0 as libc::c_int as libc::c_uint {
        ...
        *out = lodepng_malloc(*outsize) as *mut libc::c_uchar;
            ...
            if bpp < 8 as libc::c_int as libc::c_uint
                && w.wrapping_mul(bpp)
                    != w.wrapping_mul(bpp)
                        ...
                        .wrapping_mul(8 as libc::c_uint)
            {
                let mut padded: *mut libc::c_uchar = lodepng_malloc(
                    h.wrapping_mul(
                        w.wrapping_mul(bpp)
                            .wrapping_add(7 as libc::c_uint)
                            .wrapping_div(8 as libc::c_uint)
        ...
        let mut padded_passstart: [size_t; 8] = [0; 8];
        let mut passstart: [size_t; 8] = [0; 8];
        let mut adam7: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
        Adam7_getpassvalues(
            passw.as_mut_ptr(),
            passh.as_mut_ptr(),
            filter_passstart.as_mut_ptr(),
        ...
        *out = lodepng_malloc(*outsize) as *mut libc::c_uchar;
        ...
        if error == 0 {
            ...
            while i != 7 as libc::c_int as libc::c_uint {
                if bpp < 8 as libc::c_int as libc::c_uint {
                    let mut padded_0: *mut libc::c_uchar = lodepng_malloc(
                        (padded_passstart[i
                            .wrapping_add(1 as libc::c_int as libc::c_uint)
                            as usize])
                    ...
                    if padded_0.is_null() {
                        ...
                        addPaddingBits(
                            padded_0,
                            &mut *adam7.offset(
                                *passstart.as_mut_ptr().offset(i as isize)
                                    as isize
                            ),
                            (passw[i as usize])
                                .wrapping_mul(bpp)
                    ...
                    error = filter(
                        &mut *(*out).offset(
                            *filter_passstart.as_mut_ptr().offset(i as isize)
                                as isize
                        ),
                        &mut *adam7.offset(
                            *padded_passstart.as_mut_ptr().offset(i as isize)
...
unsafe extern "C" fn addUnknownChunks(
    ...
    let mut inchunk: *mut libc::c_uchar = data;
    while (inchunk.offset_from(data) as libc::c_long as size_t) < datasize {
        let mut error: libc::c_uint =
            lodepng_chunk_append(&mut (*out).data, &mut (*out).size, inchunk);
        if error != 0 {
            return error;
        }
        (*out).allocsize = (*out).size;
...
unsafe extern "C" fn isGrayICCProfile(
    ...
    return (*profile.offset(16 as libc::c_int as isize) as libc::c_int
        == 'G' as i32
        && *profile.offset(17 as libc::c_int as isize) as libc::c_int
            == 'R' as i32
        && *profile.offset(18 as libc::c_int as isize) as libc::c_int
            == 'A' as i32
        && *profile.offset(19 as libc::c_int as isize) as libc::c_int
            == 'Y' as i32) as libc::c_int as libc::c_uint;
}
...
pub unsafe extern "C" fn lodepng_encode(
    ...
    let mut current_block: u64;
    let mut data: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut datasize: size_t = 0 as libc::c_int as size_t;
    let mut outv: ucvector =
        ucvector_init(0 as *mut libc::c_uchar, 0 as libc::c_int as size_t);
    ...
    *outsize = 0 as libc::c_int as size_t;
    ...
    if ((*info_png).color.colortype as libc::c_uint
        ...
        && ((*info_png).color.palettesize == 0 as libc::c_int as libc::c_ulong
            || (*info_png).color.palettesize
                > 256 as libc::c_int as libc::c_ulong)
    {
        (*state).error = 68 as libc::c_int as libc::c_uint;
    } else if (*state).encoder.zlibsettings.btype
        > 2 as libc::c_int as libc::c_uint
    {
        ...
        if !((*state).error != 0) {
            ...
            if !((*state).error != 0) {
                ...
                if (*state).encoder.auto_convert != 0 {
                    ...
                    let mut allow_convert: libc::c_uint =
                        1 as libc::c_int as libc::c_uint;
                    ...
                    if (*state).error != 0 {
                        current_block = 10542532023647228682;
                    } else {
                        if (*info_png).background_defined != 0 {
                            let mut r: libc::c_uint =
                                0 as libc::c_int as libc::c_uint;
                            let mut g: libc::c_uint =
                                0 as libc::c_int as libc::c_uint;
                            ...
                            _ => {
                                ...
                                if (*state).error != 0 {
                                    ...
                                    if (*info_png).sbit_defined != 0 {
                                        let mut sbit_max: libc::c_uint =
                                            if (if (if (*info_png).sbit_r
                                                > (*info_png).sbit_g
                                            {
                                                (*info_png).sbit_r
                                            } else {
                                        ...
                                        allow_convert =
                                            0 as libc::c_int as libc::c_uint;
                                        if info.color.colortype as libc::c_uint
                                            == LCT_PALETTE as libc::c_int
                                                as libc::c_uint
                                            && auto_color.colortype
                                                as libc::c_uint
                                                == LCT_PALETTE as libc::c_int
                                                    as libc::c_uint
                                        {
                                            allow_convert = 1 as libc::c_int
                                                as libc::c_uint;
                                        }
                                        if info.color.colortype as libc::c_uint
                                            == LCT_RGB as libc::c_int
                ...
                match current_block {
                    ...
                    _ => {
                        if (*info_png).iccp_defined != 0 {
                            let mut gray_icc: libc::c_uint = isGrayICCProfile(
                                (*info_png).iccp_profile,
                                (*info_png).iccp_profile_size
                            );
                            let mut rgb_icc: libc::c_uint = isRGBICCProfile(
                                (*info_png).iccp_profile,
                                (*info_png).iccp_profile_size
                            );
                            let mut gray_png: libc::c_uint =
                                (info.color.colortype as libc::c_uint
                                    == LCT_GREY as libc::c_int as libc::c_uint
                                    || info.color.colortype as libc::c_uint
                                        == LCT_GREY_ALPHA as libc::c_int
                        ...
                        match current_block {
                            ...
                            _ => {
                                ...
                                {
                                    let mut converted: *mut libc::c_uchar =
                                        0 as *mut libc::c_uchar;
                                    let mut size: size_t = (w as size_t)
                                        .wrapping_mul(h as size_t)
                                        .wrapping_mul(lodepng_get_bpp(
                                            &mut info.color
                                        )
                                            as size_t)
                                        .wrapping_add(
                                                                                                                                                        ...
                                                                                                                                                        match current_block {
                                                                                                                                                            ...
                                                                                                                                                            _ => {
                                                                                                                                                                if (*state).encoder.add_id != 0 {
                                                                                                                                                                    let mut already_added_id_text: libc::c_uint = 0
                                                                                                                                                                        as libc::c_int as libc::c_uint;
                                                                                                                                                                    i = 0 as libc::c_int as size_t;
                                                                                                                                                                    while i != info.text_num {
...
pub unsafe extern "C" fn lodepng_encode_file(
    ...
    let mut buffer: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    let mut buffersize: size_t = 0;
    let mut error: libc::c_uint = lodepng_encode_memory(
        &mut buffer,
        &mut buffersize,
        image,
        w,
...
pub unsafe extern "C" fn lodepng_encoder_settings_init(
    ...
    (*settings).predefined_filters = 0 as *const libc::c_uchar;
...
pub unsafe extern "C" fn lodepng_error_text(
    ...
    match code {
        0 => {
            return b"no error, everything went ok\0" as *const u8
                as *const libc::c_char
        }
        1 => return b"nothing done yet\0" as *const u8 as *const libc::c_char,
        10 => {
            return b"end of input memory reached without huffman end code\0"
        ...
        13 => {
            return b"problem while processing dynamic deflate block\0"
                as *const u8 as *const libc::c_char;
        }
        14 => {
            return b"problem while processing dynamic deflate block\0"
        ...
        16 => {
            return b"invalid code while processing dynamic deflate block\0"
                as *const u8 as *const libc::c_char;
        }
        17 => {
            return b"end of out buffer memory reached while inflating\0"
                as *const u8 as *const libc::c_char;
        }
        18 => {
        ...
        23 => {
            return b"end of in buffer memory reached while inflating\0"
                as *const u8 as *const libc::c_char;
        }
        24 => {
            return b"invalid FCHECK in zlib header\0" as *const u8
                as *const libc::c_char;
        }
        25 => {
        ...
        28 => {
            return b"incorrect PNG signature, it's no PNG or corrupted\0"
                as *const u8 as *const libc::c_char;
        }
        29 => {
        ...
        31 => {
            return b"illegal PNG color type or bpp\0" as *const u8
                as *const libc::c_char;
        }
        32 => {
        ...
        33 => {
            return b"illegal PNG filter method\0" as *const u8
                as *const libc::c_char
        }
        34 => {
            return b"illegal PNG interlace method\0" as *const u8
                as *const libc::c_char;
        }
        35 => {
        ...
        40 => {
            return b"tRNS chunk has wrong size for grayscale image\0"
                as *const u8 as *const libc::c_char;
        }
        41 => {
        ...
        44 => {
            return b"bKGD chunk has wrong size for grayscale image\0"
                as *const u8 as *const libc::c_char;
        }
        45 => {
        ...
        51 => {
            return b"jumped past memory while inflating huffman block\0"
                as *const u8 as *const libc::c_char;
        }
        52 => {
        ...
        53 => {
            return b"size of zlib data too small\0" as *const u8
                as *const libc::c_char
        }
        54 => {
        ...
        55 => {
            return b"jumped past tree while generating huffman tree\0"
                as *const u8 as *const libc::c_char;
        }
        56 => {
        ...
        62 => {
            return b"conversion from color to grayscale not supported\0"
                as *const u8 as *const libc::c_char;
        }
        63 => {
        ...
        73 => {
            return b"invalid tIME chunk size\0" as *const u8
                as *const libc::c_char
        }
        74 => {
            return b"invalid pHYs chunk size\0" as *const u8
                as *const libc::c_char
        }
        75 => {
        ...
        76 => {
            return b"iTXt chunk too short to contain required bytes\0"
                as *const u8 as *const libc::c_char;
        }
        77 => {
        ...
        86 => {
            return b"impossible offset in lz77 encoding (internal bug)\0"
                as *const u8 as *const libc::c_char;
        }
        87 => {
        ...
        95 => {
            return b"integer overflow with combined idat chunk size\0"
                as *const u8 as *const libc::c_char;
        }
        96 => {
            return b"invalid gAMA chunk size\0" as *const u8
                as *const libc::c_char
        }
        97 => {
            return b"invalid cHRM chunk size\0" as *const u8
                as *const libc::c_char
        }
        98 => {
            return b"invalid sRGB chunk size\0" as *const u8
                as *const libc::c_char
        }
        99 => {
            return b"invalid sRGB rendering intent\0" as *const u8
                as *const libc::c_char;
        }
        100 => {
        ...
        105 => {
            return b"integer overflow of bitsize\0" as *const u8
                as *const libc::c_char;
        }
        106 => {
        ...
        108 => {
            return b"tried to add more than 256 values to a palette\0"
                as *const u8 as *const libc::c_char;
        }
        109 => {
        ...
        115 => {
            return b"sBIT value out of range\0" as *const u8
                as *const libc::c_char
        }
        _ => {}
    }
...
unsafe extern "C" fn run_static_initializers() {
    mask = ((1 as libc::c_uint) << 9 as libc::c_uint)
        .wrapping_sub(1 as libc::c_uint);
}
#[used]
