...
unsafe extern "C" fn rgba_from_hex6_string(
...
unsafe extern "C" fn rgba_from_hex3_string(
    mut str: *const libc::c_char
) -> int32_t {
    return rgba_from_rgb(
        ((h(*str.offset(0 as libc::c_int as isize)) << 4 as libc::c_int)
...
unsafe extern "C" fn rgba_from_rgb_string(
            ...
            as *const libc::c_char
    {
        ...
        let mut g: uint8_t = 0 as libc::c_int as uint8_t;
            ...
            as *const libc::c_char
    {
            ...
            && *str as libc::c_int <= '9' as i32
        {
            ...
            if '.' as i32 == *str as libc::c_int {
                str = str.offset(1);
                str;
                let mut n: libc::c_float = 0.1f64 as libc::c_float;
                while *str as libc::c_int >= '0' as i32
                    && *str as libc::c_int <= '9' as i32
                {
                    let fresh6 = str;
                    str = str.offset(1);
                    a += (*fresh6 as libc::c_int - '0' as i32) as libc::c_float
                        * n;
...
unsafe extern "C" fn rgba_from_name_string(
    ...
    let mut color: named_color = named_color {
        name: 0 as *const libc::c_char,
        val: 0
    };
    loop {
...
pub unsafe extern "C" fn rgba_from_string(
    ...
    if '#' as i32 == *str.offset(0 as libc::c_int as isize) as libc::c_int {
        str = str.offset(1);
        return rgba_from_hex_string(str, ok) as uint32_t;
    }
    if str
        == strstr(str, b"rgba\0" as *const u8 as *const libc::c_char)
            as *const libc::c_char
    {
        return rgba_from_rgba_string(str, ok) as uint32_t;
    }
    if str
        == strstr(str, b"rgb\0" as *const u8 as *const libc::c_char)
            as *const libc::c_char
    {
        return rgba_from_rgb_string(str, ok) as uint32_t;
    }
    return rgba_from_name_string(str, ok) as uint32_t;
}
#[no_mangle]
