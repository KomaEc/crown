...
#[no_mangle]
pub static mut malloc_fn: Option<
...
> = None;
#[no_mangle]
pub static mut free_fn: Option<unsafe extern "C" fn(*mut libc::c_void) -> ()> =
    None;
...
pub unsafe extern "C" fn binn_get_type_info(
    ...
    loop {
        if long_type < 0 as libc::c_int {
            current_block_11 = 11858161930907115351;
            break;
        }
        ...
        224 | 225 | 226 => {
            if !(item.is_null() || size < 0 as libc::c_int) {
                if size < 3 as libc::c_int {
                    if !pointer.is_null() {
                        current_block = 4797132336821304963;
                    } else {
...
pub unsafe extern "C" fn binn_new(
    ...
    item = binn_malloc(
        ::core::mem::size_of::<binn>() as libc::c_ulong as libc::c_int
    ) as *mut binn;
...
pub unsafe extern "C" fn binn_copy(mut old: *mut libc::c_void) -> *mut binn {
    ...
    if !item.is_null() {
        ...
        dest = ((*item).pbuf as *mut libc::c_uchar)
...
unsafe extern "C" fn binn_get_ptr_type(
...
unsafe extern "C" fn CheckAllocation(
    ...
    if (*item).used_size + add_size > (*item).alloc_size {
        ...
        alloc_size =
            CalcAllocation((*item).used_size + add_size, (*item).alloc_size);
        ptr = realloc_fn.expect("non-null function pointer")(
            (*item).pbuf,
    ...
    match storage_type {
        ...
        192 | 160 => {
            ...
            if DataSize & 0x80 as libc::c_int != 0 {
                if p.offset(::core::mem::size_of::<libc::c_int>()
...
unsafe extern "C" fn read_map_id(
    ...
    if c as libc::c_int & 0x80 as libc::c_int != 0 {
        extra_bytes = ((c as libc::c_int & 0x60 as libc::c_int)
            >> 5 as libc::c_int)
            + 1 as libc::c_int;
...
unsafe extern "C" fn binn_list_add_raw(
    ...
    if item.is_null()
        || (*item).type_0 != 0xe0 as libc::c_int
...
unsafe extern "C" fn binn_object_set_raw(
    ...
    let mut int32: libc::c_int = 0;
    if item.is_null()
        || (*item).type_0 != 0xe2 as libc::c_int
        || (*item).writable == 0 as libc::c_int
    {
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn binn_map_set_raw(
    ...
    if item.is_null()
        || (*item).type_0 != 0xe1 as libc::c_int
        || (*item).writable == 0 as libc::c_int
    {
        return 0 as libc::c_int;
    }
    ...
    base =
        ((*item).pbuf as *mut libc::c_uchar).offset((*item).used_size as isize);
    p = base;
    ...
    if id <= 0x3f as libc::c_int {
        ...
        p = p.offset(1);
        *fresh7 =
            ((sign as libc::c_int) << 6 as libc::c_int | id) as libc::c_uchar;
    } else if id <= 0xfff as libc::c_int {
        let fresh8 = p;
        p = p.offset(1);
        *fresh8 = (0x80 as libc::c_int
            | (sign as libc::c_int) << 4 as libc::c_int
            | (id & 0xf00 as libc::c_int) >> 8 as libc::c_int)
            as libc::c_uchar;
        let fresh9 = p;
        p = p.offset(1);
        *fresh9 = (id & 0xff as libc::c_int) as libc::c_uchar;
        ...
        let fresh10 = p;
        p = p.offset(1);
        *fresh10 = (0xa0 as libc::c_int
            | (sign as libc::c_int) << 4 as libc::c_int
            | (id & 0xf0000 as libc::c_int) >> 16 as libc::c_int)
            as libc::c_uchar;
        let fresh11 = p;
        p = p.offset(1);
        *fresh11 =
            ((id & 0xff00 as libc::c_int) >> 8 as libc::c_int) as libc::c_uchar;
        let fresh12 = p;
        p = p.offset(1);
        *fresh12 = (id & 0xff as libc::c_int) as libc::c_uchar;
        ...
        let fresh13 = p;
        p = p.offset(1);
        *fresh13 = (0xc0 as libc::c_int
            | (sign as libc::c_int) << 4 as libc::c_int
            | (id & 0xf000000 as libc::c_int) >> 24 as libc::c_int)
            as libc::c_uchar;
        let fresh14 = p;
        p = p.offset(1);
...
unsafe extern "C" fn compress_int(
    ...
    match type_0 {
        129 => {
            ...
            current_block = 15295662544502615925;
        }
        97 => {
        ...
        128 => {
            ...
            current_block = 17766252300826090618;
        }
        96 => {
    ...
    match current_block {
        15295662544502615925 => {
            if vint >= 0 as libc::c_int as libc::c_longlong {
                ...
                current_block = 12906009042393451248;
            }
        }
        _ => {}
    }
    match current_block {
        17766252300826090618 => {
...
unsafe extern "C" fn AddValue(
    ...
    if pvalue.is_null() {
        ...
        match storage_type {
            ...
            192 | 160 => {
                if size == 0 as libc::c_int {
                    ...
                    current_block_1 = 11602238243463217035;
                }
            }
            _ => {
                current_block_1 = 11602238243463217035;
        ...
        match current_block_1 {
            11602238243463217035 => return 0 as libc::c_int,
            _ => {}
        }
    }
    ...
    match storage_type {
        ...
        192 | 160 => {
            if size > 127 as libc::c_int {
                ...
                copy_be32(
                    p as *mut u32_0,
                    &mut int32 as *mut libc::c_int as *mut u32_0
                );
                p = p.offset(4 as libc::c_int as isize);
                (*item).used_size += 4 as libc::c_int;
            } else {
...
unsafe extern "C" fn binn_save_header(mut item: *mut binn) -> BOOL {
    ...
    if size > 127 as libc::c_int {
        ...
        size += 3 as libc::c_int;
        int32 =
            (size as libc::c_uint | 0x80000000 as libc::c_uint) as libc::c_int;
        copy_be32(
            p as *mut u32_0,
            &mut int32 as *mut libc::c_int as *mut u32_0
        );
...
#[no_mangle]
pub unsafe extern "C" fn binn_release(
    mut item: *mut binn
) -> *mut libc::c_void {
...
unsafe extern "C" fn binn_buf_count(
    mut pbuf: *mut libc::c_void
) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn binn_ptr(
    mut ptr: *mut libc::c_void
) -> *mut libc::c_void {
    let mut item: *mut binn = 0 as *mut binn;
...
pub unsafe extern "C" fn binn_is_valid_ex(
    ...
    loop {
        ...
        p = AdvanceDataPos(p, plimit);
        if p.is_null() || p < base {
            current_block = 3564554444376242489;
            break;
        }
        i += 1;
        i;
    ...
    match current_block {
        3564554444376242489 => return 0 as libc::c_int,
        _ => {
            if !ptype.is_null() && *ptype == 0 as libc::c_int {
                *ptype = type_0;
            }
...
unsafe extern "C" fn GetValue(
    ...
    match storage_type {
        ...
        64 => {
            copy_be16(
                &mut (*value).c2rust_unnamed.vint16 as *mut libc::c_short
                    as *mut u16_0,
                p as *mut u16_0
            );
            (*value).ptr = &mut (*value).c2rust_unnamed.vint16
                as *mut libc::c_short
                as *mut libc::c_void;
        }
        96 => {
            copy_be32(
                &mut (*value).c2rust_unnamed.vint32 as *mut libc::c_int
                    as *mut u32_0,
                p as *mut u32_0
            );
            (*value).ptr = &mut (*value).c2rust_unnamed.vint32
                as *mut libc::c_int
                as *mut libc::c_void;
        }
        128 => {
            ...
            (*value).ptr = &mut (*value).c2rust_unnamed.vint64 as *mut int64
                as *mut libc::c_void;
        }
        192 | 160 => {
            DataSize = *p as libc::c_int;
    ...
    match (*value).type_0 {
        1 => {
            ...
            (*value).ptr = &mut (*value).c2rust_unnamed.vbool as *mut BOOL
                as *mut libc::c_void;
        }
        2 => {
            (*value).type_0 = 0x80061 as libc::c_int;
...
pub unsafe extern "C" fn binn_list_get_value(
    ...
    if (pos <= 0 as libc::c_int) as libc::c_int | (pos > count) as libc::c_int
        != 0
    {
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn binn_read_pair(
    ...
    loop {
        ...
        counter;
        if counter == pos {
            current_block = 15530421160816212177;
            break;
        }
        p = AdvanceDataPos(p, plimit);
        if p.is_null() || p < base {
...
pub unsafe extern "C" fn binn_list_next(
    ...
    if iter.is_null()
        ...
        || (*iter).type_0 != 0xe0 as libc::c_int
    {
        return 0 as libc::c_int;
    }
    (*iter).current += 1;
...
#[no_mangle]
pub unsafe extern "C" fn binn_list_next_value(
    mut iter: *mut binn_iter
) -> *mut binn {
    let mut value: *mut binn = 0 as *mut binn;
    value = binn_malloc(
...
unsafe extern "C" fn GetWriteConvertedData(
    ...
    if (*ppvalue).is_null() {
        ...
        match type_0 {
            ...
            160 | 192 => {
                if *psize == 0 as libc::c_int {
                    ...
                    current_block_4 = 9015328886699256131;
                }
            }
            _ => {
                current_block_4 = 9015328886699256131;
        ...
        match current_block_4 {
            9015328886699256131 => return 0 as libc::c_int,
            _ => {}
        }
    }
    match type_0 {
...
unsafe extern "C" fn type_family(mut type_0: libc::c_int) -> libc::c_int {
    match type_0 {
        ...
        98 | 130 => {}
        166 | 167 => {}
        160 | 45057 | 45061 | 45058 | 45059 | 45060 => {
            return 0xf4 as libc::c_int
        }
...
unsafe extern "C" fn copy_float_value(
    ...
    match source_type {
        98 => {
            *(pdest as *mut libc::c_double) =
                *(psource as *mut libc::c_float) as libc::c_double;
        }
        130 => {
            *(pdest as *mut libc::c_float) =
                *(psource as *mut libc::c_double) as libc::c_float;
        }
        _ => return 0 as libc::c_int
    }
    return 1 as libc::c_int;
...
unsafe extern "C" fn copy_value(
    ...
    if type_family(source_type) == 0xf2 as libc::c_int
        && source_type != dest_type
    {
        return copy_int_value(psource, pdest, source_type, dest_type);
    } else if type_family(source_type) == 0xf3 as libc::c_int
        && source_type != dest_type
    {
...
pub unsafe extern "C" fn binn_list_add(
    ...
    if GetWriteConvertedData(&mut type_0, &mut pvalue, &mut size)
        == 0 as libc::c_int
    {
        return 0 as libc::c_int;
    }
    ...
    if !item.is_null() {
        ...
        match storage_type {
            ...
            160 => {
                ...
                current_block_19 = 17577394992057524319;
            }
            192 | 224 => {
                current_block_19 = 17577394992057524319;
            }
            _ => {
                (*item).ptr = &mut (*item).c2rust_unnamed.vint32
                    as *mut libc::c_int
                    as *mut libc::c_void;
...
pub unsafe extern "C" fn binn_get_int32(
    ...
    match (*value).type_0 {
        98 => {
            ...
            *pint =
                if (*value).c2rust_unnamed.vfloat as libc::c_double >= 0.0f64 {
        ...
        160 => {
            if is_integer((*value).ptr as *mut libc::c_char) != 0 {
                ...
                *pint = if atof((*value).ptr as *mut libc::c_char) >= 0.0f64 {
                    (atof((*value).ptr as *mut libc::c_char) + 0.5f64)
                        as libc::c_int
...
pub unsafe extern "C" fn binn_get_int64(
    ...
    match (*value).type_0 {
        98 => {
            ...
            *pint = (if (*value).c2rust_unnamed.vfloat as libc::c_double
                >= 0.0f64
            {
                ((*value).c2rust_unnamed.vfloat as libc::c_double + 0.5f64)
                    as libc::c_int
...
pub unsafe extern "C" fn binn_get_double(
    ...
    match (*value).type_0 {
        ...
        160 => {
            if is_integer((*value).ptr as *mut libc::c_char) != 0 {
                *pfloat =
                    atoi64((*value).ptr as *mut libc::c_char) as libc::c_double;
            } else if is_float((*value).ptr as *mut libc::c_char) != 0 {
...
#[no_mangle]
pub unsafe extern "C" fn binn_get_str(
    mut value: *mut binn
) -> *mut libc::c_char {
    let mut current_block: u64;
    let mut vint: int64 = 0;
    ...
    if type_family((*value).type_0) == 0xf2 as libc::c_int {
        ...
        match (*value).type_0 {
            98 => {
                (*value).c2rust_unnamed.vdouble =
                    (*value).c2rust_unnamed.vfloat as libc::c_double;
                current_block = 1060014361662474860;
            }
            130 => {
                current_block = 1060014361662474860;
            }
            ...
            524385 => {
                ...
                current_block = 12855249268702453289;
            }
            _ => return 0 as *mut libc::c_char
        }
        match current_block {
            12855249268702453289 => {}
            _ => {
                snprintf(
                    buf.as_mut_ptr(),
