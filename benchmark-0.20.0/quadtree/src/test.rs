...
extern "C" {
    ...
    fn quadtree_bounds_extend(bounds: *mut quadtree_bounds_t, x: libc::c_double, y: libc::c_double);
...
unsafe extern "C" fn test_node() {
    ...
    if quadtree_node_isleaf(node) == 0 {
        ...
        __assert_fail(
            ...
            (*::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"void test_node()\0"))
                .as_ptr(),
        );
    };
...
unsafe extern "C" fn test_bounds() {
    ...
    if !bounds.is_null() {
        ...
        __assert_fail(
            ...
            (*::core::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"void test_bounds()\0"))
                .as_ptr(),
        );
    };
    if (*(*bounds).nw).x == ::core::f32::INFINITY as libc::c_double {
    } else {
        __assert_fail(
    ...
    if (*(*bounds).se).x == -::core::f32::INFINITY as libc::c_double {
    } else {
        __assert_fail(
...
unsafe extern "C" fn test_tree() {
    ...
    if (*(*(*(*tree).root).bounds).nw).x == 1 as libc::c_int as libc::c_double {
        ...
        __assert_fail(
            ...
            (*::core::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"void test_tree()\0"))
                .as_ptr(),
        );
    };
...
unsafe extern "C" fn test_points() {
    ...
    if (*point).x == 5 as libc::c_int as libc::c_double {
        ...
        __assert_fail(
            ...
            (*::core::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"void test_points()\0"))
                .as_ptr(),
        );
    };
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *const libc::c_char) -> libc::c_int {
    printf(
        b"\nquadtree_t: %ld\n\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<quadtree_t>() as libc::c_ulong,
    );
    printf(
        b"quadtree_node_t: %ld\n\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<quadtree_node_t>() as libc::c_ulong,
    );
    printf(
        b"quadtree_bounds_t: %ld\n\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<quadtree_bounds_t>() as libc::c_ulong,
    );
    printf(
        b"quadtree_point_t: %ld\n\0" as *const u8 as *const libc::c_char,
        ::core::mem::size_of::<quadtree_point_t>() as libc::c_ulong,
    );
