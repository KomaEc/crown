...
pub unsafe extern "C" fn BrotliBuildCodeLengthsHuffmanTable(
    ...
    loop {
        ...
        while bits_count != 0 as libc::c_int {
            ...
            ReplicateValue(
                &mut *table.offset((BrotliReverseBits
                    as unsafe extern "C" fn(uint64_t) -> uint64_t)(
                    key
                ) as isize),
                step,
                table_size,
...
pub unsafe extern "C" fn BrotliBuildHuffmanTable(
    ...
    let mut code: HuffmanCode = HuffmanCode { bits: 0, value: 0 };
    let mut table: *mut HuffmanCode = 0 as *mut HuffmanCode;
    ...
    let mut max_length: libc::c_int = -(1 as libc::c_int);
    let mut bits: libc::c_int = 0;
    let mut bits_count: libc::c_int = 0;
    ...
    while total_size != table_size {
        memcpy(
            &mut *table.offset(table_size as isize) as *mut HuffmanCode
                as *mut libc::c_void,
            &mut *table.offset(0 as libc::c_int as isize) as *mut HuffmanCode
    ...
    while len <= max_length {
        ...
        while *count.offset(len as isize) as libc::c_int != 0 as libc::c_int {
            ...
            sub_key = (sub_key as libc::c_ulong).wrapping_add(sub_key_step)
...
pub unsafe extern "C" fn BrotliBuildSimpleHuffmanTable(
    ...
    let mut table_size: uint32_t = 1 as libc::c_int as uint32_t;
    let goal_size: uint32_t = (1 as libc::c_uint) << root_bits;
    match num_symbols {
        0 => {
            *table.offset(0 as libc::c_int as isize) = ConstructHuffmanCode(
                0 as libc::c_int as uint8_t,
        ...
        1 => {
                ...
                > *val.offset(0 as libc::c_int as isize) as libc::c_int
            {
                ...
                *table.offset(1 as libc::c_int as isize) = ConstructHuffmanCode(
                    1 as libc::c_int as uint8_t,
        ...
        2 => {
            ...
            *table.offset(2 as libc::c_int as isize) = ConstructHuffmanCode(
                1 as libc::c_int as uint8_t,
                *val.offset(0 as libc::c_int as isize)
            );
                ...
                > *val.offset(1 as libc::c_int as isize) as libc::c_int
            {
                ...
                *table.offset(3 as libc::c_int as isize) = ConstructHuffmanCode(
                    2 as libc::c_int as uint8_t,
        ...
        4 => {
            ...
            {
                let mut t_0: uint16_t = *val.offset(3 as libc::c_int as isize);
                *val.offset(3 as libc::c_int as isize) =
                    *val.offset(2 as libc::c_int as isize);
            ...
            *table.offset(4 as libc::c_int as isize) = ConstructHuffmanCode(
                1 as libc::c_int as uint8_t,
                *val.offset(0 as libc::c_int as isize)
            );
            *table.offset(5 as libc::c_int as isize) = ConstructHuffmanCode(
                2 as libc::c_int as uint8_t,
                *val.offset(1 as libc::c_int as isize)
            );
            *table.offset(6 as libc::c_int as isize) = ConstructHuffmanCode(
                1 as libc::c_int as uint8_t,
                *val.offset(0 as libc::c_int as isize)
            );
            *table.offset(7 as libc::c_int as isize) = ConstructHuffmanCode(
                3 as libc::c_int as uint8_t,
                *val.offset(3 as libc::c_int as isize)
            );
