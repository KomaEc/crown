...
extern "C" {
    ...
    fn BrotliDecoderStateCleanupAfterMetablock(
        s: *mut BrotliDecoderStateInternal
    );
...
pub const BROTLI_DECODER_ERROR_FORMAT_BLOCK_LENGTH_1: BrotliDecoderErrorCode =
    -9;
pub const BROTLI_DECODER_ERROR_FORMAT_CONTEXT_MAP_REPEAT:
...
pub const BROTLI_DECODER_ERROR_FORMAT_SIMPLE_HUFFMAN_SAME:
    BrotliDecoderErrorCode = -5;
pub const BROTLI_DECODER_ERROR_FORMAT_SIMPLE_HUFFMAN_ALPHABET:
    BrotliDecoderErrorCode = -4;
pub const BROTLI_DECODER_ERROR_FORMAT_EXUBERANT_META_NIBBLE:
...
pub const BROTLI_DECODER_PARAM_DISABLE_RING_BUFFER_REALLOCATION:
...
#[inline(always)]
unsafe extern "C" fn BrotliGetAvailableBits(
...
#[inline(always)]
unsafe extern "C" fn BrotliGetRemainingBytes(
    ...
    return ((*br).avail_in).wrapping_add(
        (BrotliGetAvailableBits(br) >> 3 as libc::c_int) as libc::c_ulong
    );
}
#[inline(always)]
...
unsafe extern "C" fn BrotliFillBitWindow(
        ...
        && n_bits <= 16 as libc::c_int as libc::c_uint
    {
        if (*br).bit_pos_ >= 48 as libc::c_int as libc::c_uint {
            ...
            (*br).bit_pos_ ^= 48 as libc::c_int as libc::c_uint;
            (*br).val_ |=
                BrotliUnalignedRead64((*br).next_in as *const libc::c_void)
                    << 16 as libc::c_int;
            (*br).avail_in = ((*br).avail_in as libc::c_ulong)
        ...
        (*br).bit_pos_ ^= 32 as libc::c_int as libc::c_uint;
        (*br).val_ |=
            (BrotliUnalignedRead32((*br).next_in as *const libc::c_void)
                as uint64_t)
                << 32 as libc::c_int;
        (*br).avail_in = ((*br).avail_in as libc::c_ulong).wrapping_sub(
            ::core::mem::size_of::<uint64_t>() as libc::c_ulong
                >> 1 as libc::c_int
        ) as size_t as size_t;
        (*br).next_in = ((*br).next_in).offset(
            (::core::mem::size_of::<uint64_t>() as libc::c_ulong
...
unsafe extern "C" fn BrotliPullByte(br: *mut BrotliBitReader) -> libc::c_int {
    ...
    (*br).bit_pos_ = ((*br).bit_pos_ as libc::c_uint)
...
#[inline(always)]
unsafe extern "C" fn BrotliGetBitsUnmasked(
    br: *mut BrotliBitReader
) -> uint64_t {
    return (*br).val_ >> (*br).bit_pos_;
}
#[inline(always)]
unsafe extern "C" fn BrotliGet16BitsUnmasked(
    br: *mut BrotliBitReader
) -> uint32_t {
...
#[inline(always)]
unsafe extern "C" fn BrotliDropBits(
    br: *mut BrotliBitReader,
    mut n_bits: uint32_t
) {
    (*br).bit_pos_ = ((*br).bit_pos_ as libc::c_uint).wrapping_add(n_bits)
        as uint32_t as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn BrotliBitReaderUnload(mut br: *mut BrotliBitReader) {
    let mut unused_bytes: uint32_t =
        BrotliGetAvailableBits(br) >> 3 as libc::c_int;
    let mut unused_bits: uint32_t = unused_bytes << 3 as libc::c_int;
    (*br).avail_in = ((*br).avail_in as libc::c_ulong)
        .wrapping_add(unused_bytes as libc::c_ulong)
        as size_t as size_t;
    ...
    (*br).bit_pos_ = ((*br).bit_pos_ as libc::c_uint).wrapping_add(unused_bits)
        as uint32_t as uint32_t;
}
#[inline(always)]
...
unsafe extern "C" fn BrotliJumpToByteBoundary(
    ...
    let mut pad_bits_count: uint32_t =
        BrotliGetAvailableBits(br) & 0x7 as libc::c_int as libc::c_uint;
...
unsafe extern "C" fn BrotliCopyBytes(
    ...
    (*br).avail_in =
        ((*br).avail_in as libc::c_ulong).wrapping_sub(num) as size_t as size_t;
...
unsafe extern "C" fn BrotliCalculateDistanceCodeLimit(
    ...
    if max_distance <= ndirect {
        result.max_alphabet_size =
            max_distance.wrapping_add(16 as libc::c_int as libc::c_uint);
        result.max_distance = max_distance;
        return result;
    } else {
        let mut forbidden_distance: uint32_t =
            max_distance.wrapping_add(1 as libc::c_int as libc::c_uint);
        ...
        offset =
            (offset >> npostfix).wrapping_add(4 as libc::c_int as libc::c_uint);
        ...
        if group == 0 as libc::c_int as libc::c_uint {
            result.max_alphabet_size =
                ndirect.wrapping_add(16 as libc::c_int as libc::c_uint);
        ...
        start = (start as libc::c_uint).wrapping_add(
            (group & 1 as libc::c_int as libc::c_uint) << ndistbits
        ) as uint32_t as uint32_t;
...
pub unsafe extern "C" fn BrotliDecoderCreateInstance(
    ...
    let mut state: *mut BrotliDecoderStateInternal =
        0 as *mut BrotliDecoderStateInternal;
    if alloc_func.is_none() && free_func.is_none() {
        state = malloc(::core::mem::size_of::<BrotliDecoderStateInternal>()
            as libc::c_ulong)
        ...
        state = alloc_func.expect("non-null function pointer")(
            opaque,
            ::core::mem::size_of::<BrotliDecoderStateInternal>()
                as libc::c_ulong
        ) as *mut BrotliDecoderStateInternal;
    }
    if state.is_null() {
...
unsafe extern "C" fn DecodeVarLenUint8(
    ...
    match (*s).substate_decode_uint8 as libc::c_uint {
        0 => {
            ...
            current_block_24 = 9323842210504078893;
        }
        1 => {
            current_block_24 = 9323842210504078893;
        }
        2 => {
            current_block_24 = 9679648470872178802;
        }
        _ => {
    ...
    match current_block_24 {
        9323842210504078893 => {
            if (BrotliSafeReadBits(br, 3 as libc::c_int as uint32_t, &mut bits)
                == 0) as libc::c_int as libc::c_long
                != 0
            {
    ...
    if (BrotliSafeReadBits(br, *value, &mut bits) == 0) as libc::c_int
        as libc::c_long
        != 0
    {
            ...
            match (*s).substate_metablock_header as libc::c_uint {
                0 => {
                    ...
                    if (*s).is_last_metablock() == 0 {
                        ...
                        current_block_76 = 8617618040855383894;
                    }
                }
                1 => {
                    current_block_76 = 8617618040855383894;
                ...
                2 => {
                    current_block_76 = 4222273867521650206;
                }
                3 => {
                    current_block_76 = 17141847291507581888;
                }
                4 => {
                    current_block_76 = 2543433949246530298;
                }
                5 => {
                    if BrotliSafeReadBits(
                        br,
                    ...
                    current_block_76 = 11094396523783428818;
                }
                6 => {
                    current_block_76 = 11094396523783428818;
                }
                7 => {
                    current_block_76 = 6262008577735007844;
                }
                _ => {
                    return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                        as BrotliDecoderErrorCode;
...
unsafe extern "C" fn DecodeSymbol(
    ...
    if (*table).bits as libc::c_uint > 8 as libc::c_uint {
        let mut nbits: uint32_t =
            ((*table).bits as libc::c_uint).wrapping_sub(8 as libc::c_uint);
        BrotliDropBits(br, 8 as libc::c_uint);
        table = table.offset(
            ((*table).value as libc::c_uint)
                .wrapping_add(bits >> 8 as libc::c_uint & BitMask(nbits))
                as isize
        );
    }
...
unsafe extern "C" fn SafeDecodeSymbol(
    ...
    available_bits = (available_bits as libc::c_uint)
        .wrapping_sub(8 as libc::c_uint) as uint32_t
        as uint32_t;
    table = table
        .offset(((*table).value as libc::c_uint).wrapping_add(val) as isize);
    if available_bits < (*table).bits as libc::c_uint {
        return 0 as libc::c_int;
    }
    BrotliDropBits(
        br,
        (8 as libc::c_uint).wrapping_add((*table).bits as libc::c_uint)
    );
    *result = (*table).value as uint32_t;
    return 1 as libc::c_int;
}
...
unsafe extern "C" fn ReadPreloadedSymbol(
    ...
    if (*bits > 8 as libc::c_uint) as libc::c_int as libc::c_long != 0 {
        ...
        let mut mask: uint32_t =
            BitMask((*bits).wrapping_sub(8 as libc::c_uint));
        BrotliDropBits(br, 8 as libc::c_uint);
...
unsafe extern "C" fn ReadSimpleHuffmanSymbols(
    ...
    while i <= num_symbols {
        ...
        if (BrotliSafeReadBits(br, max_bits, &mut v) == 0) as libc::c_int
            as libc::c_long
            != 0
        {
    ...
    while i < num_symbols {
        let mut k: uint32_t = i.wrapping_add(1 as libc::c_int as libc::c_uint);
        while k <= num_symbols {
...
unsafe extern "C" fn ProcessSingleCodeLength(
    ...
    *repeat = 0 as libc::c_int as uint32_t;
    if code_len != 0 as libc::c_int as libc::c_uint {
        *symbol_lists.offset(*next_symbol.offset(code_len as isize) as isize) =
            *symbol as uint16_t;
        *next_symbol.offset(code_len as isize) = *symbol as libc::c_int;
        *prev_code_len = code_len;
        *space = (*space as libc::c_uint)
            .wrapping_sub(32768 as libc::c_uint >> code_len)
            as uint32_t as uint32_t;
...
unsafe extern "C" fn ProcessRepeatedCodeLength(
    ...
    *repeat = (*repeat as libc::c_uint)
        .wrapping_add(repeat_delta.wrapping_add(3 as libc::c_uint))
        as uint32_t as uint32_t;
    ...
    if *repeat_code_len != 0 as libc::c_int as libc::c_uint {
        ...
        *space = (*space as libc::c_uint).wrapping_sub(
            repeat_delta
                << (15 as libc::c_int as libc::c_uint)
                    .wrapping_sub(*repeat_code_len)
        ) as uint32_t as uint32_t;
        ...
        *symbol = (*symbol as libc::c_uint).wrapping_add(repeat_delta)
            as uint32_t as uint32_t;
    };
}
unsafe extern "C" fn ReadSymbolCodeLengths(
    ...
    let mut code_length_histo: *mut uint16_t =
    ...
    while symbol < alphabet_size && space > 0 as libc::c_int as libc::c_uint {
        ...
        p = p.offset(
            (BrotliGetBitsUnmasked(br)
                & BitMask(5 as libc::c_int as uint32_t) as libc::c_ulong)
                as isize
        );
        ...
        if code_len < 16 as libc::c_int as libc::c_uint {
            ...
            let mut extra_bits: uint32_t =
                (if code_len == 16 as libc::c_int as libc::c_uint {
                    2 as libc::c_int
                } else {
                    3 as libc::c_int
                }) as uint32_t;
            let mut repeat_delta: uint32_t =
                BrotliGetBitsUnmasked(br) as uint32_t & BitMask(extra_bits);
...
unsafe extern "C" fn SafeReadSymbolCodeLengths(
    ...
    while (*h).symbol < alphabet_size
        && (*h).space > 0 as libc::c_int as libc::c_uint
    {
        let mut p: *const HuffmanCode = ((*h).table).as_mut_ptr();
        let mut code_len: uint32_t = 0;
        ...
        if (*p).bits as libc::c_uint > available_bits {
            ...
            if code_len < 16 as libc::c_int as libc::c_uint {
                ...
                let mut extra_bits: uint32_t =
                    code_len.wrapping_sub(14 as libc::c_uint);
                let mut repeat_delta: uint32_t =
                    bits >> (*p).bits as libc::c_int & BitMask(extra_bits);
                if available_bits
...
unsafe extern "C" fn ReadCodeLengthCodeLengths(
    ...
    while i < (17 as libc::c_int + 1 as libc::c_int) as libc::c_uint {
            ...
            != 0
        {
            let mut available_bits: uint32_t = BrotliGetAvailableBits(br);
            if available_bits != 0 as libc::c_int as libc::c_uint {
                ix = (BrotliGetBitsUnmasked(br)
                    & 0xf as libc::c_int as libc::c_ulong)
                    as uint32_t;
            } else {
                ix = 0 as libc::c_int as uint32_t;
            }
            if kCodeLengthPrefixLength[ix as usize] as libc::c_uint
                > available_bits
            {
                (*h).sub_loop_counter = i;
                (*h).repeat = num_codes;
        ...
        if v != 0 as libc::c_int as libc::c_uint {
            ...
            (*h).code_length_histo[v as usize] =
                ((*h).code_length_histo[v as usize]).wrapping_add(1);
            (*h).code_length_histo[v as usize];
...
unsafe extern "C" fn ReadHuffmanCode(
    ...
    loop {
        match (*h).substate_huffman as libc::c_uint {
                ...
                if (*h).sub_loop_counter != 1 as libc::c_int as libc::c_uint {
                    ...
                    memset(
                        &mut *((*h).code_length_code_lengths)
                            ...
                            as *mut libc::c_void,
                        0 as libc::c_int,
                        ::core::mem::size_of::<[uint8_t; 18]>()
                            as libc::c_ulong
                    );
                    (*h).substate_huffman = BROTLI_STATE_HUFFMAN_COMPLEX;
                    continue;
                } else {
                    current_block_67 = 16572942433401275520;
                }
            }
            1 => {
                current_block_67 = 16572942433401275520;
            ...
            2 => {
                current_block_67 = 18392348048808250851;
            }
            3 => {
                current_block_67 = 17206139237818766924;
            }
            4 => {
                let mut i: uint32_t = 0;
                let mut result_0: BrotliDecoderErrorCode =
                    ReadCodeLengthCodeLengths(s);
                if result_0 as libc::c_int
                ...
                while i <= 15 as libc::c_int as libc::c_uint {
                    (*h).next_symbol[i as usize] = i as libc::c_int
                        - (15 as libc::c_int + 1 as libc::c_int);
                    *((*h).symbol_lists)
                        .offset((*h).next_symbol[i as usize] as isize) =
                ...
                current_block_67 = 16781121832208020375;
            }
            5 => {
                current_block_67 = 16781121832208020375;
            }
        ...
        match current_block_67 {
            ...
            16781121832208020375 => {
                ...
                {
                    result_1 =
                        SafeReadSymbolCodeLengths(alphabet_size_limit, s);
                }
                if result_1 as libc::c_int
                    != BROTLI_DECODER_SUCCESS as libc::c_int
                {
        ...
        if (*h).symbol == 3 as libc::c_int as libc::c_uint {
            ...
            (*h).symbol = ((*h).symbol as libc::c_uint).wrapping_add(bits)
                as uint32_t as uint32_t;
        }
...
unsafe extern "C" fn SafeReadBlockLength(
    ...
    let mut bits: uint32_t = 0;
    let mut nbits: uint32_t =
        _kBrotliPrefixCodeRanges[index as usize].nbits as uint32_t;
    let mut offset: uint32_t =
        _kBrotliPrefixCodeRanges[index as usize].offset as uint32_t;
    ...
    *mtf.offset(0 as libc::c_int as isize) = pattern;
    loop {
        pattern = (pattern as libc::c_uint)
            .wrapping_add(0x4040404 as libc::c_int as libc::c_uint)
            as uint32_t as uint32_t;
    ...
    while i < v_len {
        ...
        *mtf_u8.offset(-(1 as libc::c_int) as isize) = value;
        loop {
            index -= 1;
            index;
            *mtf_u8.offset((index + 1 as libc::c_int) as isize) =
...
unsafe extern "C" fn HuffmanTreeGroupDecode(
    ...
    while (*h).htree_index < (*group).num_htrees as libc::c_int {
        ...
        let ref mut fresh1 =
            *((*group).htrees).offset((*h).htree_index as isize);
        *fresh1 = (*h).next;
...
unsafe extern "C" fn DecodeContextMap(
    ...
    match (*h).substate_context_map as libc::c_int {
        0 => {
            ...
            *context_map_arg = ((*s).alloc_func)
            ...
            current_block_72 = 13882978475883770559;
        }
        1 => {
            current_block_72 = 13882978475883770559;
        }
        2 => {
            current_block_72 = 2586616891417325477;
        }
        3 => {
            current_block_72 = 3911658486967328820;
        }
        4 => {
            current_block_72 = 6274489265417849000;
        }
        _ => {
            return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                as BrotliDecoderErrorCode;
    ...
    match current_block_72 {
        13882978475883770559 => {
            let mut bits: uint32_t = 0;
            if BrotliSafeGetBits(br, 5 as libc::c_int as uint32_t, &mut bits)
                == 0
            {
                return BROTLI_DECODER_NEEDS_MORE_INPUT;
            }
    ...
    match current_block_72 {
        2586616891417325477 => {
            let mut alphabet_size: uint32_t =
    ...
    match current_block_72 {
        3911658486967328820 => {
            ...
            let mut max_run_length_prefix: uint32_t =
                (*h).max_run_length_prefix;
            let mut context_map: *mut uint8_t = *context_map_arg;
            let mut code: uint32_t = (*h).code;
            let mut skip_preamble: libc::c_int =
                (code != 0xffff as libc::c_int as libc::c_uint) as libc::c_int;
            while context_index < context_map_size || skip_preamble != 0 {
                if skip_preamble == 0 {
                    ...
                    if code == 0 as libc::c_int as libc::c_uint {
                        ...
                        *context_map.offset(fresh2 as isize) =
                            0 as libc::c_int as uint8_t;
                        continue;
                ...
                reps = (reps as libc::c_uint)
                    .wrapping_add((1 as libc::c_uint) << code)
                    as uint32_t as uint32_t;
                ...
                loop {
                    ...
                    context_index = context_index.wrapping_add(1);
                    *context_map.offset(fresh4 as isize) =
                        0 as libc::c_int as uint8_t;
...
unsafe extern "C" fn DecodeBlockTypeAndLength(
    ...
    let mut type_tree: *const HuffmanCode = &mut *((*s).block_type_trees)
        .offset((tree_type * 632 as libc::c_int) as isize)
        as *mut HuffmanCode;
    let mut len_tree: *const HuffmanCode = &mut *((*s).block_len_trees)
        .offset((tree_type * 396 as libc::c_int) as isize)
        as *mut HuffmanCode;
    let mut br: *mut BrotliBitReader = &mut (*s).br;
    let mut ringbuffer: *mut uint32_t = &mut *((*s).block_type_rb)
        .as_mut_ptr()
        .offset((tree_type * 2 as libc::c_int) as isize)
        as *mut uint32_t;
    ...
    *ringbuffer.offset(0 as libc::c_int as isize) =
...
unsafe extern "C" fn DetectTrivialLiteralBlockTypes(
    ...
    while i < 8 as libc::c_int as libc::c_ulong {
        (*s).trivial_literal_contexts[i as usize] =
    ...
    while i < (*s).num_block_types[0 as libc::c_int as usize] as libc::c_ulong {
        ...
        let mut sample: size_t =
            *((*s).context_map).offset(offset as isize) as size_t;
        let mut j: size_t = 0;
        ...
        while j < ((1 as libc::c_uint) << 6 as libc::c_int) as libc::c_ulong {
            if 4 as libc::c_int & 1 as libc::c_int != 0 as libc::c_int {
                ...
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh5) as isize)
                    as libc::c_ulong
                    ^ sample;
            }
            if 4 as libc::c_int & 2 as libc::c_int != 0 as libc::c_int {
                ...
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh6) as isize)
                    as libc::c_ulong
                    ^ sample;
                let fresh7 = j;
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh7) as isize)
                    as libc::c_ulong
                    ^ sample;
            }
            if 4 as libc::c_int & 4 as libc::c_int != 0 as libc::c_int {
                ...
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh8) as isize)
                    as libc::c_ulong
                    ^ sample;
                let fresh9 = j;
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh9) as isize)
                    as libc::c_ulong
                    ^ sample;
                let fresh10 = j;
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh10) as isize)
                    as libc::c_ulong
                    ^ sample;
                let fresh11 = j;
                j = j.wrapping_add(1);
                error |= *((*s).context_map)
                    .offset(offset.wrapping_add(fresh11) as isize)
                    as libc::c_ulong
                    ^ sample;
            }
        }
        if error == 0 as libc::c_int as libc::c_ulong {
            (*s).trivial_literal_contexts[(i >> 5 as libc::c_int) as usize] |=
                (1 as libc::c_uint) << (i & 31 as libc::c_int as libc::c_ulong);
        }
        i = i.wrapping_add(1);
        i;
    }
...
#[inline(always)]
unsafe extern "C" fn PrepareLiteralDecoding(
    mut s: *mut BrotliDecoderStateInternal
) {
    let mut context_mode: uint8_t = 0;
    let mut trivial: size_t = 0;
    let mut block_type: uint32_t =
    ...
    trivial = (*s).trivial_literal_contexts
        [(block_type >> 5 as libc::c_int) as usize] as size_t;
    (*s).trivial_literal_context =
        (trivial >> (block_type & 31 as libc::c_int as libc::c_uint)
            & 1 as libc::c_int as libc::c_ulong) as libc::c_int;
    (*s).literal_htree = *((*s).literal_hgroup.htrees)
        .offset(*((*s).context_map_slice).offset(0 as libc::c_int as isize)
            as isize);
    context_mode = (*((*s).context_modes).offset(block_type as isize)
        as libc::c_int
        & 3 as libc::c_int) as uint8_t;
...
#[inline(never)]
unsafe extern "C" fn DecodeLiteralBlockSwitch(
    mut s: *mut BrotliDecoderStateInternal
) {
...
#[inline(never)]
unsafe extern "C" fn DecodeCommandBlockSwitch(
    mut s: *mut BrotliDecoderStateInternal
) {
...
unsafe extern "C" fn DecodeDistanceBlockSwitchInternal(
    ...
    (*s).dist_context_map_slice = ((*s).dist_context_map).offset(
        ((*s).block_type_rb[5 as libc::c_int as usize] << 2 as libc::c_int)
            as isize
    );
    (*s).dist_htree_index =
...
#[inline(never)]
unsafe extern "C" fn DecodeDistanceBlockSwitch(
    mut s: *mut BrotliDecoderStateInternal
) {
...
unsafe extern "C" fn WriteRingBuffer(
    ...
    let mut start: *mut uint8_t = ((*s).ringbuffer).offset(
        ((*s).partial_pos_out & (*s).ringbuffer_mask as size_t) as isize
    );
    ...
    *available_out = (*available_out as libc::c_ulong).wrapping_sub(num_written)
        as size_t as size_t;
    (*s).partial_pos_out = ((*s).partial_pos_out as libc::c_ulong)
        .wrapping_add(num_written) as size_t
        as size_t;
...
unsafe extern "C" fn BrotliEnsureRingBuffer(
    ...
    (*s).ringbuffer = ((*s).alloc_func).expect("non-null function pointer")(
        (*s).memory_manager_opaque,
    ...
    *((*s).ringbuffer)
        .offset(((*s).new_ringbuffer_size - 2 as libc::c_int) as isize) =
        0 as libc::c_int as uint8_t;
    *((*s).ringbuffer)
        .offset(((*s).new_ringbuffer_size - 1 as libc::c_int) as isize) =
        0 as libc::c_int as uint8_t;
    ...
    (*s).ringbuffer_end =
        ((*s).ringbuffer).offset((*s).ringbuffer_size as isize);
    return 1 as libc::c_int;
}
#[inline(never)]
unsafe extern "C" fn CopyUncompressedBlockToOutput(
    ...
    loop {
        ...
        match (*s).substate_uncompressed as libc::c_uint {
            0 => {
                let mut nbytes: libc::c_int =
                    BrotliGetRemainingBytes(&mut (*s).br) as libc::c_int;
...
#[inline(always)]
unsafe extern "C" fn TakeDistanceFromRingBuffer(
    mut s: *mut BrotliDecoderStateInternal
) {
    ...
    if (*s).distance_code <= 3 as libc::c_int {
        ...
        (*s).distance_code = (*s).dist_rb
            [((*s).dist_rb_idx - offset & 3 as libc::c_int) as usize];
        ...
        delta = (0x605142 as libc::c_int >> 4 as libc::c_int * base
            & 0xf as libc::c_int)
            - 3 as libc::c_int;
        (*s).distance_code = (*s).dist_rb
            [((*s).dist_rb_idx + index_delta & 0x3 as libc::c_int) as usize]
            + delta;
...
unsafe extern "C" fn CalculateDistanceLut(
    mut s: *mut BrotliDecoderStateInternal
) {
    ...
    let mut alphabet_size_limit: uint32_t =
        (*s).distance_hgroup.alphabet_size_limit as uint32_t;
    let mut postfix: uint32_t = (1 as libc::c_uint) << npostfix;
...
unsafe extern "C" fn ReadDistanceInternal(
    ...
    let mut distance_tree: *mut HuffmanCode =
    ...
    (*s).block_length[2 as libc::c_int as usize] =
        ((*s).block_length[2 as libc::c_int as usize]).wrapping_sub(1);
    (*s).block_length[2 as libc::c_int as usize];
    ...
    {
        (*s).block_length[2 as libc::c_int as usize] =
            ((*s).block_length[2 as libc::c_int as usize]).wrapping_add(1);
        (*s).block_length[2 as libc::c_int as usize];
        BrotliBitReaderRestoreState(br, &mut memento);
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn ReadCommandInternal(
    ...
    *insert_length = v.insert_len_offset as libc::c_int;
    if safe == 0 {
        if (v.insert_len_extra_bits as libc::c_int != 0 as libc::c_int)
            as libc::c_int as libc::c_long
            != 0
        {
            insert_len_extra =
                BrotliReadBits24(br, v.insert_len_extra_bits as uint32_t);
        }
        ...
        || SafeReadBits(br, v.copy_len_extra_bits as uint32_t, &mut copy_length)
            == 0
    {
        BrotliBitReaderRestoreState(br, &mut memento);
        return 0 as libc::c_int;
    ...
    (*s).copy_length =
        copy_length as libc::c_int + v.copy_len_offset as libc::c_int;
    (*s).block_length[1 as libc::c_int as usize] =
        ((*s).block_length[1 as libc::c_int as usize]).wrapping_sub(1);
    (*s).block_length[1 as libc::c_int as usize];
...
unsafe extern "C" fn ProcessCommandsInternal(
    ...
    if CheckInputAmount(safe, br, 28 as libc::c_int as size_t) == 0 {
        ...
        {
            current_block = 365208179074498991;
        } else if (*s).state as libc::c_uint
            == BROTLI_STATE_COMMAND_INNER as libc::c_int as libc::c_uint
        {
            current_block = 15351852154450863098;
        } else if (*s).state as libc::c_uint
            == BROTLI_STATE_COMMAND_POST_DECODE_LITERALS as libc::c_int
                as libc::c_uint
        {
            current_block = 12774631259498756850;
        } else if (*s).state as libc::c_uint
            == BROTLI_STATE_COMMAND_POST_WRAP_COPY as libc::c_int
                as libc::c_uint
        {
            ...
            match current_block {
                12774631259498756850 => {
                    ...
                    if (*s).distance_code >= 0 as libc::c_int {
                        ...
                        (*s).dist_rb_idx;
                        (*s).distance_code = (*s).dist_rb
                            [((*s).dist_rb_idx & 3 as libc::c_int) as usize];
                    } else {
                    ...
                    if (*s).distance_code > (*s).max_distance {
                        ...
                        if i >= 4 as libc::c_int && i <= 24 as libc::c_int {
                            ...
                            let mut mask: libc::c_int =
                                BitMask(shift) as libc::c_int;
                            let mut word_idx: libc::c_int = address & mask;
                            let mut transform_idx: libc::c_int =
                                address >> shift;
                            (*s).dist_rb_idx += (*s).distance_context;
                            offset += word_idx * i;
                            if ((*words).data).is_null() as libc::c_int
                                as libc::c_long
                                != 0
                            {
                ...
                8953117030348968745 => {
                    let mut wrap_guard: libc::c_int =
                        (*s).ringbuffer_size - pos;
                    loop {
                        i -= 1;
                        if !(i >= 0 as libc::c_int) {
                            break;
                ...
                _ => {
                    ...
                    if (*s).trivial_literal_context != 0 {
                        ...
                        let mut p1: uint8_t = *((*s).ringbuffer).offset(
                            (pos - 1 as libc::c_int & (*s).ringbuffer_mask)
                                as isize
                        );
                        let mut p2: uint8_t = *((*s).ringbuffer).offset(
                            (pos - 2 as libc::c_int & (*s).ringbuffer_mask)
                                as isize
                        );
                        loop {
                            let mut hc: *const HuffmanCode =
                                0 as *const HuffmanCode;
                            ...
                            ) == 0
                            {
                                ...
                                context = (*((*s).context_lookup)
                                    ...
                                    | *((*s).context_lookup)
                                        ...
                                        as libc::c_int)
                                    as uint8_t;
                                hc = *((*s).literal_hgroup.htrees).offset(
                                    *((*s).context_map_slice)
                                        .offset(context as isize)
                                        as isize
                                );
                                p2 = p1;
                                if safe == 0 {
                                    ...
                                    if SafeReadSymbol(hc, br, &mut literal_0)
                                        == 0
                                    {
                                        result =
                                            BROTLI_DECODER_NEEDS_MORE_INPUT;
    ...
    loop {
        if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
                ...
                == BROTLI_DECODER_NEEDS_MORE_INPUT as libc::c_int
            {
                ...
                if (*s).buffer_length != 0 as libc::c_int as libc::c_uint {
                    if (*br).avail_in == 0 as libc::c_int as libc::c_ulong {
                        ...
                        result = BROTLI_DECODER_SUCCESS;
                        (*s).buffer.u8_0[(*s).buffer_length as usize] =
                            **next_in;
                        (*s).buffer_length =
                            ((*s).buffer_length).wrapping_add(1);
                        (*s).buffer_length;
            ...
            match (*s).state as libc::c_uint {
                ...
                3 => {
                    current_block_175 = 13771482776398185125;
                }
                4 => {
                    current_block_175 = 17357205016847337288;
                }
                17 => {
                    current_block_175 = 18124477022519122349;
                }
                18 => {
                    current_block_175 = 14600133156951043000;
                }
                19 => {
                ...
                5 => {
                    ...
                    ) == 0
                    {
                        ...
                        (*s).distance_postfix_bits =
                            bits_0 & BitMask(2 as libc::c_int as uint32_t);
                        bits_0 >>= 2 as libc::c_int;
                        (*s).num_direct_distance_codes =
                            bits_0 << (*s).distance_postfix_bits;
                        ...
                        if ((*s).context_modes).is_null() {
                            ...
                            current_block_175 = 10319869968961460719;
                        }
                    }
                }
                6 => {
                ...
                22 => {
                    current_block_175 = 16152771998566204523;
                }
                23 => {
                ...
                25 => {
                    current_block_175 = 11673767183625914418;
                }
                7 => {
                    current_block_175 = 7722215783255150921;
                }
                8 => {
                    current_block_175 = 17904655888203761971;
                }
                9 | 10 => {
                    current_block_175 = 5635330090616176279;
                }
                13 => {
                    current_block_175 = 17295929920418635907;
                }
                15 | 16 => {
                    current_block_175 = 17295929920418635907;
                }
                14 => {
                    if (*s).meta_block_remaining_len < 0 as libc::c_int {
                        ...
                        if (*s).is_last_metablock() == 0 {
                            ...
                            current_block_175 = 12821325498548916293;
                        }
                    }
                }
                26 => {
            ...
            match current_block_175 {
                ...
                2520131295878969859 => {
                    (*s).max_backward_distance = ((1 as libc::c_int)
                        << (*s).window_bits)
                        - 16 as libc::c_int;
                    (*s).block_type_trees =
                        ((*s).alloc_func).expect("non-null function pointer")(
                            (*s).memory_manager_opaque,
                            (::core::mem::size_of::<HuffmanCode>()
                                as libc::c_ulong)
                                .wrapping_mul(3 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(
                                    (632 as libc::c_int + 396 as libc::c_int)
                                        as libc::c_ulong
                                )
                        ) as *mut HuffmanCode;
                    if ((*s).block_type_trees).is_null() {
                        ...
                        (*s).block_len_trees = ((*s).block_type_trees).offset(
                            (3 as libc::c_int * 632 as libc::c_int) as isize
                        );
                        (*s).state = BROTLI_STATE_METABLOCK_BEGIN;
                        current_block_175 = 13771482776398185125;
                    }
            ...
            match current_block_175 {
                13425230902034816933 => {
                    let mut npostfix: uint32_t = (*s).distance_postfix_bits;
                    let mut ndirect: uint32_t = (*s).num_direct_distance_codes;
                    let mut distance_alphabet_size_max: uint32_t =
                        (16 as libc::c_int as libc::c_uint)
                            .wrapping_add(ndirect)
                            .wrapping_add(
                                (24 as libc::c_uint)
                                    << npostfix.wrapping_add(
                                        1 as libc::c_int as libc::c_uint
                                    )
                            );
                    let mut distance_alphabet_size_limit: uint32_t =
                        distance_alphabet_size_max;
                    let mut allocation_success: libc::c_int = 1 as libc::c_int;
                    if (*s).large_window() != 0 {
                        let mut limit: BrotliDistanceCodeLimit =
                            BrotliCalculateDistanceCodeLimit(
                                0x7ffffffc as libc::c_int as uint32_t,
                                npostfix,
                                ndirect
                            );
                        distance_alphabet_size_max = (16 as libc::c_int
                            as libc::c_uint)
                            .wrapping_add(ndirect)
                            .wrapping_add(
                                (62 as libc::c_uint)
                        ...
                        match current_block_175 {
                            ...
                            _ => {
                                if (*s).is_metadata() != 0 {
                                    ...
                                    current_block_175 = 16718638665978159145;
                                } else if (*s).meta_block_remaining_len
                                    == 0 as libc::c_int
                                {
                                    (*s).state = BROTLI_STATE_METABLOCK_DONE;
                                    current_block_175 = 16718638665978159145;
            ...
            match current_block_175 {
                ...
                18124477022519122349 => {
                    let mut h: *mut BrotliMetablockHeaderArena =
                        &mut (*s).arena.header;
                    (*s).loop_counter = 0 as libc::c_int;
                    (*h).sub_loop_counter = 0 as libc::c_int as uint32_t;
                    (*h).symbol_lists = &mut *((*h).symbols_lists_array)
                        .as_mut_ptr()
            ...
            match current_block_175 {
                5023038348526654800 => {
                    let mut alphabet_size: uint32_t = ((*s).num_block_types
                        [(*s).loop_counter as usize])
                        .wrapping_add(2 as libc::c_int as libc::c_uint);
                    let mut tree_offset: libc::c_int =
                        (*s).loop_counter * 632 as libc::c_int;
                    result = ReadHuffmanCode(
                        alphabet_size,
                        alphabet_size,
                        &mut *((*s).block_type_trees)
                            .offset(tree_offset as isize),
                        0 as *mut uint32_t,
                        s
                    );
                    if result as libc::c_int
            ...
            match current_block_175 {
                6712462580143783635 => {
                    let mut alphabet_size_0: uint32_t =
                        26 as libc::c_int as uint32_t;
                    let mut tree_offset_0: libc::c_int =
                        (*s).loop_counter * 396 as libc::c_int;
                    result = ReadHuffmanCode(
                        alphabet_size_0,
                        alphabet_size_0,
                        &mut *((*s).block_len_trees)
                            .offset(tree_offset_0 as isize),
                        0 as *mut uint32_t,
                        s
                    );
                    if result as libc::c_int
            ...
            match current_block_175 {
                ...
                15622658527355336244 => {
                    let mut tree_offset_1: libc::c_int =
                        (*s).loop_counter * 396 as libc::c_int;
                    if SafeReadBlockLength(
                        s,
                        &mut *((*s).block_length)
...
pub unsafe extern "C" fn BrotliDecoderHasMoreOutput(
    ...
    return if !((*s).ringbuffer).is_null()
        && UnwrittenBytes(s, 0 as libc::c_int)
...
pub unsafe extern "C" fn BrotliDecoderTakeOutput(
    ...
    if status as libc::c_int == BROTLI_DECODER_SUCCESS as libc::c_int
        || status as libc::c_int
            == BROTLI_DECODER_NEEDS_MORE_OUTPUT as libc::c_int
    {
...
pub unsafe extern "C" fn BrotliDecoderIsFinished(
        ...
        == BROTLI_STATE_DONE as libc::c_int as libc::c_uint
    {
        ...
        && BrotliDecoderHasMoreOutput(s) == 0) as libc::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn BrotliDecoderErrorString(
    ...
    match c as libc::c_int {
        ...
        -3 => {
            return b"EXUBERANT_META_NIBBLE\0" as *const u8
                as *const libc::c_char
        }
        -4 => {
            return b"SIMPLE_HUFFMAN_ALPHABET\0" as *const u8
                as *const libc::c_char
        }
        -5 => {
            return b"SIMPLE_HUFFMAN_SAME\0" as *const u8 as *const libc::c_char
        }
        -6 => return b"CL_SPACE\0" as *const u8 as *const libc::c_char,
        -7 => return b"HUFFMAN_SPACE\0" as *const u8 as *const libc::c_char,
        -8 => {
            return b"CONTEXT_MAP_REPEAT\0" as *const u8 as *const libc::c_char
        }
        ...
        -19 => {
            return b"DICTIONARY_NOT_SET\0" as *const u8 as *const libc::c_char
        }
        -20 => {
            return b"INVALID_ARGUMENTS\0" as *const u8 as *const libc::c_char
        }
        ...
        -30 => {
            return b"BLOCK_TYPE_TREES\0" as *const u8 as *const libc::c_char
        }
