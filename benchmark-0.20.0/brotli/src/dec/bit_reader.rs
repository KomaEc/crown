...
pub unsafe extern "C" fn BrotliInitBitReader(br: *mut BrotliBitReader) {
    ...
    (*br).bit_pos_ = ((::core::mem::size_of::<uint64_t>() as libc::c_ulong)
        << 3 as libc::c_int) as uint32_t;
}
#[no_mangle]
pub unsafe extern "C" fn BrotliWarmupBitReader(
    br: *mut BrotliBitReader
) -> libc::c_int {
    let mut aligned_read_mask: size_t = (::core::mem::size_of::<uint64_t>()
        as libc::c_ulong
        >> 1 as libc::c_int)
