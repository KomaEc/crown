...
unsafe extern "C" fn ToUpperCase(mut p: *mut uint8_t) -> libc::c_int {
        ...
        < 0xc0 as libc::c_int
    {
            ...
            && *p.offset(0 as libc::c_int as isize) as libc::c_int <= 'z' as i32
        {
            ...
            *fresh0 = (*fresh0 as libc::c_int ^ 32 as libc::c_int) as uint8_t;
        }
        ...
        < 0xe0 as libc::c_int
    {
        ...
        *fresh1 = (*fresh1 as libc::c_int ^ 32 as libc::c_int) as uint8_t;
        return 2 as libc::c_int;
    }
    let ref mut fresh2 = *p.offset(2 as libc::c_int as isize);
    *fresh2 = (*fresh2 as libc::c_int ^ 5 as libc::c_int) as uint8_t;
...
unsafe extern "C" fn Shift(
    ...
    let mut scalar: uint32_t =
        (parameter as libc::c_uint & 0x7fff as libc::c_uint).wrapping_add(
            (0x1000000 as libc::c_uint).wrapping_sub(
                parameter as libc::c_uint & 0x8000 as libc::c_uint
            )
        );
        ...
        < 0x80 as libc::c_int
    {
        ...
        *word.offset(0 as libc::c_int as isize) =
        ...
        return 1 as libc::c_int;
    } else if (*word.offset(0 as libc::c_int as isize) as libc::c_int)
        < 0xc0 as libc::c_int
    {
        return 1 as libc::c_int;
    } else if (*word.offset(0 as libc::c_int as isize) as libc::c_int)
        < 0xe0 as libc::c_int
    {
        ...
        scalar = (scalar as libc::c_uint).wrapping_add(
        ...
        *word.offset(0 as libc::c_int as isize) = (0xc0 as libc::c_int
            as libc::c_uint
        ...
        *word.offset(1 as libc::c_int as isize) =
            ((*word.offset(1 as libc::c_int as isize) as libc::c_int
                ...
                | scalar & 0x3f as libc::c_int as libc::c_uint)
                as uint8_t;
        return 2 as libc::c_int;
    } else if (*word.offset(0 as libc::c_int as isize) as libc::c_int)
        < 0xf0 as libc::c_int
    {
        ...
        *word.offset(0 as libc::c_int as isize) = (0xe0 as libc::c_int
            as libc::c_uint
            | scalar >> 12 as libc::c_uint & 0xf as libc::c_int as libc::c_uint)
            as uint8_t;
        *word.offset(1 as libc::c_int as isize) =
            ((*word.offset(1 as libc::c_int as isize) as libc::c_int
                & 0xc0 as libc::c_int) as libc::c_uint
        ...
        < 0xf8 as libc::c_int
    {
        ...
        *word.offset(0 as libc::c_int as isize) = (0xf0 as libc::c_int
            as libc::c_uint
            | scalar >> 18 as libc::c_uint & 0x7 as libc::c_int as libc::c_uint)
            as uint8_t;
        *word.offset(1 as libc::c_int as isize) =
            ((*word.offset(1 as libc::c_int as isize) as libc::c_int
                & 0xc0 as libc::c_int) as libc::c_uint
...
pub unsafe extern "C" fn BrotliTransformDictionaryWord(
    ...
    let mut prefix: *const uint8_t = &*((*transforms).prefix_suffix).offset(
        *((*transforms).prefix_suffix_map).offset(
            *((*transforms).transforms).offset(
                (transform_idx * 3 as libc::c_int + 0 as libc::c_int) as isize
            ) as isize
        ) as isize
    ) as *const uint8_t;
    let mut type_0: uint8_t = *((*transforms).transforms)
        .offset((transform_idx * 3 as libc::c_int + 1 as libc::c_int) as isize);
    let mut suffix: *const uint8_t = &*((*transforms).prefix_suffix).offset(
        *((*transforms).prefix_suffix_map).offset(
            *((*transforms).transforms).offset(
                (transform_idx * 3 as libc::c_int + 2 as libc::c_int) as isize
            ) as isize
        ) as isize
    ) as *const uint8_t;
    let fresh3 = prefix;
    prefix = prefix.offset(1);
    let mut prefix_len: libc::c_int = *fresh3 as libc::c_int;
    loop {
    ...
    let t: libc::c_int = type_0 as libc::c_int;
    ...
    if t == BROTLI_TRANSFORM_UPPERCASE_FIRST as libc::c_int {
        ...
        while len > 0 as libc::c_int {
            let mut step: libc::c_int = ToUpperCase(uppercase);
            uppercase = uppercase.offset(step as isize);
            len -= step;
        }
    } else if t == BROTLI_TRANSFORM_SHIFT_FIRST as libc::c_int {
        let mut param: uint16_t = (*((*transforms).params)
            .offset((transform_idx * 2 as libc::c_int) as isize)
            as libc::c_int
            + ((*((*transforms).params).offset(
                (transform_idx * 2 as libc::c_int + 1 as libc::c_int) as isize
            ) as libc::c_int)
                << 8 as libc::c_uint))
            as uint16_t;
        Shift(&mut *dst.offset((idx - len) as isize), len, param);
    } else if t == BROTLI_TRANSFORM_SHIFT_ALL as libc::c_int {
        let mut param_0: uint16_t = (*((*transforms).params)
            .offset((transform_idx * 2 as libc::c_int) as isize)
            as libc::c_int
            + ((*((*transforms).params).offset(
                (transform_idx * 2 as libc::c_int + 1 as libc::c_int) as isize
        ...
        let mut shift: *mut uint8_t =
            &mut *dst.offset((idx - len) as isize) as *mut uint8_t;
        while len > 0 as libc::c_int {
            let mut step_0: libc::c_int = Shift(shift, len, param_0);
    ...
    let mut suffix_len: libc::c_int = *fresh9 as libc::c_int;
    loop {
...
unsafe extern "C" fn run_static_initializers() {
    kBrotliTransforms = {
        let mut init = BrotliTransforms {
            prefix_suffix_size: ::core::mem::size_of::<[libc::c_char; 217]>()
                as libc::c_ulong as uint16_t,
            prefix_suffix: kPrefixSuffix.as_ptr() as *const uint8_t,
            prefix_suffix_map: kPrefixSuffixMap.as_ptr(),
            num_transforms: (::core::mem::size_of::<[uint8_t; 363]>()
                as libc::c_ulong)
                .wrapping_div((3 as libc::c_int as libc::c_ulong).wrapping_mul(
