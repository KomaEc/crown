...
pub const BROTLI_PARAM_DISABLE_LITERAL_CONTEXT_MODELING:
...
unsafe extern "C" fn RingBufferSetup(
    ...
    let mut window_bits: libc::c_int = ComputeRbBits(params);
    let mut tail_bits: libc::c_int = (*params).lgblock;
    *(&(*rb).size_ as *const uint32_t as *mut uint32_t) =
        (1 as libc::c_uint) << window_bits;
    *(&(*rb).mask_ as *const uint32_t as *mut uint32_t) = ((1 as libc::c_uint)
        << window_bits)
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    *(&(*rb).tail_size_ as *const uint32_t as *mut uint32_t) =
        (1 as libc::c_uint) << tail_bits;
    *(&(*rb).total_size_ as *const uint32_t as *mut uint32_t) =
        ((*rb).size_).wrapping_add((*rb).tail_size_);
}
#[inline(always)]
unsafe extern "C" fn RingBufferFree(
...
unsafe extern "C" fn RingBufferInitBuffer(
    ...
    static mut kSlackForEightByteHashingEverywhere: size_t =
        7 as libc::c_int as size_t;
    let mut new_data: *mut uint8_t = if ((2 as libc::c_int as libc::c_uint)
        .wrapping_add(buflen)
        as libc::c_ulong)
        ...
        > 0 as libc::c_int as libc::c_ulong
    {
        BrotliAllocate(
            m,
            ((2 as libc::c_int as libc::c_uint).wrapping_add(buflen)
                as libc::c_ulong)
                .wrapping_add(kSlackForEightByteHashingEverywhere)
                .wrapping_mul(
    ...
    let ref mut fresh0 = *((*rb).buffer_).offset(-(1 as libc::c_int) as isize);
    *fresh0 = 0 as libc::c_int as uint8_t;
    *((*rb).buffer_).offset(-(2 as libc::c_int) as isize) = *fresh0;
...
unsafe extern "C" fn RingBufferWriteTail(
    ...
    if (masked_pos < (*rb).tail_size_ as libc::c_ulong) as libc::c_int
        as libc::c_long
        != 0
    {
        let p: size_t = ((*rb).size_ as libc::c_ulong).wrapping_add(masked_pos);
        memcpy(
...
unsafe extern "C" fn RingBufferWrite(
    ...
    if (*rb).cur_size_ < (*rb).total_size_ {
        ...
        *((*rb).buffer_).offset(
            ((*rb).size_).wrapping_sub(2 as libc::c_int as libc::c_uint)
                as isize
        ) = 0 as libc::c_int as uint8_t;
        *((*rb).buffer_).offset(
            ((*rb).size_).wrapping_sub(1 as libc::c_int as libc::c_uint)
                as isize
        ) = 0 as libc::c_int as uint8_t;
        *((*rb).buffer_).offset((*rb).size_ as isize) =
            241 as libc::c_int as uint8_t;
    }
    let masked_pos: size_t = ((*rb).pos_ & (*rb).mask_) as size_t;
    RingBufferWriteTail(bytes, n, rb);
    if (masked_pos.wrapping_add(n) <= (*rb).size_ as libc::c_ulong)
        ...
        != 0
    {
        ...
        memcpy(
            &mut *((*rb).buffer_).offset(0 as libc::c_int as isize)
                as *mut uint8_t as *mut libc::c_void,
            bytes
                .offset(((*rb).size_ as libc::c_ulong).wrapping_sub(masked_pos)
                    as isize) as *const libc::c_void,
            n.wrapping_sub(
                ((*rb).size_ as libc::c_ulong).wrapping_sub(masked_pos)
            )
        );
    }
    let mut not_first_lap: libc::c_int =
        ((*rb).pos_ & (1 as libc::c_uint) << 31 as libc::c_int
            != 0 as libc::c_int as libc::c_uint) as libc::c_int;
    let mut rb_pos_mask: uint32_t = ((1 as libc::c_uint) << 31 as libc::c_int)
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    *((*rb).buffer_).offset(-(2 as libc::c_int) as isize) = *((*rb).buffer_)
        .offset(((*rb).size_).wrapping_sub(2 as libc::c_int as libc::c_uint)
            as isize);
    *((*rb).buffer_).offset(-(1 as libc::c_int) as isize) = *((*rb).buffer_)
        .offset(((*rb).size_).wrapping_sub(1 as libc::c_int as libc::c_uint)
            as isize);
...
unsafe extern "C" fn GetInsertLengthCode(mut insertlen: size_t) -> uint16_t {
    if insertlen < 6 as libc::c_int as libc::c_ulong {
        ...
        let mut nbits: uint32_t = (Log2FloorNonZero(
...
unsafe extern "C" fn GetCopyLengthCode(mut copylen: size_t) -> uint16_t {
    if copylen < 10 as libc::c_int as libc::c_ulong {
        return copylen.wrapping_sub(2 as libc::c_int as libc::c_ulong)
            as uint16_t;
...
unsafe extern "C" fn CombineLengthCodes(
    ...
    let mut bits64: uint16_t = (copycode as libc::c_uint & 0x7 as libc::c_uint
        | (inscode as libc::c_uint & 0x7 as libc::c_uint) << 3 as libc::c_uint)
        as uint16_t;
    if use_last_distance != 0
        && (inscode as libc::c_uint) < 8 as libc::c_uint
        && (copycode as libc::c_uint) < 16 as libc::c_uint
    {
        ...
        let mut offset: uint32_t = (2 as libc::c_uint).wrapping_mul(
            ((copycode as libc::c_int >> 3 as libc::c_uint) as libc::c_uint)
                .wrapping_add((3 as libc::c_uint).wrapping_mul(
        ...
        offset = (offset << 5 as libc::c_uint)
            ...
            .wrapping_add(
                0x520d40 as libc::c_uint >> offset & 0xc0 as libc::c_uint
            );
...
#[inline(always)]
unsafe extern "C" fn InitInsertCommand(
...
unsafe extern "C" fn CommandRestoreDistanceCode(
            ...
            .wrapping_add((*dist).num_direct_distance_codes)
    {
        ...
        let mut dcode: uint32_t =
            (*self_0).dist_prefix_ as libc::c_uint & 0x3ff as libc::c_uint;
        ...
        let mut offset: uint32_t = ((2 as libc::c_uint)
            .wrapping_add(hcode & 1 as libc::c_uint)
            << nbits)
...
static mut kHashMul64: uint64_t = (0x1e35a7bd as libc::c_int as uint64_t)
    << 32 as libc::c_int
    | 0x1e35a7bd as libc::c_int as libc::c_ulong;
static mut kHashMul64Long: uint64_t = (0x1fe35a7b as libc::c_uint as uint64_t)
    << 32 as libc::c_int
    | 0xd3579bd3 as libc::c_uint as libc::c_ulong;
#[inline(always)]
...
#[inline(always)]
unsafe extern "C" fn DestroyHasher(
    mut m: *mut MemoryManager,
...
unsafe extern "C" fn HasherSetup(
    ...
    let mut one_shot: libc::c_int = (position
        == 0 as libc::c_int as libc::c_ulong
    ...
    if ((*hasher).common.extra).is_null() {
        ...
        (*hasher).common.extra =
            (if alloc_size > 0 as libc::c_int as libc::c_ulong {
                BrotliAllocate(
                    m,
                    alloc_size.wrapping_mul(
                        ::core::mem::size_of::<uint8_t>() as libc::c_ulong
                    )
                ) as *mut uint8_t
            } else {
...
unsafe extern "C" fn HashBytesH2(mut data: *const uint8_t) -> uint32_t {
    let h: uint64_t = (BrotliUnalignedRead64(data as *const libc::c_void)
...
unsafe extern "C" fn PrepareH2(
    ...
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 16 as libc::c_int >> 5 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let key: uint32_t = HashBytesH2(&*data.offset(i as isize));
...
unsafe extern "C" fn HashMemAllocInBytesH2(
    ...
    return (::core::mem::size_of::<uint32_t>() as libc::c_ulong).wrapping_mul(
        ((1 as libc::c_int) << 16 as libc::c_int) as libc::c_ulong
    );
}
#[inline(always)]
unsafe extern "C" fn StoreH2(
    ...
    let key: uint32_t = HashBytesH2(&*data.offset((ix & mask) as isize));
    if (1 as libc::c_int) << 0 as libc::c_int == 1 as libc::c_int {
...
unsafe extern "C" fn StitchToPreviousBlockH2(
    ...
    if num_bytes
        >= (HashTypeLengthH2()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn PrepareH3(
    ...
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        ...
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let key: uint32_t = HashBytesH3(&*data.offset(i as isize));
...
unsafe extern "C" fn StoreH3(
    ...
    let key: uint32_t = HashBytesH3(&*data.offset((ix & mask) as isize));
    if (1 as libc::c_int) << 1 as libc::c_int == 1 as libc::c_int {
        *((*self_0).buckets_).offset(key as isize) = ix as uint32_t;
    } else {
        let off: uint32_t = (ix
...
unsafe extern "C" fn StitchToPreviousBlockH3(
    ...
    if num_bytes
        >= (HashTypeLengthH3()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH3(
            self_0,
...
unsafe extern "C" fn PrepareH4(
    ...
    let mut buckets: *mut uint32_t = (*self_0).buckets_;
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 17 as libc::c_int >> 5 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let key: uint32_t = HashBytesH4(&*data.offset(i as isize));
...
unsafe extern "C" fn StoreH4(
    ...
    let key: uint32_t = HashBytesH4(&*data.offset((ix & mask) as isize));
    if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
        *((*self_0).buckets_).offset(key as isize) = ix as uint32_t;
    } else {
        let off: uint32_t = (ix
...
unsafe extern "C" fn StitchToPreviousBlockH4(
    ...
    if num_bytes
        >= (HashTypeLengthH4()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH4(
            self_0,
...
unsafe extern "C" fn PrepareH54(
    ...
    let mut buckets: *mut uint32_t = (*self_0).buckets_;
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 20 as libc::c_int >> 5 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let key: uint32_t = HashBytesH54(&*data.offset(i as isize));
            if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
                *buckets.offset(key as isize) = 0 as libc::c_int as uint32_t;
            } else {
                let mut j: uint32_t = 0;
...
unsafe extern "C" fn StoreH54(
    ...
    let key: uint32_t = HashBytesH54(&*data.offset((ix & mask) as isize));
    if (1 as libc::c_int) << 2 as libc::c_int == 1 as libc::c_int {
        *((*self_0).buckets_).offset(key as isize) = ix as uint32_t;
    } else {
        let off: uint32_t = (ix
...
unsafe extern "C" fn StitchToPreviousBlockH54(
    ...
    if num_bytes
        >= (HashTypeLengthH54()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH54(
            self_0,
...
unsafe extern "C" fn HashBytesH5(
    ...
    let mut h: uint32_t = (BrotliUnalignedRead32(data as *const libc::c_void))
...
unsafe extern "C" fn InitializeH5(
    ...
    (*self_0).bucket_size_ =
        (1 as libc::c_int as size_t) << (*common).params.bucket_bits;
    (*self_0).block_size_ =
        (1 as libc::c_int as size_t) << (*common).params.block_bits;
    (*self_0).block_mask_ = ((*self_0).block_size_)
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        as uint32_t;
    (*self_0).num_ = (*common).extra as *mut uint16_t;
    (*self_0).buckets_ = &mut *((*self_0).num_)
        .offset((*self_0).bucket_size_ as isize)
        as *mut uint16_t as *mut uint32_t;
    (*self_0).block_bits_ = (*common).params.block_bits;
    (*self_0).num_last_distances_to_check_ =
...
unsafe extern "C" fn PrepareH5(
    ...
    let mut partial_prepare_threshold: size_t =
        (*self_0).bucket_size_ >> 6 as libc::c_int;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let key: uint32_t =
                HashBytesH5(&*data.offset(i as isize), (*self_0).hash_shift_);
        ...
        memset(
            ...
            0 as libc::c_int,
            ((*self_0).bucket_size_).wrapping_mul(
...
unsafe extern "C" fn HashMemAllocInBytesH5(
    ...
    let mut bucket_size: size_t =
        (1 as libc::c_int as size_t) << (*params).hasher.bucket_bits;
    let mut block_size: size_t =
        (1 as libc::c_int as size_t) << (*params).hasher.block_bits;
    return (::core::mem::size_of::<uint16_t>() as libc::c_ulong)
...
unsafe extern "C" fn StoreH5(
    ...
    let key: uint32_t =
        HashBytesH5(&*data.offset((ix & mask) as isize), (*self_0).hash_shift_);
    let minor_ix: size_t = (*((*self_0).num_).offset(key as isize)
        as libc::c_uint
        & (*self_0).block_mask_) as size_t;
    let offset: size_t =
        minor_ix.wrapping_add((key << (*self_0).block_bits_) as libc::c_ulong);
    *((*self_0).buckets_).offset(offset as isize) = ix as uint32_t;
    let ref mut fresh1 = *((*self_0).num_).offset(key as isize);
...
unsafe extern "C" fn StitchToPreviousBlockH5(
    ...
    if num_bytes
        >= (HashTypeLengthH5()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH5(
            self_0,
...
unsafe extern "C" fn StoreH6(
    ...
    let minor_ix: size_t = (*num.offset(key as isize) as libc::c_uint
        & (*self_0).block_mask_) as size_t;
    let offset: size_t =
        minor_ix.wrapping_add((key << (*self_0).block_bits_) as libc::c_ulong);
...
unsafe extern "C" fn StitchToPreviousBlockH6(
    ...
    if num_bytes
        >= (HashTypeLengthH6()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH6(
            self_0,
...
unsafe extern "C" fn HashBytesH40(mut data: *const uint8_t) -> size_t {
    let h: uint32_t = (BrotliUnalignedRead32(data as *const libc::c_void))
        .wrapping_mul(kHashMul32);
...
unsafe extern "C" fn HeadH40(mut extra: *mut libc::c_void) -> *mut uint16_t {
    return &mut *((AddrH40
        as unsafe extern "C" fn(*mut libc::c_void) -> *mut uint32_t)(
        extra
    ))
    .offset(((1 as libc::c_int) << 15 as libc::c_int) as isize)
        as *mut uint32_t as *mut uint16_t;
}
unsafe extern "C" fn TinyHashH40(mut extra: *mut libc::c_void) -> *mut uint8_t {
    return &mut *((HeadH40
        as unsafe extern "C" fn(*mut libc::c_void) -> *mut uint16_t)(
        extra
    ))
    .offset(((1 as libc::c_int) << 15 as libc::c_int) as isize)
...
unsafe extern "C" fn BanksH40(mut extra: *mut libc::c_void) -> *mut BankH40 {
    return &mut *((TinyHashH40
        as unsafe extern "C" fn(*mut libc::c_void) -> *mut uint8_t)(
        extra
    ))
    .offset(65536 as libc::c_int as isize) as *mut uint8_t
        as *mut BankH40;
}
unsafe extern "C" fn InitializeH40(
    ...
    (*self_0).max_hops = ((if (*params).quality > 6 as libc::c_int {
        ...
        8 as libc::c_uint
    }) << (*params).quality - 4 as libc::c_int)
        as size_t;
}
unsafe extern "C" fn PrepareH40(
    ...
    let mut addr: *mut uint32_t = AddrH40((*self_0).extra);
    let mut head: *mut uint16_t = HeadH40((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH40((*self_0).extra);
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 15 as libc::c_int >> 6 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let mut bucket: size_t = HashBytesH40(&*data.offset(i as isize));
        ...
        memset(
            ...
            0 as libc::c_int,
            (::core::mem::size_of::<uint16_t>() as libc::c_ulong).wrapping_mul(
                ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_ulong
            )
        );
    }
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<[uint16_t; 1]>() as libc::c_ulong
    );
}
#[inline(always)]
unsafe extern "C" fn HashMemAllocInBytesH40(
    ...
    return (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
        .wrapping_mul(
            ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_ulong
        )
        .wrapping_add(
        ...
        .wrapping_add(
            (::core::mem::size_of::<BankH40>() as libc::c_ulong)
...
unsafe extern "C" fn StoreH40(
    ...
    let mut head: *mut uint16_t = HeadH40((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH40((*self_0).extra);
    let mut banks: *mut BankH40 = BanksH40((*self_0).extra);
    let key: size_t = HashBytesH40(&*data.offset((ix & mask) as isize));
    let bank: size_t =
        key & (1 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let fresh3 = (*self_0).free_slot_idx[bank as usize];
    (*self_0).free_slot_idx[bank as usize] =
        ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh3 as libc::c_int
        & ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
        as size_t;
    let mut delta: size_t =
        ix.wrapping_sub(*addr.offset(key as isize) as libc::c_ulong);
    *tiny_hash.offset(ix as uint16_t as isize) = key as uint8_t;
    ...
    (*banks.offset(bank as isize)).slots[idx as usize].delta =
        delta as uint16_t;
    (*banks.offset(bank as isize)).slots[idx as usize].next =
        *head.offset(key as isize);
...
unsafe extern "C" fn StitchToPreviousBlockH40(
    ...
    if num_bytes
        >= (HashTypeLengthH40()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH40(
            self_0,
...
unsafe extern "C" fn PrepareH41(
    ...
    let mut addr: *mut uint32_t = AddrH41((*self_0).extra);
    let mut head: *mut uint16_t = HeadH41((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH41((*self_0).extra);
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 15 as libc::c_int >> 6 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let mut bucket: size_t = HashBytesH41(&*data.offset(i as isize));
            *addr.offset(bucket as isize) = 0xcccccccc as libc::c_uint;
            *head.offset(bucket as isize) = 0xcccc as libc::c_int as uint16_t;
            i = i.wrapping_add(1);
            i;
...
unsafe extern "C" fn HashMemAllocInBytesH41(
    ...
    return (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
        ...
        .wrapping_add(
            (::core::mem::size_of::<BankH41>() as libc::c_ulong)
                .wrapping_mul(1 as libc::c_int as libc::c_ulong)
        );
}
#[inline(always)]
unsafe extern "C" fn StoreH41(
    ...
    let mut head: *mut uint16_t = HeadH41((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH41((*self_0).extra);
    let mut banks: *mut BankH41 = BanksH41((*self_0).extra);
    let key: size_t = HashBytesH41(&*data.offset((ix & mask) as isize));
    let bank: size_t =
        key & (1 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let fresh4 = (*self_0).free_slot_idx[bank as usize];
    (*self_0).free_slot_idx[bank as usize] =
        ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh4 as libc::c_int
        & ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
        as size_t;
    let mut delta: size_t =
        ix.wrapping_sub(*addr.offset(key as isize) as libc::c_ulong);
...
unsafe extern "C" fn StitchToPreviousBlockH41(
    ...
    if num_bytes
        >= (HashTypeLengthH41()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH41(
            self_0,
...
unsafe extern "C" fn PrepareH42(
    ...
    let mut addr: *mut uint32_t = AddrH42((*self_0).extra);
    let mut head: *mut uint16_t = HeadH42((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH42((*self_0).extra);
    let mut partial_prepare_threshold: size_t =
        ((1 as libc::c_int) << 15 as libc::c_int >> 6 as libc::c_int) as size_t;
    if one_shot != 0 && input_size <= partial_prepare_threshold {
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            let mut bucket: size_t = HashBytesH42(&*data.offset(i as isize));
            *addr.offset(bucket as isize) = 0xcccccccc as libc::c_uint;
            *head.offset(bucket as isize) = 0xcccc as libc::c_int as uint16_t;
            i = i.wrapping_add(1);
            i;
...
unsafe extern "C" fn HashMemAllocInBytesH42(
    ...
    return (::core::mem::size_of::<uint32_t>() as libc::c_ulong)
        ...
        .wrapping_add(
            (::core::mem::size_of::<BankH42>() as libc::c_ulong)
...
unsafe extern "C" fn StoreH42(
    ...
    let mut head: *mut uint16_t = HeadH42((*self_0).extra);
    let mut tiny_hash: *mut uint8_t = TinyHashH42((*self_0).extra);
    let mut banks: *mut BankH42 = BanksH42((*self_0).extra);
    let key: size_t = HashBytesH42(&*data.offset((ix & mask) as isize));
    let bank: size_t =
        key & (512 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let fresh5 = (*self_0).free_slot_idx[bank as usize];
    (*self_0).free_slot_idx[bank as usize] =
        ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh5 as libc::c_int
...
unsafe extern "C" fn StitchToPreviousBlockH42(
    ...
    if num_bytes
        >= (HashTypeLengthH42()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 3 as libc::c_int as libc::c_ulong
    {
        StoreH42(
            self_0,
...
unsafe extern "C" fn PrepareH35(
    ...
    if (*self_0).fresh != 0 {
        ...
        (*self_0).hb_common.extra = ((*self_0).extra as *mut uint8_t).offset(
            HashMemAllocInBytesH3((*self_0).params, one_shot, input_size)
                as isize
        ) as *mut libc::c_void;
...
unsafe extern "C" fn PrepareH55(
    ...
    if (*self_0).fresh != 0 {
        (*self_0).fresh = 0 as libc::c_int;
        (*self_0).hb_common.extra = ((*self_0).extra as *mut uint8_t).offset(
            HashMemAllocInBytesH54((*self_0).params, one_shot, input_size)
                as isize
        ) as *mut libc::c_void;
...
unsafe extern "C" fn HashMemAllocInBytesH55(
    ...
    return (HashMemAllocInBytesH54(params, one_shot, input_size))
        .wrapping_add(HashMemAllocInBytesHROLLING_FAST(
            params, one_shot, input_size
        ));
}
#[inline(always)]
...
unsafe extern "C" fn PrepareH65(
    ...
    if (*self_0).fresh != 0 {
        (*self_0).fresh = 0 as libc::c_int;
        (*self_0).hb_common.extra = ((*self_0).extra as *mut uint8_t).offset(
            HashMemAllocInBytesH6((*self_0).params, one_shot, input_size)
                as isize
        ) as *mut libc::c_void;
...
unsafe extern "C" fn HashMemAllocInBytesH65(
    ...
    return (HashMemAllocInBytesH6(params, one_shot, input_size)).wrapping_add(
        HashMemAllocInBytesHROLLING(params, one_shot, input_size)
    );
}
#[inline(always)]
...
static mut kRollingHashMul32HROLLING_FAST: uint32_t =
    69069 as libc::c_int as uint32_t;
...
unsafe extern "C" fn InitializeHROLLING_FAST(
    ...
    while i < 32 as libc::c_int as libc::c_ulong {
        (*self_0).factor_remove = ((*self_0).factor_remove as libc::c_uint)
            .wrapping_mul((*self_0).factor)
...
unsafe extern "C" fn StitchToPreviousBlockHROLLING_FAST(
    ...
    if position & (4 as libc::c_int - 1 as libc::c_int) as libc::c_ulong
        != 0 as libc::c_int as libc::c_ulong
    {
        let mut diff: size_t = (4 as libc::c_int as libc::c_ulong)
            .wrapping_sub(
                position
        ...
        position =
            (position as libc::c_ulong).wrapping_add(diff) as size_t as size_t;
    }
...
static mut kRollingHashMul32HROLLING: uint32_t =
    69069 as libc::c_int as uint32_t;
...
unsafe extern "C" fn StitchToPreviousBlockHROLLING(
    ...
    if position & (1 as libc::c_int - 1 as libc::c_int) as libc::c_ulong
        != 0 as libc::c_int as libc::c_ulong
    {
        let mut diff: size_t = (1 as libc::c_int as libc::c_ulong)
            .wrapping_sub(
                position
...
unsafe extern "C" fn InitializeH10(
    ...
    (*self_0).buckets_ = (*common).extra as *mut uint32_t;
    (*self_0).forest_ = &mut *((*self_0).buckets_)
        .offset(((1 as libc::c_int) << 17 as libc::c_int) as isize)
        as *mut uint32_t;
    ...
    (*self_0).invalid_pos_ = (0 as libc::c_int as libc::c_ulong)
        .wrapping_sub((*self_0).window_mask_)
        as uint32_t;
}
...
unsafe extern "C" fn HashMemAllocInBytesH10(
    ...
    let mut num_nodes: size_t = (1 as libc::c_int as size_t) << (*params).lgwin;
...
#[inline(always)]
unsafe extern "C" fn LeftChildIndexH10(
    mut self_0: *mut H10,
    pos: size_t
) -> size_t {
...
#[inline(always)]
unsafe extern "C" fn RightChildIndexH10(
    mut self_0: *mut H10,
    pos: size_t
) -> size_t {
    return (2 as libc::c_int as libc::c_ulong)
...
unsafe extern "C" fn StoreAndFindMatchesH10(
    ...
    let max_comp_len: size_t =
        brotli_min_size_t(max_length, 128 as libc::c_int as size_t);
    let should_reroot_tree: libc::c_int =
        if max_length >= 128 as libc::c_int as libc::c_ulong {
            1 as libc::c_int
        } else {
            0 as libc::c_int
        };
    let key: uint32_t = HashBytesH10(&*data.offset(cur_ix_masked as isize));
    let mut buckets: *mut uint32_t = (*self_0).buckets_;
    ...
    let mut best_len_left: size_t = 0 as libc::c_int as size_t;
    let mut best_len_right: size_t = 0 as libc::c_int as size_t;
    ...
    loop {
        ...
        if backward == 0 as libc::c_int as libc::c_ulong
            ...
            || depth_remaining == 0 as libc::c_int as libc::c_ulong
        {
            ...
            if !matches.is_null() && len > *best_len {
                *best_len = len;
                ...
                InitBackwardMatch(fresh6, backward, len);
            }
            if len >= max_comp_len {
                if should_reroot_tree != 0 {
                    *forest.offset(node_left as isize) = *forest
                        .offset(LeftChildIndexH10(self_0, prev_ix) as isize);
                    *forest.offset(node_right as isize) = *forest
                        .offset(RightChildIndexH10(self_0, prev_ix) as isize);
                }
                break;
            } else {
                if *data.offset(cur_ix_masked.wrapping_add(len) as isize)
                    as libc::c_int
...
unsafe extern "C" fn StitchToPreviousBlockH10(
    ...
    if num_bytes
        >= (HashTypeLengthH10()).wrapping_sub(1 as libc::c_int as libc::c_ulong)
        && position >= 128 as libc::c_int as libc::c_ulong
    {
        ...
        i = i_start;
        while i < i_end {
            let max_backward: size_t =
                ((*self_0).window_mask_).wrapping_sub(brotli_max_size_t(
...
#[inline(always)]
unsafe extern "C" fn BrotliUnalignedRead32(
    mut p: *const libc::c_void
) -> uint32_t {
    return *(p as *const uint32_t);
}
#[inline(always)]
unsafe extern "C" fn BrotliUnalignedRead64(
    mut p: *const libc::c_void
) -> uint64_t {
    return *(p as *const uint64_t);
}
#[inline(always)]
unsafe extern "C" fn BrotliUnalignedWrite64(
...
#[inline(always)]
unsafe extern "C" fn brotli_min_uint32_t(
    mut a: uint32_t,
    mut b: uint32_t
) -> uint32_t {
    return if a < b { a } else { b };
...
unsafe extern "C" fn Log2FloorNonZero(mut n: size_t) -> uint32_t {
    return 31 as libc::c_uint
        ^ (n as uint32_t).leading_zeros() as i32 as uint32_t;
}
#[inline(always)]
...
unsafe extern "C" fn FindMatchLengthWithLimit(
    ...
    loop {
            ...
            != 0
        {
            ...
            let mut x: uint64_t =
                BrotliUnalignedRead64(s2 as *const libc::c_void)
                    ^ BrotliUnalignedRead64(
                        s1.offset(matched as isize) as *const libc::c_void
                    );
            let mut matching_bits: size_t =
                (x as libc::c_ulonglong).trailing_zeros() as i32 as size_t;
            matched = (matched as libc::c_ulong)
                .wrapping_add(matching_bits >> 3 as libc::c_int)
                as size_t as size_t;
            return matched;
        }
    }
...
unsafe extern "C" fn SanitizeParams(mut params: *mut BrotliEncoderParams) {
    ...
    if (*params).lgwin < 10 as libc::c_int {
        ...
        let mut max_lgwin: libc::c_int = if (*params).large_window != 0 {
            30 as libc::c_int
        } else {
            24 as libc::c_int
        };
...
unsafe extern "C" fn ComputeLgBlock(
    ...
    let mut lgblock: libc::c_int = (*params).lgblock;
    if (*params).quality == 0 as libc::c_int
        || (*params).quality == 1 as libc::c_int
    {
...
unsafe extern "C" fn ComputeRbBits(
    ...
    return 1 as libc::c_int
        + brotli_max_int((*params).lgwin, (*params).lgblock);
}
#[inline(always)]
unsafe extern "C" fn MaxMetablockSize(
    mut params: *const BrotliEncoderParams
) -> size_t {
    let mut bits: libc::c_int =
        brotli_min_int(ComputeRbBits(params), 24 as libc::c_int);
...
unsafe extern "C" fn ChooseHasher(
        ...
        && (*params).lgwin >= 19 as libc::c_int
    {
        ...
        (*hparams).num_last_distances_to_check =
            if (*params).quality < 7 as libc::c_int {
                4 as libc::c_int
            } else if (*params).quality < 9 as libc::c_int {
                10 as libc::c_int
            } else {
...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as libc::c_ulong != 0 {
        current_block = 3832267279414616450;
    } else {
    ...
    loop {
        match current_block {
            12517898123489920830 => {
                ...
                let fresh7 = population;
                population = population.offset(1);
                p = *fresh7 as size_t;
                sum =
                    (sum as libc::c_ulong).wrapping_add(p) as size_t as size_t;
                retval -= p as libc::c_double * FastLog2(p);
                current_block = 3832267279414616450;
            }
            _ => {
                let fresh8 = population;
                population = population.offset(1);
                p = *fresh8 as size_t;
                sum =
                    (sum as libc::c_ulong).wrapping_add(p) as size_t as size_t;
...
unsafe extern "C" fn InitMetaBlockSplit(mut mb: *mut MetaBlockSplit) {
    ...
    (*mb).literal_histograms = 0 as *mut HistogramLiteral;
    (*mb).literal_histograms_size = 0 as libc::c_int as size_t;
    (*mb).command_histograms = 0 as *mut HistogramCommand;
    (*mb).command_histograms_size = 0 as libc::c_int as size_t;
    (*mb).distance_histograms = 0 as *mut HistogramDistance;
...
unsafe extern "C" fn BrotliWriteBits(
    ...
    let mut p: *mut uint8_t =
        &mut *array.offset((*pos >> 3 as libc::c_int) as isize) as *mut uint8_t;
...
unsafe extern "C" fn UnprocessedInputSize(
    mut s: *mut BrotliEncoderState
) -> uint64_t {
    return ((*s).input_pos_).wrapping_sub((*s).last_processed_pos_);
}
unsafe extern "C" fn RemainingInputBlockSize(
    mut s: *mut BrotliEncoderState
) -> size_t {
    let delta: uint64_t = UnprocessedInputSize(s);
...
unsafe extern "C" fn WrapPosition(mut position: uint64_t) -> uint32_t {
    ...
    let mut gb: uint64_t = position >> 30 as libc::c_int;
...
unsafe extern "C" fn HashTableSize(
    ...
    let mut htsize: size_t = 256 as libc::c_int as size_t;
...
unsafe extern "C" fn GetHashTable(
    ...
    let mut m: *mut MemoryManager = &mut (*s).memory_manager_;
    let max_table_size: size_t = MaxHashTableSize(quality);
    ...
    if htsize
        <= (::core::mem::size_of::<[libc::c_int; 1024]>() as libc::c_ulong)
            .wrapping_div(::core::mem::size_of::<libc::c_int>() as libc::c_ulong)
    {
        ...
        if htsize > (*s).large_table_size_ {
            ...
            (*s)
                .large_table_ = if htsize > 0 as libc::c_int as libc::c_ulong {
                BrotliAllocate(
                    m,
                    htsize
                        .wrapping_mul(
...
unsafe extern "C" fn InitCommandPrefixCodes(
    ...
    static mut kDefaultCommandCodeNumBits: size_t =
        448 as libc::c_int as size_t;
    memcpy(
    ...
    memcpy(
        ...
        ::core::mem::size_of::<[uint16_t; 128]>() as libc::c_ulong
    );
    memcpy(
        cmd_code as *mut libc::c_void,
        kDefaultCommandCode.as_ptr() as *const libc::c_void,
        ::core::mem::size_of::<[uint8_t; 57]>() as libc::c_ulong
    );
...
unsafe extern "C" fn ChooseContextMap(
    ...
    let mut monogram_histo: [uint32_t; 3] =
        [0 as libc::c_int as uint32_t, 0, 0];
    let mut two_prefix_histo: [uint32_t; 6] =
        [0 as libc::c_int as uint32_t, 0, 0, 0, 0, 0];
    ...
    while i < 9 as libc::c_int as libc::c_ulong {
        monogram_histo
            [i.wrapping_rem(3 as libc::c_int as libc::c_ulong) as usize] =
            (monogram_histo
                [i.wrapping_rem(3 as libc::c_int as libc::c_ulong) as usize]
                as libc::c_uint)
                .wrapping_add(*bigram_histo.offset(i as isize))
                as uint32_t as uint32_t;
        two_prefix_histo
            [i.wrapping_rem(6 as libc::c_int as libc::c_ulong) as usize] =
            (two_prefix_histo
                [i.wrapping_rem(6 as libc::c_int as libc::c_ulong) as usize]
                as libc::c_uint)
                .wrapping_add(*bigram_histo.offset(i as isize))
    ...
    entropy[1 as libc::c_int as usize] = ShannonEntropy(
    ...
    while i < 3 as libc::c_int as libc::c_ulong {
        entropy[3 as libc::c_int as usize] += ShannonEntropy(
            bigram_histo
                .offset((3 as libc::c_int as libc::c_ulong).wrapping_mul(i)
                    as isize),
            3 as libc::c_int as size_t,
            &mut dummy
        );
    ...
    total = (monogram_histo[0 as libc::c_int as usize])
        ...
        .wrapping_add(monogram_histo[2 as libc::c_int as usize])
        as size_t;
    ...
    if quality < 7 as libc::c_int {
        entropy[3 as libc::c_int as usize] = entropy[1 as libc::c_int as usize]
            * 10 as libc::c_int as libc::c_double;
    }
    if entropy[1 as libc::c_int as usize] - entropy[2 as libc::c_int as usize]
        < 0.2f64
        && entropy[1 as libc::c_int as usize]
            - entropy[3 as libc::c_int as usize]
            < 0.2f64
    {
        *num_literal_contexts = 1 as libc::c_int as size_t;
    } else if entropy[2 as libc::c_int as usize]
        - entropy[3 as libc::c_int as usize]
        < 0.02f64
    {
...
unsafe extern "C" fn ShouldUseComplexStaticContextMap(
    ...
    if size_hint < ((1 as libc::c_int) << 20 as libc::c_int) as libc::c_ulong {
        ...
        let mut dummy: size_t = 0;
        let mut i: size_t = 0;
        let mut utf8_lut: ContextLut =
            &*_kBrotliContextLookupTable.as_ptr().offset(
                ((CONTEXT_UTF8 as libc::c_int) << 9 as libc::c_int) as isize
            ) as *const uint8_t;
        while start_pos.wrapping_add(64 as libc::c_int as libc::c_ulong)
            <= end_pos
        {
            let stride_end_pos: size_t =
                start_pos.wrapping_add(64 as libc::c_int as libc::c_ulong);
            let mut prev2: uint8_t = *input.offset((start_pos & mask) as isize);
            let mut prev1: uint8_t = *input.offset(
                (start_pos.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    & mask) as isize
            );
            ...
            while pos < stride_end_pos {
                ...
                combined_histo[(literal as libc::c_int >> 3 as libc::c_int)
                    ...
                    .wrapping_add(1);
                combined_histo
                    [(literal as libc::c_int >> 3 as libc::c_int) as usize];
                context_histo[context as usize]
                    [(literal as libc::c_int >> 3 as libc::c_int) as usize] =
                    (context_histo[context as usize][(literal as libc::c_int
                        >> 3 as libc::c_int)
                        as usize])
                        .wrapping_add(1);
                context_histo[context as usize]
        ...
        entropy[0 as libc::c_int as usize] = 1.0f64 / total as libc::c_double;
        entropy[1 as libc::c_int as usize] *=
            entropy[0 as libc::c_int as usize];
...
unsafe extern "C" fn DecideOverLiteralContextModeling(
    ...
    ) != 0)
    {
        ...
        let mut bigram_prefix_histo: [uint32_t; 9] =
            [0 as libc::c_int as uint32_t, 0, 0, 0, 0, 0, 0, 0, 0];
        while start_pos.wrapping_add(64 as libc::c_int as libc::c_ulong)
            <= end_pos
        {
            ...
            let mut prev: libc::c_int =
                lut[(*input.offset((start_pos & mask) as isize) as libc::c_int
            ...
            while pos < stride_end_pos {
                ...
                bigram_prefix_histo[(prev
                    + lut
                        [(literal as libc::c_int >> 6 as libc::c_int) as usize])
...
unsafe extern "C" fn ShouldCompress(
            ...
            .wrapping_add(2 as libc::c_int as libc::c_ulong)
    {
        if num_literals as libc::c_double > 0.99f64 * bytes as libc::c_double {
            ...
            let bit_cost_threshold: libc::c_double = bytes as libc::c_double
                * kMinEntropy
            ...
            while i < t {
                literal_histo[*data
                    .offset((pos as libc::c_ulong & mask) as isize)
                ...
                literal_histo[*data
                    .offset((pos as libc::c_ulong & mask) as isize)
                    as usize];
                pos = (pos as libc::c_uint).wrapping_add(kSampleRate)
                    as uint32_t as uint32_t;
                i = i.wrapping_add(1);
                i;
            }
            if BitsEntropy(
                literal_histo.as_mut_ptr(),
...
unsafe extern "C" fn WriteMetaBlockInternal(
    ...
    let wrapped_last_flush_pos: uint32_t = WrapPosition(last_flush_pos);
    let mut last_bytes: uint16_t = 0;
    let mut last_bytes_bits: uint8_t = 0;
    let mut literal_context_lut: ContextLut =
        &*_kBrotliContextLookupTable.as_ptr().offset(
    ...
    ) == 0
    {
        memcpy(
            ...
            (4 as libc::c_int as libc::c_ulong).wrapping_mul(
                ::core::mem::size_of::<libc::c_int>() as libc::c_ulong
            )
        );
    ...
    last_bytes = ((*storage.offset(1 as libc::c_int as isize) as libc::c_int)
        << 8 as libc::c_int
        | *storage.offset(0 as libc::c_int as isize) as libc::c_int)
        as uint16_t;
    ...
    if (*params).quality <= 2 as libc::c_int {
        ...
        if (*params).quality < 10 as libc::c_int {
            let mut num_literal_contexts: size_t = 1 as libc::c_int as size_t;
            let mut literal_context_map: *const uint32_t = 0 as *const uint32_t;
        ...
        < *storage_ix >> 3 as libc::c_int
    {
        ...
        *storage.offset(1 as libc::c_int as isize) =
...
unsafe extern "C" fn ChooseDistanceParams(
    mut params: *mut BrotliEncoderParams
) {
    let mut distance_postfix_bits: uint32_t = 0 as libc::c_int as uint32_t;
    let mut num_direct_distance_codes: uint32_t = 0 as libc::c_int as uint32_t;
    if (*params).quality >= 4 as libc::c_int {
...
unsafe extern "C" fn EnsureInitialized(
    ...
    let mut lgwin: libc::c_int = (*s).params.lgwin;
    if (*s).params.quality == 0 as libc::c_int
        || (*s).params.quality == 1 as libc::c_int
    {
...
unsafe extern "C" fn BrotliEncoderInitParams(
    mut params: *mut BrotliEncoderParams
) {
    ...
    (*params).dist.alphabet_size_max =
        ((16 as libc::c_int + 0 as libc::c_int) as libc::c_uint).wrapping_add(
            (24 as libc::c_uint) << 0 as libc::c_int + 1 as libc::c_int
        );
...
pub unsafe extern "C" fn BrotliEncoderCreateInstance(
    ...
    let mut state: *mut BrotliEncoderState = 0 as *mut BrotliEncoderState;
    if alloc_func.is_none() && free_func.is_none() {
        state = malloc(
            ::core::mem::size_of::<BrotliEncoderState>() as libc::c_ulong
...
pub unsafe extern "C" fn BrotliEncoderDestroyInstance(
    ...
    if state.is_null() {
        ...
        let mut opaque: *mut libc::c_void = (*m).opaque;
...
unsafe extern "C" fn CopyInputToRingBuffer(
    ...
    (*s).input_pos_ = ((*s).input_pos_ as libc::c_ulong)
        .wrapping_add(input_size) as uint64_t as uint64_t;
...
unsafe extern "C" fn UpdateLastProcessedPos(
    ...
    let mut wrapped_last_processed_pos: uint32_t =
...
unsafe extern "C" fn ExtendLastCommand(
    ...
    let mut last_command: *mut Command = &mut *((*s).commands_).offset(
        ((*s).num_commands_).wrapping_sub(1 as libc::c_int as libc::c_ulong)
            as isize
    ) as *mut Command;
    let mut data: *const uint8_t = (*s).ringbuffer_.buffer_;
    let mask: uint32_t = (*s).ringbuffer_.mask_;
    let mut max_backward_distance: uint64_t = ((1 as libc::c_int as uint64_t)
        << (*s).params.lgwin)
        .wrapping_sub(16 as libc::c_int as libc::c_ulong);
    let mut last_copy_len: uint64_t = ((*last_command).copy_len_
        & 0x1ffffff as libc::c_int as libc::c_uint)
        as uint64_t;
    let mut last_processed_pos: uint64_t =
        ((*s).last_processed_pos_).wrapping_sub(last_copy_len);
    let mut max_distance: uint64_t =
        if last_processed_pos < max_backward_distance {
            last_processed_pos
        } else {
            max_backward_distance
        };
    let mut cmd_dist: uint64_t =
        (*s).dist_cache_[0 as libc::c_int as usize] as uint64_t;
    let mut distance_code: uint32_t =
        CommandRestoreDistanceCode(last_command, &mut (*s).params.dist);
    if distance_code < 16 as libc::c_int as libc::c_uint
        || distance_code.wrapping_sub(
                ...
                && *data.offset((*wrapped_last_processed_pos & mask) as isize)
                    ...
                    == *data.offset(
                        ((*wrapped_last_processed_pos as libc::c_ulong)
                            .wrapping_sub(cmd_dist)
                            & mask as libc::c_ulong)
                            as isize
                    ) as libc::c_int
            {
                (*last_command).copy_len_ =
                    ((*last_command).copy_len_).wrapping_add(1);
                (*last_command).copy_len_;
                *bytes = (*bytes).wrapping_sub(1);
                *bytes;
                *wrapped_last_processed_pos =
                    (*wrapped_last_processed_pos).wrapping_add(1);
                *wrapped_last_processed_pos;
            }
        }
        GetLengthCode(
            ...
            (((*last_command).copy_len_
                & 0x1ffffff as libc::c_int as libc::c_uint)
                as libc::c_int
                + ((*last_command).copy_len_ >> 25 as libc::c_int)
                    as libc::c_int) as size_t,
            if (*last_command).dist_prefix_ as libc::c_int
                & 0x3ff as libc::c_int
                == 0 as libc::c_int
            {
                1 as libc::c_int
...
unsafe extern "C" fn EncodeData(
    ...
    let mut literal_context_lut: ContextLut = 0 as *const uint8_t;
    ...
    {
        (*s).command_buf_ = if kCompressFragmentTwoPassBlockSize
            > 0 as libc::c_int as libc::c_ulong
        {
            BrotliAllocate(
                m,
        ...
        (*s).literal_buf_ = if kCompressFragmentTwoPassBlockSize
            > 0 as libc::c_int as libc::c_ulong
        {
            BrotliAllocate(
                m,
        ...
        || (*s).params.quality == 1 as libc::c_int
    {
        ...
        storage = GetBrotliStorage(
            ...
            (2 as libc::c_int as libc::c_uint)
                .wrapping_mul(bytes)
                .wrapping_add(503 as libc::c_int as libc::c_uint)
                as size_t
        );
        if 0 as libc::c_int != 0 {
            return 0 as libc::c_int;
        }
        *storage.offset(0 as libc::c_int as isize) =
            (*s).last_bytes_ as uint8_t;
        *storage.offset(1 as libc::c_int as isize) =
        ...
        (*s).last_bytes_ = *storage
            .offset((storage_ix >> 3 as libc::c_int) as isize)
            as uint16_t;
        (*s).last_bytes_bits_ =
            (storage_ix & 7 as libc::c_uint as libc::c_ulong) as uint8_t;
        UpdateLastProcessedPos(s);
        *output =
            &mut *storage.offset(0 as libc::c_int as isize) as *mut uint8_t;
        *out_size = storage_ix >> 3 as libc::c_int;
        return 1 as libc::c_int;
    }
    let mut newsize: size_t = ((*s).num_commands_)
        .wrapping_add(bytes.wrapping_div(2 as libc::c_int as libc::c_uint)
            as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    if newsize > (*s).cmd_alloc_size_ {
        let mut new_commands: *mut Command = 0 as *mut Command;
        newsize = (newsize as libc::c_ulong).wrapping_add(
            bytes
        ...
        new_commands = if newsize > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                ...
                newsize.wrapping_mul(
                    ::core::mem::size_of::<Command>() as libc::c_ulong
                )
            ) as *mut Command
        } else {
            0 as *mut Command
    ...
    literal_context_lut = &*_kBrotliContextLookupTable.as_ptr().offset(
        ((literal_context_mode as libc::c_uint) << 9 as libc::c_int) as isize
    ) as *const uint8_t;
    if 0 as libc::c_int != 0 {
        return 0 as libc::c_int;
    }
    ...
    let max_length: size_t = MaxMetablockSize(&mut (*s).params);
    let max_literals: size_t =
        max_length.wrapping_div(8 as libc::c_int as libc::c_ulong);
    let max_commands: size_t =
        max_length.wrapping_div(8 as libc::c_int as libc::c_ulong);
    let processed_bytes: size_t =
        ((*s).input_pos_).wrapping_sub((*s).last_flush_pos_);
    let next_input_fits_metablock: libc::c_int =
        if processed_bytes.wrapping_add(InputBlockSize(s)) <= max_length {
            1 as libc::c_int
        } else {
            0 as libc::c_int
        };
    let should_flush: libc::c_int = if (*s).params.quality < 4 as libc::c_int
    ...
    if (*s).last_insert_len_ > 0 as libc::c_int as libc::c_ulong {
        let fresh9 = (*s).num_commands_;
        (*s).num_commands_ = ((*s).num_commands_).wrapping_add(1);
        InitInsertCommand(
            &mut *((*s).commands_).offset(fresh9 as isize),
            (*s).last_insert_len_
        );
        (*s).num_literals_ = ((*s).num_literals_ as libc::c_ulong)
            .wrapping_add((*s).last_insert_len_)
            as size_t as size_t;
        (*s).last_insert_len_ = 0 as libc::c_int as size_t;
    }
    ...
    let metablock_size: uint32_t =
        ((*s).input_pos_).wrapping_sub((*s).last_flush_pos_) as uint32_t;
    ...
    *storage_0.offset(1 as libc::c_int as isize) =
        ((*s).last_bytes_ as libc::c_int >> 8 as libc::c_int) as uint8_t;
    ...
    (*s).last_bytes_ = *storage_0
        .offset((storage_ix_0 >> 3 as libc::c_int) as isize)
        as uint16_t;
    (*s).last_bytes_bits_ =
        (storage_ix_0 & 7 as libc::c_uint as libc::c_ulong) as uint8_t;
    ...
    *header.offset(1 as libc::c_int as isize) =
    ...
    if block_size == 0 as libc::c_int as libc::c_ulong {
        ...
        let mut nbits: uint32_t =
            if block_size == 1 as libc::c_int as libc::c_ulong {
                0 as libc::c_int as libc::c_uint
            } else {
                (Log2FloorNonZero(
                    (block_size as uint32_t)
                        .wrapping_sub(1 as libc::c_int as libc::c_uint)
                        as size_t
                ))
                .wrapping_add(1 as libc::c_int as libc::c_uint)
...
unsafe extern "C" fn BrotliCompressBufferQuality10(
    ...
    let mut current_block: u64;
    let mut memory_manager: MemoryManager = MemoryManager {
        alloc_func: None,
        free_func: None,
        opaque: 0 as *mut libc::c_void
    };
    let mut m: *mut MemoryManager = &mut memory_manager;
    let mask: size_t = !(0 as libc::c_int as size_t) >> 1 as libc::c_int;
    ...
    let max_out_size: size_t = *encoded_size;
    let mut total_out_size: size_t = 0 as libc::c_int as size_t;
    let mut last_bytes: uint16_t = 0;
    let mut last_bytes_bits: uint8_t = 0;
    let hasher_eff_size: size_t = brotli_min_size_t(
        input_size,
        ((1 as libc::c_int as size_t) << lgwin)
            .wrapping_sub(16 as libc::c_int as libc::c_ulong)
    ...
    let lgmetablock: libc::c_int =
        brotli_min_int(24 as libc::c_int, lgwin + 1 as libc::c_int);
    let mut max_block_size: size_t = 0;
    let max_metablock_size: size_t =
        (1 as libc::c_int as size_t) << lgmetablock;
    let max_literals_per_metablock: size_t =
        max_metablock_size.wrapping_div(8 as libc::c_int as libc::c_ulong);
    let max_commands_per_metablock: size_t =
        max_metablock_size.wrapping_div(8 as libc::c_int as libc::c_ulong);
    let mut metablock_start: size_t = 0 as libc::c_int as size_t;
    let mut prev_byte: uint8_t = 0 as libc::c_int as uint8_t;
    let mut prev_byte2: uint8_t = 0 as libc::c_int as uint8_t;
    ...
    if 0 as libc::c_int != 0 {
        current_block = 5134792718928260434;
    } else {
        ...
        match current_block {
            ...
            _ => {
                if ok != 0 && metablock_start < input_size {
                    let metablock_end: size_t = brotli_min_size_t(
                        input_size,
                        metablock_start.wrapping_add(max_metablock_size)
                    );
                    let expected_num_commands: size_t = metablock_end
                        .wrapping_sub(metablock_start)
                        .wrapping_div(12 as libc::c_int as libc::c_ulong)
                        .wrapping_add(16 as libc::c_int as libc::c_ulong);
                    let mut commands: *mut Command = 0 as *mut Command;
                    let mut num_commands: size_t = 0 as libc::c_int as size_t;
                    let mut last_insert_len: size_t =
                        0 as libc::c_int as size_t;
                    let mut num_literals: size_t = 0 as libc::c_int as size_t;
                    let mut metablock_size: size_t = 0 as libc::c_int as size_t;
                    let mut cmd_alloc_size: size_t = 0 as libc::c_int as size_t;
                    let mut is_last: libc::c_int = 0;
                    let mut storage: *mut uint8_t = 0 as *mut uint8_t;
                    let mut storage_ix: size_t = 0;
                    let mut literal_context_mode: ContextType =
                        ChooseContextMode(
                            &mut params,
                            input_buffer,
                            metablock_start,
                    ...
                    let mut literal_context_lut: ContextLut =
                        &*_kBrotliContextLookupTable.as_ptr().offset(
                            ((literal_context_mode as libc::c_uint)
                                << 9 as libc::c_int)
                                as isize
                        ) as *const uint8_t;
                    ...
                    while block_start < metablock_end {
                        ...
                        let mut nodes: *mut ZopfliNode = if block_size
                            .wrapping_add(1 as libc::c_int as libc::c_ulong)
                            > 0 as libc::c_int as libc::c_ulong
                        {
                            BrotliAllocate(
                    ...
                    if last_insert_len > 0 as libc::c_int as libc::c_ulong {
                        let fresh10 = num_commands;
                        num_commands = num_commands.wrapping_add(1);
                        InitInsertCommand(
                            &mut *commands.offset(fresh10 as isize),
                            last_insert_len
                        );
                        num_literals = (num_literals as libc::c_ulong)
                            .wrapping_add(last_insert_len)
                            as size_t
                            as size_t;
                    }
                            ...
                            > 0 as libc::c_int as libc::c_ulong
                        {
                            BrotliAllocate(
                                ...
                                (2 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(metablock_size)
                                    .wrapping_add(
                                        503 as libc::c_int as libc::c_ulong
                                    )
                                    .wrapping_mul(
                                        ::core::mem::size_of::<uint8_t>()
                                            as libc::c_ulong
                    ...
                    last_bytes = *storage
                        .offset((storage_ix >> 3 as libc::c_int) as isize)
                        as uint16_t;
                    last_bytes_bits = (storage_ix
                        & 7 as libc::c_uint as libc::c_ulong)
                        as uint8_t;
                    metablock_start = (metablock_start as libc::c_ulong)
                        .wrapping_add(metablock_size)
                        as size_t
                        as size_t;
                    ...
                    let out_size: size_t = storage_ix >> 3 as libc::c_int;
                    ...
                    if total_out_size <= max_out_size {
                        ...
                        encoded_buffer =
                            encoded_buffer.offset(out_size as isize);
                    } else {
                        ok = 0 as libc::c_int;
                    }
...
pub unsafe extern "C" fn BrotliEncoderMaxCompressedSize(
    ...
    let mut num_large_blocks: size_t = input_size >> 14 as libc::c_int;
    let mut overhead: size_t = (2 as libc::c_int as libc::c_ulong)
        .wrapping_add(
            (4 as libc::c_int as libc::c_ulong).wrapping_mul(num_large_blocks)
        )
...
unsafe extern "C" fn MakeUncompressedStream(
    ...
    *output.offset(fresh11 as isize) = 0x21 as libc::c_int as uint8_t;
    let fresh12 = result;
    result = result.wrapping_add(1);
    *output.offset(fresh12 as isize) = 0x3 as libc::c_int as uint8_t;
    while size > 0 as libc::c_int as libc::c_ulong {
        let mut nibbles: uint32_t = 0 as libc::c_int as uint32_t;
        ...
        bits = nibbles << 1 as libc::c_int
            | chunk_size.wrapping_sub(1 as libc::c_int as libc::c_uint)
                << 3 as libc::c_int
            | (1 as libc::c_uint)
                << (19 as libc::c_int as libc::c_uint).wrapping_add(
                    (4 as libc::c_int as libc::c_uint).wrapping_mul(nibbles)
                );
        let fresh13 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh13 as isize) = bits as uint8_t;
        let fresh14 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh14 as isize) =
            (bits >> 8 as libc::c_int) as uint8_t;
        let fresh15 = result;
        result = result.wrapping_add(1);
        *output.offset(fresh15 as isize) =
            (bits >> 16 as libc::c_int) as uint8_t;
        if nibbles == 2 as libc::c_int as libc::c_uint {
            let fresh16 = result;
            result = result.wrapping_add(1);
            *output.offset(fresh16 as isize) =
                (bits >> 24 as libc::c_int) as uint8_t;
        }
        memcpy(
            &mut *output.offset(result as isize) as *mut uint8_t
                as *mut libc::c_void,
            &*input.offset(offset as isize) as *const uint8_t
                as *const libc::c_void,
            chunk_size as libc::c_ulong
        );
        result = (result as libc::c_ulong)
            .wrapping_add(chunk_size as libc::c_ulong)
            as size_t as size_t;
    ...
    let fresh17 = result;
    result = result.wrapping_add(1);
    *output.offset(fresh17 as isize) = 3 as libc::c_int as uint8_t;
    return result;
}
#[no_mangle]
pub unsafe extern "C" fn BrotliEncoderCompress(
    ...
    let mut s: *mut BrotliEncoderState = 0 as *mut BrotliEncoderState;
    let mut out_size: size_t = *encoded_size;
    let mut input_start: *const uint8_t = input_buffer;
    let mut output_start: *mut uint8_t = encoded_buffer;
    ...
    if quality == 10 as libc::c_int {
        let lg_win: libc::c_int = brotli_min_int(
            30 as libc::c_int,
            brotli_max_int(16 as libc::c_int, lgwin)
        );
        let mut ok: libc::c_int = BrotliCompressBufferQuality10(
            lg_win,
            input_size,
            input_buffer,
            encoded_size,
        ...
        if s.is_null() {
            ...
            let mut next_in: *const uint8_t = input_buffer;
            let mut available_out: size_t = *encoded_size;
            let mut next_out: *mut uint8_t = encoded_buffer;
            ...
            *encoded_size = total_out;
            ...
            if !(result == 0
                || max_out_size != 0 && *encoded_size > max_out_size)
            {
                return 1 as libc::c_int;
            }
        }
...
unsafe extern "C" fn InjectBytePaddingBlock(mut s: *mut BrotliEncoderState) {
    ...
    let mut destination: *mut uint8_t = 0 as *mut uint8_t;
    (*s).last_bytes_ = 0 as libc::c_int as uint16_t;
    (*s).last_bytes_bits_ = 0 as libc::c_int as uint8_t;
    ...
    *destination.offset(0 as libc::c_int as isize) = seal as uint8_t;
    if seal_bits > 8 as libc::c_int as libc::c_ulong {
        *destination.offset(1 as libc::c_int as isize) =
            (seal >> 8 as libc::c_int) as uint8_t;
    }
    if seal_bits > 16 as libc::c_int as libc::c_ulong {
        *destination.offset(2 as libc::c_int as isize) =
            (seal >> 16 as libc::c_int) as uint8_t;
    }
    (*s).available_out_ = ((*s).available_out_ as libc::c_ulong).wrapping_add(
        seal_bits.wrapping_add(7 as libc::c_int as libc::c_ulong)
            >> 3 as libc::c_int
    ) as size_t as size_t;
}
unsafe extern "C" fn InjectFlushOrPushOutput(
    ...
    {
        let mut copy_output_size: size_t =
        ...
        *available_out = (*available_out as libc::c_ulong)
            .wrapping_sub(copy_output_size) as size_t
            as size_t;
        (*s).next_out_ = ((*s).next_out_).offset(copy_output_size as isize);
        (*s).available_out_ = ((*s).available_out_ as libc::c_ulong)
            .wrapping_sub(copy_output_size)
            as size_t as size_t;
        (*s).total_out_ = ((*s).total_out_ as libc::c_ulong)
            .wrapping_add(copy_output_size) as size_t
            as size_t;
...
unsafe extern "C" fn BrotliEncoderCompressStreamFast(
    ...
    let block_size_limit: size_t =
        (1 as libc::c_int as size_t) << (*s).params.lgwin;
    let buf_size: size_t = brotli_min_size_t(
        kCompressFragmentTwoPassBlockSize,
        brotli_min_size_t(*available_in, block_size_limit)
    );
    let mut tmp_command_buf: *mut uint32_t = 0 as *mut uint32_t;
    let mut command_buf: *mut uint32_t = 0 as *mut uint32_t;
    let mut tmp_literal_buf: *mut uint8_t = 0 as *mut uint8_t;
    let mut literal_buf: *mut uint8_t = 0 as *mut uint8_t;
    let mut m: *mut MemoryManager = &mut (*s).memory_manager_;
    if (*s).params.quality != 0 as libc::c_int
        && (*s).params.quality != 1 as libc::c_int
    {
    ...
    loop {
        ...
        let mut is_last: libc::c_int = (*available_in == block_size
            && op as libc::c_uint
                == BROTLI_OPERATION_FINISH as libc::c_int as libc::c_uint)
            as libc::c_int;
        let mut force_flush: libc::c_int = (*available_in == block_size
            && op as libc::c_uint
                == BROTLI_OPERATION_FLUSH as libc::c_int as libc::c_uint)
            as libc::c_int;
        let mut max_out_size: size_t = (2 as libc::c_int as libc::c_ulong)
            .wrapping_mul(block_size)
            .wrapping_add(503 as libc::c_int as libc::c_ulong);
        let mut inplace: libc::c_int = 1 as libc::c_int;
        let mut storage: *mut uint8_t = 0 as *mut uint8_t;
        let mut storage_ix: size_t = (*s).last_bytes_bits_ as size_t;
        let mut table_size: size_t = 0;
        let mut table: *mut libc::c_int = 0 as *mut libc::c_int;
        if force_flush != 0 && block_size == 0 as libc::c_int as libc::c_ulong {
            ...
            *storage.offset(0 as libc::c_int as isize) =
                (*s).last_bytes_ as uint8_t;
            *storage.offset(1 as libc::c_int as isize) =
                ((*s).last_bytes_ as libc::c_int >> 8 as libc::c_int)
                    as uint8_t;
            table = GetHashTable(
                s,
                (*s).params.quality,
            ...
            if inplace != 0 {
                let mut out_bytes: size_t = storage_ix >> 3 as libc::c_int;
                *next_out = (*next_out).offset(out_bytes as isize);
                *available_out = (*available_out as libc::c_ulong)
                    .wrapping_sub(out_bytes)
                    as size_t as size_t;
                (*s).total_out_ = ((*s).total_out_ as libc::c_ulong)
                    .wrapping_add(out_bytes)
                    as size_t as size_t;
                if !total_out.is_null() {
                    *total_out = (*s).total_out_;
                }
            } else {
                let mut out_bytes_0: size_t = storage_ix >> 3 as libc::c_int;
                (*s).next_out_ = storage;
...
unsafe extern "C" fn ProcessMetadata(
    ...
    loop {
        ...
        if (*s).input_pos_ != (*s).last_flush_pos_ {
            let mut result: libc::c_int = EncodeData(
                s,
                0 as libc::c_int,
                1 as libc::c_int,
        ...
        } else if (*s).remaining_metadata_bytes_
            == 0 as libc::c_int as libc::c_uint
        {
            (*s).remaining_metadata_bytes_ = !(0 as libc::c_int as uint32_t);
            (*s).stream_state_ = BROTLI_STREAM_PROCESSING;
            ...
            let mut copy: uint32_t = brotli_min_size_t(
                (*s).remaining_metadata_bytes_ as size_t,
                *available_out
            ) as uint32_t;
            memcpy(
            ...
            *available_in = (*available_in as libc::c_ulong)
                .wrapping_sub(copy as libc::c_ulong)
                as size_t as size_t;
            (*s).remaining_metadata_bytes_ =
                ((*s).remaining_metadata_bytes_ as libc::c_uint)
                    .wrapping_sub(copy) as uint32_t as uint32_t;
            *next_out = (*next_out).offset(copy as isize);
            *available_out = (*available_out as libc::c_ulong)
                .wrapping_sub(copy as libc::c_ulong)
                as size_t as size_t;
        } else {
            let mut copy_0: uint32_t = brotli_min_uint32_t(
                (*s).remaining_metadata_bytes_,
            ...
            *available_in = (*available_in as libc::c_ulong)
                .wrapping_sub(copy_0 as libc::c_ulong)
                as size_t as size_t;
            (*s).remaining_metadata_bytes_ =
                ((*s).remaining_metadata_bytes_ as libc::c_uint)
                    .wrapping_sub(copy_0) as uint32_t
                    as uint32_t;
...
unsafe extern "C" fn UpdateSizeHint(
    ...
    if (*s).params.size_hint == 0 as libc::c_int as libc::c_ulong {
        ...
        let mut tail: uint64_t = available_in;
        let mut limit: uint32_t = (1 as libc::c_uint) << 30 as libc::c_int;
        let mut total: uint32_t = 0;
        if delta >= limit as libc::c_ulong
            || tail >= limit as libc::c_ulong
...
pub unsafe extern "C" fn BrotliEncoderCompressStream(
    ...
    loop {
            ...
            && *available_in != 0 as libc::c_int as libc::c_ulong
        {
            ...
            *available_in = (*available_in as libc::c_ulong)
                .wrapping_sub(copy_input_size)
                as size_t as size_t;
            if (*s).flint_ as libc::c_int > 0 as libc::c_int {
                (*s).flint_ = ((*s).flint_ as libc::c_int
                    - copy_input_size as libc::c_int)
                    as int8_t;
            }
        } else if InjectFlushOrPushOutput(s, available_out, next_out, total_out)
            != 0
        {
            ...
            let mut is_last: libc::c_int = if *available_in
                == 0 as libc::c_int as libc::c_ulong
                && op as libc::c_uint
                    == BROTLI_OPERATION_FINISH as libc::c_int as libc::c_uint
            {
            ...
            let mut force_flush: libc::c_int = if *available_in
                == 0 as libc::c_int as libc::c_ulong
                && op as libc::c_uint
                    == BROTLI_OPERATION_FLUSH as libc::c_int as libc::c_uint
            {
            ...
            if is_last == 0 && (*s).flint_ as libc::c_int == 0 as libc::c_int {
                (*s).flint_ =
                    BROTLI_FLINT_WAITING_FOR_FLUSHING as libc::c_int as int8_t;
...
pub unsafe extern "C" fn BrotliEncoderTakeOutput(
    ...
    if consumed_size != 0 {
        ...
        (*s).available_out_ = ((*s).available_out_ as libc::c_ulong)
            .wrapping_sub(consumed_size) as size_t
            as size_t;
        (*s).total_out_ = ((*s).total_out_ as libc::c_ulong)
            .wrapping_add(consumed_size) as size_t
            as size_t;
        CheckFlushComplete(s);
        *size = consumed_size;
    } else {
