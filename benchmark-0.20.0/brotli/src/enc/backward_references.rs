...
unsafe extern "C" fn PrepareDistanceCache(
    ...
    if num_distances > 4 as libc::c_int {
        let mut last_distance: libc::c_int =
            *distance_cache.offset(0 as libc::c_int as isize);
        *distance_cache.offset(4 as libc::c_int as isize) =
            last_distance - 1 as libc::c_int;
        *distance_cache.offset(5 as libc::c_int as isize) =
            last_distance + 1 as libc::c_int;
        *distance_cache.offset(6 as libc::c_int as isize) =
            last_distance - 2 as libc::c_int;
        *distance_cache.offset(7 as libc::c_int as isize) =
            last_distance + 2 as libc::c_int;
        *distance_cache.offset(8 as libc::c_int as isize) =
            last_distance - 3 as libc::c_int;
        *distance_cache.offset(9 as libc::c_int as isize) =
            last_distance + 3 as libc::c_int;
        if num_distances > 10 as libc::c_int {
            let mut next_last_distance: libc::c_int =
                *distance_cache.offset(1 as libc::c_int as isize);
            *distance_cache.offset(10 as libc::c_int as isize) =
                next_last_distance - 1 as libc::c_int;
            *distance_cache.offset(11 as libc::c_int as isize) =
                next_last_distance + 1 as libc::c_int;
            *distance_cache.offset(12 as libc::c_int as isize) =
                next_last_distance - 2 as libc::c_int;
            *distance_cache.offset(13 as libc::c_int as isize) =
                next_last_distance + 2 as libc::c_int;
            *distance_cache.offset(14 as libc::c_int as isize) =
                next_last_distance - 3 as libc::c_int;
            *distance_cache.offset(15 as libc::c_int as isize) =
                next_last_distance + 3 as libc::c_int;
        }
    }
}
...
unsafe extern "C" fn BackwardReferenceScore(
    ...
    return ((30 as libc::c_int * 8 as libc::c_int) as libc::c_ulong)
        ...
        .wrapping_add(
            (135 as libc::c_int as libc::c_ulong).wrapping_mul(copy_length)
        )
        .wrapping_sub(
...
unsafe extern "C" fn BackwardReferencePenaltyUsingLastDistance(
    ...
    return (39 as libc::c_int as size_t).wrapping_add(
...
unsafe extern "C" fn TestStaticDictionaryItem(
    ...
    offset = ((*(*dictionary).words).offsets_by_length[len as usize]
        as libc::c_ulong)
    ...
    if matchlen
        .wrapping_add((*dictionary).cutoffTransformsCount as libc::c_ulong)
        <= len
    ...
    let mut transform_id: size_t = (cut << 2 as libc::c_int).wrapping_add(
...
unsafe extern "C" fn SearchInStaticDictionary(
    ...
    let mut i: size_t = 0;
    if (*common).dict_num_matches
        < (*common).dict_num_lookups >> 7 as libc::c_int
    {
        return;
    }
        ...
        }) as libc::c_ulong
    {
        (*common).dict_num_lookups =
            ((*common).dict_num_lookups).wrapping_add(1);
        (*common).dict_num_lookups;
        if *((*dictionary).hash_table_lengths).offset(key as isize)
            as libc::c_int
            != 0 as libc::c_int
        {
            let mut item_matches: libc::c_int = TestStaticDictionaryItem(
                dictionary,
                *((*dictionary).hash_table_lengths).offset(key as isize)
                    as size_t,
                *((*dictionary).hash_table_words).offset(key as isize)
                    as size_t,
                data,
                max_length,
                max_backward,
            ...
            if item_matches != 0 {
                (*common).dict_num_matches =
                    ((*common).dict_num_matches).wrapping_add(1);
                (*common).dict_num_matches;
            }
        }
        i = i.wrapping_add(1);
...
unsafe extern "C" fn FindLongestMatchH2(
    ...
    let mut compare_char: libc::c_int = *data
        .offset(cur_ix_masked.wrapping_add(best_len_in) as isize)
        as libc::c_int;
    let mut key: size_t =
        HashBytesH2(&*data.offset(cur_ix_masked as isize)) as size_t;
    ...
    let mut cached_backward: size_t =
        *distance_cache.offset(0 as libc::c_int as isize) as size_t;
    ...
    if (1 as libc::c_int) << 0 as libc::c_int == 1 as libc::c_int {
        ...
        *buckets.offset(key as isize) = cur_ix as uint32_t;
        ...
        prev_ix &= ring_buffer_mask as uint32_t as libc::c_ulong;
        if compare_char
            != *data.offset(prev_ix.wrapping_add(best_len_in) as isize)
                as libc::c_int
        {
            return;
        }
        if (backward == 0 as libc::c_int as libc::c_ulong
            || backward > max_backward) as libc::c_int
            as libc::c_long
            != 0
        {
            return;
        ...
        if len_0 >= 4 as libc::c_int as libc::c_ulong {
            let score_0: size_t = BackwardReferenceScore(len_0, backward);
        ...
        while i < ((1 as libc::c_int) << 0 as libc::c_int) as libc::c_ulong {
            keys[i as usize] = key.wrapping_add(i << 3 as libc::c_int)
                & (((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
                    as libc::c_ulong;
            i = i.wrapping_add(1);
            i;
                    ...
                    as libc::c_int)
            {
                    ...
                    != 0)
                {
                    ...
                    if len_1 >= 4 as libc::c_int as libc::c_ulong {
                        let score_1: size_t =
                            BackwardReferenceScore(len_1, backward_0);
                        if best_score < score_1 {
                            best_len = len_1;
                            (*out).len = len_1;
                            compare_char =
                                *data
                                    .offset(cur_ix_masked.wrapping_add(len_1)
                                        as isize)
                                    as libc::c_int;
                            best_score = score_1;
                            (*out).score = score_1;
...
unsafe extern "C" fn FindLongestMatchH3(
    ...
    let mut compare_char: libc::c_int = *data
        ...
        as libc::c_int;
    let mut key: size_t =
        HashBytesH3(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
...
unsafe extern "C" fn FindLongestMatchH4(
    ...
    let mut compare_char: libc::c_int = *data
        ...
        as libc::c_int;
    let mut key: size_t =
        HashBytesH4(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
...
unsafe extern "C" fn FindLongestMatchH54(
    ...
    let mut compare_char: libc::c_int = *data
        ...
        as libc::c_int;
    let mut key: size_t =
        HashBytesH54(&*data.offset(cur_ix_masked as isize)) as size_t;
    let mut key_out: size_t = 0;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = best_len_in;
...
unsafe extern "C" fn StoreH5(
    ...
    *((*self_0).buckets_).offset(offset as isize) = ix as uint32_t;
    let ref mut fresh0 = *((*self_0).num_).offset(key as isize);
...
unsafe extern "C" fn FindLongestMatchH5(
        ...
        if !(prev_ix >= cur_ix) {
            if !((backward > max_backward) as libc::c_int as libc::c_long != 0)
            {
                            ...
                            as libc::c_int)
                {
                    ...
                    {
                        let mut score: size_t =
                            BackwardReferenceScoreUsingLastDistance(len);
                        if best_score < score {
                            if i != 0 as libc::c_int as libc::c_ulong {
                                score = (score as libc::c_ulong).wrapping_sub(
    ...
    let mut bucket: *mut uint32_t = &mut *buckets
        .offset((key << (*self_0).block_bits_) as isize)
        as *mut uint32_t;
    let down: size_t =
        if *num.offset(key as isize) as libc::c_ulong > (*self_0).block_size_ {
            (*num.offset(key as isize) as libc::c_ulong)
                .wrapping_sub((*self_0).block_size_)
        } else {
    ...
    while i > down {
        i = i.wrapping_sub(1);
        let mut prev_ix_0: size_t = *bucket
            .offset((i & (*self_0).block_mask_ as libc::c_ulong) as isize)
            as size_t;
        ...
        if cur_ix_masked.wrapping_add(best_len) > ring_buffer_mask
            ...
            || *data.offset(cur_ix_masked.wrapping_add(best_len) as isize)
                as libc::c_int
                != *data.offset(prev_ix_0.wrapping_add(best_len) as isize)
                    as libc::c_int
        {
            continue;
        }
    ...
    *bucket.offset(
        (*num.offset(key as isize) as libc::c_uint & (*self_0).block_mask_)
            as isize
    ) = cur_ix as uint32_t;
...
unsafe extern "C" fn FindLongestMatchH40(
    ...
    let mut addr: *mut uint32_t = AddrH40((*self_0).extra);
    let mut head: *mut uint16_t = HeadH40((*self_0).extra);
    let mut tiny_hashes: *mut uint8_t = TinyHashH40((*self_0).extra);
    let mut banks: *mut BankH40 = BanksH40((*self_0).extra);
    let cur_ix_masked: size_t = cur_ix & ring_buffer_mask;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = (*out).len;
    let mut i: size_t = 0;
    let key: size_t = HashBytesH40(&*data.offset(cur_ix_masked as isize));
    ...
    let bank: size_t =
        key & (1 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let mut backward_0: size_t = 0 as libc::c_int as size_t;
    let mut hops: size_t = (*self_0).max_hops;
    let mut delta: size_t =
        cur_ix.wrapping_sub(*addr.offset(key as isize) as libc::c_ulong);
    ...
    loop {
        ...
        slot =
            (*banks.offset(bank as isize)).slots[last as usize].next as size_t;
        delta =
            (*banks.offset(bank as isize)).slots[last as usize].delta as size_t;
        if cur_ix_masked.wrapping_add(best_len) > ring_buffer_mask
            || prev_ix_0.wrapping_add(best_len) > ring_buffer_mask
            || *data.offset(cur_ix_masked.wrapping_add(best_len) as isize)
                as libc::c_int
...
unsafe extern "C" fn StoreH41(
    ...
    let bank: size_t =
        key & (1 as libc::c_int - 1 as libc::c_int) as libc::c_ulong;
    let fresh6 = (*self_0).free_slot_idx[bank as usize];
    (*self_0).free_slot_idx[bank as usize] =
        ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh6 as libc::c_int
        & ((1 as libc::c_int) << 16 as libc::c_int) - 1 as libc::c_int)
        as size_t;
    let mut delta: size_t =
        ix.wrapping_sub(*addr.offset(key as isize) as libc::c_ulong);
...
unsafe extern "C" fn FindLongestMatchH41(
    ...
    let mut addr: *mut uint32_t = AddrH41((*self_0).extra);
    let mut head: *mut uint16_t = HeadH41((*self_0).extra);
    let mut tiny_hashes: *mut uint8_t = TinyHashH41((*self_0).extra);
    let mut banks: *mut BankH41 = BanksH41((*self_0).extra);
    let cur_ix_masked: size_t = cur_ix & ring_buffer_mask;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = (*out).len;
    let mut i: size_t = 0;
    let key: size_t = HashBytesH41(&*data.offset(cur_ix_masked as isize));
    let tiny_hash: uint8_t = key as uint8_t;
    (*out).len = 0 as libc::c_int as size_t;
    (*out).len_code_delta = 0 as libc::c_int;
    i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn StoreH42(
    ...
    (*self_0).free_slot_idx[bank as usize] =
        ((*self_0).free_slot_idx[bank as usize]).wrapping_add(1);
    let idx: size_t = (fresh8 as libc::c_int
...
unsafe extern "C" fn FindLongestMatchH42(
    ...
    let mut addr: *mut uint32_t = AddrH42((*self_0).extra);
    let mut head: *mut uint16_t = HeadH42((*self_0).extra);
    let mut tiny_hashes: *mut uint8_t = TinyHashH42((*self_0).extra);
    let mut banks: *mut BankH42 = BanksH42((*self_0).extra);
    let cur_ix_masked: size_t = cur_ix & ring_buffer_mask;
    let mut min_score: size_t = (*out).score;
    let mut best_score: size_t = (*out).score;
    let mut best_len: size_t = (*out).len;
    let mut i: size_t = 0;
    let key: size_t = HashBytesH42(&*data.offset(cur_ix_masked as isize));
    let tiny_hash: uint8_t = key as uint8_t;
    (*out).len = 0 as libc::c_int as size_t;
    (*out).len_code_delta = 0 as libc::c_int;
    i = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn FindLongestMatchHROLLING_FAST(
    ...
    pos = (*self_0).next_ix;
    while pos <= cur_ix {
        let mut code: uint32_t = (*self_0).state
            & (16777216 as libc::c_int * 64 as libc::c_int - 1 as libc::c_int)
                as libc::c_uint;
        let mut rem: uint8_t = *data.offset((pos & ring_buffer_mask) as isize);
        let mut add: uint8_t = *data.offset(
            (pos.wrapping_add(32 as libc::c_int as libc::c_ulong)
                & ring_buffer_mask) as isize
        );
        ...
        if code < 16777216 as libc::c_int as libc::c_uint {
            ...
            *((*self_0).table).offset(code as isize) = pos as uint32_t;
            if pos == cur_ix
                && found_ix != kInvalidPosHROLLING_FAST as libc::c_ulong
            {
                let mut backward: size_t =
                    cur_ix.wrapping_sub(found_ix) as uint32_t as size_t;
                if backward <= max_backward {
                    ...
                    {
                        let mut score: size_t =
                            BackwardReferenceScore(len, backward);
                        if score > (*out).score {
                            (*out).len = len;
                            (*out).distance = backward;
                            (*out).score = score;
...
unsafe extern "C" fn ComputeDistanceCode(
    ...
    if distance <= max_distance {
        let mut distance_plus_3: size_t =
            distance.wrapping_add(3 as libc::c_int as libc::c_ulong);
        let mut offset0: size_t = distance_plus_3.wrapping_sub(
            *dist_cache.offset(0 as libc::c_int as isize) as size_t
        );
        let mut offset1: size_t = distance_plus_3.wrapping_sub(
            *dist_cache.offset(1 as libc::c_int as isize) as size_t
        );
...
unsafe extern "C" fn CreateBackwardReferencesNH2(
    ...
    let random_heuristics_window_size: size_t =
        LiteralSpreeLengthForSparseSearch(params);
    let mut apply_random_heuristics: size_t =
        position.wrapping_add(random_heuristics_window_size);
    let gap: size_t = 0 as libc::c_int as size_t;
    let kMinScore: size_t = ((30 as libc::c_int * 8 as libc::c_int)
        as libc::c_ulong)
        .wrapping_mul(::core::mem::size_of::<size_t>() as libc::c_ulong)
    ...
    while position.wrapping_add(HashTypeLengthH2()) < pos_end {
        ...
        if sr.score > kMinScore {
            let mut delayed_backward_references_in_row: libc::c_int =
                0 as libc::c_int;
            max_length = max_length.wrapping_sub(1);
            max_length;
            loop {
                let cost_diff_lazy: size_t = 175 as libc::c_int as size_t;
                ...
                sr2.len = if (*params).quality < 5 as libc::c_int {
                    brotli_min_size_t(
                        (sr.len)
                            .wrapping_sub(1 as libc::c_int as libc::c_ulong),
                        max_length
            ...
            apply_random_heuristics = position
                .wrapping_add(
                    (2 as libc::c_int as libc::c_ulong).wrapping_mul(sr.len)
                )
            ...
            let mut distance_code: size_t = ComputeDistanceCode(
                sr.distance,
                dictionary_start.wrapping_add(gap),
                dist_cache
            );
                ...
                && distance_code > 0 as libc::c_int as libc::c_ulong
            {
                ...
                *dist_cache.offset(0 as libc::c_int as isize) =
                    sr.distance as libc::c_int;
                PrepareDistanceCacheH2(privat, dist_cache);
            }
            let fresh10 = commands;
            ...
            *num_literals = (*num_literals as libc::c_ulong)
                .wrapping_add(insert_length)
                as size_t as size_t;
            insert_length = 0 as libc::c_int as size_t;
            let mut range_start: size_t =
                position.wrapping_add(2 as libc::c_int as libc::c_ulong);
            let mut range_end: size_t =
            ...
            position = (position as libc::c_ulong).wrapping_add(sr.len)
                as size_t as size_t;
        } else {
            insert_length = insert_length.wrapping_add(1);
            insert_length;
            ...
            if position > apply_random_heuristics {
                if position
                    > apply_random_heuristics.wrapping_add(
    ...
    insert_length = (insert_length as libc::c_ulong)
        .wrapping_add(pos_end.wrapping_sub(position))
        as size_t as size_t;
    *last_insert_len = insert_length;
    *num_commands = (*num_commands as libc::c_ulong).wrapping_add(
        commands.offset_from(orig_commands) as libc::c_long as size_t
    ) as size_t as size_t;
}
#[inline(never)]
