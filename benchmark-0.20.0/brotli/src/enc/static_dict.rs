...
unsafe extern "C" fn Hash(mut data: *const uint8_t) -> uint32_t {
    let mut h: uint32_t = (BrotliUnalignedRead32(data as *const libc::c_void))
        .wrapping_mul(kDictHashMul32);
    return h >> 32 as libc::c_int - kDictNumBits;
}
#[inline(always)]
unsafe extern "C" fn AddMatch(
    ...
    let mut match_0: uint32_t =
        (distance << 5 as libc::c_int).wrapping_add(len_code) as uint32_t;
...
unsafe extern "C" fn DictMatchLength(
    ...
    let offset: size_t = ((*dictionary).offsets_by_length[len as usize]
        as libc::c_ulong)
...
unsafe extern "C" fn IsMatch(
    ...
    if w.len as libc::c_ulong > max_length {
        ...
        let offset: size_t = ((*dictionary).offsets_by_length[w.len as usize]
            as libc::c_ulong)
            .wrapping_add((w.len as size_t).wrapping_mul(w.idx as size_t));
        let mut dict: *const uint8_t =
        ...
        if w.transform as libc::c_int == 0 as libc::c_int {
            ...
            while i < w.len as libc::c_ulong {
                ...
                {
                    if *dict.offset(i as isize) as libc::c_int
                        ^ 32 as libc::c_int
...
pub unsafe extern "C" fn BrotliFindAllStaticDictionaryMatches(
    ...
    let mut has_found_match: libc::c_int = 0 as libc::c_int;
    let mut offset: size_t =
        *((*dictionary).buckets).offset(Hash(data) as isize) as size_t;
    let mut end: libc::c_int = (offset == 0) as libc::c_int;
    while end == 0 {
        let fresh0 = offset;
        offset = offset.wrapping_add(1);
        let mut w: DictWord =
            *((*dictionary).dict_words).offset(fresh0 as isize);
        let l: size_t = (w.len as libc::c_int & 0x1f as libc::c_int) as size_t;
        let n: size_t = (1 as libc::c_int as size_t)
            << (*(*dictionary).words).size_bits_by_length[l as usize]
                as libc::c_int;
        ...
        if w.transform as libc::c_int == 0 as libc::c_int {
            ...
            if matchlen >= l.wrapping_sub(1 as libc::c_int as libc::c_ulong) {
                ...
                if l.wrapping_add(2 as libc::c_int as libc::c_ulong)
                    < max_length
                    && *data.offset(
                        l.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                            as isize
            ...
            while len <= maxlen {
                ...
                let mut transform_id: size_t = (cut << 2 as libc::c_int)
                    .wrapping_add(
            ...
            if *s.offset(0 as libc::c_int as isize) as libc::c_int == ' ' as i32
            {
                    ...
                    == 'a' as i32
                {
                    ...
                    } else if *s.offset(2 as libc::c_int as isize)
                        as libc::c_int
                        == 's' as i32
                    {
                    ...
                    == 'i' as i32
                {
                        ...
                        == 's' as i32
                    {
                            ...
                            == ' ' as i32
                        {
                            AddMatch(
                                id.wrapping_add(
                                    (47 as libc::c_int as libc::c_ulong)
                                        .wrapping_mul(n)
                                ),
                                l.wrapping_add(
                                    4 as libc::c_int as libc::c_ulong
                    ...
                    == 'f' as i32
                {
                        ...
                        == 'r' as i32
                    {
                                ...
                                == ' ' as i32
                        {
                            AddMatch(
                                id.wrapping_add(
                                    (37 as libc::c_int as libc::c_ulong)
                                        .wrapping_mul(n)
                                ),
                                l.wrapping_add(
                                    6 as libc::c_int as libc::c_ulong
                    ...
                    == 't' as i32
                {
                        ...
                        == 'h' as i32
                    {
                        ...
                        } else if *s.offset(3 as libc::c_int as isize)
                            as libc::c_int
                            == 'a' as i32
                        {
                            if *s.offset(4 as libc::c_int as isize)
                ...
                == '.' as i32
            {
                    ...
                    == ' ' as i32
                {
                            ...
                            == 'h' as i32
                    {
                        ...
                        } else if *s.offset(4 as libc::c_int as isize)
                            as libc::c_int
                            == 'i' as i32
                        {
                            if *s.offset(5 as libc::c_int as isize)
                ...
                == '=' as i32
            {
                    ...
                    == '"' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                            (70 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(n)
                        ),
                        l.wrapping_add(2 as libc::c_int as libc::c_ulong),
                        l,
                    ...
                    == '\'' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                            (86 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(n)
                        ),
                        l.wrapping_add(2 as libc::c_int as libc::c_ulong),
                        l,
                ...
                == 'a' as i32
            {
                        ...
                        == ' ' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                            (84 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(n)
                        ),
                        l.wrapping_add(3 as libc::c_int as libc::c_ulong),
                        l,
                ...
                == 'e' as i32
            {
                    ...
                    == 'r' as i32
                {
                        ...
                        == ' ' as i32
                    {
                        AddMatch(
                            id.wrapping_add(
                                (82 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n)
                            ),
                            l.wrapping_add(3 as libc::c_int as libc::c_ulong),
                            l,
                    ...
                    == 's' as i32
                {
                            ...
                            == ' ' as i32
                    {
                        AddMatch(
                            id.wrapping_add(
                                (95 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n)
                            ),
                            l.wrapping_add(4 as libc::c_int as libc::c_ulong),
                            l,
                ...
                == 'f' as i32
            {
                        ...
                        == ' ' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                            (90 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(n)
                        ),
                        l.wrapping_add(4 as libc::c_int as libc::c_ulong),
                        l,
                ...
                == 'l' as i32
            {
                    ...
                    == 'e' as i32
                {
                            ...
                            == ' ' as i32
                    {
                        AddMatch(
                            id.wrapping_add(
                                (93 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n)
                            ),
                            l.wrapping_add(5 as libc::c_int as libc::c_ulong),
                            l,
                    ...
                    == 'y' as i32
                {
                        ...
                        == ' ' as i32
                    {
                        AddMatch(
                            id.wrapping_add(
                                (61 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n)
                            ),
                            l.wrapping_add(3 as libc::c_int as libc::c_ulong),
                            l,
                ...
                == 'o' as i32
            {
                        ...
                        == ' ' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                            (106 as libc::c_int as libc::c_ulong)
                                .wrapping_mul(n)
                        ),
                        l.wrapping_add(4 as libc::c_int as libc::c_ulong),
                        l,
            ...
            let is_all_caps: libc::c_int = if w.transform as libc::c_int
            ...
            if *s_0.offset(0 as libc::c_int as isize) as libc::c_int
                == ' ' as i32
            {
                AddMatch(
                    id.wrapping_add(
                ...
                == '"' as i32
            {
                ...
                if *s_0.offset(1 as libc::c_int as isize) as libc::c_int
                    == '>' as i32
                {
                    AddMatch(
                        id.wrapping_add(
                ...
                == '.' as i32)
    {
        ...
        let mut offset_0: size_t = *((*dictionary).buckets)
            .offset(Hash(&*data.offset(1 as libc::c_int as isize)) as isize)
            as size_t;
        let mut end_0: libc::c_int = (offset_0 == 0) as libc::c_int;
        while end_0 == 0 {
            let fresh1 = offset_0;
            offset_0 = offset_0.wrapping_add(1);
            let mut w_0: DictWord =
                *((*dictionary).dict_words).offset(fresh1 as isize);
            let l_0: size_t =
                (w_0.len as libc::c_int & 0x1f as libc::c_int) as size_t;
            let n_0: size_t = (1 as libc::c_int as size_t)
                << (*(*dictionary).words).size_bits_by_length[l_0 as usize]
                    as libc::c_int;
            let id_0: size_t = w_0.idx as size_t;
            end_0 = (w_0.len as libc::c_int & 0x80 as libc::c_int != 0)
                as libc::c_int;
            ...
            if w_0.transform as libc::c_int == 0 as libc::c_int {
                ...
                has_found_match = 1 as libc::c_int;
                if l_0.wrapping_add(2 as libc::c_int as libc::c_ulong)
                    >= max_length
                {
                    continue;
                }
                s_1 = &*data
                    .offset(l_0.wrapping_add(1 as libc::c_int as libc::c_ulong)
                    ...
                    == '(' as i32
                {
                        ...
                        == ',' as i32
                    {
                        AddMatch(
                            id_0.wrapping_add(
                                (103 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n_0)
                            ),
                            l_0.wrapping_add(2 as libc::c_int as libc::c_ulong),
                            l_0,
                    ...
                    } else if *s_1.offset(0 as libc::c_int as isize)
                        as libc::c_int
                        == '.' as i32
                    {
                        AddMatch(
                            id_0.wrapping_add(
                                (71 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n_0)
                            ),
                            l_0.wrapping_add(2 as libc::c_int as libc::c_ulong),
                            l_0,
                        ...
                        == '=' as i32
                    {
                            ...
                            == '"' as i32
                        {
                            AddMatch(
                                id_0.wrapping_add(
                                    (81 as libc::c_int as libc::c_ulong)
                                        .wrapping_mul(n_0)
                                ),
                                l_0.wrapping_add(
                                    3 as libc::c_int as libc::c_ulong
                        ...
                        } else if *s_1.offset(1 as libc::c_int as isize)
                            as libc::c_int
                            == '\'' as i32
                        {
                            AddMatch(
                                id_0.wrapping_add(
                                    (98 as libc::c_int as libc::c_ulong)
                                        .wrapping_mul(n_0)
                                ),
                                l_0.wrapping_add(
                                    3 as libc::c_int as libc::c_ulong
                ...
                let is_all_caps_0: libc::c_int = if w_0.transform as libc::c_int
                    != BROTLI_TRANSFORM_UPPERCASE_FIRST as libc::c_int
                {
                    1 as libc::c_int
                } else {
                ...
                let mut s_2: *const uint8_t = 0 as *const uint8_t;
                if IsMatch(
                    (*dictionary).words,
                    w_0,
                    &*data.offset(1 as libc::c_int as isize),
                ...
                s_2 = &*data
                    .offset(l_0.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        as isize) as *const uint8_t;
                if *s_2.offset(0 as libc::c_int as isize) as libc::c_int
                    == ' ' as i32
                {
                    AddMatch(
                        id_0.wrapping_add(
                    ...
                    == ',' as i32
                {
                    if is_all_caps_0 == 0 {
                        AddMatch(
                            id_0.wrapping_add(
                                (109 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n_0)
                            ),
                            l_0.wrapping_add(2 as libc::c_int as libc::c_ulong),
                            l_0,
                    ...
                    == '=' as i32
                {
                    ...
                    } else if *s_2.offset(1 as libc::c_int as isize)
                        as libc::c_int
                        == '\'' as i32
                    {
                        AddMatch(
        ...
        if *data.offset(1 as libc::c_int as isize) as libc::c_int == ' ' as i32
            ...
            || *data.offset(0 as libc::c_int as isize) as libc::c_int
                ...
                && *data.offset(1 as libc::c_int as isize) as libc::c_int
                    == 0xa0 as libc::c_int
        {
            let mut offset_1: size_t = *((*dictionary).buckets)
                .offset(Hash(&*data.offset(2 as libc::c_int as isize)) as isize)
                as size_t;
            let mut end_1: libc::c_int = (offset_1 == 0) as libc::c_int;
            while end_1 == 0 {
                let fresh2 = offset_1;
                offset_1 = offset_1.wrapping_add(1);
                let mut w_1: DictWord =
                    *((*dictionary).dict_words).offset(fresh2 as isize);
                let l_1: size_t =
                    (w_1.len as libc::c_int & 0x1f as libc::c_int) as size_t;
                let n_1: size_t = (1 as libc::c_int as size_t)
                    ...
                    ) != 0
                {
                        ...
                        == 0xc2 as libc::c_int
                    {
                        AddMatch(
                            id_1.wrapping_add(
                                (102 as libc::c_int as libc::c_ulong)
                                    .wrapping_mul(n_1)
                            ),
                    ...
                    {
                        let mut t: size_t =
                            (if *data.offset(0 as libc::c_int as isize)
                                as libc::c_int
                                == 'e' as i32
                            {
                                18 as libc::c_int
        ...
        if *data.offset(0 as libc::c_int as isize) as libc::c_int == ' ' as i32
            ...
            || *data.offset(0 as libc::c_int as isize) as libc::c_int
                ...
                && *data.offset(4 as libc::c_int as isize) as libc::c_int
                    == '/' as i32
        {
            let mut offset_2: size_t = *((*dictionary).buckets)
                .offset(Hash(&*data.offset(5 as libc::c_int as isize)) as isize)
                as size_t;
            let mut end_2: libc::c_int = (offset_2 == 0) as libc::c_int;
            while end_2 == 0 {
                let fresh3 = offset_2;
                offset_2 = offset_2.wrapping_add(1);
                let mut w_2: DictWord =
                    *((*dictionary).dict_words).offset(fresh3 as isize);
                let l_2: size_t =
                    (w_2.len as libc::c_int & 0x1f as libc::c_int) as size_t;
                let n_2: size_t = (1 as libc::c_int as size_t)
                    ...
                    ) != 0
                {
                    ...
                    has_found_match = 1 as libc::c_int;
                    if l_2.wrapping_add(5 as libc::c_int as libc::c_ulong)
                        < max_length
                    {
                        let mut s_3: *const uint8_t = &*data.offset(
                            l_2.wrapping_add(5 as libc::c_int as libc::c_ulong)
                                as isize
                        )
                            as *const uint8_t;
                            ...
                            == ' ' as i32
                        {
                            if l_2
                                .wrapping_add(8 as libc::c_int as libc::c_ulong)
                                < max_length
                                && *s_3.offset(0 as libc::c_int as isize)
                                    as libc::c_int
                                    == ' ' as i32
                                && *s_3.offset(1 as libc::c_int as isize)
                                    as libc::c_int
                                    == 'o' as i32
                                && *s_3.offset(2 as libc::c_int as isize)
                                    as libc::c_int
                                    == 'f' as i32
                                && *s_3.offset(3 as libc::c_int as isize)
                                    as libc::c_int
                                    == ' ' as i32
                            {
                                AddMatch(
                                ...
                                if l_2.wrapping_add(
                                    ...
                                    && *s_3.offset(4 as libc::c_int as isize)
                                        as libc::c_int
                                        == 't' as i32
                                    && *s_3.offset(5 as libc::c_int as isize)
                                        as libc::c_int
                                        == 'h' as i32
                                    && *s_3.offset(6 as libc::c_int as isize)
                                        as libc::c_int
                                        == 'e' as i32
                                    && *s_3.offset(7 as libc::c_int as isize)
                                        as libc::c_int
                                        == ' ' as i32
                                {
                                    AddMatch(
