...
pub unsafe extern "C" fn BrotliSetDepth(
    ...
    loop {
        if (*pool.offset(p as isize)).index_left_ as libc::c_int
            >= 0 as libc::c_int
        {
            level += 1;
            level;
            ...
            stack[level as usize] =
                (*pool.offset(p as isize)).index_right_or_value_ as libc::c_int;
        ...
        if n == 1 as libc::c_int as libc::c_ulong {
            ...
            *tree.offset(
            ...
            while k != 0 as libc::c_int as libc::c_ulong {
                ...
                let mut j_end: size_t = (2 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(n)
                    .wrapping_sub(k);
                (*tree.offset(j_end as isize)).total_count_ = ((*tree
                ...
                (*tree.offset(j_end as isize)).index_right_or_value_ =
                    right as int16_t;
                *tree.offset(
                    j_end.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        as isize
                ) = sentinel;
                k = k.wrapping_sub(1);
                k;
...
unsafe extern "C" fn BrotliWriteHuffmanTreeRepetitions(
    ...
    if previous_value as libc::c_int != value as libc::c_int {
        ...
        *extra_bits_data.offset(*tree_size as isize) =
...
pub unsafe extern "C" fn BrotliOptimizeHuffmanCountsForRle(
    ...
    let mut smallest_nonzero: uint32_t =
        ((1 as libc::c_int) << 30 as libc::c_int) as uint32_t;
    i = 0 as libc::c_int as size_t;
    while i < length {
    ...
    if smallest_nonzero < 4 as libc::c_int as libc::c_uint {
        ...
        if zeros < 6 as libc::c_int as libc::c_ulong {
            ...
            while i < length.wrapping_sub(1 as libc::c_int as libc::c_ulong) {
                if *counts
                    .offset(i.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        as isize)
                    != 0 as libc::c_int as libc::c_uint
    ...
    while i <= length {
        if i == length
            || *good_for_rle.offset(i as isize) as libc::c_int != 0
            ...
            || ((256 as libc::c_int as libc::c_uint)
                .wrapping_mul(*counts.offset(i as isize))
                as libc::c_ulong)
                .wrapping_sub(limit)
                .wrapping_add(streak_limit)
                >= (2 as libc::c_int as libc::c_ulong)
                    .wrapping_mul(streak_limit)
        {
                    ...
                    && sum == 0 as libc::c_int as libc::c_ulong
            {
                ...
                let mut count: size_t = sum
                    .wrapping_add(
                        stride.wrapping_div(2 as libc::c_int as libc::c_ulong)
                    )
                    .wrapping_div(stride);
            ...
            if i < length.wrapping_sub(2 as libc::c_int as libc::c_ulong) {
                limit =
                    (256 as libc::c_int as libc::c_uint)
                        .wrapping_mul(
                            (*counts.offset(i as isize))
                                .wrapping_add(*counts.offset(i.wrapping_add(
                        ...
                        .wrapping_div(3 as libc::c_int as libc::c_uint)
                        .wrapping_add(420 as libc::c_int as libc::c_uint)
                        as size_t;
            } else if i < length {
                limit = (256 as libc::c_int as libc::c_uint)
                    .wrapping_mul(*counts.offset(i as isize))
        ...
        if i != length {
            sum = (sum as libc::c_ulong)
                .wrapping_add(*counts.offset(i as isize) as libc::c_ulong)
                as size_t as size_t;
            if stride >= 4 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn DecideOverRleUse(
    ...
    while i < length {
        ...
        {
            total_reps_zero = (total_reps_zero as libc::c_ulong)
                .wrapping_add(reps) as size_t
                as size_t;
    ...
    *use_rle_for_zero = if total_reps_zero
...
pub unsafe extern "C" fn BrotliWriteHuffmanTree(
    ...
    while i < new_length {
            ...
            || value as libc::c_int == 0 as libc::c_int && use_rle_for_zero != 0
        {
            ...
            k = i.wrapping_add(1 as libc::c_int as libc::c_ulong);
            while k < new_length
                && *depth.offset(k as isize) as libc::c_int
                    == value as libc::c_int
            {
                reps = reps.wrapping_add(1);
                reps;
...
unsafe extern "C" fn BrotliReverseBits(
    ...
    let mut retval: size_t =
        kLut[(bits as libc::c_int & 0xf as libc::c_int) as usize];
    let mut i: size_t = 0;
...
pub unsafe extern "C" fn BrotliConvertBitDepthsToSymbols(
    ...
    while i < 16 as libc::c_int as libc::c_ulong {
        code = (code
            + bl_count
                [i.wrapping_sub(1 as libc::c_int as libc::c_ulong) as usize]
                as libc::c_int)
            << 1 as libc::c_int;
