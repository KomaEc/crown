...
unsafe extern "C" fn BuildAndStoreLiteralPrefixCode(
    ...
    if input_size < ((1 as libc::c_int) << 15 as libc::c_int) as libc::c_ulong {
        ...
        while i < 256 as libc::c_int as libc::c_ulong {
            let adjust: uint32_t = (2 as libc::c_int as libc::c_uint)
                .wrapping_mul(brotli_min_uint32_t(
                    histogram[i as usize],
                    11 as libc::c_uint
                ));
            histogram[i as usize] = (histogram[i as usize] as libc::c_uint)
                .wrapping_add(adjust)
                as uint32_t as uint32_t;
            histogram_total = (histogram_total as libc::c_ulong)
                .wrapping_add(adjust as libc::c_ulong)
                as size_t as size_t;
            i = i.wrapping_add(1);
            i;
        }
        ...
        while i < input_size {
            histogram[*input.offset(i as isize) as usize] =
                (histogram[*input.offset(i as isize) as usize]).wrapping_add(1);
            histogram[*input.offset(i as isize) as usize];
            i = (i as libc::c_ulong).wrapping_add(kSampleRate) as size_t
                as size_t;
        }
        histogram_total = input_size
        ...
        i = 0 as libc::c_int as size_t;
        while i < 256 as libc::c_int as libc::c_ulong {
            let adjust_0: uint32_t = (1 as libc::c_int as libc::c_uint)
                .wrapping_add((2 as libc::c_int as libc::c_uint).wrapping_mul(
                    brotli_min_uint32_t(
                        histogram[i as usize],
                        11 as libc::c_uint
                    )
            ...
            histogram[i as usize] = (histogram[i as usize] as libc::c_uint)
                ...
                as uint32_t as uint32_t;
            histogram_total = (histogram_total as libc::c_ulong)
                .wrapping_add(adjust_0 as libc::c_ulong)
                as size_t as size_t;
            i = i.wrapping_add(1);
            i;
        }
    ...
    while i < 256 as libc::c_int as libc::c_ulong {
        if histogram[i as usize] != 0 {
            literal_ratio = (literal_ratio as libc::c_ulong).wrapping_add(
                (histogram[i as usize])
...
unsafe extern "C" fn BuildAndStoreCommandPrefixCode(
    ...
    while i < 8 as libc::c_int as libc::c_ulong {
        cmd_depth[(128 as libc::c_int as libc::c_ulong)
            ...
            as usize] =
            *depth
                .offset((40 as libc::c_int as libc::c_ulong).wrapping_add(i)
                    as isize);
        cmd_depth[(256 as libc::c_int as libc::c_ulong)
            .wrapping_add((8 as libc::c_int as libc::c_ulong).wrapping_mul(i))
            as usize] =
            *depth
                .offset((48 as libc::c_int as libc::c_ulong).wrapping_add(i)
                    as isize);
        cmd_depth[(448 as libc::c_int as libc::c_ulong)
            .wrapping_add((8 as libc::c_int as libc::c_ulong).wrapping_mul(i))
            as usize] =
            *depth
                .offset((56 as libc::c_int as libc::c_ulong).wrapping_add(i)
                    as isize);
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn EmitInsertLen(
    ...
    if insertlen < 6 as libc::c_int as libc::c_ulong {
        let code: size_t =
            insertlen.wrapping_add(40 as libc::c_int as libc::c_ulong);
        BrotliWriteBits(
        ...
        *fresh0;
        ...
        let nbits: uint32_t =
            (Log2FloorNonZero(tail)).wrapping_sub(1 as libc::c_uint);
        let prefix: size_t = tail >> nbits;
        let inscode: size_t = ((nbits << 1 as libc::c_int) as libc::c_ulong)
            .wrapping_add(prefix)
        ...
        *fresh1;
        ...
        let code_0: size_t =
            nbits_0.wrapping_add(50 as libc::c_int as libc::c_uint) as size_t;
        BrotliWriteBits(
...
unsafe extern "C" fn EmitCopyLen(
    ...
    if copylen < 10 as libc::c_int as libc::c_ulong {
        BrotliWriteBits(
            *depth.offset(
                copylen.wrapping_add(14 as libc::c_int as libc::c_ulong)
                    as isize
            ) as size_t,
            *bits.offset(
                copylen.wrapping_add(14 as libc::c_int as libc::c_ulong)
        ...
        let ref mut fresh6 = *histo
            .offset(copylen.wrapping_add(14 as libc::c_int as libc::c_ulong)
                as isize);
        ...
        *fresh6;
        ...
        let nbits: uint32_t =
            (Log2FloorNonZero(tail)).wrapping_sub(1 as libc::c_uint);
        let prefix: size_t = tail >> nbits;
        let code: size_t = ((nbits << 1 as libc::c_int) as libc::c_ulong)
            .wrapping_add(prefix)
        ...
        *fresh7;
        ...
        let nbits_0: uint32_t = Log2FloorNonZero(tail_0);
        let code_0: size_t =
            nbits_0.wrapping_add(28 as libc::c_int as libc::c_uint) as size_t;
        BrotliWriteBits(
            *depth.offset(code_0 as isize) as size_t,
            *bits.offset(code_0 as isize) as uint64_t,
            storage_ix,
...
unsafe extern "C" fn EmitCopyLenLastDistance(
    ...
    if copylen < 12 as libc::c_int as libc::c_ulong {
        BrotliWriteBits(
            *depth
                .offset(copylen.wrapping_sub(4 as libc::c_int as libc::c_ulong)
                    as isize) as size_t,
            *bits
                .offset(copylen.wrapping_sub(4 as libc::c_int as libc::c_ulong)
                    as isize) as uint64_t,
            storage_ix,
            storage
        );
...
unsafe extern "C" fn EmitDistance(
    ...
    let d: size_t = distance.wrapping_add(3 as libc::c_int as libc::c_ulong);
    let nbits: uint32_t = (Log2FloorNonZero(d)).wrapping_sub(1 as libc::c_uint);
    let prefix: size_t = d >> nbits & 1 as libc::c_int as libc::c_ulong;
    let offset: size_t =
        (2 as libc::c_int as libc::c_ulong).wrapping_add(prefix) << nbits;
    let distcode: size_t = ((2 as libc::c_int as libc::c_uint)
...
unsafe extern "C" fn UpdateBits(
    ...
    while n_bits > 0 as libc::c_int as libc::c_ulong {
        ...
        let mut n_unchanged_bits: size_t =
            pos & 7 as libc::c_int as libc::c_ulong;
        let mut n_changed_bits: size_t = brotli_min_size_t(
            n_bits,
            (8 as libc::c_int as libc::c_ulong).wrapping_sub(n_unchanged_bits)
        );
        let mut total_bits: size_t =
            n_unchanged_bits.wrapping_add(n_changed_bits);
        let mut mask: uint32_t = !((1 as libc::c_uint) << total_bits)
            .wrapping_sub(1 as libc::c_uint)
            | ((1 as libc::c_uint) << n_unchanged_bits)
                .wrapping_sub(1 as libc::c_uint);
        let mut unchanged_bits: uint32_t =
            *array.offset(byte_pos as isize) as libc::c_uint & mask;
        let mut changed_bits: uint32_t = bits
            & ((1 as libc::c_uint) << n_changed_bits)
                .wrapping_sub(1 as libc::c_uint);
        *array.offset(byte_pos as isize) =
            (changed_bits << n_unchanged_bits | unchanged_bits) as uint8_t;
        n_bits = (n_bits as libc::c_ulong).wrapping_sub(n_changed_bits)
            as size_t as size_t;
        bits >>= n_changed_bits;
        pos = (pos as libc::c_ulong).wrapping_add(n_changed_bits) as size_t
            as size_t;
    }
}
unsafe extern "C" fn RewindBitPosition(
    ...
    *fresh19 =
        (*fresh19 as libc::c_int & mask as uint8_t as libc::c_int) as uint8_t;
...
unsafe extern "C" fn ShouldMergeBlock(
    ...
    let total: size_t = len
        ...
        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
        .wrapping_div(kSampleRate);
    let mut r: libc::c_double = (FastLog2(total) + 0.5f64)
...
unsafe extern "C" fn ShouldUseUncompressedMode(
    ...
    let compressed: size_t =
        next_emit.offset_from(metablock_start) as libc::c_long as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentFastImpl(
    ...
    static mut kFirstBlockSize: size_t =
        ((3 as libc::c_int) << 15 as libc::c_int) as size_t;
    ...
    let mut mlen_storage_ix: size_t =
        (*storage_ix).wrapping_add(3 as libc::c_int as libc::c_ulong);
    ...
    BrotliWriteBits(
        ...
        *cmd_code.offset((*cmd_code_numbits >> 3 as libc::c_int) as isize)
            as uint64_t,
        storage_ix,
        storage
    );
    loop {
        ...
        if (block_size >= kInputMarginBytes) as libc::c_int as libc::c_long != 0
        {
            ...
            's_111: loop {
                ...
                let mut matched: size_t = (5 as libc::c_int as libc::c_ulong)
                    .wrapping_add(FindMatchLengthWithLimit(
                ...
                let mut insert: size_t =
                    base.offset_from(next_emit) as libc::c_long as size_t;
                ip = ip.offset(matched as isize);
                if (insert < 6210 as libc::c_int as libc::c_ulong)
                    as libc::c_int as libc::c_long
                    != 0
                {
                    EmitInsertLen(
                ...
                ) != 0
                {
                    ...
                    input_size = (input_size as libc::c_ulong).wrapping_sub(
                        base.offset_from(input) as libc::c_long as size_t
                    ) as size_t as size_t;
                    input = base;
                    next_emit = input;
                    current_block = 13152504803125880496;
                    break;
                } else {
                    EmitLongInsertLen(
                        insert,
                ...
                if distance == last_distance {
                    BrotliWriteBits(
                        ...
                        *cmd_bits.offset(64 as libc::c_int as isize)
                            as uint64_t,
                        storage_ix,
                        storage
                    );
                    cmd_histo[64 as libc::c_int as usize] =
                        (cmd_histo[64 as libc::c_int as usize]).wrapping_add(1);
                    cmd_histo[64 as libc::c_int as usize];
                } else {
                    EmitDistance(
                        distance as size_t,
                ...
                let mut prev_hash: uint32_t =
                    HashBytesAtOffset(input_bytes, 0 as libc::c_int, shift);
                let mut cur_hash: uint32_t =
                    HashBytesAtOffset(input_bytes, 3 as libc::c_int, shift);
                *table.offset(prev_hash as isize) = (ip.offset_from(base_ip)
                    as libc::c_long
                    - 3 as libc::c_int as libc::c_long)
                    as libc::c_int;
                prev_hash =
                    HashBytesAtOffset(input_bytes, 1 as libc::c_int, shift);
                *table.offset(prev_hash as isize) = (ip.offset_from(base_ip)
                    as libc::c_long
                    - 2 as libc::c_int as libc::c_long)
                    as libc::c_int;
                prev_hash =
                    HashBytesAtOffset(input_bytes, 2 as libc::c_int, shift);
                *table.offset(prev_hash as isize) = (ip.offset_from(base_ip)
                    as libc::c_long
                ...
                *table.offset(cur_hash as isize) =
                ...
                while IsMatch(ip, candidate) != 0 {
                    ...
                    let mut matched_0: size_t = (5 as libc::c_int
                        as libc::c_ulong)
                        .wrapping_add(FindMatchLengthWithLimit(
                            candidate.offset(5 as libc::c_int as isize),
                            ip.offset(5 as libc::c_int as isize),
                    ...
                    last_distance = base_0.offset_from(candidate)
                        as libc::c_long
                        as libc::c_int;
                    EmitCopyLen(
                        matched_0,
    ...
    if is_last == 0 {
        *cmd_code.offset(0 as libc::c_int as isize) =
            0 as libc::c_int as uint8_t;
