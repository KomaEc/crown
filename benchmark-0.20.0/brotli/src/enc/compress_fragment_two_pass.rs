...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as libc::c_ulong != 0 {
        current_block = 1866536837779013497;
    } else {
...
unsafe extern "C" fn Hash(
    ...
    .wrapping_mul(kHashMul32 as libc::c_ulong);
...
unsafe extern "C" fn HashBytesAtOffset(
    ...
    let h: uint64_t = (v
        >> (8 as libc::c_int as libc::c_ulong).wrapping_mul(offset)
        << (8 as libc::c_int as libc::c_ulong)
            .wrapping_sub(length)
            .wrapping_mul(8 as libc::c_int as libc::c_ulong))
    .wrapping_mul(kHashMul32 as libc::c_ulong);
...
unsafe extern "C" fn BuildAndStoreCommandPrefixCode(
    ...
    memcpy(
        cmd_depth.as_mut_ptr().offset(24 as libc::c_int as isize)
            as *mut libc::c_void,
        depth as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(32 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(48 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(40 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(8 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(48 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(56 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(56 as libc::c_int as isize)
            as *mut libc::c_void,
    ...
    memcpy(
        ...
        cmd_bits.as_mut_ptr().offset(24 as libc::c_int as isize)
            as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong
    );
    memcpy(
        bits.offset(8 as libc::c_int as isize) as *mut libc::c_void,
        cmd_bits.as_mut_ptr().offset(40 as libc::c_int as isize)
            as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong
    );
    memcpy(
        bits.offset(16 as libc::c_int as isize) as *mut libc::c_void,
        cmd_bits.as_mut_ptr().offset(56 as libc::c_int as isize)
            as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong
    );
    memcpy(
    ...
    memcpy(
        ...
        cmd_bits.as_mut_ptr().offset(32 as libc::c_int as isize)
            as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong
    );
    memcpy(
        bits.offset(56 as libc::c_int as isize) as *mut libc::c_void,
        cmd_bits.as_mut_ptr().offset(48 as libc::c_int as isize)
            as *const libc::c_void,
        16 as libc::c_int as libc::c_ulong
    );
    BrotliConvertBitDepthsToSymbols(
    ...
    memcpy(
        cmd_depth.as_mut_ptr().offset(64 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(32 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(128 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(40 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(192 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(48 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    memcpy(
        cmd_depth.as_mut_ptr().offset(384 as libc::c_int as isize)
            as *mut libc::c_void,
        depth.offset(56 as libc::c_int as isize) as *const libc::c_void,
        8 as libc::c_int as libc::c_ulong
    );
    ...
    while i < 8 as libc::c_int as libc::c_ulong {
        ...
        cmd_depth[(256 as libc::c_int as libc::c_ulong)
            ...
            as usize] =
            *depth
                .offset((8 as libc::c_int as libc::c_ulong).wrapping_add(i)
                    as isize);
        cmd_depth[(448 as libc::c_int as libc::c_ulong)
            .wrapping_add((8 as libc::c_int as libc::c_ulong).wrapping_mul(i))
            as usize] =
            *depth
                .offset((16 as libc::c_int as libc::c_ulong).wrapping_add(i)
                    as isize);
        i = i.wrapping_add(1);
        i;
    }
...
unsafe extern "C" fn EmitInsertLen(
    ...
    if insertlen < 6 as libc::c_int as libc::c_uint {
        **commands = insertlen;
        ...
        let tail: uint32_t =
            insertlen.wrapping_sub(2 as libc::c_int as libc::c_uint);
        let nbits: uint32_t =
            (Log2FloorNonZero(tail as size_t)).wrapping_sub(1 as libc::c_uint);
        let prefix: uint32_t = tail >> nbits;
        let inscode: uint32_t = (nbits << 1 as libc::c_int)
            .wrapping_add(prefix)
            .wrapping_add(2 as libc::c_int as libc::c_uint);
        let extra: uint32_t = tail.wrapping_sub(prefix << nbits);
        **commands = inscode | extra << 8 as libc::c_int;
    } else if insertlen < 2114 as libc::c_int as libc::c_uint {
        let tail_0: uint32_t =
            insertlen.wrapping_sub(66 as libc::c_int as libc::c_uint);
        let nbits_0: uint32_t = Log2FloorNonZero(tail_0 as size_t);
        let code: uint32_t =
            nbits_0.wrapping_add(10 as libc::c_int as libc::c_uint);
        let extra_0: uint32_t =
            tail_0.wrapping_sub((1 as libc::c_uint) << nbits_0);
        **commands = code | extra_0 << 8 as libc::c_int;
    } else if insertlen < 6210 as libc::c_int as libc::c_uint {
        let extra_1: uint32_t =
            insertlen.wrapping_sub(2114 as libc::c_int as libc::c_uint);
        **commands =
            21 as libc::c_int as libc::c_uint | extra_1 << 8 as libc::c_int;
    } else if insertlen < 22594 as libc::c_int as libc::c_uint {
        let extra_2: uint32_t =
            insertlen.wrapping_sub(6210 as libc::c_int as libc::c_uint);
        **commands =
            22 as libc::c_int as libc::c_uint | extra_2 << 8 as libc::c_int;
    } else {
        let extra_3: uint32_t =
            insertlen.wrapping_sub(22594 as libc::c_int as libc::c_uint);
        **commands =
            23 as libc::c_int as libc::c_uint | extra_3 << 8 as libc::c_int;
    }
...
unsafe extern "C" fn EmitCopyLen(
    ...
    if copylen < 10 as libc::c_int as libc::c_ulong {
        ...
        **commands = (code | extra << 8 as libc::c_int) as uint32_t;
        ...
        let code_0: size_t =
            nbits_0.wrapping_add(52 as libc::c_int as libc::c_ulong);
        let extra_0: size_t =
            tail_0.wrapping_sub((1 as libc::c_int as size_t) << nbits_0);
        **commands = (code_0 | extra_0 << 8 as libc::c_int) as uint32_t;
    } else {
        let extra_1: size_t =
            copylen.wrapping_sub(2118 as libc::c_int as libc::c_ulong);
        **commands = (63 as libc::c_int as libc::c_ulong
            | extra_1 << 8 as libc::c_int) as uint32_t;
    }
    *commands = (*commands).offset(1);
    *commands;
}
...
unsafe extern "C" fn EmitCopyLenLastDistance(
    ...
    if copylen < 12 as libc::c_int as libc::c_ulong {
        **commands = copylen.wrapping_add(20 as libc::c_int as libc::c_ulong)
            as uint32_t;
        *commands = (*commands).offset(1);
        *commands;
    } else if copylen < 72 as libc::c_int as libc::c_ulong {
        let tail: size_t =
            copylen.wrapping_sub(8 as libc::c_int as libc::c_ulong);
        let nbits: size_t = (Log2FloorNonZero(tail))
            .wrapping_sub(1 as libc::c_int as libc::c_uint)
            as size_t;
        let prefix: size_t = tail >> nbits;
        ...
        *commands;
        ...
        let extra_0: size_t = tail_0 & 31 as libc::c_int as libc::c_ulong;
        **commands = (code_0 | extra_0 << 8 as libc::c_int) as uint32_t;
        *commands = (*commands).offset(1);
        *commands;
        **commands = 64 as libc::c_int as uint32_t;
        *commands = (*commands).offset(1);
        *commands;
    } else if copylen < 2120 as libc::c_int as libc::c_ulong {
        let tail_1: size_t =
            copylen.wrapping_sub(72 as libc::c_int as libc::c_ulong);
        let nbits_0: size_t = Log2FloorNonZero(tail_1) as size_t;
        let code_1: size_t =
            nbits_0.wrapping_add(52 as libc::c_int as libc::c_ulong);
        let extra_1: size_t =
            tail_1.wrapping_sub((1 as libc::c_int as size_t) << nbits_0);
        **commands = (code_1 | extra_1 << 8 as libc::c_int) as uint32_t;
        *commands = (*commands).offset(1);
        *commands;
        **commands = 64 as libc::c_int as uint32_t;
        *commands = (*commands).offset(1);
        ...
        **commands = (63 as libc::c_int as libc::c_ulong
            | extra_2 << 8 as libc::c_int) as uint32_t;
        *commands = (*commands).offset(1);
        *commands;
        **commands = 64 as libc::c_int as uint32_t;
        *commands = (*commands).offset(1);
...
unsafe extern "C" fn EmitDistance(
    ...
    let mut d: uint32_t =
        distance.wrapping_add(3 as libc::c_int as libc::c_uint);
    let mut nbits: uint32_t = (Log2FloorNonZero(d as size_t))
        .wrapping_sub(1 as libc::c_int as libc::c_uint);
    let prefix: uint32_t = d >> nbits & 1 as libc::c_int as libc::c_uint;
    let offset: uint32_t =
        (2 as libc::c_int as libc::c_uint).wrapping_add(prefix) << nbits;
    let distcode: uint32_t = (2 as libc::c_int as libc::c_uint)
    ...
    **commands = distcode | extra << 8 as libc::c_int;
    *commands = (*commands).offset(1);
    *commands;
}
...
unsafe extern "C" fn CreateCommands(
    ...
    let shift: size_t =
        (64 as libc::c_uint as libc::c_ulong).wrapping_sub(table_bits);
    let mut ip_end: *const uint8_t = input.offset(block_size as isize);
    let mut next_emit: *const uint8_t = input;
    let mut last_distance: libc::c_int = -(1 as libc::c_int);
    ...
    if (block_size >= kInputMarginBytes) as libc::c_int as libc::c_long != 0 {
        ...
        's_30: loop {
            ...
            let mut matched: size_t =
                min_match.wrapping_add(FindMatchLengthWithLimit(
            ...
            let mut distance: libc::c_int =
                base.offset_from(candidate) as libc::c_long as libc::c_int;
            let mut insert: libc::c_int =
                base.offset_from(next_emit) as libc::c_long as libc::c_int;
            ...
            *literals = (*literals).offset(insert as isize);
            ...
            if min_match == 4 as libc::c_int as libc::c_ulong {
                ...
                *table.offset(prev_hash as isize) = (ip.offset_from(base_ip)
                    as libc::c_long
            ...
            candidate =
                base_ip.offset(*table.offset(cur_hash as isize) as isize);
            *table.offset(cur_hash as isize) =
                ...
                && IsMatch(ip, candidate, min_match) != 0
            {
                ...
                candidate =
                    base_ip.offset(*table.offset(cur_hash_0 as isize) as isize);
    ...
    if next_emit < ip_end {
        let insert_0: uint32_t =
            ip_end.offset_from(next_emit) as libc::c_long as uint32_t;
...
unsafe extern "C" fn StoreCommands(
    ...
    while i < num_commands {
        let code: uint32_t =
            *commands.offset(i as isize) & 0xff as libc::c_int as libc::c_uint;
        cmd_histo[code as usize] = (cmd_histo[code as usize]).wrapping_add(1);
        cmd_histo[code as usize];
        i = i.wrapping_add(1);
        i;
    }
    cmd_histo[1 as libc::c_int as usize] = (cmd_histo[1 as libc::c_int as usize]
        as libc::c_uint)
        .wrapping_add(1 as libc::c_int as libc::c_uint)
        as uint32_t as uint32_t;
    cmd_histo[2 as libc::c_int as usize] = (cmd_histo[2 as libc::c_int as usize]
        as libc::c_uint)
        .wrapping_add(1 as libc::c_int as libc::c_uint)
        as uint32_t as uint32_t;
    cmd_histo[64 as libc::c_int as usize] =
        (cmd_histo[64 as libc::c_int as usize] as libc::c_uint)
            .wrapping_add(1 as libc::c_int as libc::c_uint) as uint32_t
            as uint32_t;
    cmd_histo[84 as libc::c_int as usize] =
        (cmd_histo[84 as libc::c_int as usize] as libc::c_uint)
            .wrapping_add(1 as libc::c_int as libc::c_uint) as uint32_t
            as uint32_t;
    ...
    while i < num_commands {
        ...
        let code_0: uint32_t = cmd & 0xff as libc::c_int as libc::c_uint;
        let extra: uint32_t = cmd >> 8 as libc::c_int;
        BrotliWriteBits(
        ...
        if code_0 < 24 as libc::c_int as libc::c_uint {
            let insert: uint32_t =
                (kInsertOffset[code_0 as usize]).wrapping_add(extra);
...
unsafe extern "C" fn ShouldCompress(
    ...
    let mut corpus_size: libc::c_double = input_size as libc::c_double;
    if (num_literals as libc::c_double) < 0.98f64 * corpus_size {
        ...
        let max_total_bit_cost: libc::c_double =
            corpus_size * 8 as libc::c_int as libc::c_double * 0.98f64
                / 43 as libc::c_int as libc::c_double;
        let mut i: size_t = 0;
        i = 0 as libc::c_int as size_t;
        while i < input_size {
            literal_histo[*input.offset(i as isize) as usize] = (literal_histo
                [*input.offset(i as isize) as usize])
                .wrapping_add(1);
            literal_histo[*input.offset(i as isize) as usize];
            i = (i as libc::c_ulong)
                .wrapping_add(43 as libc::c_int as libc::c_ulong)
                as size_t as size_t;
        }
        return if BitsEntropy(
...
unsafe extern "C" fn RewindBitPosition(
    ...
    let bitpos: size_t = new_storage_ix & 7 as libc::c_int as libc::c_ulong;
    let mask: size_t = ((1 as libc::c_uint) << bitpos)
        .wrapping_sub(1 as libc::c_int as libc::c_uint)
        as size_t;
    let ref mut fresh3 =
        *storage.offset((new_storage_ix >> 3 as libc::c_int) as isize);
    *fresh3 =
        (*fresh3 as libc::c_int & mask as uint8_t as libc::c_int) as uint8_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl(
    ...
    while input_size > 0 as libc::c_int as libc::c_ulong {
        ...
        num_literals =
            literals.offset_from(literal_buf) as libc::c_long as size_t;
        if ShouldCompress(input, block_size, num_literals) != 0 {
            let num_commands: size_t =
                commands.offset_from(command_buf) as libc::c_long as size_t;
            BrotliStoreMetaBlockHeader(
                block_size,
                0 as libc::c_int,
                storage_ix,
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl13(
    ...
    let mut min_match: size_t = (if 13 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl17(
    ...
    let mut min_match: size_t = (if 17 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl15(
    ...
    let mut min_match: size_t = (if 15 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl16(
    ...
    let mut min_match: size_t = (if 16 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl14(
    ...
    let mut min_match: size_t = (if 14 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl12(
    ...
    let mut min_match: size_t = (if 12 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl11(
    ...
    let mut min_match: size_t = (if 11 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl8(
    ...
    let mut min_match: size_t = (if 8 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl9(
    ...
    let mut min_match: size_t = (if 9 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
...
unsafe extern "C" fn BrotliCompressFragmentTwoPassImpl10(
    ...
    let mut min_match: size_t = (if 10 as libc::c_int <= 15 as libc::c_int {
        4 as libc::c_int
    } else {
        6 as libc::c_int
    }) as size_t;
