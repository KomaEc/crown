...
unsafe extern "C" fn BrotliParseAsUTF8(
    ...
    if *input.offset(0 as libc::c_int as isize) as libc::c_int
        ...
        == 0 as libc::c_int
    {
        *symbol = *input.offset(0 as libc::c_int as isize) as libc::c_int;
            ...
            == 0x80 as libc::c_int
    {
        *symbol = (*input.offset(0 as libc::c_int as isize) as libc::c_int
            ...
            | *input.offset(3 as libc::c_int as isize) as libc::c_int
                & 0x3f as libc::c_int;
        if *symbol > 0xffff as libc::c_int && *symbol <= 0x10ffff as libc::c_int
        {
            return 4 as libc::c_int as size_t;
        }
    }
    *symbol = 0x110000 as libc::c_int
        | *input.offset(0 as libc::c_int as isize) as libc::c_int;
    return 1 as libc::c_int as size_t;
}
#[no_mangle]
pub unsafe extern "C" fn BrotliIsMostlyUTF8(
    ...
    let mut size_utf8: size_t = 0 as libc::c_int as size_t;
    ...
    while i < length {
        ...
        if symbol < 0x110000 as libc::c_int {
            size_utf8 = (size_utf8 as libc::c_ulong).wrapping_add(bytes_read)
                as size_t as size_t;
        }
    }
    return if size_utf8 as libc::c_double
        > min_fraction * length as libc::c_double
    {
        1 as libc::c_int
    } else {
        0 as libc::c_int
