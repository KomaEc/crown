...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as libc::c_ulong != 0 {
        current_block = 14788401607242816034;
    } else {
...
unsafe extern "C" fn RecomputeDistancePrefixes(
    ...
    let mut i: size_t = 0;
    if (*orig_params).distance_postfix_bits
    ...
    while i < num_commands {
            ...
            && (*cmd).cmd_prefix_ as libc::c_int >= 128 as libc::c_int
        {
            if equal_params != 0 {
                ...
                let mut distance: uint32_t =
                    CommandRestoreDistanceCode(cmd, orig_params);
            ...
            extra_bits += (dist_prefix as libc::c_int >> 10 as libc::c_int)
                as libc::c_double;
        }
        i = i.wrapping_add(1);
        i;
...
pub unsafe extern "C" fn BrotliBuildMetaBlock(
    ...
    if (*params).disable_literal_context_modeling == 0 {
        literal_context_multiplier =
            ((1 as libc::c_int) << 6 as libc::c_int) as size_t;
            ...
            > 0 as libc::c_int as libc::c_ulong
        {
            BrotliAllocate(
                ...
                ((*mb).literal_split.num_types).wrapping_mul(
                    ::core::mem::size_of::<ContextType>() as libc::c_ulong
                )
            ) as *mut ContextType
        } else {
    ...
    literal_histograms =
        if literal_histograms_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
    ...
    distance_histograms_size =
        (*mb).distance_split.num_types << 2 as libc::c_int;
    distance_histograms =
        if distance_histograms_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
                distance_histograms_size
    ...
    (*mb).command_histograms =
        if (*mb).command_histograms_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
    ...
    (*mb).literal_context_map_size =
        (*mb).literal_split.num_types << 6 as libc::c_int;
    ...
    (*mb).literal_histograms =
        if (*mb).literal_histograms_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
    ...
    if (*params).disable_literal_context_modeling != 0 {
        ...
        while i != 0 as libc::c_int as libc::c_ulong {
            ...
            {
                *((*mb).literal_context_map)
                    .offset((i << 6 as libc::c_int).wrapping_add(j) as isize) =
    ...
    (*mb).distance_context_map_size =
        (*mb).distance_split.num_types << 2 as libc::c_int;
    (*mb).distance_context_map = if (*mb).distance_context_map_size
        > 0 as libc::c_int as libc::c_ulong
    {
        BrotliAllocate(
            m,
    ...
    (*mb).distance_histograms =
        if (*mb).distance_histograms_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
...
unsafe extern "C" fn InitBlockSplitterLiteral(
    ...
    *histograms = if *histograms_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            (*histograms_size).wrapping_mul(::core::mem::size_of::<
                HistogramLiteral
            >() as libc::c_ulong)
        ) as *mut HistogramLiteral
    } else {
    ...
    (*self_0).last_histogram_ix_[1 as libc::c_int as usize] =
...
unsafe extern "C" fn BlockSplitterFinishBlockLiteral(
    ...
    let mut last_entropy: *mut libc::c_double =
        ((*self_0).last_entropy_).as_mut_ptr();
    let mut histograms: *mut HistogramLiteral = (*self_0).histograms_;
    (*self_0).block_size_ =
        brotli_max_size_t((*self_0).block_size_, (*self_0).min_block_size_);
    if (*self_0).num_blocks_ == 0 as libc::c_int as libc::c_ulong {
        ...
        *((*split).types).offset(0 as libc::c_int as isize) =
            0 as libc::c_int as uint8_t;
        *last_entropy.offset(0 as libc::c_int as isize) = BitsEntropy(
            ((*histograms.offset(0 as libc::c_int as isize)).data_)
                .as_mut_ptr(),
            (*self_0).alphabet_size_
        );
        *last_entropy.offset(1 as libc::c_int as isize) =
        ...
        (*self_0).curr_histogram_ix_ =
            ((*self_0).curr_histogram_ix_).wrapping_add(1);
        (*self_0).curr_histogram_ix_;
        ...
        while j < 2 as libc::c_int as libc::c_ulong {
            let mut last_histogram_ix: size_t =
                (*self_0).last_histogram_ix_[j as usize];
            ...
            diff[j as usize] = combined_entropy[j as usize]
                - entropy
            ...
            < diff[0 as libc::c_int as usize] - 20.0f64
        {
            ...
            *last_entropy.offset(0 as libc::c_int as isize) =
            ...
            let ref mut fresh2 = *((*split).lengths).offset(
                ((*self_0).num_blocks_)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
            *fresh2 = (*fresh2 as libc::c_uint)
                .wrapping_add((*self_0).block_size_ as uint32_t)
                as uint32_t as uint32_t;
            *histograms.offset(
                (*self_0).last_histogram_ix_[0 as libc::c_int as usize]
                    as isize
            ...
            *last_entropy.offset(0 as libc::c_int as isize) =
            ...
            (*self_0).merge_last_count_ =
                ((*self_0).merge_last_count_).wrapping_add(1);
            if (*self_0).merge_last_count_ > 1 as libc::c_int as libc::c_ulong {
                (*self_0).target_block_size_ =
                    ((*self_0).target_block_size_ as libc::c_ulong)
        ...
        *last_entropy.offset(1 as libc::c_int as isize) =
            ...
            < diff[0 as libc::c_int as usize] - 20.0f64
        {
            ...
            *last_entropy.offset(0 as libc::c_int as isize) =
            ...
            let ref mut fresh3 = *((*split).lengths).offset(
                ((*self_0).num_blocks_)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
        ...
        *last_entropy.offset(1 as libc::c_int as isize) =
            ...
            < diff[0 as libc::c_int as usize] - 20.0f64
        {
            ...
            *last_entropy.offset(0 as libc::c_int as isize) =
            ...
            let ref mut fresh4 = *((*split).lengths).offset(
                ((*self_0).num_blocks_)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
...
unsafe extern "C" fn InitContextBlockSplitter(
    ...
    (*self_0).max_block_types_ =
        (256 as libc::c_int as libc::c_ulong).wrapping_div(num_contexts);
    (*self_0).min_block_size_ = min_block_size;
    (*self_0).split_threshold_ = split_threshold;
    (*self_0).num_blocks_ = 0 as libc::c_int as size_t;
    (*self_0).split_ = split;
...
unsafe extern "C" fn ContextBlockSplitterFinishBlock(
    ...
    if (*self_0).num_blocks_ == 0 as libc::c_int as libc::c_ulong {
        ...
        *((*split).types).offset(0 as libc::c_int as isize) =
        ...
        (*split).num_types;
        (*self_0).curr_histogram_ix_ =
            ((*self_0).curr_histogram_ix_ as libc::c_ulong)
                .wrapping_add(num_contexts) as size_t as size_t;
        if (*self_0).curr_histogram_ix_ < *(*self_0).histograms_size_ {
            ClearHistogramsLiteral(
                &mut *((*self_0).histograms_)
                    .offset((*self_0).curr_histogram_ix_ as isize),
        ...
        let mut combined_histo: *mut HistogramLiteral = if (2 as libc::c_int
            as libc::c_ulong)
        ...
        while i_0 < num_contexts {
            let mut curr_histo_ix: size_t =
                ((*self_0).curr_histogram_ix_).wrapping_add(i_0);
            let mut j: size_t = 0;
            entropy[i_0 as usize] = BitsEntropy(
                ((*histograms.offset(curr_histo_ix as isize)).data_)
                    .as_mut_ptr(),
                (*self_0).alphabet_size_
            );
            j = 0 as libc::c_int as size_t;
            while j < 2 as libc::c_int as libc::c_ulong {
                let mut jx: size_t =
                    j.wrapping_mul(num_contexts).wrapping_add(i_0);
            ...
            && diff[1 as libc::c_int as usize] > (*self_0).split_threshold_
        {
            ...
            *((*split).types).offset((*self_0).num_blocks_ as isize) =
            ...
            (*split).num_types = ((*split).num_types).wrapping_add(1);
            (*split).num_types;
            (*self_0).curr_histogram_ix_ = ((*self_0).curr_histogram_ix_
                as libc::c_ulong)
            ...
            *((*split).types).offset((*self_0).num_blocks_ as isize) =
            ...
            while i_0 < num_contexts {
                *histograms.offset(
                    ...
                    .offset(num_contexts.wrapping_add(i_0) as isize);
                *last_entropy.offset(num_contexts.wrapping_add(i_0) as isize) =
                    *last_entropy.offset(i_0 as isize);
                *last_entropy.offset(i_0 as isize) =
            ...
            let ref mut fresh5 = *((*split).lengths).offset(
                ((*self_0).num_blocks_)
                    .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            );
...
unsafe extern "C" fn ContextBlockSplitterAddSymbol(
    ...
    HistogramAddLiteral(
        &mut *((*self_0).histograms_).offset(
            ((*self_0).curr_histogram_ix_).wrapping_add(context) as isize
        ),
        symbol
    );
    (*self_0).block_size_ = ((*self_0).block_size_).wrapping_add(1);
...
unsafe extern "C" fn BrotliBuildMetaBlockGreedyInternal(
    ...
    i = 0 as libc::c_int as size_t;
    while i < n_commands {
        num_literals = (num_literals as libc::c_ulong).wrapping_add(
            (*commands.offset(i as isize)).insert_len_ as libc::c_ulong
        ) as size_t as size_t;
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < n_commands {
        ...
        while j != 0 as libc::c_int as libc::c_ulong {
            let mut literal: uint8_t =
                *ringbuffer.offset((pos & mask) as isize);
            if num_contexts == 1 as libc::c_int as libc::c_ulong {
