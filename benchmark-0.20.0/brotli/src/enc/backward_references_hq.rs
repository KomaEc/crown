...
unsafe extern "C" fn PrefixEncodeCopyDistance(
        ...
        < (16 as libc::c_int as libc::c_ulong).wrapping_add(num_direct_codes)
    {
        ...
        *extra_bits = 0 as libc::c_int as uint32_t;
        ...
        let mut prefix: size_t =
            dist >> bucket & 1 as libc::c_int as libc::c_ulong;
        let mut offset: size_t =
            (2 as libc::c_int as libc::c_ulong).wrapping_add(prefix) << bucket;
        let mut nbits: size_t = bucket.wrapping_sub(postfix_bits);
        *code =
            (nbits << 10 as libc::c_int
                | (16 as libc::c_int as libc::c_ulong)
                    .wrapping_add(num_direct_codes)
                    .wrapping_add(
                        (2 as libc::c_int as libc::c_ulong)
                            .wrapping_mul(nbits.wrapping_sub(
...
unsafe extern "C" fn InitCommand(
    ...
    let mut delta: uint32_t =
        copylen_code_delta as int8_t as uint8_t as uint32_t;
    (*self_0).insert_len_ = insertlen as uint32_t;
    (*self_0).copy_len_ =
        (copylen | (delta << 25 as libc::c_int) as libc::c_ulong) as uint32_t;
...
#[inline(always)]
unsafe extern "C" fn MaxZopfliLen(
...
unsafe extern "C" fn InitDictionaryBackwardMatch(
    ...
    (*self_0).distance = dist as uint32_t;
    (*self_0).length_and_code = (len << 5 as libc::c_int
        | (if len == len_code {
...
#[inline(always)]
unsafe extern "C" fn BackwardMatchLength(
...
unsafe extern "C" fn BackwardMatchLengthCode(
    ...
    let mut code: size_t = ((*self_0).length_and_code
...
unsafe extern "C" fn FindAllMatchesH10(
    ...
    let cur_ix_masked: size_t = cur_ix & ring_buffer_mask;
    let mut best_len: size_t = 1 as libc::c_int as size_t;
    let short_match_max_backward: size_t =
        (if (*params).quality != 11 as libc::c_int {
            16 as libc::c_int
        } else {
            64 as libc::c_int
        }) as size_t;
    ...
    while i > stop && best_len <= 2 as libc::c_int as libc::c_ulong {
        ...
        if !(*data.offset(cur_ix_masked as isize) as libc::c_int
            ...
            || *data.offset(
                ...
                != *data.offset(
                    prev_ix.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        as isize
                ) as libc::c_int)
        {
    ...
    let mut minlen: size_t = brotli_max_size_t(
    ...
    ) != 0
    {
        let mut maxlen: size_t =
            brotli_min_size_t(37 as libc::c_int as size_t, max_length);
        let mut l: size_t = 0;
        l = minlen;
        while l <= maxlen {
            ...
            if dict_id < kInvalidMatch {
                let mut distance: size_t = dictionary_distance
                    .wrapping_add(
                        (dict_id >> 5 as libc::c_int) as libc::c_ulong
                    )
                    .wrapping_add(1 as libc::c_int as libc::c_ulong);
...
unsafe extern "C" fn StoreH10(
    ...
    let max_backward: size_t = ((*self_0).window_mask_)
        .wrapping_sub(16 as libc::c_int as libc::c_ulong)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
...
#[inline(always)]
unsafe extern "C" fn ZopfliNodeCopyLength(
    mut self_0: *const ZopfliNode
) -> uint32_t {
    return (*self_0).length & 0x1ffffff as libc::c_int as libc::c_uint;
}
#[inline(always)]
unsafe extern "C" fn ZopfliNodeLengthCode(
    mut self_0: *const ZopfliNode
) -> uint32_t {
    let modifier: uint32_t = (*self_0).length >> 25 as libc::c_int;
    return (ZopfliNodeCopyLength(self_0))
        .wrapping_add(9 as libc::c_uint)
        .wrapping_sub(modifier);
}
#[inline(always)]
unsafe extern "C" fn ZopfliNodeCopyDistance(
    mut self_0: *const ZopfliNode
) -> uint32_t {
    return (*self_0).distance;
}
#[inline(always)]
unsafe extern "C" fn ZopfliNodeDistanceCode(
    mut self_0: *const ZopfliNode
) -> uint32_t {
    let short_code: uint32_t =
        (*self_0).dcode_insert_length >> 27 as libc::c_int;
...
#[inline(always)]
unsafe extern "C" fn ZopfliNodeCommandLength(
    mut self_0: *const ZopfliNode
) -> uint32_t {
    return (ZopfliNodeCopyLength(self_0)).wrapping_add(
        (*self_0).dcode_insert_length
...
unsafe extern "C" fn InitZopfliCostModel(
    ...
    (*self_0).literal_costs_ =
        if num_bytes.wrapping_add(2 as libc::c_int as libc::c_ulong)
            > 0 as libc::c_int as libc::c_ulong
        {
            BrotliAllocate(
                m,
    ...
    (*self_0).cost_dist_ =
        if (*dist).alphabet_size_limit > 0 as libc::c_int as libc::c_uint {
            BrotliAllocate(
                m,
...
unsafe extern "C" fn SetCost(
    ...
    while i < histogram_size {
        sum = (sum as libc::c_ulong)
            .wrapping_add(*histogram.offset(i as isize) as libc::c_ulong)
            as size_t as size_t;
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < histogram_size {
        if *histogram.offset(i as isize) == 0 as libc::c_int as libc::c_uint {
            ...
            *cost.offset(i as isize) = log2sum
                - FastLog2(*histogram.offset(i as isize) as size_t)
                    as libc::c_float;
...
unsafe extern "C" fn ZopfliCostModelSetFromCommands(
    ...
    let mut min_cost_cmd: libc::c_float = kInfinity;
    let mut i: size_t = 0;
    let mut cost_cmd: *mut libc::c_float = ((*self_0).cost_cmd_).as_mut_ptr();
    memset(
    ...
    while i < num_commands {
        let mut inslength: size_t =
            (*commands.offset(i as isize)).insert_len_ as size_t;
        let mut copylength: size_t =
            CommandCopyLen(&*commands.offset(i as isize)) as size_t;
        let mut distcode: size_t =
            ((*commands.offset(i as isize)).dist_prefix_ as libc::c_int
                & 0x3ff as libc::c_int) as size_t;
        let mut cmdcode: size_t =
            (*commands.offset(i as isize)).cmd_prefix_ as size_t;
        let mut j: size_t = 0;
        histogram_cmd[cmdcode as usize] =
            (histogram_cmd[cmdcode as usize]).wrapping_add(1);
        histogram_cmd[cmdcode as usize];
        ...
        pos = (pos as libc::c_ulong)
            .wrapping_add(inslength.wrapping_add(copylength))
            as size_t as size_t;
        i = i.wrapping_add(1);
        i;
    }
    ...
    while i < 704 as libc::c_int as libc::c_ulong {
        min_cost_cmd =
            brotli_min_float(min_cost_cmd, *cost_cmd.offset(i as isize));
        i = i.wrapping_add(1);
        i;
    }
    (*self_0).min_cost_cmd_ = min_cost_cmd;
    let mut literal_costs: *mut libc::c_float = (*self_0).literal_costs_;
    let mut literal_carry: libc::c_float = 0.0f64 as libc::c_float;
...
unsafe extern "C" fn ZopfliCostModelSetFromLiteralCosts(
    ...
    let mut literal_costs: *mut libc::c_float = (*self_0).literal_costs_;
    let mut literal_carry: libc::c_float = 0.0f64 as libc::c_float;
    let mut cost_dist: *mut libc::c_float = (*self_0).cost_dist_;
    let mut cost_cmd: *mut libc::c_float = ((*self_0).cost_cmd_).as_mut_ptr();
    let mut num_bytes: size_t = (*self_0).num_bytes_;
    let mut i: size_t = 0;
    ...
    *literal_costs.offset(0 as libc::c_int as isize) = 0.0f64 as libc::c_float;
    ...
    while i < 704 as libc::c_int as libc::c_ulong {
        *cost_cmd.offset(i as isize) = FastLog2(
            (11 as libc::c_int as libc::c_uint).wrapping_add(i as uint32_t)
                as size_t
        ) as libc::c_float;
        i = i.wrapping_add(1);
        i;
    ...
    while i < (*self_0).distance_histogram_size as libc::c_ulong {
        *cost_dist.offset(i as isize) = FastLog2(
            (20 as libc::c_int as libc::c_uint).wrapping_add(i as uint32_t)
                as size_t
        ) as libc::c_float;
        i = i.wrapping_add(1);
        i;
    }
    (*self_0).min_cost_cmd_ =
        FastLog2(11 as libc::c_int as size_t) as libc::c_float;
}
#[inline(always)]
...
unsafe extern "C" fn UpdateZopfliNode(
    ...
    (*next).length = (len
        | len
            .wrapping_add(9 as libc::c_uint as libc::c_ulong)
            .wrapping_sub(len_code)
...
unsafe extern "C" fn StartPosQueueSize(
...
unsafe extern "C" fn StartPosQueuePush(
    ...
    let fresh3 = (*self_0).idx_;
    (*self_0).idx_ = ((*self_0).idx_).wrapping_add(1);
    let mut offset: size_t = !fresh3 & 7 as libc::c_int as libc::c_ulong;
    let mut len: size_t = StartPosQueueSize(self_0);
    let mut i: size_t = 0;
    let mut q: *mut PosData = ((*self_0).q_).as_mut_ptr();
    *q.offset(offset as isize) = *posdata;
    i = 1 as libc::c_int as size_t;
    while i < len {
        if (*q.offset((offset & 7 as libc::c_int as libc::c_ulong) as isize))
            .costdiff
            > (*q.offset(
            ...
            .costdiff
        {
            let mut __brotli_swap_tmp: PosData = *q
                .offset((offset & 7 as libc::c_int as libc::c_ulong) as isize);
            *q.offset((offset & 7 as libc::c_int as libc::c_ulong) as isize) =
                *q.offset(
                    (offset.wrapping_add(1 as libc::c_int as libc::c_ulong)
                        & 7 as libc::c_int as libc::c_ulong)
                        as isize
...
unsafe extern "C" fn StartPosQueueAt(
    ...
    return &*((*self_0).q_).as_ptr().offset(
        (k.wrapping_sub((*self_0).idx_) & 7 as libc::c_int as libc::c_ulong)
            as isize
    ) as *const PosData;
}
unsafe extern "C" fn ComputeMinimumCopyLength(
    ...
    let mut min_cost: libc::c_float = start_cost;
    let mut len: size_t = 2 as libc::c_int as size_t;
    let mut next_len_bucket: size_t = 4 as libc::c_int as size_t;
    let mut next_len_offset: size_t = 10 as libc::c_int as size_t;
...
unsafe extern "C" fn ComputeDistanceShortcut(
    ...
    let clen: size_t =
        ZopfliNodeCopyLength(&*nodes.offset(pos as isize)) as size_t;
    let ilen: size_t = ((*nodes.offset(pos as isize)).dcode_insert_length
        & 0x7ffffff as libc::c_int as libc::c_uint)
        as size_t;
    let dist: size_t =
        ZopfliNodeCopyDistance(&*nodes.offset(pos as isize)) as size_t;
    if pos == 0 as libc::c_int as libc::c_ulong {
        return 0 as libc::c_int as uint32_t;
    } else if dist.wrapping_add(clen)
        <= block_start.wrapping_add(pos).wrapping_add(gap)
            ...
            > 0 as libc::c_int as libc::c_uint
    {
        ...
        return (*nodes
            .offset(pos.wrapping_sub(clen).wrapping_sub(ilen) as isize))
        .u
        .shortcut;
    };
}
unsafe extern "C" fn ComputeDistanceCache(
    ...
    while idx < 4 as libc::c_int && p > 0 as libc::c_int as libc::c_ulong {
        let ilen: size_t = ((*nodes.offset(p as isize)).dcode_insert_length
            & 0x7ffffff as libc::c_int as libc::c_uint)
            as size_t;
        let clen: size_t =
            ZopfliNodeCopyLength(&*nodes.offset(p as isize)) as size_t;
        let dist: size_t =
            ZopfliNodeCopyDistance(&*nodes.offset(p as isize)) as size_t;
        let fresh4 = idx;
        idx = idx + 1;
        *dist_cache.offset(fresh4 as isize) = dist as libc::c_int;
        p = (*nodes.offset(p.wrapping_sub(clen).wrapping_sub(ilen) as isize))
            .u
            .shortcut as size_t;
    }
    while idx < 4 as libc::c_int {
        let fresh5 = starting_dist_cache;
        starting_dist_cache = starting_dist_cache.offset(1);
        *dist_cache.offset(idx as isize) = *fresh5;
        idx += 1;
        idx;
    }
}
unsafe extern "C" fn EvaluateNode(
    ...
    let mut node_cost: libc::c_float = (*nodes.offset(pos as isize)).u.cost;
    (*nodes.offset(pos as isize)).u.shortcut = ComputeDistanceShortcut(
        block_start,
        pos,
        max_backward_limit,
        gap,
...
unsafe extern "C" fn UpdateNodes(
    ...
    let max_distance: size_t = brotli_min_size_t(cur_ix, max_backward_limit);
    let dictionary_start: size_t = brotli_min_size_t(
        cur_ix.wrapping_add(stream_offset),
        max_backward_limit
    );
    let max_len: size_t = num_bytes.wrapping_sub(pos);
    let max_zopfli_len: size_t = MaxZopfliLen(params);
    let max_iters: size_t = MaxZopfliCandidates(params);
    let mut min_len: size_t = 0;
    let mut result: size_t = 0 as libc::c_int as size_t;
    let mut k: size_t = 0;
    let mut gap: size_t = 0 as libc::c_int as size_t;
    EvaluateNode(
    ...
    let mut posdata: *const PosData =
        StartPosQueueAt(queue, 0 as libc::c_int as size_t);
    let mut min_cost: libc::c_float = (*posdata).cost
    ...
    while k < max_iters && k < StartPosQueueSize(queue) {
        ...
        let inscode: uint16_t = GetInsertLengthCode(pos.wrapping_sub(start));
        let start_costdiff: libc::c_float = (*posdata_0).costdiff;
        let base_cost: libc::c_float = start_costdiff
        ...
        let mut best_len: size_t =
            min_len.wrapping_sub(1 as libc::c_int as libc::c_ulong);
        ...
        while j < 16 as libc::c_int as libc::c_ulong && best_len < max_len {
            ...
            let backward: size_t = ((*posdata_0).distance_cache[idx as usize]
                + kDistanceCacheOffset[j as usize])
                as size_t;
            let mut prev_ix: size_t = cur_ix.wrapping_sub(backward);
            let mut len: size_t = 0 as libc::c_int as size_t;
            let mut continuation: uint8_t = *ringbuffer
                ...
                if backward <= max_distance {
                    if !(prev_ix >= cur_ix) {
                                    ...
                                    as libc::c_int)
                        {
                            ...
                            let dist_cost: libc::c_float = base_cost
                                + ZopfliCostModelGetDistanceCost(model, j);
                            let mut l: size_t = 0;
                            l = best_len.wrapping_add(
                                1 as libc::c_int as libc::c_ulong
                            );
                            while l <= len {
                                let copycode: uint16_t = GetCopyLengthCode(l);
                                ...
                                let cost: libc::c_float =
                                    (if (cmdcode as libc::c_int)
                                        < 128 as libc::c_int
                                    {
                                        base_cost
                                    } else {
                                ...
                                if cost
                                    < (*nodes
                                        .offset(pos.wrapping_add(l) as isize))
                                    .u
                                    .cost
                                {
                                    UpdateZopfliNode(
        ...
        if !(k >= 2 as libc::c_int as libc::c_ulong) {
            ...
            while j < num_matches {
                ...
                let mut is_dictionary_match: libc::c_int =
                ...
                dist_cost_0 = base_cost
                    ...
                    + ZopfliCostModelGetDistanceCost(
                        model,
                        (dist_symbol as libc::c_int & 0x3ff as libc::c_int)
                            as size_t
                    );
                max_match_len = BackwardMatchLength(&mut match_0);
                if len_0 < max_match_len
                    && (is_dictionary_match != 0
                        || max_match_len > max_zopfli_len)
                {
                    len_0 = max_match_len;
                }
                while len_0 <= max_match_len {
                    ...
                    let copycode_0: uint16_t = GetCopyLengthCode(len_code);
                    let cmdcode_0: uint16_t = CombineLengthCodes(
                        inscode,
                        copycode_0,
                        0 as libc::c_int
                    );
                    let cost_0: libc::c_float = dist_cost_0
                        + GetCopyExtra(copycode_0) as libc::c_float
                        + ZopfliCostModelGetCommandCost(model, cmdcode_0);
                    if cost_0
                        < (*nodes.offset(pos.wrapping_add(len_0) as isize))
                            .u
                            .cost
                    {
                        UpdateZopfliNode(
...
unsafe extern "C" fn ComputeShortestPathFromNodes(
    ...
    while (*nodes.offset(index as isize)).dcode_insert_length
        & 0x7ffffff as libc::c_int as libc::c_uint
        == 0 as libc::c_int as libc::c_uint
        && (*nodes.offset(index as isize)).length
    ...
    while index != 0 as libc::c_int as libc::c_ulong {
        let mut len: size_t =
            ZopfliNodeCommandLength(&mut *nodes.offset(index as isize))
                as size_t;
...
pub unsafe extern "C" fn BrotliZopfliCreateCommands(
    ...
    let stream_offset: size_t = (*params).stream_offset;
    let max_backward_limit: size_t = ((1 as libc::c_int as size_t)
        << (*params).lgwin)
        .wrapping_sub(16 as libc::c_int as libc::c_ulong);
    let mut pos: size_t = 0 as libc::c_int as size_t;
    let mut offset: uint32_t =
        (*nodes.offset(0 as libc::c_int as isize)).u.next;
    let mut i: size_t = 0;
    let mut gap: size_t = 0 as libc::c_int as size_t;
    i = 0 as libc::c_int as size_t;
    while offset != !(0 as libc::c_int as uint32_t) {
        ...
        let mut insert_length: size_t = ((*next).dcode_insert_length
            & 0x7ffffff as libc::c_int as libc::c_uint)
            as size_t;
        pos = (pos as libc::c_ulong).wrapping_add(insert_length) as size_t
            as size_t;
        offset = (*next).u.next;
        ...
        let mut is_dictionary: libc::c_int =
            if distance > dictionary_start.wrapping_add(gap) {
                1 as libc::c_int
            } else {
                0 as libc::c_int
            };
        ...
        if is_dictionary == 0 && dist_code > 0 as libc::c_int as libc::c_ulong {
            *dist_cache.offset(3 as libc::c_int as isize) =
        ...
        *num_literals = (*num_literals as libc::c_ulong)
            .wrapping_add(insert_length) as size_t
            as size_t;
        pos = (pos as libc::c_ulong).wrapping_add(copy_length) as size_t
            as size_t;
        i = i.wrapping_add(1);
        i;
    }
    *last_insert_len = (*last_insert_len as libc::c_ulong)
        .wrapping_add(num_bytes.wrapping_sub(pos))
        as size_t as size_t;
}
unsafe extern "C" fn ZopfliIterate(
    ...
    let mut cur_match_pos: size_t = 0 as libc::c_int as size_t;
    let mut i: size_t = 0;
    (*nodes.offset(0 as libc::c_int as isize)).length =
        0 as libc::c_int as uint32_t;
    (*nodes.offset(0 as libc::c_int as isize)).u.cost =
    ...
    while i.wrapping_add(3 as libc::c_int as libc::c_ulong) < num_bytes {
        ...
        if *num_matches.offset(i as isize) == 1 as libc::c_int as libc::c_uint
            && BackwardMatchLength(&*matches.offset(
        ...
        if skip > 1 as libc::c_int as libc::c_ulong {
            ...
            while skip != 0 {
                i = i.wrapping_add(1);
                i;
                if i.wrapping_add(3 as libc::c_int as libc::c_ulong)
                    >= num_bytes
                {
                    break;
                }
                ...
                cur_match_pos = (cur_match_pos as libc::c_ulong).wrapping_add(
                    *num_matches.offset(i as isize) as libc::c_ulong
                ) as size_t as size_t;
                skip = skip.wrapping_sub(1);
                skip;
            }
...
pub unsafe extern "C" fn BrotliZopfliComputeShortestPath(
    ...
    let max_backward_limit: size_t = ((1 as libc::c_int as size_t)
        ...
        .wrapping_sub(16 as libc::c_int as libc::c_ulong);
    let max_zopfli_len: size_t = MaxZopfliLen(params);
    let mut model: ZopfliCostModel = ZopfliCostModel {
        cost_cmd_: [0.; 704],
    ...
    let mut i: size_t = 0;
    let mut gap: size_t = 0 as libc::c_int as size_t;
    let mut lz_matches_offset: size_t = 0 as libc::c_int as size_t;
    (*nodes.offset(0 as libc::c_int as isize)).length =
        0 as libc::c_int as uint32_t;
    (*nodes.offset(0 as libc::c_int as isize)).u.cost =
        0 as libc::c_int as libc::c_float;
        ...
        < num_bytes
    {
        ...
        let max_distance: size_t = brotli_min_size_t(pos, max_backward_limit);
        let dictionary_start: size_t = brotli_min_size_t(
        ...
        if num_matches > 0 as libc::c_int as libc::c_ulong
            && BackwardMatchLength(&mut *matches.as_mut_ptr().offset(
                num_matches.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            )) > max_zopfli_len
        {
            matches[0 as libc::c_int as usize] = matches[num_matches
                .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                as usize];
...
pub unsafe extern "C" fn BrotliCreateZopfliBackwardReferences(
    ...
    let mut nodes: *mut ZopfliNode = if num_bytes
        .wrapping_add(1 as libc::c_int as libc::c_ulong)
        > 0 as libc::c_int as libc::c_ulong
    {
        BrotliAllocate(
            ...
            num_bytes
                .wrapping_add(1 as libc::c_int as libc::c_ulong)
                .wrapping_mul(
                    ::core::mem::size_of::<ZopfliNode>() as libc::c_ulong
                )
        ) as *mut ZopfliNode
    } else {
        0 as *mut ZopfliNode
    ...
    *num_commands = (*num_commands as libc::c_ulong).wrapping_add(
...
pub unsafe extern "C" fn BrotliCreateHqZopfliBackwardReferences(
    ...
    let max_backward_limit: size_t = ((1 as libc::c_int as size_t)
        << (*params).lgwin)
        .wrapping_sub(16 as libc::c_int as libc::c_ulong);
    let mut num_matches: *mut uint32_t =
        if num_bytes > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
                num_bytes.wrapping_mul(
    ...
    let mut matches_size: size_t =
        (4 as libc::c_int as libc::c_ulong).wrapping_mul(num_bytes);
    let store_end: size_t = if num_bytes >= StoreLookaheadH10() {
        position
            .wrapping_add(num_bytes)
            .wrapping_sub(StoreLookaheadH10())
    ...
    let mut nodes: *mut ZopfliNode = 0 as *mut ZopfliNode;
    let mut matches: *mut BackwardMatch =
        if matches_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
                matches_size
                    .wrapping_mul(::core::mem::size_of::<BackwardMatch>()
                        as libc::c_ulong)
    ...
    let mut gap: size_t = 0 as libc::c_int as size_t;
    let mut shadow_matches: size_t = 0 as libc::c_int as size_t;
        ...
        < num_bytes
    {
                ...
                .wrapping_add(shadow_matches)
        {
            ...
            let mut new_array: *mut BackwardMatch = 0 as *mut BackwardMatch;
            while _new_size
                < cur_match_pos
                    .wrapping_add(128 as libc::c_int as libc::c_ulong)
                    .wrapping_add(shadow_matches)
        ...
        num_found_matches = FindAllMatchesH10(
            ...
            params,
            &mut *matches
                .offset(cur_match_pos.wrapping_add(shadow_matches) as isize)
        );
        ...
        *num_matches.offset(i as isize) = num_found_matches as uint32_t;
        if num_found_matches > 0 as libc::c_int as libc::c_ulong {
            let match_len: size_t = BackwardMatchLength(&mut *matches.offset(
                cur_match_end.wrapping_sub(1 as libc::c_int as libc::c_ulong)
                    as isize
            ));
            if match_len > 325 as libc::c_int as libc::c_ulong {
                let skip: size_t =
                    match_len.wrapping_sub(1 as libc::c_int as libc::c_ulong);
                let fresh6 = cur_match_pos;
                cur_match_pos = cur_match_pos.wrapping_add(1);
                *matches.offset(fresh6 as isize) = *matches.offset(
                    cur_match_end
                        .wrapping_sub(1 as libc::c_int as libc::c_ulong)
                        as isize
                );
    ...
    while i < 2 as libc::c_int as libc::c_ulong {
        ...
        *num_commands =
            (*num_commands as libc::c_ulong).wrapping_add(ZopfliIterate(
                num_bytes,
                position,
                ringbuffer,
                ringbuffer_mask,
