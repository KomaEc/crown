...
unsafe extern "C" fn ShannonEntropy(
    ...
    if size & 1 as libc::c_int as libc::c_ulong != 0 {
        current_block = 8915143567050124603;
    } else {
...
pub unsafe extern "C" fn BrotliPopulationCostLiteral(
    ...
    static mut kOneSymbolHistogramCost: libc::c_double =
        12 as libc::c_int as libc::c_double;
    static mut kTwoSymbolHistogramCost: libc::c_double =
        20 as libc::c_int as libc::c_double;
    static mut kThreeSymbolHistogramCost: libc::c_double =
        28 as libc::c_int as libc::c_double;
    static mut kFourSymbolHistogramCost: libc::c_double =
        37 as libc::c_int as libc::c_double;
    ...
    if count == 2 as libc::c_int {
        return kTwoSymbolHistogramCost
            + (*histogram).total_count_ as libc::c_double;
    }
    if count == 3 as libc::c_int {
        let histo0: uint32_t =
            (*histogram).data_[s[0 as libc::c_int as usize] as usize];
        let histo1: uint32_t =
            (*histogram).data_[s[1 as libc::c_int as usize] as usize];
        let histo2: uint32_t =
            (*histogram).data_[s[2 as libc::c_int as usize] as usize];
    ...
    if count == 4 as libc::c_int {
        ...
        return kFourSymbolHistogramCost
            + (3 as libc::c_int as libc::c_uint).wrapping_mul(h23)
                as libc::c_double
            + (2 as libc::c_int as libc::c_uint).wrapping_mul(
                (histo[0 as libc::c_int as usize])
                    .wrapping_add(histo[1 as libc::c_int as usize])
            ) as libc::c_double
            - histomax_0 as libc::c_double;
    }
    let mut max_depth: size_t = 1 as libc::c_int as size_t;
    ...
    let log2total: libc::c_double = FastLog2((*histogram).total_count_);
    i = 0 as libc::c_int as size_t;
    while i < data_size {
        if (*histogram).data_[i as usize] > 0 as libc::c_int as libc::c_uint {
            let mut log2p: libc::c_double =
            ...
            depth_histo[depth as usize] =
                (depth_histo[depth as usize]).wrapping_add(1);
            depth_histo[depth as usize];
            i = i.wrapping_add(1);
            i;
        } else {
            let mut reps: uint32_t = 1 as libc::c_int as uint32_t;
            let mut k: size_t = 0;
            k = i.wrapping_add(1 as libc::c_int as libc::c_ulong);
            while k < data_size
                && (*histogram).data_[k as usize]
            ...
            i = (i as libc::c_ulong).wrapping_add(reps as libc::c_ulong)
                as size_t as size_t;
            if i == data_size {
                break;
            }
            if reps < 3 as libc::c_int as libc::c_uint {
                depth_histo[0 as libc::c_int as usize] =
                    (depth_histo[0 as libc::c_int as usize] as libc::c_uint)
                ...
                while reps > 0 as libc::c_int as libc::c_uint {
                    depth_histo[17 as libc::c_int as usize] = (depth_histo
                        [17 as libc::c_int as usize])
                        .wrapping_add(1);
                    depth_histo[17 as libc::c_int as usize];
    ...
    bits += (18 as libc::c_int as libc::c_ulong).wrapping_add(
        (2 as libc::c_int as libc::c_ulong).wrapping_mul(max_depth)
    ) as libc::c_double;
    bits += BitsEntropy(
