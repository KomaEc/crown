...
#[inline(always)]
unsafe extern "C" fn brotli_max_uint32_t(
    mut a: uint32_t,
    mut b: uint32_t
) -> uint32_t {
...
#[inline(always)]
unsafe extern "C" fn CommandDistanceContext(
    mut self_0: *const Command
) -> uint32_t {
    let mut r: uint32_t =
        ((*self_0).cmd_prefix_ as libc::c_int >> 6 as libc::c_int) as uint32_t;
    let mut c: uint32_t =
        ((*self_0).cmd_prefix_ as libc::c_int & 7 as libc::c_int) as uint32_t;
    if (r == 0 as libc::c_int as libc::c_uint
        || r == 2 as libc::c_int as libc::c_uint
...
#[inline(always)]
unsafe extern "C" fn CommandCopyLenCode(
    mut self_0: *const Command
) -> uint32_t {
    let mut modifier: uint32_t = (*self_0).copy_len_ >> 25 as libc::c_int;
    let mut delta: int32_t = (modifier
...
unsafe extern "C" fn SortHuffmanTreeItems(
    ...
    if n < 13 as libc::c_int as libc::c_ulong {
        ...
        let mut g: libc::c_int = if n < 57 as libc::c_int as libc::c_ulong {
            2 as libc::c_int
        } else {
            0 as libc::c_int
        };
        while g < 6 as libc::c_int {
            ...
            while i_0 < n {
                ...
                {
                    *items.offset(j_0 as isize) =
                        *items.offset(j_0.wrapping_sub(gap) as isize);
                    j_0 = (j_0 as libc::c_ulong).wrapping_sub(gap) as size_t
                        as size_t;
                }
...
unsafe extern "C" fn BrotliWriteBitsPrepareStorage(
    ...
    *array.offset((pos >> 3 as libc::c_int) as isize) =
...
unsafe extern "C" fn BlockLengthPrefixCode(mut len: uint32_t) -> uint32_t {
    let mut code: uint32_t = (if len >= 177 as libc::c_int as libc::c_uint {
    ...
    while code < (26 as libc::c_int - 1 as libc::c_int) as libc::c_uint
        && len
            >= _kBrotliPrefixCodeRanges
                [code.wrapping_add(1 as libc::c_int as libc::c_uint) as usize]
...
unsafe extern "C" fn GetBlockLengthPrefixCode(
    ...
    *extra = len.wrapping_sub(
        _kBrotliPrefixCodeRanges[*code as usize].offset as libc::c_uint
    );
}
unsafe extern "C" fn InitBlockTypeCodeCalculator(
    mut self_0: *mut BlockTypeCodeCalculator
) {
    (*self_0).last_type = 1 as libc::c_int as size_t;
    (*self_0).second_last_type = 0 as libc::c_int as size_t;
}
#[inline(always)]
unsafe extern "C" fn NextBlockTypeCode(
    ...
    let mut type_code: size_t = (if type_0 as libc::c_ulong
        == ((*calculator).last_type)
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
    {
        1 as libc::c_uint
    } else if type_0 as libc::c_ulong == (*calculator).second_last_type {
        0 as libc::c_uint
    } else {
...
unsafe extern "C" fn BrotliEncodeMlen(
    ...
    let mut lg: size_t = (if length == 1 as libc::c_int as libc::c_ulong {
        1 as libc::c_int as libc::c_uint
    } else {
        (Log2FloorNonZero(
            length.wrapping_sub(1 as libc::c_int as libc::c_ulong) as uint32_t
                as size_t
        ))
        .wrapping_add(1 as libc::c_int as libc::c_uint)
    }) as size_t;
    let mut mnibbles: size_t = (if lg < 16 as libc::c_int as libc::c_ulong {
        16 as libc::c_int as libc::c_ulong
    } else {
        lg.wrapping_add(3 as libc::c_int as libc::c_ulong)
    })
    .wrapping_div(4 as libc::c_int as libc::c_ulong);
    *nibblesbits = mnibbles.wrapping_sub(4 as libc::c_int as libc::c_ulong);
    *numbits = mnibbles.wrapping_mul(4 as libc::c_int as libc::c_ulong);
    *bits = length.wrapping_sub(1 as libc::c_int as libc::c_ulong);
}
#[inline(always)]
unsafe extern "C" fn StoreCommandExtra(
    ...
    let mut inscode: uint16_t =
        GetInsertLengthCode((*cmd).insert_len_ as size_t);
    ...
    let mut copyextraval: uint64_t =
        copylen_code.wrapping_sub(GetCopyBase(copycode)) as uint64_t;
...
unsafe extern "C" fn BrotliStoreHuffmanTreeOfHuffmanTreeToBitMask(
    ...
    let mut skip_some: size_t = 0 as libc::c_int as size_t;
    let mut codes_to_store: size_t =
    ...
    if *code_length_bitdepth
        .offset(kStorageOrder[0 as libc::c_int as usize] as isize)
        as libc::c_int
        == 0 as libc::c_int
        && *code_length_bitdepth
            .offset(kStorageOrder[1 as libc::c_int as usize] as isize)
            as libc::c_int
            == 0 as libc::c_int
    {
        skip_some = 2 as libc::c_int as size_t;
        if *code_length_bitdepth
            .offset(kStorageOrder[2 as libc::c_int as usize] as isize)
            as libc::c_int
            == 0 as libc::c_int
        {
    ...
    while i < codes_to_store {
        let mut l: size_t = *code_length_bitdepth
            .offset(kStorageOrder[i as usize] as isize)
            as size_t;
        BrotliWriteBits(
...
unsafe extern "C" fn StoreSimpleHuffmanTree(
    ...
    while i < num_symbols {
        ...
        while j < num_symbols {
            if (*depths.offset(*symbols.offset(j as isize) as isize)
                as libc::c_int)
                < *depths.offset(*symbols.offset(i as isize) as isize)
                    as libc::c_int
            {
    ...
    if num_symbols == 2 as libc::c_int as libc::c_ulong {
        ...
        BrotliWriteBits(
            1 as libc::c_int as size_t,
            (if *depths
                .offset(*symbols.offset(0 as libc::c_int as isize) as isize)
                as libc::c_int
                == 1 as libc::c_int
            {
                1 as libc::c_int
...
pub unsafe extern "C" fn BrotliStoreHuffmanTree(
    ...
    let mut huffman_tree_size: size_t = 0 as libc::c_int as size_t;
    ...
    let mut i: size_t = 0;
    let mut num_codes: libc::c_int = 0 as libc::c_int;
    let mut code: size_t = 0 as libc::c_int as size_t;
...
unsafe extern "C" fn BuildAndStoreHuffmanTree(
    ...
    let mut i: size_t = 0;
    let mut max_bits: size_t = 0 as libc::c_int as size_t;
    i = 0 as libc::c_int as size_t;
    ...
    let mut max_bits_counter: size_t =
        alphabet_size.wrapping_sub(1 as libc::c_int as libc::c_ulong);
    ...
    if count <= 1 as libc::c_int as libc::c_ulong {
        ...
        BrotliWriteBits(
            max_bits,
            s4[0 as libc::c_int as usize],
            storage_ix,
            storage
        );
        *depth.offset(s4[0 as libc::c_int as usize] as isize) =
            0 as libc::c_int as uint8_t;
        *bits.offset(s4[0 as libc::c_int as usize] as isize) =
            0 as libc::c_int as uint16_t;
        return;
    }
    memset(
...
pub unsafe extern "C" fn BrotliBuildAndStoreHuffmanTreeFast(
    ...
    while total != 0 as libc::c_int as libc::c_ulong {
        if *histogram.offset(length as isize) != 0 {
            ...
            count = count.wrapping_add(1);
            count;
            total = (total as libc::c_ulong).wrapping_sub(
                *histogram.offset(length as isize) as libc::c_ulong
            ) as size_t as size_t;
        }
    ...
    if count <= 1 as libc::c_int as libc::c_ulong {
        ...
        *depth.offset(symbols[0 as libc::c_int as usize] as isize) =
            0 as libc::c_int as uint8_t;
        *bits.offset(symbols[0 as libc::c_int as usize] as isize) =
            0 as libc::c_int as uint16_t;
        return;
    }
    memset(
        depth as *mut libc::c_void,
        0 as libc::c_int,
        length.wrapping_mul(::core::mem::size_of::<uint8_t>() as libc::c_ulong)
    );
    let max_tree_size: size_t = (2 as libc::c_int as libc::c_ulong)
        .wrapping_mul(length)
        .wrapping_add(1 as libc::c_int as libc::c_ulong);
    let mut tree: *mut HuffmanTree =
        if max_tree_size > 0 as libc::c_int as libc::c_ulong {
            BrotliAllocate(
                m,
                max_tree_size.wrapping_mul(
    ...
    loop {
        ...
        let n: libc::c_int =
            node.offset_from(tree) as libc::c_long as libc::c_int;
        ...
        *fresh2 = sentinel;
        ...
        while k > 0 as libc::c_int {
            ...
            (*node.offset(-(1 as libc::c_int) as isize)).total_count_ =
                ((*tree.offset(left as isize)).total_count_)
                    .wrapping_add((*tree.offset(right as isize)).total_count_);
            (*node.offset(-(1 as libc::c_int) as isize)).index_left_ =
                left as int16_t;
    ...
    if count <= 4 as libc::c_int as libc::c_ulong {
        ...
        while i_0 < count {
            ...
            while j_0 < count {
                if (*depth.offset(symbols[j_0 as usize] as isize)
                    as libc::c_int)
                    < *depth.offset(symbols[i_0 as usize] as isize)
                        as libc::c_int
                {
        ...
        while i_1 < length {
            ...
            while k_0 < length
                && *depth.offset(k_0 as isize) as libc::c_int
                    == value as libc::c_int
            {
...
unsafe extern "C" fn MoveToFrontTransform(
    ...
    let mut mtf_size: size_t =
        max_value.wrapping_add(1 as libc::c_int as libc::c_uint) as size_t;
    i = 0 as libc::c_int as size_t;
    while i < v_size {
...
unsafe extern "C" fn RunLengthCodeZeros(
    ...
    let mut max_reps: uint32_t = 0 as libc::c_int as uint32_t;
    let mut i: size_t = 0;
    let mut max_prefix: uint32_t = 0;
    i = 0 as libc::c_int as size_t;
    while i < in_size {
        let mut reps: uint32_t = 0 as libc::c_int as uint32_t;
        while i < in_size
            && *v.offset(i as isize) != 0 as libc::c_int as libc::c_uint
        {
            i = i.wrapping_add(1);
            i;
        }
    ...
    while i < in_size {
        if *v.offset(i as isize) != 0 as libc::c_int as libc::c_uint {
            ...
            *out_size;
            ...
            let mut reps_0: uint32_t = 1 as libc::c_int as uint32_t;
            let mut k: size_t = 0;
            ...
            i = (i as libc::c_ulong).wrapping_add(reps_0 as libc::c_ulong)
                as size_t as size_t;
            while reps_0 != 0 as libc::c_int as libc::c_uint {
                if reps_0 < (2 as libc::c_uint) << max_prefix {
                    let mut run_length_prefix: uint32_t =
                        Log2FloorNonZero(reps_0 as size_t);
                    let extra_bits: uint32_t = reps_0
                        .wrapping_sub((1 as libc::c_uint) << run_length_prefix);
                    *v.offset(*out_size as isize) = run_length_prefix
                        .wrapping_add(extra_bits << 9 as libc::c_int);
                    *out_size = (*out_size).wrapping_add(1);
                    *out_size;
                    break;
                } else {
                    let extra_bits_0: uint32_t = ((1 as libc::c_uint)
                        << max_prefix)
                        .wrapping_sub(1 as libc::c_uint);
                    *v.offset(*out_size as isize) = max_prefix
                        .wrapping_add(extra_bits_0 << 9 as libc::c_int);
                    reps_0 = (reps_0 as libc::c_uint).wrapping_sub(
...
unsafe extern "C" fn EncodeContextMap(
    ...
    let mut i: size_t = 0;
    let mut rle_symbols: *mut uint32_t = 0 as *mut uint32_t;
    let mut max_run_length_prefix: uint32_t = 6 as libc::c_int as uint32_t;
    let mut num_rle_symbols: size_t = 0 as libc::c_int as size_t;
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<[uint32_t; 272]>() as libc::c_ulong
    );
    i = 0 as libc::c_int as size_t;
    while i < num_rle_symbols {
        histogram[(*rle_symbols.offset(i as isize) & kSymbolMask) as usize] =
            (histogram
    ...
    let mut use_rle: libc::c_int =
        if max_run_length_prefix > 0 as libc::c_int as libc::c_uint {
            1 as libc::c_int
        } else {
            0 as libc::c_int
        };
    ...
    i = 0 as libc::c_int as size_t;
    while i < num_rle_symbols {
        let rle_symbol: uint32_t =
            *rle_symbols.offset(i as isize) & kSymbolMask;
        let extra_bits_val: uint32_t =
            *rle_symbols.offset(i as isize) >> 9 as libc::c_int;
        BrotliWriteBits(
...
unsafe extern "C" fn StoreBlockSwitch(
    ...
    let mut typecode: size_t =
        NextBlockTypeCode(&mut (*code).type_code_calculator, block_type);
...
unsafe extern "C" fn BuildAndStoreBlockSplitCode(
    ...
    memset(
        ...
        0 as libc::c_int,
        ::core::mem::size_of::<[uint32_t; 26]>() as libc::c_ulong
    );
    InitBlockTypeCodeCalculator(&mut type_code_calculator);
    i = 0 as libc::c_int as size_t;
    while i < num_blocks {
        let mut type_code: size_t = NextBlockTypeCode(
            &mut type_code_calculator,
            *types.offset(i as isize)
        );
        if i != 0 as libc::c_int as libc::c_ulong {
            type_histo[type_code as usize] =
                (type_histo[type_code as usize]).wrapping_add(1);
            type_histo[type_code as usize];
        }
        length_histo
    ...
    if num_types > 1 as libc::c_int as libc::c_ulong {
        BuildAndStoreHuffmanTree(
            &mut *type_histo.as_mut_ptr().offset(0 as libc::c_int as isize),
        ...
        BuildAndStoreHuffmanTree(
            &mut *length_histo.as_mut_ptr().offset(0 as libc::c_int as isize),
...
unsafe extern "C" fn StoreTrivialContextMap(
    ...
    if num_types > 1 as libc::c_int as libc::c_ulong {
        let mut repeat_code: size_t =
            context_bits.wrapping_sub(1 as libc::c_uint as libc::c_ulong);
        let mut repeat_bits: size_t = ((1 as libc::c_uint) << repeat_code)
            .wrapping_sub(1 as libc::c_uint)
            as size_t;
        ...
        i = 0 as libc::c_int as size_t;
        while i < num_types {
            let mut code: size_t = if i == 0 as libc::c_int as libc::c_ulong {
...
unsafe extern "C" fn InitBlockEncoder(
    ...
    InitBlockTypeCodeCalculator(
        &mut (*self_0).block_split_code_.type_code_calculator
    );
...
unsafe extern "C" fn StoreSymbol(
    ...
    if (*self_0).block_len_ == 0 as libc::c_int as libc::c_ulong {
        ...
        let mut block_len: uint32_t =
            *((*self_0).block_lengths_).offset(block_ix as isize);
        let mut block_type: uint8_t =
            *((*self_0).block_types_).offset(block_ix as isize);
...
unsafe extern "C" fn StoreSymbolWithContext(
    ...
    (*self_0).block_len_ = ((*self_0).block_len_).wrapping_sub(1);
    (*self_0).block_len_;
    let mut histo_ix: size_t = *context_map
        .offset(((*self_0).entropy_ix_).wrapping_add(context) as isize)
        as size_t;
...
unsafe extern "C" fn BuildAndStoreEntropyCodesLiteral(
    ...
    let table_size: size_t =
        histograms_size.wrapping_mul((*self_0).histogram_length_);
    (*self_0).depths_ = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            table_size.wrapping_mul(
...
unsafe extern "C" fn JumpToByteBoundary(
    ...
    *storage.offset((*storage_ix >> 3 as libc::c_int) as isize) =
        0 as libc::c_int as uint8_t;
}
#[no_mangle]
pub unsafe extern "C" fn BrotliStoreMetaBlock(
    ...
    let mut num_effective_distance_symbols: uint32_t =
        (*params).dist.alphabet_size_limit;
    let mut tree: *mut HuffmanTree = 0 as *mut HuffmanTree;
    ...
    let mut literal_enc: BlockEncoder = BlockEncoder {
        histogram_length_: 0,
        num_block_types_: 0,
    ...
    let mut command_enc: BlockEncoder = BlockEncoder {
        histogram_length_: 0,
        num_block_types_: 0,
        block_types_: 0 as *const uint8_t,
        block_lengths_: 0 as *const uint32_t,
    ...
    let mut distance_enc: BlockEncoder = BlockEncoder {
        histogram_length_: 0,
        num_block_types_: 0,
        block_types_: 0 as *const uint8_t,
        block_lengths_: 0 as *const uint32_t,
    ...
    tree = if 2 as libc::c_int * 704 as libc::c_int + 1 as libc::c_int
        > 0 as libc::c_int
    {
        BrotliAllocate(
            m,
            ((2 as libc::c_int * 704 as libc::c_int + 1 as libc::c_int)
                as libc::c_ulong)
                .wrapping_mul(
                    ::core::mem::size_of::<HuffmanTree>() as libc::c_ulong
                )
    ...
    BrotliWriteBits(
        4 as libc::c_int as size_t,
        ((*dist).num_direct_distance_codes >> (*dist).distance_postfix_bits)
            as uint64_t,
        storage_ix,
        storage
    );
    ...
    while i < n_commands {
        ...
        if (*mb).literal_context_map_size == 0 as libc::c_int as libc::c_ulong {
            ...
            while j_0 != 0 as libc::c_int as libc::c_ulong {
                let mut context: size_t =
                    (*literal_context_lut.offset(prev_byte as isize)
                        as libc::c_int
                        | *literal_context_lut
        ...
        pos = (pos as libc::c_ulong)
            .wrapping_add(CommandCopyLen(&cmd) as libc::c_ulong)
            as size_t as size_t;
        if CommandCopyLen(&cmd) != 0 {
            prev_byte2 = *input.offset(
                (pos.wrapping_sub(2 as libc::c_int as libc::c_ulong) & mask)
                    as isize
            );
            prev_byte = *input.offset(
                (pos.wrapping_sub(1 as libc::c_int as libc::c_ulong) & mask)
                    as isize
            );
            if cmd.cmd_prefix_ as libc::c_int >= 128 as libc::c_int {
                let mut dist_code: size_t = (cmd.dist_prefix_ as libc::c_int
                    & 0x3ff as libc::c_int)
                    as size_t;
                let mut distnumextra: uint32_t =
                    (cmd.dist_prefix_ as libc::c_int >> 10 as libc::c_int)
                        as uint32_t;
                let mut distextra: uint64_t = cmd.dist_extra_ as uint64_t;
                if (*mb).distance_context_map_size
                    == 0 as libc::c_int as libc::c_ulong
                {
                    StoreSymbol(
                        &mut distance_enc,
                    ...
                    let mut context_0: size_t =
                        CommandDistanceContext(&cmd) as size_t;
                    StoreSymbolWithContext(
                        &mut distance_enc,
                        dist_code,
                        context_0,
...
unsafe extern "C" fn StoreDataWithHuffmanCodes(
    ...
    while i < n_commands {
        ...
        if CommandCopyLen(&cmd) != 0
            && cmd.cmd_prefix_ as libc::c_int >= 128 as libc::c_int
        {
            let dist_code: size_t = (cmd.dist_prefix_ as libc::c_int
                & 0x3ff as libc::c_int)
                as size_t;
            let distnumextra: uint32_t = (cmd.dist_prefix_ as libc::c_int
                >> 10 as libc::c_int)
                as uint32_t;
...
pub unsafe extern "C" fn BrotliStoreMetaBlockTrivial(
    ...
    let mut lit_histo: HistogramLiteral = HistogramLiteral {
        data_: [0; 256],
        total_count_: 0,
        bit_cost_: 0.
    };
    let mut cmd_histo: HistogramCommand = HistogramCommand {
        data_: [0; 704],
        total_count_: 0,
        bit_cost_: 0.
    };
    let mut dist_histo: HistogramDistance = HistogramDistance {
        data_: [0; 544],
        total_count_: 0,
        bit_cost_: 0.
    };
    ...
    BuildAndStoreHuffmanTree(
        ...
        ((16 as libc::c_int + 0 as libc::c_int) as libc::c_uint).wrapping_add(
            (62 as libc::c_uint) << 0 as libc::c_int + 1 as libc::c_int
        ) as size_t,
        num_distance_symbols as size_t,
        tree,
...
pub unsafe extern "C" fn BrotliStoreMetaBlockFast(
    ...
    let mut num_distance_symbols: uint32_t = (*params).dist.alphabet_size_max;
    let mut distance_alphabet_bits: uint32_t = (Log2FloorNonZero(
        num_distance_symbols.wrapping_sub(1 as libc::c_int as libc::c_uint)
            as size_t
    ))
    .wrapping_add(1 as libc::c_int as libc::c_uint);
    StoreCompressedMetaBlockHeader(is_last, length, storage_ix, storage);
    ...
    if n_commands <= 128 as libc::c_int as libc::c_ulong {
        ...
        while i < n_commands {
            ...
            num_literals = (num_literals as libc::c_ulong)
                .wrapping_add(cmd.insert_len_ as libc::c_ulong)
                as size_t as size_t;
            pos = (pos as libc::c_ulong)
                .wrapping_add(CommandCopyLen(&cmd) as libc::c_ulong)
                as size_t as size_t;
...
pub unsafe extern "C" fn BrotliStoreUncompressedMetaBlock(
    ...
    {
        let mut len1: size_t = mask
            .wrapping_add(1 as libc::c_int as libc::c_ulong)
            .wrapping_sub(masked_pos);
        memcpy(
            &mut *storage.offset((*storage_ix >> 3 as libc::c_int) as isize)
                as *mut uint8_t as *mut libc::c_void,
            &*input.offset(masked_pos as isize) as *const uint8_t
                as *const libc::c_void,
            len1
        );
        *storage_ix = (*storage_ix as libc::c_ulong)
            .wrapping_add(len1 << 3 as libc::c_int)
            as size_t as size_t;
    ...
    *storage_ix = (*storage_ix as libc::c_ulong)
        .wrapping_add(len << 3 as libc::c_int) as size_t
        as size_t;
...
unsafe extern "C" fn run_static_initializers() {
    kSymbolMask = ((1 as libc::c_uint) << 9 as libc::c_int)
        .wrapping_sub(1 as libc::c_uint);
}
#[used]
