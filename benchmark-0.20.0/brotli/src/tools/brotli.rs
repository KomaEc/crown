...
unsafe extern "C" fn ParseInt(
    ...
    while i < 5 as libc::c_int {
        let mut c: libc::c_char = *s.offset(i as isize);
    ...
    if i > 1 as libc::c_int && *s.offset(0 as libc::c_int as isize) as libc::c_int == '0' as i32 {
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn ParseAlias(mut name: *const libc::c_char) -> Command {
    let mut unbrotli: *const libc::c_char = b"unbrotli\0" as *const u8 as *const libc::c_char;
    let mut unbrotli_len: size_t = strlen(unbrotli);
    name = FileName(name);
    if strncmp(name, unbrotli, unbrotli_len) == 0 as libc::c_int {
        let mut terminator: libc::c_char = *name.offset(unbrotli_len as isize);
        if terminator as libc::c_int == 0 as libc::c_int || terminator as libc::c_int == '.' as i32
        {
...
unsafe extern "C" fn ParseParams(mut params: *mut Context) -> Command {
    let mut argc: libc::c_int = (*params).argc;
    let mut argv: *mut *mut libc::c_char = (*params).argv;
    let mut i: libc::c_int = 0;
    let mut next_option_index: libc::c_int = 0 as libc::c_int;
    let mut input_count: size_t = 0 as libc::c_int as size_t;
    let mut longest_path_len: size_t = 1 as libc::c_int as size_t;
    let mut command_set: libc::c_int = 0 as libc::c_int;
    let mut quality_set: libc::c_int = 0 as libc::c_int;
    let mut output_set: libc::c_int = 0 as libc::c_int;
    let mut keep_set: libc::c_int = 0 as libc::c_int;
    let mut lgwin_set: libc::c_int = 0 as libc::c_int;
    let mut suffix_set: libc::c_int = 0 as libc::c_int;
    let mut after_dash_dash: libc::c_int = 0 as libc::c_int;
    let mut command: Command = ParseAlias(*argv.offset(0 as libc::c_int as isize));
    i = 1 as libc::c_int;
    while i < argc {
        ...
        if arg_len == 0 as libc::c_int as libc::c_ulong {
                ...
                || arg_len == 1 as libc::c_int as libc::c_ulong
            {
                    ...
                    && *arg.offset(1 as libc::c_int as isize) as libc::c_int == '-' as i32
                {
                ...
                } else if *arg.offset(1 as libc::c_int as isize) as libc::c_int != '-' as i32 {
                    let mut j: size_t = 0;
                    j = 1 as libc::c_int as size_t;
                    while j < arg_len {
                        let mut c: libc::c_char = *arg.offset(j as isize);
                        if c as libc::c_int >= '0' as i32 && c as libc::c_int <= '9' as i32 {
                            ...
                            return COMMAND_HELP;
                        } else if c as libc::c_int == 'j' as i32 || c as libc::c_int == 'k' as i32 {
                            if keep_set != 0 {
                                fprintf(
                                    stderr,
                            ...
                            (*params).junk_source = if c as libc::c_int == 'j' as i32 {
                                1 as libc::c_int
                            } else {
                                0 as libc::c_int
                            };
                            ...
                            if j.wrapping_add(1 as libc::c_int as libc::c_ulong) != arg_len {
                                fprintf(
                                    stderr,
                        ...
                        == 0 as libc::c_int
                    {
                        ...
                        quality_set = 1 as libc::c_int;
                        (*params).quality = 11 as libc::c_int;
                    } else if strcmp(b"decompress\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if command_set != 0 {
                            fprintf(
                    ...
                    {
                        return COMMAND_HELP;
                    } else if strcmp(b"keep\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if keep_set != 0 {
                            fprintf(
                    ...
                    } else if strcmp(b"no-copy-stat\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if (*params).copy_stat == 0 {
                            fprintf(
                        ...
                        (*params).copy_stat = 0 as libc::c_int;
                    } else if strcmp(b"rm\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if keep_set != 0 {
                            fprintf(
                    ...
                    } else if strcmp(b"stdout\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if output_set != 0 {
                            fprintf(
                        ...
                        output_set = 1 as libc::c_int;
                        (*params).write_to_stdout = 1 as libc::c_int;
                    } else if strcmp(b"test\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if command_set != 0 {
                            fprintf(
                        ...
                        command_set = 1 as libc::c_int;
                        command = COMMAND_TEST_INTEGRITY;
                    } else if strcmp(b"verbose\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        if (*params).verbosity > 0 as libc::c_int {
                            fprintf(
                        ...
                        (*params).verbosity = 1 as libc::c_int;
                    } else if strcmp(b"version\0" as *const u8 as *const libc::c_char, arg)
                        == 0 as libc::c_int
                    {
                        return COMMAND_VERSION;
                    } else {
                        let mut value: *const libc::c_char = strrchr(arg, '=' as i32);
                        ...
                        value;
                        if strncmp(b"lgwin\0" as *const u8 as *const libc::c_char, arg, key_len)
                            == 0 as libc::c_int
                        {
                            if lgwin_set != 0 {
                                fprintf(
    ...
    (*params).decompress = (command as libc::c_uint
        == COMMAND_DECOMPRESS as libc::c_int as libc::c_uint)
        as libc::c_int;
    (*params).test_integrity = (command as libc::c_uint
...
unsafe extern "C" fn PrintVersion() {
    let mut major: libc::c_int = 0x1000009 as libc::c_int >> 24 as libc::c_int;
    let mut minor: libc::c_int =
        0x1000009 as libc::c_int >> 12 as libc::c_int & 0xfff as libc::c_int;
    let mut patch: libc::c_int = 0x1000009 as libc::c_int & 0xfff as libc::c_int;
    fprintf(
        stdout,
        b"brotli %d.%d.%d\n\0" as *const u8 as *const libc::c_char,
        major,
...
unsafe extern "C" fn PrintablePath(mut path: *const libc::c_char) -> *const libc::c_char {
...
unsafe extern "C" fn NextFile(mut context: *mut Context) -> libc::c_int {
    ...
    if (*context).decompress != 0 {
        ...
        let mut name: *mut libc::c_char = FileName((*context).modified_path) as *mut libc::c_char;
        let mut name_suffix: *mut libc::c_char = 0 as *mut libc::c_char;
        ...
        *name_suffix.offset(0 as libc::c_int as isize) = 0 as libc::c_int as libc::c_char;
        return 1 as libc::c_int;
    } else {
        strcpy(
...
unsafe extern "C" fn OpenFiles(mut context: *mut Context) -> libc::c_int {
    let mut is_ok: libc::c_int = OpenInputFile((*context).current_input_path, &mut (*context).fin);
...
unsafe extern "C" fn CloseFiles(
    ...
    let mut is_ok: libc::c_int = 1 as libc::c_int;
...
unsafe extern "C" fn InitializeBuffers(mut context: *mut Context) {
    ...
    (*context).next_in = 0 as *const uint8_t;
...
unsafe extern "C" fn ProvideInput(mut context: *mut Context) -> libc::c_int {
    ...
    (*context).total_in = ((*context).total_in as libc::c_ulong)
        .wrapping_add((*context).available_in) as size_t as size_t;
...
unsafe extern "C" fn WriteOutput(mut context: *mut Context) -> libc::c_int {
    let mut out_size: size_t =
        ((*context).next_out).offset_from((*context).output) as libc::c_long as size_t;
    (*context).total_out =
        ((*context).total_out as libc::c_ulong).wrapping_add(out_size) as size_t as size_t;
...
unsafe extern "C" fn DecompressFile(
    ...
    loop {
            ...
            == BROTLI_DECODER_RESULT_SUCCESS as libc::c_int as libc::c_uint
        {
            ...
            let mut has_more_input: libc::c_int =
                ((*context).available_in != 0 as libc::c_int as libc::c_ulong
            ...
            if (*context).verbosity > 0 as libc::c_int {
                fprintf(
                    stderr,
                    b"Decompressed \0" as *const u8 as *const libc::c_char,
                );
...
unsafe extern "C" fn DecompressFiles(mut context: *mut Context) -> libc::c_int {
    while NextFile(context) != 0 {
        let mut is_ok: libc::c_int = 1 as libc::c_int;
        let mut s: *mut BrotliDecoderState =
            BrotliDecoderCreateInstance(None, None, 0 as *mut libc::c_void);
        if s.is_null() {
            fprintf(
                stderr,
                b"out of memory\n\0" as *const u8 as *const libc::c_char,
        ...
        BrotliDecoderSetParameter(s, BROTLI_DECODER_PARAM_LARGE_WINDOW, 1 as libc::c_uint);
...
unsafe extern "C" fn CompressFile(
    ...
    let mut is_eof: libc::c_int = 0 as libc::c_int;
    InitializeBuffers(context);
    loop {
...
unsafe extern "C" fn CompressFiles(mut context: *mut Context) -> libc::c_int {
    while NextFile(context) != 0 {
        let mut is_ok: libc::c_int = 1 as libc::c_int;
        let mut s: *mut BrotliEncoderState =
            BrotliEncoderCreateInstance(None, None, 0 as *mut libc::c_void);
        if s.is_null() {
            fprintf(
                stderr,
                b"out of memory\n\0" as *const u8 as *const libc::c_char,
        ...
        if (*context).lgwin > 0 as libc::c_int {
            if (*context).lgwin > 24 as libc::c_int {
                BrotliEncoderSetParameter(s, BROTLI_PARAM_LARGE_WINDOW, 1 as libc::c_uint);
            }
            BrotliEncoderSetParameter(s, BROTLI_PARAM_LGWIN, (*context).lgwin as uint32_t);
        } else {
            let mut lgwin: uint32_t = 24 as libc::c_int as uint32_t;
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *mut libc::c_char) -> libc::c_int {
    ...
    if command as libc::c_uint == COMMAND_COMPRESS as libc::c_int as libc::c_uint
        ...
        || command as libc::c_uint == COMMAND_TEST_INTEGRITY as libc::c_int as libc::c_uint
    {
        if is_ok != 0 {
            let mut modified_path_len: size_t = (context.longest_path_len)
                .wrapping_add(strlen(context.suffix))
                .wrapping_add(1 as libc::c_int as libc::c_ulong);
            context.modified_path = malloc(modified_path_len) as *mut libc::c_char;
            context.buffer = malloc(kFileBufferSize.wrapping_mul(2 as libc::c_int as libc::c_ulong))
                as *mut uint8_t;
    ...
    match command as libc::c_uint {
        ...
        2 | 3 | _ => {
            is_ok = (command as libc::c_uint == COMMAND_HELP as libc::c_int as libc::c_uint)
                as libc::c_int;
