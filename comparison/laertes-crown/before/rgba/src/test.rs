...
extern "C" {
    ...
    fn rgba_to_string(rgba: rgba_t, buf: *mut std::os::raw::c_char, len: size_t);
    fn rgba_from_string(str: *const std::os::raw::c_char, ok: *mut std::os::raw::c_short) -> uint32_t;
...
pub unsafe extern "C" fn test_named() {
    let mut ok: std::os::raw::c_short = 0;
...
pub unsafe extern "C" fn test_rgb() {
    ...
    val = rgba_from_string(b"rgb(0,0,0)\0" as *const u8 as *const std::os::raw::c_char, &mut ok)
        as int32_t;
    if ok as std::os::raw::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const std::os::raw::c_char,
...
pub unsafe extern "C" fn test_hex() {
    ...
    val = rgba_from_string(b"#ffffff\0" as *const u8 as *const std::os::raw::c_char, &mut ok)
        as int32_t;
    if ok as std::os::raw::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const std::os::raw::c_char,
    ...
    val = rgba_from_string(b"#ffcc00\0" as *const u8 as *const std::os::raw::c_char, &mut ok)
        as int32_t;
    if ok as std::os::raw::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const std::os::raw::c_char,
    ...
    val = rgba_from_string(b"#fco\0" as *const u8 as *const std::os::raw::c_char, &mut ok)
        as int32_t;
    if ok as std::os::raw::c_int != 0 {} else {
        __assert_fail(
            b"ok\0" as *const u8 as *const std::os::raw::c_char,
