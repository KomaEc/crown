...
unsafe extern "C" fn h(mut c: std::os::raw::c_char) -> std::os::raw::c_int {
...
unsafe extern "C" fn rgba_from_hex6_string(mut str: *const std::os::raw::c_char) -> uint32_t {
...
unsafe extern "C" fn rgba_from_hex3_string(mut str: *const std::os::raw::c_char) -> int32_t {
    return rgba_from_rgb(
        ((h(*str.offset(0 as std::os::raw::c_int as isize)) << 4 as std::os::raw::c_int)
...
unsafe extern "C" fn rgba_from_rgb_string(
            ...
            as *const std::os::raw::c_char
    {
        ...
        *ok = 1 as std::os::raw::c_int as std::os::raw::c_short;
        return rgba_from_rgb(r, g, b);
    }
    *ok = 0 as std::os::raw::c_int as std::os::raw::c_short;
