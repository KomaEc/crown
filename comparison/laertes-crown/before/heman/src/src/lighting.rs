...
extern "C" {
    static mut _gamma: std::os::raw::c_float;
    ...
    fn kmMax(lhs: std::os::raw::c_float, rhs: std::os::raw::c_float) -> std::os::raw::c_float;
    fn kmClamp(
...
static mut _occlusion_scale: std::os::raw::c_float = 1.0f32;
#[no_mangle]
...
pub unsafe extern "C" fn heman_lighting_apply(
    ...
    static mut default_pos: [std::os::raw::c_float; 3] = [-0.5f32, 0.5f32, 1.0f32];
...
unsafe extern "C" fn azimuth_slope(mut a: kmVec3, mut b: kmVec3) -> std::os::raw::c_float {
...
unsafe extern "C" fn horizon_scan(
    ...
    let mut sweep: std::os::raw::c_int = 0;
