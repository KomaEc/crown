...
static mut gradients3D: [std::os::raw::c_schar; 72] = [
...
static mut gradients4D: [std::os::raw::c_schar; 256] = [
...
#[inline]
unsafe extern "C" fn fastFloor(mut x: std::os::raw::c_double) -> std::os::raw::c_int {
...
pub unsafe extern "C" fn open_simplex_noise(
    ...
    *ctx = malloc(::std::mem::size_of::<osn_context>() as std::os::raw::c_ulong)
        as *mut osn_context;
    if (*ctx).is_null() {
        return -(12 as std::os::raw::c_int);
    }
    ...
    *fresh3 = 0 as *mut int16_t;
    rc = allocate_perm(*ctx, 256 as std::os::raw::c_int, 256 as std::os::raw::c_int);
    if rc != 0 {
...
pub unsafe extern "C" fn open_simplex_noise2(
    ...
    let mut dx0 = x - xb;
    let mut dy0 = y - yb;
    let mut dx_ext: std::os::raw::c_double = 0.;
    let mut dy_ext: std::os::raw::c_double = 0.;
    let mut xsv_ext: std::os::raw::c_int = 0;
    let mut ysv_ext: std::os::raw::c_int = 0;
...
pub unsafe extern "C" fn open_simplex_noise3(
    ...
    let mut dy0 = y - yb;
    let mut dz0 = z - zb;
    let mut dx_ext0: std::os::raw::c_double = 0.;
    let mut dy_ext0: std::os::raw::c_double = 0.;
    let mut dz_ext0: std::os::raw::c_double = 0.;
    let mut dx_ext1: std::os::raw::c_double = 0.;
    let mut dy_ext1: std::os::raw::c_double = 0.;
    let mut dz_ext1: std::os::raw::c_double = 0.;
    let mut xsv_ext0: std::os::raw::c_int = 0;
    let mut ysv_ext0: std::os::raw::c_int = 0;
    let mut zsv_ext0: std::os::raw::c_int = 0;
    let mut xsv_ext1: std::os::raw::c_int = 0;
    let mut ysv_ext1: std::os::raw::c_int = 0;
    let mut zsv_ext1: std::os::raw::c_int = 0;
    let mut value = 0 as std::os::raw::c_int as std::os::raw::c_double;
    if inSum <= 1 as std::os::raw::c_int as std::os::raw::c_double {
        ...
        let mut aScore_1: std::os::raw::c_double = 0.;
        let mut aPoint_1: int8_t = 0;
        let mut aIsFurtherSide: std::os::raw::c_int = 0;
        let mut bScore_1: std::os::raw::c_double = 0.;
        let mut bPoint_1: int8_t = 0;
        let mut bIsFurtherSide: std::os::raw::c_int = 0;
...
pub unsafe extern "C" fn open_simplex_noise4(
    ...
    let mut dy_ext0: std::os::raw::c_double = 0.;
    let mut dz_ext0: std::os::raw::c_double = 0.;
    let mut dw_ext0: std::os::raw::c_double = 0.;
    let mut dx_ext1: std::os::raw::c_double = 0.;
    let mut dy_ext1: std::os::raw::c_double = 0.;
    let mut dz_ext1: std::os::raw::c_double = 0.;
    let mut dw_ext1: std::os::raw::c_double = 0.;
    let mut dx_ext2: std::os::raw::c_double = 0.;
    let mut dy_ext2: std::os::raw::c_double = 0.;
    let mut dz_ext2: std::os::raw::c_double = 0.;
    let mut dw_ext2: std::os::raw::c_double = 0.;
    let mut xsv_ext0: std::os::raw::c_int = 0;
    let mut ysv_ext0: std::os::raw::c_int = 0;
    let mut zsv_ext0: std::os::raw::c_int = 0;
    let mut wsv_ext0: std::os::raw::c_int = 0;
    let mut xsv_ext1: std::os::raw::c_int = 0;
    let mut ysv_ext1: std::os::raw::c_int = 0;
    let mut zsv_ext1: std::os::raw::c_int = 0;
    let mut wsv_ext1: std::os::raw::c_int = 0;
    let mut xsv_ext2: std::os::raw::c_int = 0;
    let mut ysv_ext2: std::os::raw::c_int = 0;
    let mut zsv_ext2: std::os::raw::c_int = 0;
    let mut wsv_ext2: std::os::raw::c_int = 0;
    let mut value = 0 as std::os::raw::c_int as std::os::raw::c_double;
    if inSum <= 1 as std::os::raw::c_int as std::os::raw::c_double {
        let mut aPoint = 0x1 as std::os::raw::c_int as int8_t;
        let mut aScore = xins;
        ...
        let mut aScore_2: std::os::raw::c_double = 0.;
        let mut aPoint_2: int8_t = 0;
        let mut aIsBiggerSide_0 = 1 as std::os::raw::c_int;
        let mut bScore_2: std::os::raw::c_double = 0.;
