...
extern "C" {
    ...
    fn kmVec3LengthSq(pIn: *const kmVec3) -> std::os::raw::c_float;
    ...
    fn kmVec3Dot(pV1: *const kmVec3, pV2: *const kmVec3) -> std::os::raw::c_float;
    fn kmVec3Add(
        pOut: *mut kmVec3,
        pV1: *const kmVec3,
        pV2: *const kmVec3,
...
pub unsafe extern "C" fn kmQuaternionIsIdentity(
    ...
    return ((*pIn).x as std::os::raw::c_double == 0.0f64 && (*pIn).y as std::os::raw::c_double == 0.0f64
        && (*pIn).z as std::os::raw::c_double == 0.0f64 && (*pIn).w as std::os::raw::c_double == 1.0f64)
        as std::os::raw::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn kmQuaternionRotationMatrix(
    ...
    let mut x: std::os::raw::c_float = 0.;
    let mut y: std::os::raw::c_float = 0.;
    let mut z: std::os::raw::c_float = 0.;
    let mut w: std::os::raw::c_float = 0.;
    let mut pMatrix = 0 as *mut std::os::raw::c_float;
    let mut m4x4: [std::os::raw::c_float; 16] = [
    ...
    m4x4[0 as std::os::raw::c_int as usize] = (*pIn).mat[0 as std::os::raw::c_int as usize];
    m4x4[1 as std::os::raw::c_int as usize] = (*pIn).mat[3 as std::os::raw::c_int as usize];
    m4x4[2 as std::os::raw::c_int as usize] = (*pIn).mat[6 as std::os::raw::c_int as usize];
    m4x4[4 as std::os::raw::c_int as usize] = (*pIn).mat[1 as std::os::raw::c_int as usize];
    m4x4[5 as std::os::raw::c_int as usize] = (*pIn).mat[4 as std::os::raw::c_int as usize];
    m4x4[6 as std::os::raw::c_int as usize] = (*pIn).mat[7 as std::os::raw::c_int as usize];
    m4x4[8 as std::os::raw::c_int as usize] = (*pIn).mat[2 as std::os::raw::c_int as usize];
    m4x4[9 as std::os::raw::c_int as usize] = (*pIn).mat[5 as std::os::raw::c_int as usize];
    m4x4[10 as std::os::raw::c_int as usize] = (*pIn).mat[8 as std::os::raw::c_int as usize];
...
pub unsafe extern "C" fn kmQuaternionSlerp(
    ...
    kmQuaternionScale(&mut t1, q1, cos(theta as std::os::raw::c_double) as std::os::raw::c_float);
    kmQuaternionScale(&mut t2, &mut tmp, sin(theta as std::os::raw::c_double) as std::os::raw::c_float);
...
pub unsafe extern "C" fn kmQuaternionToAxisAngle(
    ...
    mut pAngle: *mut std::os::raw::c_float,
) {
    let mut tempAngle: std::os::raw::c_float = 0.;
    let mut scale: std::os::raw::c_float = 0.;
...
pub unsafe extern "C" fn kmQuaternionRotationBetweenVec3(
    ...
    let mut a: std::os::raw::c_float = 0.;
    ...
    if a < 1e-6f32 - 1.0f32 {
        if fabs(kmVec3LengthSq(fallback) as std::os::raw::c_double) < 0.0001f64 {
            ...
            if fabs(kmVec3LengthSq(&mut axis) as std::os::raw::c_double) < 0.0001f64 {
...
pub unsafe extern "C" fn kmQuaternionGetPitch(
    ...
    let mut result = atan2(
        (2 as std::os::raw::c_int as std::os::raw::c_float * ((*q).y * (*q).z + (*q).w * (*q).x))
...
pub unsafe extern "C" fn kmQuaternionGetYaw(
    ...
    let mut result = asin(
        (-(2 as std::os::raw::c_int) as std::os::raw::c_float * ((*q).x * (*q).z - (*q).w * (*q).y))
            as std::os::raw::c_double,
    ) as std::os::raw::c_float;
    return result;
}
...
pub unsafe extern "C" fn kmQuaternionGetRoll(
    ...
    let mut result = atan2(
        (2 as std::os::raw::c_int as std::os::raw::c_float * ((*q).x * (*q).y + (*q).w * (*q).z))
            as std::os::raw::c_double,
        ((*q).w * (*q).w + (*q).x * (*q).x - (*q).y * (*q).y - (*q).z * (*q).z)
            as std::os::raw::c_double,
    ) as std::os::raw::c_float;
