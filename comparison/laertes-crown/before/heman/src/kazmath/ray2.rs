...
extern "C" {
    ...
    fn kmVec2Length(pIn: *const kmVec2) -> std::os::raw::c_float;
    fn kmVec2Normalize(pOut: *mut kmVec2, pIn: *const kmVec2) -> *mut kmVec2;
    fn kmVec2Dot(pV1: *const kmVec2, pV2: *const kmVec2) -> std::os::raw::c_float;
    fn kmVec2Subtract(
        pOut: *mut kmVec2,
        pV1: *const kmVec2,
        pV2: *const kmVec2,
...
pub unsafe extern "C" fn kmLine2WithLineIntersection(
    ...
    mut outTA: *mut std::os::raw::c_float,
    mut outTB: *mut std::os::raw::c_float,
...
pub unsafe extern "C" fn kmSegment2WithSegmentIntersection(
    ...
    let mut ua: std::os::raw::c_float = 0.;
    let mut ub: std::os::raw::c_float = 0.;
...
pub unsafe extern "C" fn kmRay2IntersectTriangle(
    ...
    mut intersection: *mut kmVec2,
    mut normal_out: *mut kmVec2,
    mut distance_out: *mut std::os::raw::c_float,
) -> std::os::raw::c_uchar {
...
pub unsafe extern "C" fn kmRay2IntersectBox(
    ...
    points[0 as std::os::raw::c_int as usize] = p1;
    points[1 as std::os::raw::c_int as usize] = p2;
    points[2 as std::os::raw::c_int as usize] = p3;
    points[3 as std::os::raw::c_int as usize] = p4;
    ...
    while i < 4 as std::os::raw::c_int as std::os::raw::c_uint {
        ...
        let mut next_point = if i == 3 as std::os::raw::c_int as std::os::raw::c_uint {
            points[0 as std::os::raw::c_int as usize]
        } else {
            points[i.wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint) as usize]
        };
        let mut other_point = if i == 3 as std::os::raw::c_int as std::os::raw::c_uint
            || i == 0 as std::os::raw::c_int as std::os::raw::c_uint
        {
            points[1 as std::os::raw::c_int as usize]
        } else {
            points[0 as std::os::raw::c_int as usize]
        };
