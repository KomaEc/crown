...
extern "C" {
    fn kmVec2Fill(pOut: *mut kmVec2, x: std::os::raw::c_float, y: std::os::raw::c_float) -> *mut kmVec2;
    fn kmVec2Add(
        pOut: *mut kmVec2,
        pV1: *const kmVec2,
        pV2: *const kmVec2,
...
#[no_mangle]
pub unsafe extern "C" fn kmAABB2DiameterX(mut aabb: *const kmAABB2) -> std::os::raw::c_float {
    return (*aabb).max.x - (*aabb).min.x;
}
#[no_mangle]
pub unsafe extern "C" fn kmAABB2DiameterY(mut aabb: *const kmAABB2) -> std::os::raw::c_float {
