...
extern "C" {
    ...
    fn kmRadiansToDegrees(radians: std::os::raw::c_float) -> std::os::raw::c_float;
...
#[no_mangle]
pub unsafe extern "C" fn kmVec3Length(mut pIn: *const kmVec3) -> std::os::raw::c_float {
    return sqrtf(kmSQR((*pIn).x) + kmSQR((*pIn).y) + kmSQR((*pIn).z));
}
#[no_mangle]
pub unsafe extern "C" fn kmVec3LengthSq(mut pIn: *const kmVec3) -> std::os::raw::c_float {
...
pub unsafe extern "C" fn kmVec3MultiplyMat3(
    ...
    v
        ...
        + (*pV).y * (*pM).mat[3 as std::os::raw::c_int as usize]
        + (*pV).z * (*pM).mat[6 as std::os::raw::c_int as usize];
    v
        .y = (*pV).x * (*pM).mat[1 as std::os::raw::c_int as usize]
        + (*pV).y * (*pM).mat[4 as std::os::raw::c_int as usize]
        + (*pV).z * (*pM).mat[7 as std::os::raw::c_int as usize];
    v
...
pub unsafe extern "C" fn kmVec3MultiplyMat4(
    ...
    v
        ...
        + (*pV).y * (*pM).mat[4 as std::os::raw::c_int as usize]
        + (*pV).z * (*pM).mat[8 as std::os::raw::c_int as usize]
        + (*pM).mat[12 as std::os::raw::c_int as usize];
    v
        .y = (*pV).x * (*pM).mat[1 as std::os::raw::c_int as usize]
        + (*pV).y * (*pM).mat[5 as std::os::raw::c_int as usize]
...
pub unsafe extern "C" fn kmVec3InverseTransform(
    ...
    v1.x = (*pVect).x - (*pM).mat[12 as std::os::raw::c_int as usize];
    v1.y = (*pVect).y - (*pM).mat[13 as std::os::raw::c_int as usize];
    v1.z = (*pVect).z - (*pM).mat[14 as std::os::raw::c_int as usize];
    v2
        .x = v1.x * (*pM).mat[0 as std::os::raw::c_int as usize]
        + v1.y * (*pM).mat[1 as std::os::raw::c_int as usize]
        + v1.z * (*pM).mat[2 as std::os::raw::c_int as usize];
    v2
        .y = v1.x * (*pM).mat[4 as std::os::raw::c_int as usize]
        + v1.y * (*pM).mat[5 as std::os::raw::c_int as usize]
        + v1.z * (*pM).mat[6 as std::os::raw::c_int as usize];
    v2
        .z = v1.x * (*pM).mat[8 as std::os::raw::c_int as usize]
        + v1.y * (*pM).mat[9 as std::os::raw::c_int as usize]
        + v1.z * (*pM).mat[10 as std::os::raw::c_int as usize];
    (*pOut).x = v2.x;
    (*pOut).y = v2.y;
    (*pOut).z = v2.z;
    return pOut;
...
pub unsafe extern "C" fn kmVec3InverseTransformNormal(
    ...
    let mut v = kmVec3 { x: 0., y: 0., z: 0. };
    v
        .x = (*pVect).x * (*pM).mat[0 as std::os::raw::c_int as usize]
        + (*pVect).y * (*pM).mat[1 as std::os::raw::c_int as usize]
        + (*pVect).z * (*pM).mat[2 as std::os::raw::c_int as usize];
    v
        .y = (*pVect).x * (*pM).mat[4 as std::os::raw::c_int as usize]
        + (*pVect).y * (*pM).mat[5 as std::os::raw::c_int as usize]
        + (*pVect).z * (*pM).mat[6 as std::os::raw::c_int as usize];
    v
        .z = (*pVect).x * (*pM).mat[8 as std::os::raw::c_int as usize]
        + (*pVect).y * (*pM).mat[9 as std::os::raw::c_int as usize]
        + (*pVect).z * (*pM).mat[10 as std::os::raw::c_int as usize];
    (*pOut).x = v.x;
    (*pOut).y = v.y;
    (*pOut).z = v.z;
    return pOut;
...
pub unsafe extern "C" fn kmVec3TransformCoord(
    ...
    kmVec4Fill(&mut inV, (*pV).x, (*pV).y, (*pV).z, 1.0f64 as std::os::raw::c_float);
...
pub unsafe extern "C" fn kmVec3AreEqual(
    ...
    if ((*p1).x as std::os::raw::c_double) < (*p2).x as std::os::raw::c_double + 0.0001f64
...
pub unsafe extern "C" fn kmVec3GetHorizontalAngle(
    ...
    let z1 = sqrt(((*pIn).x * (*pIn).x + (*pIn).z * (*pIn).z) as std::os::raw::c_double)
        as std::os::raw::c_float;
    (*pOut)
        .y = kmRadiansToDegrees(
        atan2((*pIn).x as std::os::raw::c_double, (*pIn).z as std::os::raw::c_double) as std::os::raw::c_float,
    );
    if (*pOut).y < 0 as std::os::raw::c_int as std::os::raw::c_float {
        (*pOut).y += 360 as std::os::raw::c_int as std::os::raw::c_float;
    }
    if (*pOut).y >= 360 as std::os::raw::c_int as std::os::raw::c_float {
        (*pOut).y -= 360 as std::os::raw::c_int as std::os::raw::c_float;
    }
    (*pOut)
        .x = (kmRadiansToDegrees(
        atan2(z1 as std::os::raw::c_double, (*pIn).y as std::os::raw::c_double) as std::os::raw::c_float,
    ) as std::os::raw::c_double - 90.0f64) as std::os::raw::c_float;
    if (*pOut).x < 0 as std::os::raw::c_int as std::os::raw::c_float {
        (*pOut).x += 360 as std::os::raw::c_int as std::os::raw::c_float;
    }
    if (*pOut).x >= 360 as std::os::raw::c_int as std::os::raw::c_float {
        (*pOut).x -= 360 as std::os::raw::c_int as std::os::raw::c_float;
    }
    return pOut;
}
...
pub unsafe extern "C" fn kmVec3RotationToDirection(
    ...
    let srsp = sr * sp;
    let crsp = cr * sp;
    let pseudoMatrix: [std::os::raw::c_float; 9] = [
        cp * cy,
        cp * sy,
        -sp,
        srsp * cy - cr * sy,
    ...
    (*pOut)
        .x = (*forwards).x * pseudoMatrix[0 as std::os::raw::c_int as usize]
        + (*forwards).y * pseudoMatrix[3 as std::os::raw::c_int as usize]
        + (*forwards).z * pseudoMatrix[6 as std::os::raw::c_int as usize];
    (*pOut)
        .y = (*forwards).x * pseudoMatrix[1 as std::os::raw::c_int as usize]
        + (*forwards).y * pseudoMatrix[4 as std::os::raw::c_int as usize]
        + (*forwards).z * pseudoMatrix[7 as std::os::raw::c_int as usize];
    (*pOut)
        .z = (*forwards).x * pseudoMatrix[2 as std::os::raw::c_int as usize]
        + (*forwards).y * pseudoMatrix[5 as std::os::raw::c_int as usize]
        + (*forwards).z * pseudoMatrix[8 as std::os::raw::c_int as usize];
    return pOut;
}
#[no_mangle]
