...
extern "C" {
    ...
    fn kmVec3Length(pIn: *const kmVec3) -> std::os::raw::c_float;
    ...
    fn kmAlmostEqual(lhs: std::os::raw::c_float, rhs: std::os::raw::c_float) -> std::os::raw::c_uchar;
}
#[derive(Copy, Clone)]
#[repr(C)]
pub struct kmMat4 {
...
pub unsafe extern "C" fn kmPlaneFromPoints(
    ...
    (*pOut).b = n.y;
    (*pOut).c = n.z;
    (*pOut).d = kmVec3Dot(kmVec3Scale(&mut n, &mut n, -1.0f64 as std::os::raw::c_float), p1);
    return pOut;
}
#[no_mangle]
...
pub unsafe extern "C" fn kmPlaneExtractFromMat4(
    ...
    (*pOut)
        ...
        + scale as std::os::raw::c_float * (*pIn).mat[row as usize];
    (*pOut)
        .b = (*pIn).mat[7 as std::os::raw::c_int as usize]
        + scale as std::os::raw::c_float * (*pIn).mat[(row + 4 as std::os::raw::c_int) as usize];
    (*pOut)
        .c = (*pIn).mat[11 as std::os::raw::c_int as usize]
        + scale as std::os::raw::c_float * (*pIn).mat[(row + 8 as std::os::raw::c_int) as usize];
    (*pOut)
        .d = (*pIn).mat[15 as std::os::raw::c_int as usize]
        + scale as std::os::raw::c_float * (*pIn).mat[(row + 12 as std::os::raw::c_int) as usize];
