...
#[no_mangle]
pub unsafe extern "C" fn kmVec2Length(mut pIn: *const kmVec2) -> std::os::raw::c_float {
    return sqrtf(kmSQR((*pIn).x) + kmSQR((*pIn).y));
}
#[no_mangle]
pub unsafe extern "C" fn kmVec2LengthSq(mut pIn: *const kmVec2) -> std::os::raw::c_float {
