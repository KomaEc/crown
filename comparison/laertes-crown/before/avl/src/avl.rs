...
#[no_mangle]
pub unsafe extern "C" fn height(mut N: *mut Node) -> std::os::raw::c_int {
    if N.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn max(mut a: std::os::raw::c_int, mut b: std::os::raw::c_int) -> std::os::raw::c_int {
    return if a > b { a } else { b };
}
#[no_mangle]
pub unsafe extern "C" fn newNode(mut key: std::os::raw::c_int) -> *mut Node {
...
#[no_mangle]
pub unsafe extern "C" fn getBalance(mut N: *mut Node) -> std::os::raw::c_int {
    if N.is_null() {
        return 0 as std::os::raw::c_int;
    }
