...
#[no_mangle]
pub static mut LODEPNG_VERSION_STRING: *const std::os::raw::c_char = b"20221108\0" as *const u8
    as *const std::os::raw::c_char;
unsafe extern "C" fn lodepng_malloc(mut size: size_t) -> *mut std::os::raw::c_void {
    return malloc(size);
}
...
unsafe extern "C" fn lodepng_free(mut ptr: *mut std::os::raw::c_void) {
    free(ptr);
}
...
unsafe extern "C" fn lodepng_strlen(mut a: *const std::os::raw::c_char) -> size_t {
    let mut orig = a;
    while *a != 0 {
        a = a.offset(1);
    }
...
unsafe extern "C" fn lodepng_addofl(
    ...
    *result = a.wrapping_add(b);
    return (*result < a) as std::os::raw::c_int;
}
unsafe extern "C" fn lodepng_mulofl(
    ...
    *result = a.wrapping_mul(b);
    return (a != 0 as std::os::raw::c_int as std::os::raw::c_ulong && (*result).wrapping_div(a) != b)
        as std::os::raw::c_int;
}
...
unsafe extern "C" fn uivector_cleanup(mut p: *mut std::os::raw::c_void) {
...
unsafe extern "C" fn string_cleanup(mut out: *mut *mut std::os::raw::c_char) {
    lodepng_free(*out as *mut std::os::raw::c_void);
    *out = 0 as *mut std::os::raw::c_char;
}
...
pub unsafe extern "C" fn lodepng_load_file(
    ...
    *out = lodepng_malloc(size as size_t) as *mut std::os::raw::c_uchar;
    if (*out).is_null() && size > 0 as std::os::raw::c_int as std::os::raw::c_long {
...
unsafe extern "C" fn LodePNGBitWriter_init(
    ...
    *fresh6 = data;
    (*writer).bp = 0 as std::os::raw::c_int as std::os::raw::c_uchar;
}
unsafe extern "C" fn writeBits(
    ...
    if nbits == 1 as std::os::raw::c_int as std::os::raw::c_ulong {
        if (*writer).bp as std::os::raw::c_uint & 7 as std::os::raw::c_uint
            == 0 as std::os::raw::c_int as std::os::raw::c_uint
        {
            if ucvector_resize(
                (*writer).data,
                ((*(*writer).data).size).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_ulong),
            ) == 0
            {
                return;
            }
        ...
        let ref mut fresh7 = *((*(*writer).data).data)
            .offset(
                ((*(*writer).data).size).wrapping_sub(1 as std::os::raw::c_int as std::os::raw::c_ulong)
                    as isize,
            );
        *fresh7 = (*fresh7 as std::os::raw::c_uint
            | value << ((*writer).bp as std::os::raw::c_uint & 7 as std::os::raw::c_uint))
            as std::os::raw::c_uchar;
        ...
        while i != nbits {
            ...
            *fresh9 = (*fresh9 as std::os::raw::c_int
                | ((value >> i & 1 as std::os::raw::c_int as std::os::raw::c_uint) as std::os::raw::c_uchar
                    as std::os::raw::c_int)
                    << ((*writer).bp as std::os::raw::c_uint & 7 as std::os::raw::c_uint))
                as std::os::raw::c_uchar;
    ...
    while i != nbits {
        ...
        *fresh11 = (*fresh11 as std::os::raw::c_int
            | ((value
                ...
                << ((*writer).bp as std::os::raw::c_uint & 7 as std::os::raw::c_uint)) as std::os::raw::c_uchar;
...
unsafe extern "C" fn LodePNGBitReader_init(
    ...
    *fresh13 = data;
    (*reader).size = size;
    if lodepng_mulofl(size, 8 as std::os::raw::c_uint as size_t, &mut (*reader).bitsize) != 0 {
        return 105 as std::os::raw::c_int as std::os::raw::c_uint;
    }
    if lodepng_addofl((*reader).bitsize, 64 as std::os::raw::c_uint as size_t, &mut temp) != 0 {
        return 105 as std::os::raw::c_int as std::os::raw::c_uint;
    }
    (*reader).bp = 0 as std::os::raw::c_int as size_t;
    (*reader).buffer = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn ensureBits9(mut reader: *mut LodePNGBitReader, mut nbits: size_t) {
    let mut start = (*reader).bp >> 3 as std::os::raw::c_uint;
    ...
    if start.wrapping_add(1 as std::os::raw::c_uint as std::os::raw::c_ulong) < size {
        ...
        (*reader).buffer >>= (*reader).bp & 7 as std::os::raw::c_uint as std::os::raw::c_ulong;
    } else {
        (*reader).buffer = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        ...
        (*reader).buffer
            |= ((*((*reader).data)
                ...
                << (8 as std::os::raw::c_uint as std::os::raw::c_ulong)
                    .wrapping_sub((*reader).bp & 7 as std::os::raw::c_uint as std::os::raw::c_ulong);
    } else {
        (*reader).buffer = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        if start.wrapping_add(0 as std::os::raw::c_uint as std::os::raw::c_ulong) < size {
            (*reader).buffer
...
static mut LENGTHBASE: [std::os::raw::c_uint; 29] = [
...
static mut LENGTHEXTRA: [std::os::raw::c_uint; 29] = [
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut DISTANCEBASE: [std::os::raw::c_uint; 30] = [
    1 as std::os::raw::c_int as std::os::raw::c_uint,
    2 as std::os::raw::c_int as std::os::raw::c_uint,
    3 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut DISTANCEEXTRA: [std::os::raw::c_uint; 30] = [
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut CLCL_ORDER: [std::os::raw::c_uint; 19] = [
...
unsafe extern "C" fn HuffmanTree_cleanup(mut tree: *mut HuffmanTree) {
    lodepng_free((*tree).codes as *mut std::os::raw::c_void);
    lodepng_free((*tree).lengths as *mut std::os::raw::c_void);
    lodepng_free((*tree).table_len as *mut std::os::raw::c_void);
    lodepng_free((*tree).table_value as *mut std::os::raw::c_void);
}
static mut mask: std::os::raw::c_uint = 0;
unsafe extern "C" fn HuffmanTree_makeTable(mut tree: *mut HuffmanTree) -> std::os::raw::c_uint {
    static mut headsize: std::os::raw::c_uint = (1 as std::os::raw::c_uint) << 9 as std::os::raw::c_uint;
    let mut i: size_t = 0;
    ...
    while i < (*tree).numcodes as std::os::raw::c_ulong {
        ...
        let mut index: std::os::raw::c_uint = 0;
    ...
    *fresh20 = lodepng_malloc(
    ...
    while i < (*tree).numcodes as std::os::raw::c_ulong {
        ...
        let mut symbol_0: std::os::raw::c_uint = 0;
        let mut reverse: std::os::raw::c_uint = 0;
        if !(l_2 == 0 as std::os::raw::c_int as std::os::raw::c_uint) {
            ...
            if l_2 <= 9 as std::os::raw::c_uint {
                ...
                let mut j_0: std::os::raw::c_uint = 0;
                if maxlen < l_2 {
                    return 55 as std::os::raw::c_int as std::os::raw::c_uint;
                }
...
unsafe extern "C" fn huffmanDecodeSymbol(
    ...
    let mut code = peekBits(reader, 9 as std::os::raw::c_uint as size_t) as std::os::raw::c_ushort;
    let mut l = *((*codetree).table_len).offset(code as isize) as std::os::raw::c_ushort;
    ...
    if l as std::os::raw::c_uint <= 9 as std::os::raw::c_uint {
        ...
        advanceBits(reader, 9 as std::os::raw::c_uint as size_t);
        ...
        advanceBits(
            reader,
            (*((*codetree).table_len).offset(value as isize) as std::os::raw::c_uint)
                .wrapping_sub(9 as std::os::raw::c_uint) as size_t,
        );
        return *((*codetree).table_value).offset(value as isize) as std::os::raw::c_uint;
    };
}
...
unsafe extern "C" fn getTreeInflateDynamic(
    ...
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    let mut n: std::os::raw::c_uint = 0;
    let mut HLIT: std::os::raw::c_uint = 0;
    let mut HDIST: std::os::raw::c_uint = 0;
    let mut HCLEN: std::os::raw::c_uint = 0;
    let mut i: std::os::raw::c_uint = 0;
    ...
    ensureBits17(reader, 14 as std::os::raw::c_int as size_t);
    HLIT = (readBits(reader, 5 as std::os::raw::c_int as size_t))
        .wrapping_add(257 as std::os::raw::c_int as std::os::raw::c_uint);
    HDIST = (readBits(reader, 5 as std::os::raw::c_int as size_t))
        .wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint);
    HCLEN = (readBits(reader, 4 as std::os::raw::c_int as size_t))
    ...
    if error == 0 {
        ...
        ) != 0
        {
            ...
            i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
            while i != HCLEN {
                ensureBits9(reader, 3 as std::os::raw::c_int as size_t);
                *bitlen_cl
                    .offset(
                        CLCL_ORDER[i as usize] as isize,
                    ) = readBits(reader, 3 as std::os::raw::c_int as size_t);
                i = i.wrapping_add(1);
            }
            i = HCLEN;
            ...
            if !(error != 0) {
                ...
                if bitlen_ll.is_null() || bitlen_d.is_null() {
                    ...
                    while i < HLIT.wrapping_add(HDIST) {
                        ...
                        ensureBits25(reader, 22 as std::os::raw::c_int as size_t);
                        ...
                        if code <= 15 as std::os::raw::c_int as std::os::raw::c_uint {
                            ...
                            if i == 0 as std::os::raw::c_int as std::os::raw::c_uint {
                                ...
                                replength = replength
                                    .wrapping_add(readBits(reader, 2 as std::os::raw::c_int as size_t));
                            ...
                            replength_0 = replength_0
                                .wrapping_add(readBits(reader, 3 as std::os::raw::c_int as size_t));
                            n = 0 as std::os::raw::c_int as std::os::raw::c_uint;
                            while n < replength_0 {
                                if i >= HLIT.wrapping_add(HDIST) {
                            ...
                            replength_1 = replength_1
                                .wrapping_add(readBits(reader, 7 as std::os::raw::c_int as size_t));
                            n = 0 as std::os::raw::c_int as std::os::raw::c_uint;
                            while n < replength_1 {
                                if i >= HLIT.wrapping_add(HDIST) {
...
unsafe extern "C" fn inflateHuffmanBlock(
    ...
    while error == 0 && done == 0 {
        let mut code_ll: std::os::raw::c_uint = 0;
        ensureBits32(reader, 30 as std::os::raw::c_int as size_t);
        ...
        {
            let mut code_d: std::os::raw::c_uint = 0;
            let mut distance: std::os::raw::c_uint = 0;
            let mut numextrabits_l: std::os::raw::c_uint = 0;
            let mut numextrabits_d: std::os::raw::c_uint = 0;
            ...
            if numextrabits_l != 0 as std::os::raw::c_int as std::os::raw::c_uint {
                ensureBits25(reader, 5 as std::os::raw::c_int as size_t);
                length = (length as std::os::raw::c_ulong)
                    .wrapping_add(
                        readBits(reader, numextrabits_l as size_t) as std::os::raw::c_ulong,
                    ) as size_t as size_t;
            }
            ensureBits32(reader, 28 as std::os::raw::c_int as size_t);
...
unsafe extern "C" fn inflateNoCompression(
    ...
    let mut NLEN: std::os::raw::c_uint = 0;
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    bytepos = ((*reader).bp).wrapping_add(7 as std::os::raw::c_uint as std::os::raw::c_ulong)
    ...
    LEN = (*((*reader).data).offset(bytepos as isize) as std::os::raw::c_uint)
        .wrapping_add(
            (*((*reader).data)
    ...
    bytepos = (bytepos as std::os::raw::c_ulong).wrapping_add(2 as std::os::raw::c_int as std::os::raw::c_ulong)
        as size_t as size_t;
    NLEN = (*((*reader).data).offset(bytepos as isize) as std::os::raw::c_uint)
        .wrapping_add(
            (*((*reader).data)
                .offset(bytepos.wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_ulong) as isize)
                as std::os::raw::c_uint) << 8 as std::os::raw::c_uint,
    ...
    if LEN != 0 {
        lodepng_memcpy(
            ...
            ((*reader).data).offset(bytepos as isize) as *const std::os::raw::c_void,
            LEN as size_t,
        );
        bytepos = (bytepos as std::os::raw::c_ulong).wrapping_add(LEN as std::os::raw::c_ulong) as size_t
            as size_t;
    }
    (*reader).bp = bytepos << 3 as std::os::raw::c_uint;
    return error;
}
unsafe extern "C" fn lodepng_inflatev(
    ...
    while BFINAL == 0 {
        let mut BTYPE: std::os::raw::c_uint = 0;
        if (reader.bitsize).wrapping_sub(reader.bp) < 3 as std::os::raw::c_int as std::os::raw::c_ulong {
            return 52 as std::os::raw::c_int as std::os::raw::c_uint;
        }
        ensureBits9(&mut reader, 3 as std::os::raw::c_int as size_t);
        BFINAL = readBits(&mut reader, 1 as std::os::raw::c_int as size_t);
        BTYPE = readBits(&mut reader, 2 as std::os::raw::c_int as size_t);
...
static mut MAX_SUPPORTED_DEFLATE_LENGTH: size_t = 258 as std::os::raw::c_int as size_t;
...
static mut HASH_NUM_VALUES: std::os::raw::c_uint = 65536 as std::os::raw::c_int as std::os::raw::c_uint;
static mut HASH_BIT_MASK: std::os::raw::c_uint = 65535 as std::os::raw::c_int as std::os::raw::c_uint;
unsafe extern "C" fn hash_init(
    ...
    *fresh58 = lodepng_malloc(
    ...
    while i != HASH_NUM_VALUES {
        *((*hash).head).offset(i as isize) = -(1 as std::os::raw::c_int);
        i = i.wrapping_add(1);
    }
    i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    while i != windowsize {
        *((*hash).val).offset(i as isize) = -(1 as std::os::raw::c_int);
        i = i.wrapping_add(1);
    }
    i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    while i != windowsize {
        *((*hash).chain).offset(i as isize) = i as std::os::raw::c_ushort;
        i = i.wrapping_add(1);
    }
    i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    while i as std::os::raw::c_ulong <= MAX_SUPPORTED_DEFLATE_LENGTH {
        *((*hash).headz).offset(i as isize) = -(1 as std::os::raw::c_int);
        i = i.wrapping_add(1);
    }
    i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    while i != windowsize {
        *((*hash).chainz).offset(i as isize) = i as std::os::raw::c_ushort;
        i = i.wrapping_add(1);
    }
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn hash_cleanup(mut hash: *mut Hash) {
    lodepng_free((*hash).head as *mut std::os::raw::c_void);
    lodepng_free((*hash).val as *mut std::os::raw::c_void);
    lodepng_free((*hash).chain as *mut std::os::raw::c_void);
    lodepng_free((*hash).zeros as *mut std::os::raw::c_void);
    lodepng_free((*hash).headz as *mut std::os::raw::c_void);
    lodepng_free((*hash).chainz as *mut std::os::raw::c_void);
}
...
unsafe extern "C" fn updateHashChain(
    ...
    *((*hash).val).offset(wpos as isize) = hashval as std::os::raw::c_int;
    if *((*hash).head).offset(hashval as isize) != -(1 as std::os::raw::c_int) {
        *((*hash).chain)
            .offset(
                wpos as isize,
            ) = *((*hash).head).offset(hashval as isize) as std::os::raw::c_ushort;
    }
    *((*hash).head).offset(hashval as isize) = wpos as std::os::raw::c_int;
    *((*hash).zeros).offset(wpos as isize) = numzeros;
    if *((*hash).headz).offset(numzeros as isize) != -(1 as std::os::raw::c_int) {
        *((*hash).chainz)
            .offset(
                wpos as isize,
            ) = *((*hash).headz).offset(numzeros as isize) as std::os::raw::c_ushort;
    }
    *((*hash).headz).offset(numzeros as isize) = wpos as std::os::raw::c_int;
}
unsafe extern "C" fn encodeLZ77(
    ...
    let mut hashval: std::os::raw::c_uint = 0;
    let mut current_offset: std::os::raw::c_uint = 0;
    let mut current_length: std::os::raw::c_uint = 0;
    let mut prev_offset: std::os::raw::c_uint = 0;
    ...
    let mut hashpos: std::os::raw::c_uint = 0;
    ...
    while pos < insize {
        ...
        updateHashChain(hash, wpos, hashval, numzeros as std::os::raw::c_ushort);
        length = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        offset = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        hashpos = *((*hash).chain).offset(wpos as isize) as std::os::raw::c_uint;
        lastptr = &*in_0
            .offset(
        ...
        loop {
            ...
            if hashpos == *((*hash).chain).offset(hashpos as isize) as std::os::raw::c_uint {
                break;
            }
            if numzeros >= 3 as std::os::raw::c_int as std::os::raw::c_uint && length > numzeros {
                hashpos = *((*hash).chainz).offset(hashpos as isize) as std::os::raw::c_uint;
                if *((*hash).zeros).offset(hashpos as isize) as std::os::raw::c_uint != numzeros
                {
                    break;
                }
            } else {
                hashpos = *((*hash).chain).offset(hashpos as isize) as std::os::raw::c_uint;
                if *((*hash).val).offset(hashpos as isize) != hashval as std::os::raw::c_int {
                    break;
                }
            }
        }
        if lazymatching != 0 {
                ...
                && (length as std::os::raw::c_ulong) < MAX_SUPPORTED_DEFLATE_LENGTH
            {
                    ...
                    > lazylength.wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint)
                {
                    ...
                    length = lazylength;
                    offset = lazyoffset;
                    *((*hash).head).offset(hashval as isize) = -(1 as std::os::raw::c_int);
                    *((*hash).headz).offset(numzeros as isize) = -(1 as std::os::raw::c_int);
...
unsafe extern "C" fn deflateNoCompression(
    ...
    while i != numdeflateblocks {
        let mut BFINAL: std::os::raw::c_uint = 0;
        let mut BTYPE: std::os::raw::c_uint = 0;
        let mut LEN: std::os::raw::c_uint = 0;
        let mut NLEN: std::os::raw::c_uint = 0;
        let mut firstbyte: std::os::raw::c_uchar = 0;
                    ...
                    if !(error != 0) {
                        ...
                        if bitlen_lld.is_null() || bitlen_lld_e.is_null() {
                            ...
                            if !(error != 0) {
                                ...
                                writeBits(writer, BFINAL, 1 as std::os::raw::c_int as size_t);
                                writeBits(
                                    writer,
                                    0 as std::os::raw::c_int as std::os::raw::c_uint,
                                ...
                                HCLEN = numcodes_cl
                                    ...
                                    as std::os::raw::c_uint;
                                writeBits(writer, HLIT, 5 as std::os::raw::c_int as size_t);
                                writeBits(writer, HDIST, 5 as std::os::raw::c_int as size_t);
                                writeBits(writer, HCLEN, 4 as std::os::raw::c_int as size_t);
                                i = 0 as std::os::raw::c_int as size_t;
                                while i != numcodes_cl {
                                    writeBits(
                                        writer,
...
unsafe extern "C" fn deflateFixed(
    ...
    if error == 0 {
        writeBits(writer, BFINAL, 1 as std::os::raw::c_int as size_t);
        writeBits(writer, 1 as std::os::raw::c_int as std::os::raw::c_uint, 1 as std::os::raw::c_int as size_t);
        writeBits(writer, 0 as std::os::raw::c_int as std::os::raw::c_uint, 1 as std::os::raw::c_int as size_t);
        if (*settings).use_lz77 != 0 {
            let mut lz77_encoded = uivector {
                data: 0 as *mut std::os::raw::c_uint,
                size: 0,
...
unsafe extern "C" fn lodepng_zlib_decompressv(
    ...
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    let mut CM: std::os::raw::c_uint = 0;
    let mut CINFO: std::os::raw::c_uint = 0;
    let mut FDICT: std::os::raw::c_uint = 0;
...
unsafe extern "C" fn zlib_decompress(
    ...
    let mut error: std::os::raw::c_uint = 0;
...
pub unsafe extern "C" fn lodepng_compress_settings_init(
    ...
    (*settings).btype = 2 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).use_lz77 = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).windowsize = 2048 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).minmatch = 3 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).nicematch = 128 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).lazymatching = 1 as std::os::raw::c_int as std::os::raw::c_uint;
...
pub unsafe extern "C" fn lodepng_decompress_settings_init(
    ...
    (*settings).ignore_adler32 = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).ignore_nlen = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).max_output_size = 0 as std::os::raw::c_int as size_t;
...
static mut lodepng_crc32_table: [std::os::raw::c_uint; 256] = [
...
unsafe extern "C" fn readBitFromReversedStream(
    ...
    let mut result = (*bitstream.offset((*bitpointer >> 3 as std::os::raw::c_int) as isize)
        as std::os::raw::c_int
        >> (7 as std::os::raw::c_int as std::os::raw::c_ulong)
            .wrapping_sub(*bitpointer & 0x7 as std::os::raw::c_int as std::os::raw::c_ulong)
...
unsafe extern "C" fn readBitsFromReversedStream(
    ...
    while i < nbits {
        ...
        result |= readBitFromReversedStream(bitpointer, bitstream) as std::os::raw::c_uint;
        i = i.wrapping_add(1);
    }
    return result;
}
unsafe extern "C" fn setBitOfReversedStream(
    ...
    if bit as std::os::raw::c_int == 0 as std::os::raw::c_int {
        let ref mut fresh80 = *bitstream
            .offset((*bitpointer >> 3 as std::os::raw::c_uint) as isize);
        *fresh80 = (*fresh80 as std::os::raw::c_int
            & !((1 as std::os::raw::c_uint)
                << (7 as std::os::raw::c_uint as std::os::raw::c_ulong)
                    .wrapping_sub(*bitpointer & 7 as std::os::raw::c_uint as std::os::raw::c_ulong))
...
pub unsafe extern "C" fn lodepng_chunk_data(
    ...
    return &mut *chunk.offset(8 as std::os::raw::c_int as isize) as *mut std::os::raw::c_uchar;
}
#[no_mangle]
...
pub unsafe extern "C" fn lodepng_chunk_append(
    ...
    new_buffer = lodepng_realloc(*out as *mut std::os::raw::c_void, new_length)
        as *mut std::os::raw::c_uchar;
...
unsafe extern "C" fn lodepng_chunk_init(
    mut chunk: *mut *mut std::os::raw::c_uchar,
    mut out: *mut ucvector,
    ...
    if lodepng_addofl(new_length, 12 as std::os::raw::c_int as size_t, &mut new_length) != 0 {
        return 77 as std::os::raw::c_int as std::os::raw::c_uint;
    }
    ...
    *chunk = ((*out).data)
    ...
    lodepng_memcpy(
        (*chunk).offset(4 as std::os::raw::c_int as isize) as *mut std::os::raw::c_void,
...
unsafe extern "C" fn lodepng_color_mode_equal(
    ...
    let mut i: size_t = 0;
    if (*a).colortype as std::os::raw::c_uint != (*b).colortype as std::os::raw::c_uint {
    ...
    i = 0 as std::os::raw::c_int as size_t;
    while i != ((*a).palettesize).wrapping_mul(4 as std::os::raw::c_int as std::os::raw::c_ulong) {
        if *((*a).palette).offset(i as isize) as std::os::raw::c_int
            != *((*b).palette).offset(i as isize) as std::os::raw::c_int
        {
            return 0 as std::os::raw::c_int;
        }
        i = i.wrapping_add(1);
...
pub unsafe extern "C" fn lodepng_is_greyscale_type(
    ...
    return ((*info).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint
        || (*info).colortype as std::os::raw::c_uint
...
pub unsafe extern "C" fn lodepng_is_alpha_type(
    ...
    return ((*info).colortype as std::os::raw::c_uint & 4 as std::os::raw::c_int as std::os::raw::c_uint
...
pub unsafe extern "C" fn lodepng_is_palette_type(
    ...
    return ((*info).colortype as std::os::raw::c_uint
...
pub unsafe extern "C" fn lodepng_can_have_alpha(
    ...
    return ((*info).key_defined != 0 || lodepng_is_alpha_type(info) != 0
        || lodepng_has_palette_alpha(info) != 0) as std::os::raw::c_int as std::os::raw::c_uint;
}
...
unsafe extern "C" fn lodepng_pixel_overflow(
    ...
    if lodepng_mulofl(numpixels, 8 as std::os::raw::c_int as size_t, &mut total) != 0 {
        return 1 as std::os::raw::c_int;
    }
    if lodepng_mulofl(w.wrapping_div(8 as std::os::raw::c_uint) as size_t, bpp, &mut line) != 0 {
        return 1 as std::os::raw::c_int;
    }
    if lodepng_addofl(
        line,
    ...
    if lodepng_addofl(line, 5 as std::os::raw::c_int as size_t, &mut line) != 0 {
        return 1 as std::os::raw::c_int;
    }
...
unsafe extern "C" fn color_tree_add(
    ...
    let mut bit: std::os::raw::c_int = 0;
    bit = 0 as std::os::raw::c_int;
    while bit < 8 as std::os::raw::c_int {
        let mut i = 8 as std::os::raw::c_int * (r as std::os::raw::c_int >> bit & 1 as std::os::raw::c_int)
            + 4 as std::os::raw::c_int * (g as std::os::raw::c_int >> bit & 1 as std::os::raw::c_int)
...
unsafe extern "C" fn rgba8ToPixel(
    ...
    if (*mode).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint {
        let mut gray = r;
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            *out.offset(i as isize) = gray;
        } else if (*mode).bitdepth == 16 as std::os::raw::c_int as std::os::raw::c_uint {
            ...
            *out
            ...
            gray = (gray as std::os::raw::c_uint
                >> (8 as std::os::raw::c_uint).wrapping_sub((*mode).bitdepth)
                & ((1 as std::os::raw::c_uint) << (*mode).bitdepth)
                    .wrapping_sub(1 as std::os::raw::c_uint)) as std::os::raw::c_uchar;
            addColorBits(out, i, (*mode).bitdepth, gray as std::os::raw::c_uint);
        }
    } else if (*mode).colortype as std::os::raw::c_uint == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            *out
                .offset(
    ...
    } else if (*mode).colortype as std::os::raw::c_uint
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            *out.offset(i as isize) = index as std::os::raw::c_uchar;
            ...
            addColorBits(out, i, (*mode).bitdepth, index as std::os::raw::c_uint);
        }
    } else if (*mode).colortype as std::os::raw::c_uint
...
unsafe extern "C" fn getPixelColorRGBA8(
    mut r: *mut std::os::raw::c_uchar,
    mut g: *mut std::os::raw::c_uchar,
    mut b: *mut std::os::raw::c_uchar,
    mut a: *mut std::os::raw::c_uchar,
    mut in_0: *const std::os::raw::c_uchar,
    mut i: size_t,
    mut mode: *const LodePNGColorMode,
) {
    if (*mode).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint {
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            ...
            *g = *b;
            *r = *g;
            if (*mode).key_defined != 0 && *r as std::os::raw::c_uint == (*mode).key_r {
                *a = 0 as std::os::raw::c_int as std::os::raw::c_uchar;
            } else {
                *a = 255 as std::os::raw::c_int as std::os::raw::c_uchar;
            }
        } else if (*mode).bitdepth == 16 as std::os::raw::c_int as std::os::raw::c_uint {
            *b = *in_0
                .offset(
            ...
            *r = *g;
            ...
            let mut highest = ((1 as std::os::raw::c_uint) << (*mode).bitdepth)
                .wrapping_sub(1 as std::os::raw::c_uint);
            let mut j = i.wrapping_mul((*mode).bitdepth as std::os::raw::c_ulong);
    ...
    } else if (*mode).colortype as std::os::raw::c_uint == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            ...
            *b = *in_0
            ...
            if (*mode).key_defined != 0 && *r as std::os::raw::c_uint == (*mode).key_r
                && *g as std::os::raw::c_uint == (*mode).key_g
                && *b as std::os::raw::c_uint == (*mode).key_b
            {
                *a = 0 as std::os::raw::c_int as std::os::raw::c_uchar;
            } else {
                *a = 255 as std::os::raw::c_int as std::os::raw::c_uchar;
        ...
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        if (*mode).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint {
            ...
            let mut j_0 = i.wrapping_mul((*mode).bitdepth as std::os::raw::c_ulong);
...
unsafe extern "C" fn getPixelColorRGBA16(
    mut r: *mut std::os::raw::c_ushort,
    mut g: *mut std::os::raw::c_ushort,
    mut b: *mut std::os::raw::c_ushort,
    mut a: *mut std::os::raw::c_ushort,
    mut in_0: *const std::os::raw::c_uchar,
    mut i: size_t,
    mut mode: *const LodePNGColorMode,
) {
    if (*mode).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint {
        *b = (256 as std::os::raw::c_int
            * *in_0
                .offset(
                    i
                        .wrapping_mul(2 as std::os::raw::c_int as std::os::raw::c_ulong)
        ...
        *r = *g;
        ...
        {
            *a = 0 as std::os::raw::c_int as std::os::raw::c_ushort;
        } else {
            *a = 65535 as std::os::raw::c_int as std::os::raw::c_ushort;
        }
    } else if (*mode).colortype as std::os::raw::c_uint == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
    {
        *r = (256 as std::os::raw::c_uint)
            .wrapping_mul(
                *in_0
                    .offset(
                        i
...
pub unsafe extern "C" fn lodepng_convert(
    ...
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    if (*mode_in).colortype as std::os::raw::c_uint == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    ...
    if (*mode_out).colortype as std::os::raw::c_uint
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        let mut palettesize = (*mode_out).palettesize;
        let mut palette: *const std::os::raw::c_uchar = (*mode_out).palette;
        let mut palsize = (1 as std::os::raw::c_uint as size_t) << (*mode_out).bitdepth;
        ...
        i = 0 as std::os::raw::c_int as size_t;
        while i != palsize {
            let mut p: *const std::os::raw::c_uchar = &*palette
    ...
    if error == 0 {
        if (*mode_in).bitdepth == 16 as std::os::raw::c_int as std::os::raw::c_uint
            && (*mode_out).bitdepth == 16 as std::os::raw::c_int as std::os::raw::c_uint
        {
            i = 0 as std::os::raw::c_int as size_t;
            while i != numpixels {
        ...
        } else if (*mode_out).bitdepth == 8 as std::os::raw::c_int as std::os::raw::c_uint
            && (*mode_out).colortype as std::os::raw::c_uint
                == LCT_RGBA as std::os::raw::c_int as std::os::raw::c_uint
        {
...
pub unsafe extern "C" fn lodepng_convert_rgb(
    mut r_out: *mut std::os::raw::c_uint,
    mut g_out: *mut std::os::raw::c_uint,
    mut b_out: *mut std::os::raw::c_uint,
    ...
    let mut mul = (65535 as std::os::raw::c_int as std::os::raw::c_uint)
        .wrapping_div(
            ((1 as std::os::raw::c_uint) << (*mode_in).bitdepth).wrapping_sub(1 as std::os::raw::c_uint),
        );
    let mut shift = (16 as std::os::raw::c_int as std::os::raw::c_uint)
        .wrapping_sub((*mode_out).bitdepth);
    if (*mode_in).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint
        || (*mode_in).colortype as std::os::raw::c_uint
            == LCT_GREY_ALPHA as std::os::raw::c_int as std::os::raw::c_uint
    {
        b = r_in.wrapping_mul(mul);
        g = b;
        r = g;
    } else if (*mode_in).colortype as std::os::raw::c_uint
        == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
        || (*mode_in).colortype as std::os::raw::c_uint
            == LCT_RGBA as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        if r_in as std::os::raw::c_ulong >= (*mode_in).palettesize {
            return 82 as std::os::raw::c_int as std::os::raw::c_uint;
        }
        r = (*((*mode_in).palette)
            .offset(
    ...
    if (*mode_out).colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint
        || (*mode_out).colortype as std::os::raw::c_uint
            == LCT_GREY_ALPHA as std::os::raw::c_int as std::os::raw::c_uint
    {
        *r_out = r >> shift;
    } else if (*mode_out).colortype as std::os::raw::c_uint
        == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
        || (*mode_out).colortype as std::os::raw::c_uint
            == LCT_RGBA as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        while (i as std::os::raw::c_ulong) < (*mode_out).palettesize {
...
unsafe extern "C" fn getValueRequiredBits(mut value: std::os::raw::c_uchar) -> std::os::raw::c_uint {
    ...
    *fresh161 = (*fresh161 as std::os::raw::c_ulong).wrapping_add(numpixels) as size_t as size_t;
    ...
    if numcolors_done == 0 {
        ...
        loop {
            ...
            let mut color: *const std::os::raw::c_uchar = &mut *((*stats).palette)
                .as_mut_ptr()
                .offset(i.wrapping_mul(4 as std::os::raw::c_int as std::os::raw::c_ulong) as isize)
                as *mut std::os::raw::c_uchar;
            error = color_tree_add(
    ...
    match current_block {
        15925075030174552612 => {
            if (*mode_in).bitdepth == 16 as std::os::raw::c_int as std::os::raw::c_uint && sixteen == 0 {
                let mut r = 0 as std::os::raw::c_int as std::os::raw::c_ushort;
                let mut g = 0 as std::os::raw::c_int as std::os::raw::c_ushort;
                let mut b = 0 as std::os::raw::c_int as std::os::raw::c_ushort;
                let mut a = 0 as std::os::raw::c_int as std::os::raw::c_ushort;
...
unsafe extern "C" fn lodepng_color_stats_add(
    ...
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    let mut image: [std::os::raw::c_uchar; 8] = [0; 8];
...
unsafe extern "C" fn auto_choose_color(
    ...
    let mut error = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    let mut palettebits: std::os::raw::c_uint = 0;
    let mut i: size_t = 0;
    let mut n: size_t = 0;
    let mut numpixels = (*stats).numpixels;
    let mut palette_ok: std::os::raw::c_uint = 0;
    let mut gray_ok: std::os::raw::c_uint = 0;
    ...
    gray_ok = ((*stats).colored == 0) as std::os::raw::c_int as std::os::raw::c_uint;
    ...
    if palette_ok != 0 {
        ...
        i = 0 as std::os::raw::c_int as size_t;
        while i != (*stats).numcolors as std::os::raw::c_ulong {
        ...
        if key != 0 {
            let mut mask_0 = ((1 as std::os::raw::c_uint) << (*mode_out).bitdepth)
                .wrapping_sub(1 as std::os::raw::c_uint);
            (*mode_out).key_r = (*stats).key_r as std::os::raw::c_uint & mask_0;
            (*mode_out).key_g = (*stats).key_g as std::os::raw::c_uint & mask_0;
            (*mode_out).key_b = (*stats).key_b as std::os::raw::c_uint & mask_0;
...
static mut ADAM7_IX: [std::os::raw::c_uint; 7] = [
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    2 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut ADAM7_IY: [std::os::raw::c_uint; 7] = [
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
    0 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut ADAM7_DX: [std::os::raw::c_uint; 7] = [
    8 as std::os::raw::c_int as std::os::raw::c_uint,
    8 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
...
static mut ADAM7_DY: [std::os::raw::c_uint; 7] = [
    8 as std::os::raw::c_int as std::os::raw::c_uint,
    8 as std::os::raw::c_int as std::os::raw::c_uint,
    8 as std::os::raw::c_int as std::os::raw::c_uint,
    4 as std::os::raw::c_int as std::os::raw::c_uint,
...
pub unsafe extern "C" fn lodepng_inspect(
    mut w: *mut std::os::raw::c_uint,
    mut h: *mut std::os::raw::c_uint,
...
unsafe extern "C" fn Adam7_deinterlace(
    ...
    let mut passw: [std::os::raw::c_uint; 7] = [0; 7];
    let mut passh: [std::os::raw::c_uint; 7] = [0; 7];
    ...
    if bpp >= 8 as std::os::raw::c_int as std::os::raw::c_uint {
        ...
        i = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        while i != 7 as std::os::raw::c_int as std::os::raw::c_uint {
            let mut x_0: std::os::raw::c_uint = 0;
            let mut y_0: std::os::raw::c_uint = 0;
            let mut b_0: std::os::raw::c_uint = 0;
...
unsafe extern "C" fn postProcessScanlines(
    ...
    if (*info_png).interlace_method == 0 as std::os::raw::c_int as std::os::raw::c_uint {
        if bpp < 8 as std::os::raw::c_int as std::os::raw::c_uint
            && w.wrapping_mul(bpp)
                != w
                    .wrapping_mul(bpp)
...
unsafe extern "C" fn readChunk_tEXt(
    ...
    if error == 0 {
        let mut length: std::os::raw::c_uint = 0;
        let mut string2_begin: std::os::raw::c_uint = 0;
        length = 0 as std::os::raw::c_int as std::os::raw::c_uint;
...
unsafe extern "C" fn readChunk_iTXt(
    ...
    let mut zlibsettings = (*decoder).zlibsettings;
    let mut length: std::os::raw::c_uint = 0;
    let mut begin: std::os::raw::c_uint = 0;
    let mut compressed: std::os::raw::c_uint = 0;
    let mut key = 0 as *mut std::os::raw::c_char;
...
unsafe extern "C" fn readChunk_tIME(
    ...
    (*info).time_defined = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*info)
        .time
        .year = (256 as std::os::raw::c_uint)
        .wrapping_mul(*data.offset(0 as std::os::raw::c_int as isize) as std::os::raw::c_uint)
        .wrapping_add(*data.offset(1 as std::os::raw::c_int as isize) as std::os::raw::c_uint);
    (*info).time.month = *data.offset(2 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    (*info).time.day = *data.offset(3 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    (*info).time.hour = *data.offset(4 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    (*info).time.minute = *data.offset(5 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    (*info).time.second = *data.offset(6 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn readChunk_pHYs(
    ...
    (*info).phys_defined = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*info)
    ...
    (*info).phys_unit = *data.offset(8 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn readChunk_gAMA(
    ...
    (*info).gama_defined = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*info)
...
unsafe extern "C" fn readChunk_cHRM(
    ...
    (*info).chrm_defined = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*info)
...
unsafe extern "C" fn readChunk_sRGB(
    ...
    (*info).srgb_defined = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*info).srgb_intent = *data.offset(0 as std::os::raw::c_int as isize) as std::os::raw::c_uint;
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
...
pub unsafe extern "C" fn lodepng_inspect_chunk(
    ...
    let mut chunkLength: std::os::raw::c_uint = 0;
...
unsafe extern "C" fn decodeGeneric(
    ...
    *out = 0 as *mut std::os::raw::c_uchar;
    *h = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    *w = *h;
    ...
    if (*state).error == 0 {
        if (*state).info_png.interlace_method == 0 as std::os::raw::c_int as std::os::raw::c_uint {
            ...
            expected_size = lodepng_get_raw_size_idat(*w, *h, bpp as std::os::raw::c_uint);
        } else {
            ...
            expected_size = (expected_size as std::os::raw::c_ulong)
                .wrapping_add(
                    lodepng_get_raw_size_idat(
                        (*w).wrapping_add(7 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 3 as std::os::raw::c_int,
                        (*h).wrapping_add(7 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 3 as std::os::raw::c_int,
                        bpp_0 as std::os::raw::c_uint,
                    ),
                ) as size_t as size_t;
            if *w > 4 as std::os::raw::c_int as std::os::raw::c_uint {
                expected_size = (expected_size as std::os::raw::c_ulong)
                    .wrapping_add(
                        lodepng_get_raw_size_idat(
                            (*w).wrapping_add(3 as std::os::raw::c_int as std::os::raw::c_uint)
                                >> 3 as std::os::raw::c_int,
                            (*h).wrapping_add(7 as std::os::raw::c_int as std::os::raw::c_uint)
                                >> 3 as std::os::raw::c_int,
                            bpp_0 as std::os::raw::c_uint,
            ...
            expected_size = (expected_size as std::os::raw::c_ulong)
                .wrapping_add(
                    lodepng_get_raw_size_idat(
                        (*w).wrapping_add(3 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 2 as std::os::raw::c_int,
                        (*h).wrapping_add(3 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 3 as std::os::raw::c_int,
                        bpp_0 as std::os::raw::c_uint,
                    ),
                ) as size_t as size_t;
            ...
            expected_size = (expected_size as std::os::raw::c_ulong)
                .wrapping_add(
                    lodepng_get_raw_size_idat(
                        (*w).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 1 as std::os::raw::c_int,
                        (*h).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 2 as std::os::raw::c_int,
                        bpp_0 as std::os::raw::c_uint,
                    ),
                ) as size_t as size_t;
            if *w > 1 as std::os::raw::c_int as std::os::raw::c_uint {
                expected_size = (expected_size as std::os::raw::c_ulong)
                    .wrapping_add(
                        lodepng_get_raw_size_idat(
                            (*w).wrapping_add(0 as std::os::raw::c_int as std::os::raw::c_uint)
                                >> 1 as std::os::raw::c_int,
                            (*h).wrapping_add(1 as std::os::raw::c_int as std::os::raw::c_uint)
                                >> 1 as std::os::raw::c_int,
                            bpp_0 as std::os::raw::c_uint,
            ...
            expected_size = (expected_size as std::os::raw::c_ulong)
                .wrapping_add(
                    lodepng_get_raw_size_idat(
                        (*w).wrapping_add(0 as std::os::raw::c_int as std::os::raw::c_uint),
                        (*h).wrapping_add(0 as std::os::raw::c_int as std::os::raw::c_uint)
                            >> 1 as std::os::raw::c_int,
                        bpp_0 as std::os::raw::c_uint,
                    ),
                ) as size_t as size_t;
    ...
    if (*state).error == 0 {
        lodepng_memset(*out as *mut std::os::raw::c_void, 0 as std::os::raw::c_int, outsize);
        (*state)
...
pub unsafe extern "C" fn lodepng_decoder_settings_init(
    ...
    (*settings).color_convert = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).read_text_chunks = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).remember_unknown_chunks = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).max_text_size = 16777216 as std::os::raw::c_int as size_t;
    (*settings).max_icc_size = 16777216 as std::os::raw::c_int as size_t;
    (*settings).ignore_crc = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).ignore_critical = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).ignore_end = 0 as std::os::raw::c_int as std::os::raw::c_uint;
...
pub unsafe extern "C" fn lodepng_state_init(mut state: *mut LodePNGState) {
    ...
    (*state).error = 1 as std::os::raw::c_int as std::os::raw::c_uint;
}
#[no_mangle]
...
unsafe extern "C" fn writeSignature(mut out: *mut ucvector) -> std::os::raw::c_uint {
    let mut pos = (*out).size;
    let signature: [std::os::raw::c_uchar; 8] = [
...
unsafe extern "C" fn addChunk_PLTE(
    ...
    if (*info).palettesize == 0 as std::os::raw::c_int as std::os::raw::c_ulong
        || (*info).palettesize > 256 as std::os::raw::c_int as std::os::raw::c_ulong
    {
    ...
    let mut error = lodepng_chunk_init(
        &mut chunk,
        out,
        ((*info).palettesize).wrapping_mul(3 as std::os::raw::c_int as std::os::raw::c_ulong)
            as std::os::raw::c_uint,
        b"PLTE\0" as *const u8 as *const std::os::raw::c_char,
    );
    if error != 0 {
...
unsafe extern "C" fn addChunk_tRNS(
    ...
    let mut chunk = 0 as *mut std::os::raw::c_uchar;
    if (*info).colortype as std::os::raw::c_uint == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint {
        let mut i: size_t = 0;
    ...
    } else if (*info).colortype as std::os::raw::c_uint
        == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).key_defined != 0 {
            ...
            *chunk
                ...
                ) = ((*info).key_r >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
            *chunk
                .offset(
                    9 as std::os::raw::c_int as isize,
                ) = ((*info).key_r & 255 as std::os::raw::c_int as std::os::raw::c_uint)
                as std::os::raw::c_uchar;
        }
    } else if (*info).colortype as std::os::raw::c_uint == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).key_defined != 0 {
            ...
            *chunk
                ...
                ) = ((*info).key_g >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
            *chunk
                .offset(
                    11 as std::os::raw::c_int as isize,
                ) = ((*info).key_g & 255 as std::os::raw::c_int as std::os::raw::c_uint)
                as std::os::raw::c_uchar;
            *chunk
                .offset(
                    12 as std::os::raw::c_int as isize,
                ) = ((*info).key_b >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
            *chunk
                .offset(
                    13 as std::os::raw::c_int as isize,
                ) = ((*info).key_b & 255 as std::os::raw::c_int as std::os::raw::c_uint)
                as std::os::raw::c_uchar;
        }
    }
    if !chunk.is_null() {
...
unsafe extern "C" fn addChunk_IEND(mut out: *mut ucvector) -> std::os::raw::c_uint {
...
unsafe extern "C" fn addChunk_bKGD(
            ...
            == LCT_GREY_ALPHA as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        *chunk
            .offset(
                8 as std::os::raw::c_int as isize,
            ) = ((*info).background_r >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
        *chunk
            .offset(
                9 as std::os::raw::c_int as isize,
            ) = ((*info).background_r & 255 as std::os::raw::c_int as std::os::raw::c_uint)
            as std::os::raw::c_uchar;
    } else if (*info).color.colortype as std::os::raw::c_uint
        == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
        || (*info).color.colortype as std::os::raw::c_uint
            == LCT_RGBA as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        *chunk
            .offset(
                10 as std::os::raw::c_int as isize,
            ) = ((*info).background_g >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
        *chunk
            .offset(
                11 as std::os::raw::c_int as isize,
            ) = ((*info).background_g & 255 as std::os::raw::c_int as std::os::raw::c_uint)
            as std::os::raw::c_uchar;
        *chunk
            .offset(
                12 as std::os::raw::c_int as isize,
            ) = ((*info).background_b >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
        *chunk
            .offset(
                13 as std::os::raw::c_int as isize,
            ) = ((*info).background_b & 255 as std::os::raw::c_int as std::os::raw::c_uint)
            as std::os::raw::c_uchar;
    } else if (*info).color.colortype as std::os::raw::c_uint
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
...
unsafe extern "C" fn addChunk_tIME(
    ...
    *chunk
        .offset(
            8 as std::os::raw::c_int as isize,
        ) = ((*time).year >> 8 as std::os::raw::c_int) as std::os::raw::c_uchar;
    *chunk
        .offset(
            9 as std::os::raw::c_int as isize,
        ) = ((*time).year & 255 as std::os::raw::c_int as std::os::raw::c_uint) as std::os::raw::c_uchar;
    *chunk.offset(10 as std::os::raw::c_int as isize) = (*time).month as std::os::raw::c_uchar;
    *chunk.offset(11 as std::os::raw::c_int as isize) = (*time).day as std::os::raw::c_uchar;
    *chunk.offset(12 as std::os::raw::c_int as isize) = (*time).hour as std::os::raw::c_uchar;
    *chunk.offset(13 as std::os::raw::c_int as isize) = (*time).minute as std::os::raw::c_uchar;
    *chunk.offset(14 as std::os::raw::c_int as isize) = (*time).second as std::os::raw::c_uchar;
    lodepng_chunk_generate_crc(chunk);
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn addChunk_pHYs(
    ...
    lodepng_set32bitInt(chunk.offset(8 as std::os::raw::c_int as isize), (*info).phys_x);
    lodepng_set32bitInt(chunk.offset(12 as std::os::raw::c_int as isize), (*info).phys_y);
    *chunk.offset(16 as std::os::raw::c_int as isize) = (*info).phys_unit as std::os::raw::c_uchar;
    lodepng_chunk_generate_crc(chunk);
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn addChunk_gAMA(
    ...
    lodepng_set32bitInt(chunk.offset(8 as std::os::raw::c_int as isize), (*info).gama_gamma);
    lodepng_chunk_generate_crc(chunk);
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn addChunk_cHRM(
    ...
    lodepng_set32bitInt(chunk.offset(8 as std::os::raw::c_int as isize), (*info).chrm_white_x);
    lodepng_set32bitInt(chunk.offset(12 as std::os::raw::c_int as isize), (*info).chrm_white_y);
    lodepng_set32bitInt(chunk.offset(16 as std::os::raw::c_int as isize), (*info).chrm_red_x);
    lodepng_set32bitInt(chunk.offset(20 as std::os::raw::c_int as isize), (*info).chrm_red_y);
    lodepng_set32bitInt(chunk.offset(24 as std::os::raw::c_int as isize), (*info).chrm_green_x);
    lodepng_set32bitInt(chunk.offset(28 as std::os::raw::c_int as isize), (*info).chrm_green_y);
    lodepng_set32bitInt(chunk.offset(32 as std::os::raw::c_int as isize), (*info).chrm_blue_x);
    lodepng_set32bitInt(chunk.offset(36 as std::os::raw::c_int as isize), (*info).chrm_blue_y);
    lodepng_chunk_generate_crc(chunk);
    return 0 as std::os::raw::c_int as std::os::raw::c_uint;
}
unsafe extern "C" fn addChunk_sRGB(
    ...
    let mut data = (*info).srgb_intent as std::os::raw::c_uchar;
    return lodepng_chunk_createv(
        out,
        1 as std::os::raw::c_int as std::os::raw::c_uint,
        b"sRGB\0" as *const u8 as *const std::os::raw::c_char,
...
unsafe extern "C" fn addChunk_iCCP(
    ...
    if error == 0 {
        lodepng_memcpy(
            chunk.offset(8 as std::os::raw::c_int as isize) as *mut std::os::raw::c_void,
            (*info).iccp_name as *const std::os::raw::c_void,
            keysize,
        );
        *chunk
            .offset(
...
unsafe extern "C" fn addChunk_sBIT(
    ...
    if (*info).color.colortype as std::os::raw::c_uint == LCT_GREY as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).sbit_r == 0 as std::os::raw::c_int as std::os::raw::c_uint
        ...
        *chunk.offset(8 as std::os::raw::c_int as isize) = (*info).sbit_r as std::os::raw::c_uchar;
    } else if (*info).color.colortype as std::os::raw::c_uint
        == LCT_RGB as std::os::raw::c_int as std::os::raw::c_uint
        || (*info).color.colortype as std::os::raw::c_uint
            == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).sbit_r == 0 as std::os::raw::c_int as std::os::raw::c_uint
            || (*info).sbit_g == 0 as std::os::raw::c_int as std::os::raw::c_uint
            || (*info).sbit_b == 0 as std::os::raw::c_int as std::os::raw::c_uint
        {
            return 115 as std::os::raw::c_int as std::os::raw::c_uint;
        }
        ...
        *chunk.offset(8 as std::os::raw::c_int as isize) = (*info).sbit_r as std::os::raw::c_uchar;
        *chunk.offset(9 as std::os::raw::c_int as isize) = (*info).sbit_g as std::os::raw::c_uchar;
        *chunk.offset(10 as std::os::raw::c_int as isize) = (*info).sbit_b as std::os::raw::c_uchar;
    } else if (*info).color.colortype as std::os::raw::c_uint
        == LCT_GREY_ALPHA as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).sbit_r == 0 as std::os::raw::c_int as std::os::raw::c_uint
            || (*info).sbit_a == 0 as std::os::raw::c_int as std::os::raw::c_uint
        {
            return 115 as std::os::raw::c_int as std::os::raw::c_uint;
        }
        ...
        *chunk.offset(8 as std::os::raw::c_int as isize) = (*info).sbit_r as std::os::raw::c_uchar;
        *chunk.offset(9 as std::os::raw::c_int as isize) = (*info).sbit_a as std::os::raw::c_uchar;
    } else if (*info).color.colortype as std::os::raw::c_uint
        == LCT_RGBA as std::os::raw::c_int as std::os::raw::c_uint
    {
        if (*info).sbit_r == 0 as std::os::raw::c_int as std::os::raw::c_uint
        ...
        *chunk.offset(9 as std::os::raw::c_int as isize) = (*info).sbit_g as std::os::raw::c_uchar;
        *chunk.offset(10 as std::os::raw::c_int as isize) = (*info).sbit_b as std::os::raw::c_uchar;
        *chunk.offset(11 as std::os::raw::c_int as isize) = (*info).sbit_a as std::os::raw::c_uchar;
    }
    if !chunk.is_null() {
        lodepng_chunk_generate_crc(chunk);
    }
...
unsafe extern "C" fn filter(
    ...
    if (*settings).filter_palette_zero != 0
        && ((*color).colortype as std::os::raw::c_uint
            == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
            || (*color).bitdepth < 8 as std::os::raw::c_int as std::os::raw::c_uint)
    {
        strategy = LFS_ZERO;
    }
    if bpp == 0 as std::os::raw::c_int as std::os::raw::c_uint {
        ...
        && strategy as std::os::raw::c_uint <= LFS_FOUR as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        let mut attempt: [*mut std::os::raw::c_uchar; 5] = [0 as *mut std::os::raw::c_uchar; 5];
        let mut smallest = 0 as std::os::raw::c_int as size_t;
        let mut type_1: std::os::raw::c_uchar = 0;
        ...
        let mut attempt_0: [*mut std::os::raw::c_uchar; 5] = [0 as *mut std::os::raw::c_uchar; 5];
        let mut bestSum = 0 as std::os::raw::c_int as size_t;
        let mut type_2: std::os::raw::c_uint = 0;
        let mut bestType_0 = 0 as std::os::raw::c_int as std::os::raw::c_uint;
        let mut count: [std::os::raw::c_uint; 256] = [0; 256];
    ...
    } else if strategy as std::os::raw::c_uint == LFS_BRUTE_FORCE as std::os::raw::c_int as std::os::raw::c_uint
    {
        ...
        let mut attempt_1: [*mut std::os::raw::c_uchar; 5] = [0 as *mut std::os::raw::c_uchar; 5];
...
unsafe extern "C" fn addPaddingBits(
    ...
    while y != h {
        ...
        x = 0 as std::os::raw::c_int as size_t;
        while x != diff {
            setBitOfReversedStream(&mut obp, out, 0 as std::os::raw::c_int as std::os::raw::c_uchar);
            x = x.wrapping_add(1);
        }
        y = y.wrapping_add(1);
    }
...
unsafe extern "C" fn preProcessScanlines(
    ...
    if (*info_png).interlace_method == 0 as std::os::raw::c_int as std::os::raw::c_uint {
        ...
        *outsize = filter_passstart[7 as std::os::raw::c_int as usize];
        *out = lodepng_malloc(*outsize) as *mut std::os::raw::c_uchar;
        if (*out).is_null() {
            error = 83 as std::os::raw::c_int as std::os::raw::c_uint;
        }
...
pub unsafe extern "C" fn lodepng_encode(
    ...
    *outsize = 0 as std::os::raw::c_int as size_t;
    ...
    if ((*info_png).color.colortype as std::os::raw::c_uint
        == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
        || (*state).encoder.force_palette != 0)
        && ((*info_png).color.palettesize == 0 as std::os::raw::c_int as std::os::raw::c_ulong
            || (*info_png).color.palettesize > 256 as std::os::raw::c_int as std::os::raw::c_ulong)
    {
    ...
    } else if (*info_png).interlace_method > 1 as std::os::raw::c_int as std::os::raw::c_uint {
                                ...
                                if (*state).error != 0 {
                                    ...
                                    if (*info_png).sbit_defined != 0 {
                                        ...
                                        let mut equal = (((*info_png).sbit_g == 0
                                            ...
                                            && ((*info_png).sbit_a == 0
                                                || (*info_png).sbit_a == (*info_png).sbit_r)) as std::os::raw::c_int
                                            as std::os::raw::c_uint;
                                        ...
                                        if info.color.colortype as std::os::raw::c_uint
                                            ...
                                            && auto_color.colortype as std::os::raw::c_uint
                                                == LCT_PALETTE as std::os::raw::c_int as std::os::raw::c_uint
                                            && (*info_png).sbit_a == 8 as std::os::raw::c_int as std::os::raw::c_uint
                                            && sbit_max <= 8 as std::os::raw::c_int as std::os::raw::c_uint
                                        {
                                            allow_convert = 1 as std::os::raw::c_int as std::os::raw::c_uint;
                                        }
                                                                                                                                                        ...
                                                                                                                                                        match current_block {
                                                                                                                                                            ...
                                                                                                                                                            _ => {
                                                                                                                                                                if (*state).encoder.add_id != 0 {
                                                                                                                                                                    ...
                                                                                                                                                                    i = 0 as std::os::raw::c_int as size_t;
                                                                                                                                                                    while i != info.text_num {
                                                                                                                                                                        let mut k: *const std::os::raw::c_char = *(info.text_keys)
                                                                                                                                                                            .offset(i as isize);
...
pub unsafe extern "C" fn lodepng_encoder_settings_init(
    ...
    (*settings).filter_palette_zero = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).filter_strategy = LFS_MINSUM;
    (*settings).auto_convert = 1 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).force_palette = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    let ref mut fresh190 = (*settings).predefined_filters;
    *fresh190 = 0 as *const std::os::raw::c_uchar;
    (*settings).add_id = 0 as std::os::raw::c_int as std::os::raw::c_uint;
    (*settings).text_compression = 1 as std::os::raw::c_int as std::os::raw::c_uint;
}
#[no_mangle]
