...
#[no_mangle]
pub unsafe extern "C" fn json_hexadecimal_digit(c: std::os::raw::c_char) -> std::os::raw::c_int {
...
pub unsafe extern "C" fn json_hexadecimal_value(
    ...
    mut result: *mut std::os::raw::c_ulong,
) -> std::os::raw::c_int {
    let mut p = 0 as *const std::os::raw::c_char;
    let mut digit: std::os::raw::c_int = 0;
    if size
...
pub unsafe extern "C" fn json_get_string_size(
    ...
    let mut codepoint: std::os::raw::c_ulong = 0;
...
#[no_mangle]
pub unsafe extern "C" fn is_valid_unquoted_key_char(c: std::os::raw::c_char) -> std::os::raw::c_int {
    ...
    *fresh28 = (*fresh28 as std::os::raw::c_ulong)
                    ...
                    ) as std::os::raw::c_int)
    {
        ...
        if json_parse_flags_allow_inf_and_nan as std::os::raw::c_int as std::os::raw::c_ulong
            & flags_bitset != 0
        {
            let inf: [std::os::raw::c_char; 9] = *::std::mem::transmute::<
                &[u8; 9],
                &[std::os::raw::c_char; 9],
            >(b"Infinity\0");
            ...
            let nan: [std::os::raw::c_char; 4] = *::std::mem::transmute::<
                &[u8; 4],
                &[std::os::raw::c_char; 4],
            >(b"NaN\0");
...
pub unsafe extern "C" fn json_parse_ex(
    ...
    let mut allocation = 0 as *mut std::os::raw::c_void;
    let mut value = 0 as *mut json_value_s;
    let mut total_size: size_t = 0;
    let mut input_error: std::os::raw::c_int = 0;
    if !result.is_null() {
...
pub unsafe extern "C" fn json_extract_value(
    ...
    return json_extract_value_ex(value, None, 0 as *mut std::os::raw::c_void);
}
#[no_mangle]
...
#[no_mangle]
pub unsafe extern "C" fn json_value_is_true(value: *const json_value_s) -> std::os::raw::c_int {
    return ((*value).type_0 == json_type_true as std::os::raw::c_int as std::os::raw::c_ulong)
        as std::os::raw::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn json_value_is_false(value: *const json_value_s) -> std::os::raw::c_int {
    return ((*value).type_0 == json_type_false as std::os::raw::c_int as std::os::raw::c_ulong)
        as std::os::raw::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn json_value_is_null(value: *const json_value_s) -> std::os::raw::c_int {
    return ((*value).type_0 == json_type_null as std::os::raw::c_int as std::os::raw::c_ulong)
        as std::os::raw::c_int;
}
#[no_mangle]
...
pub unsafe extern "C" fn json_write_number(
        ...
        && 'I' as i32 == *((*number).number).offset(i as isize) as std::os::raw::c_int
    {
        ...
        if '\0' as i32 == *fresh150 as std::os::raw::c_int {
            let mut dbl_max = 0 as *const std::os::raw::c_char;
            if '-' as i32
                == *((*number).number).offset(0 as std::os::raw::c_int as isize) as std::os::raw::c_int
            {
                let fresh151 = data;
