...
impl std::default::Default for __sFILE {
    fn default() -> Self {
        ...
        _bf: crate::smoke::__sbuf::default(),
        ...
        _seek: None,
        _write: None,
        _ub: crate::smoke::__sbuf::default(),
        _extra: 0 as * mut crate::smoke::__sFILEX,
        _ur: std::os::raw::c_int::default(),
        _ubuf: [std::os::raw::c_uchar::default(); 3],
        _nbuf: [std::os::raw::c_uchar::default(); 1],
        _lb: crate::smoke::__sbuf::default(),
...
pub type FILE = crate::smoke::__sFILE;
