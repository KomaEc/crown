...
impl std::default::Default for __sFILE {
    fn default() -> Self {
        ...
        _bf: crate::blocksort::__sbuf::default(),
        ...
        _seek: None,
        _write: None,
        _ub: crate::blocksort::__sbuf::default(),
        ...
        _lb: crate::blocksort::__sbuf::default(),
...
impl std::default::Default for bz_stream {
    fn default() -> Self {
        ...
        avail_in: std::os::raw::c_uint::default(),
        total_in_lo32: std::os::raw::c_uint::default(),
        total_in_hi32: std::os::raw::c_uint::default(),
        next_out: 0 as * mut std::os::raw::c_char,
        avail_out: std::os::raw::c_uint::default(),
        total_out_lo32: std::os::raw::c_uint::default(),
        total_out_hi32: std::os::raw::c_uint::default(),
...
impl std::default::Default for EState {
    fn default() -> Self {
        ...
        mode: std::os::raw::c_int::default(),
        state: std::os::raw::c_int::default(),
        avail_in_expect: std::os::raw::c_uint::default(),
        ...
        workFactor: std::os::raw::c_int::default(),
        state_in_ch: std::os::raw::c_uint::default(),
        state_in_len: std::os::raw::c_int::default(),
        rNToGo: std::os::raw::c_int::default(),
        rTPos: std::os::raw::c_int::default(),
        nblock: std::os::raw::c_int::default(),
        nblockMAX: std::os::raw::c_int::default(),
        numZ: std::os::raw::c_int::default(),
        state_out_pos: std::os::raw::c_int::default(),
        nInUse: std::os::raw::c_int::default(),
        inUse: [std::os::raw::c_uchar::default(); 256],
        unseqToSeq: [std::os::raw::c_uchar::default(); 256],
        bsBuff: std::os::raw::c_uint::default(),
        bsLive: std::os::raw::c_int::default(),
        blockCRC: std::os::raw::c_uint::default(),
        combinedCRC: std::os::raw::c_uint::default(),
        verbosity: std::os::raw::c_int::default(),
        blockNo: std::os::raw::c_int::default(),
        blockSize100k: std::os::raw::c_int::default(),
        nMTF: std::os::raw::c_int::default(),
        mtfFreq: [std::os::raw::c_int::default(); 258],
        ...
        code: [[std::os::raw::c_int::default(); 258]; 6],
        rfreq: [[std::os::raw::c_int::default(); 258]; 6],
        len_pack: [[std::os::raw::c_uint::default(); 4]; 258]
        }
    }
}
...
pub unsafe extern "C" fn BZ2_blockSort(mut s: *mut EState) {
    ...
    let mut quadrant: *mut UInt16 = core::ptr::null_mut();
