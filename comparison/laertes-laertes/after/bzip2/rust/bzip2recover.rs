...
pub struct BitStream {
    ...
    pub buffLive: std::os::raw::c_int,
    pub mode: std::os::raw::c_char,
}
impl std::default::Default for BitStream {
    fn default() -> Self {
        BitStream {
        handle: core::ptr::null_mut(),
        buffer: std::os::raw::c_int::default(),
        buffLive: std::os::raw::c_int::default(),
        mode: std::os::raw::c_char::default()
        }
    }
}
...
unsafe fn main_0(mut argc: Int32, mut argv: *mut *mut Char) -> Int32 {
    ...
    let mut bsIn: *mut BitStream = core::ptr::null_mut();
    let mut bsWr: *mut BitStream = core::ptr::null_mut();
    let mut b: Int32 = 0;
