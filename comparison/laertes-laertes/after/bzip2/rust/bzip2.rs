...
pub type __darwin_blkcnt_t = std::os::raw::c_longlong;
pub type __darwin_blksize_t = std::os::raw::c_int;
pub type __darwin_dev_t = std::os::raw::c_int;
pub type __darwin_gid_t = std::os::raw::c_uint;
pub type __darwin_ino64_t = std::os::raw::c_ulonglong;
pub type __darwin_mode_t = std::os::raw::c_ushort;
pub use crate::blocksort::__darwin_off_t;
pub type __darwin_uid_t = std::os::raw::c_uint;
...
pub type dev_t = std::os::raw::c_int;
pub type mode_t = std::os::raw::c_ushort;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub struct _RuneRange {
    ...
    pub __ranges: * mut crate::bzip2::_RuneEntry,
}
...
pub struct _RuneLocale {
    ...
    pub __runetype_ext: crate::bzip2::_RuneRange,
    pub __maplower_ext: crate::bzip2::_RuneRange,
    pub __mapupper_ext: crate::bzip2::_RuneRange,
    pub __variable: * mut core::ffi::c_void,
    pub __variable_len: std::os::raw::c_int,
    pub __ncharclasses: std::os::raw::c_int,
    pub __charclasses: * mut crate::bzip2::_RuneCharClass,
}
impl std::default::Default for _RuneLocale {
    fn default() -> Self {
        ...
        __runetype_ext: crate::bzip2::_RuneRange::default(),
        __maplower_ext: crate::bzip2::_RuneRange::default(),
        __mapupper_ext: crate::bzip2::_RuneRange::default(),
...
impl std::default::Default for utimbuf {
    fn default() -> Self {
        utimbuf {
        actime: std::os::raw::c_long::default(),
        modtime: std::os::raw::c_long::default()
        }
    }
}
...
impl std::default::Default for stat {
    fn default() -> Self {
        stat {
        st_dev: std::os::raw::c_int::default(),
        st_mode: std::os::raw::c_ushort::default(),
        st_nlink: std::os::raw::c_ushort::default(),
        st_ino: std::os::raw::c_ulonglong::default(),
        st_uid: std::os::raw::c_uint::default(),
        st_gid: std::os::raw::c_uint::default(),
        st_rdev: std::os::raw::c_int::default(),
        st_atimespec: crate::bzip2::timespec::default(),
        st_mtimespec: crate::bzip2::timespec::default(),
        st_ctimespec: crate::bzip2::timespec::default(),
        st_birthtimespec: crate::bzip2::timespec::default(),
        st_size: std::os::raw::c_longlong::default(),
        st_blocks: std::os::raw::c_longlong::default(),
        st_blksize: std::os::raw::c_int::default(),
        st_flags: std::os::raw::c_uint::default(),
        st_gen: std::os::raw::c_uint::default(),
        st_lspare: std::os::raw::c_int::default(),
        st_qspare: [std::os::raw::c_longlong::default(); 2]
        }
    }
}
...
#[repr(C)]
pub struct UInt64 {
    pub b: [std::os::raw::c_uchar; 8],
}
impl std::default::Default for UInt64 {
    fn default() -> Self {
        UInt64 {
        b: [std::os::raw::c_uchar::default(); 8]
        }
    }
}
...
pub struct zzzz {
    ...
    pub link: * mut crate::bzip2::zzzz,
}
impl std::default::Default for zzzz {
    fn default() -> Self {
        zzzz {
...
--*/
pub type Cell = crate::bzip2::zzzz;
#[inline]
...
unsafe extern "C" fn uInt64_from_UInt32s<'a1>(mut n: Option<&'a1 mut crate::bzip2::UInt64>, mut lo32: std::os::raw::c_uint,
                                         mut hi32: std::os::raw::c_uint) {
    (*borrow_mut(&mut n).unwrap()).b[7 as std::os::raw::c_int as usize] =
        (hi32 >> 24 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[6 as std::os::raw::c_int as usize] =
        (hi32 >> 16 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[5 as std::os::raw::c_int as usize] =
        (hi32 >> 8 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[4 as std::os::raw::c_int as usize] =
        (hi32 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as UChar;
    (*borrow_mut(&mut n).unwrap()).b[3 as std::os::raw::c_int as usize] =
        (lo32 >> 24 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[2 as std::os::raw::c_int as usize] =
        (lo32 >> 16 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[1 as std::os::raw::c_int as usize] =
        (lo32 >> 8 as std::os::raw::c_int & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as
            UChar;
    (*borrow_mut(&mut n).unwrap()).b[0 as std::os::raw::c_int as usize] =
        (lo32 & 0xff as std::os::raw::c_int as std::os::raw::c_uint) as UChar;
}
unsafe extern "C" fn uInt64_to_double<'a1>(mut n: Option<&'a1 mut crate::bzip2::UInt64>) -> std::os::raw::c_double {
    let mut i: Int32 = 0;
    let mut base: std::os::raw::c_double = 1.0f64;
    let mut sum: std::os::raw::c_double = 0.0f64;
    i = 0 as std::os::raw::c_int;
    while i < 8 as std::os::raw::c_int {
        sum += base * (*borrow(& n).unwrap()).b[i as usize] as std::os::raw::c_double;
        base *= 256.0f64;
        i += 1
    }
    return sum;
}
unsafe extern "C" fn uInt64_isZero<'a1>(mut n: Option<&'a1 mut crate::bzip2::UInt64>) -> std::os::raw::c_uchar {
    let mut i: Int32 = 0;
    i = 0 as std::os::raw::c_int;
    while i < 8 as std::os::raw::c_int {
        if (*borrow(& n).unwrap()).b[i as usize] as std::os::raw::c_int != 0 as std::os::raw::c_int {
...
unsafe extern "C" fn uInt64_qrm10<'a1>(mut n: Option<&'a1 mut crate::bzip2::UInt64>) -> std::os::raw::c_int {
    ...
    while i >= 0 as std::os::raw::c_int {
        tmp =
            rem.wrapping_mul(256 as std::os::raw::c_int as
                                 std::os::raw::c_uint).wrapping_add((*borrow_mut(&mut n).unwrap()).b[i as usize]
                                                                as
                                                                std::os::raw::c_uint);
        (*borrow_mut(&mut n).unwrap()).b[i as usize] =
...
*/
unsafe extern "C" fn uInt64_toAscii<'a1>(mut outbuf: * mut std::os::raw::c_char,
                                    mut n: Option<&'a1 mut crate::bzip2::UInt64>) {
    let mut i: Int32 = 0;
    let mut q: Int32 = 0;
    let mut buf: [UChar; 32] = [0; 32];
    let mut nBuf: Int32 = 0 as std::os::raw::c_int;
    let mut n_copy: UInt64 = *borrow_mut(&mut n).unwrap();
    loop  {
        q = uInt64_qrm10(Some(&mut n_copy));
        buf[nBuf as usize] = (q + '0' as i32) as UChar;
        nBuf += 1;
        if !(uInt64_isZero(Some(&mut n_copy)) == 0) { break ; }
    }
...
unsafe extern "C" fn compressStream(mut stream: *mut FILE,
    ...
    let mut bzf: *mut std::os::raw::c_void = core::ptr::null_mut();
    ...
    if !(ferror(stream) != 0) {
        if !(ferror(zStream) != 0) {
            bzf =
                BZ2_bzWriteOpen(Some(&mut bzerr), zStream, blockSize100k, verbosity,
                                workFactor);
            if bzerr != 0 as std::os::raw::c_int {
                ...
                loop  {
                    ...
                    if nIbuf > 0 as std::os::raw::c_int {
                        BZ2_bzWrite(Some(&mut bzerr), bzf,
                                                    ...
                                                    if nbytes_in_lo32 ==
                                                                   ...
                                                                   std::os::raw::c_uint
                                                       {
                                                        ...
                                                        uInt64_from_UInt32s(Some(&mut nbytes_out),
                                                                            ...
                                                                            nbytes_out_hi32);
                                                        nbytes_in_d =
                                                            uInt64_to_double(Some(&mut nbytes_in));
                                                        nbytes_out_d =
                                                            uInt64_to_double(Some(&mut nbytes_out));
...
unsafe extern "C" fn uncompressStream(mut zStream: *mut FILE,
    ...
    let mut unusedTmp: *mut UChar = core::ptr::null_mut();
        ...
        if !(ferror(zStream) != 0) {
            's_51:
                loop  {
                    ...
                    bzf =
                        BZ2_bzReadOpen(Some(&mut bzerr), zStream, verbosity,
                    ...
                    BZ2_bzReadGetUnused(Some(&mut bzerr), bzf, Some(&mut unusedTmpV),
                                        Some(&mut nUnused));
                    if bzerr != 0 as std::os::raw::c_int {
                ...
                _ => {
                    ...
                    match current_block {
                        ...
                        _ => {
                            match current_block {
                                673979509383251364 => {
                                    BZ2_bzReadClose(Some(&mut bzerr_dummy), bzf);
                                    match bzerr {
                                        -9 => {
                                            current_block =
                                                3642457097893642164;
...
unsafe extern "C" fn myMalloc(mut n: Int32) -> *mut std::os::raw::c_void {
    let mut p: *mut std::os::raw::c_void = core::ptr::null_mut();
...
/*---------------------------------------------*/
unsafe extern "C" fn addFlagsFromEnvVar<'a1>(mut argList: Option<&'a1 mut * mut crate::bzip2::zzzz>,
                                        mut varName: * mut std::os::raw::c_char) {
    let mut i: Int32 = 0;
    let mut j: Int32 = 0;
    let mut k: Int32 = 0;
    let mut envbase: *mut Char = core::ptr::null_mut();
    let mut p: *mut Char = core::ptr::null_mut();
    ...
    if !envbase.is_null() {
        ...
        while 1 as std::os::raw::c_int as Bool != 0 {
            ...
            if i > 0 as std::os::raw::c_int {
                ...
                *borrow_mut(&mut argList).unwrap() = snocString(*borrow_mut(&mut argList).unwrap(), tmpName.as_mut_ptr())
            }
        }
    };
}
