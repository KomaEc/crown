...
pub type WINDOW = crate::src::robotfindskitten::_win_st;
pub type attr_t = std::os::raw::c_uint;
...
impl std::default::Default for screen_object {
    fn default() -> Self {
        screen_object {
        x: std::os::raw::c_int::default(),
        y: std::os::raw::c_int::default(),
        color: std::os::raw::c_int::default(),
        bold: false,
        character: std::os::raw::c_char::default()
        }
    }
}
 ...
 *****************************************************************************/
#[no_mangle]
pub extern "C" fn validchar(mut a: std::os::raw::c_char) -> std::os::raw::c_int {
