...
#[no_mangle]
pub unsafe extern "C" fn ztrunc(mut a: *mut zahl, mut b: *mut zahl,
                                mut bits: size_t) {
    ...
    if ((*a).used < chars) as std::os::raw::c_int as std::os::raw::c_long != 0 {
        bits = 0 as std::os::raw::c_int as size_t
    }
