...
- [x] The analysis engine generates many useless constraint variables. Figure out why.
- [x] Is the handling of nested pointer correct? `p = q` should introduce more constraints when `p` is nested!
