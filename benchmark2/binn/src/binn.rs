...
unsafe extern "C" fn GetValue(mut p: *mut libc::c_uchar, mut value: *mut binn) -> BOOL {
    ...
    match storage_type {
        ...
        64 => {
            ...
            *fresh29 = &mut (*value).c2rust_unnamed.vint16 as *mut libc::c_short
                as *mut libc::c_void;
        }
        96 => {
            copy_be32(
            ...
            *fresh30 = &mut (*value).c2rust_unnamed.vint32 as *mut libc::c_int
                as *mut libc::c_void;
        }
        128 => {
            copy_be64(
...
pub unsafe extern "C" fn binn_iter_init(
    ...
    *fresh36 = (ptr as *mut libc::c_uchar)
        .offset(size as isize)
        .offset(-(1 as libc::c_int as isize));
    let ref mut fresh37 = (*iter).pnext;
    *fresh37 = (ptr as *mut libc::c_uchar).offset(header_size as isize);
    (*iter).count = count;
...
unsafe extern "C" fn copy_raw_value(
    ...
    match data_store {
        ...
        192 | 160 | 224 => {
            let ref mut fresh42 = *(pdest as *mut *mut libc::c_char);
            *fresh42 = psource as *mut libc::c_char;
        }
        _ => return 0 as libc::c_int,
    }
    return 1 as libc::c_int;
...
unsafe extern "C" fn zero_value(mut pvalue: *mut libc::c_void, mut type_0: libc::c_int) {
    match binn_get_read_storage(type_0) {
        ...
        192 | 160 | 224 => {
            let ref mut fresh43 = *(pvalue as *mut *mut libc::c_char);
    ...
    if !item.is_null() {
        ...
        match storage_type {
            ...
            _ => {
                ...
                *fresh48 = &mut (*item).c2rust_unnamed.vint32 as *mut libc::c_int
                    as *mut libc::c_void;
