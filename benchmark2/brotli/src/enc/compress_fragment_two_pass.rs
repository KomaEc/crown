...
unsafe extern "C" fn EmitInsertLen(
    ...
    if insertlen < 6 as libc::c_int as libc::c_uint {
        ...
        **commands = 21 as libc::c_int as libc::c_uint | extra_1 << 8 as libc::c_int;
    } else if insertlen < 22594 as libc::c_int as libc::c_uint {
        let extra_2 = insertlen.wrapping_sub(6210 as libc::c_int as libc::c_uint);
        **commands = 22 as libc::c_int as libc::c_uint | extra_2 << 8 as libc::c_int;
    } else {
        let extra_3 = insertlen.wrapping_sub(22594 as libc::c_int as libc::c_uint);
        **commands = 23 as libc::c_int as libc::c_uint | extra_3 << 8 as libc::c_int;
    }
...
unsafe extern "C" fn EmitCopyLen(mut copylen: size_t, mut commands: *mut *mut uint32_t) {
    if copylen < 10 as libc::c_int as libc::c_ulong {
        ...
        **commands = (63 as libc::c_int as libc::c_ulong | extra_1 << 8 as libc::c_int)
            as uint32_t;
    }
    *commands = (*commands).offset(1);
}
...
unsafe extern "C" fn EmitCopyLenLastDistance(
    ...
    if copylen < 12 as libc::c_int as libc::c_ulong {
        ...
        **commands = (63 as libc::c_int as libc::c_ulong | extra_2 << 8 as libc::c_int)
            as uint32_t;
        *commands = (*commands).offset(1);
        **commands = 64 as libc::c_int as uint32_t;
        *commands = (*commands).offset(1);
...
unsafe extern "C" fn RewindBitPosition(
    ...
    let mask = ((1 as libc::c_uint) << bitpos)
        .wrapping_sub(1 as libc::c_int as libc::c_uint) as size_t;
    let ref mut fresh3 = *storage.offset((new_storage_ix >> 3 as libc::c_int) as isize);
    *fresh3 = (*fresh3 as libc::c_int & mask as uint8_t as libc::c_int) as uint8_t;
