...
pub unsafe extern "C" fn rgba_new(mut rgba: uint32_t) -> rgba_t {
    ...
    color
        .r = (rgba >> 24 as libc::c_int) as libc::c_double
        / 255 as libc::c_int as libc::c_double;
    color
        .g = (rgba >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
        as libc::c_double / 255 as libc::c_int as libc::c_double;
    color
        .b = (rgba >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint)
        as libc::c_double / 255 as libc::c_int as libc::c_double;
    color
        .a = (rgba & 0xff as libc::c_int as libc::c_uint) as libc::c_double
        / 255 as libc::c_int as libc::c_double;
    return color;
}
#[no_mangle]
