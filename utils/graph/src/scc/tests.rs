...
use super::*;
use crate::implementation::sparse_bit_vector::SparseBitVectorGraph as TestGraph;

#[test]
fn diamond() {
    let graph: TestGraph<usize> = TestGraph::new(4, [(0, 1), (0, 2), (1, 3), (2, 3)].into_iter());
...
fn test_big_scc() {
    ...
    +-- 2 <--+
         */
    let graph: TestGraph<usize> =
        TestGraph::new(4, [(0, 1), (1, 2), (1, 3), (2, 0), (3, 2)].into_iter());
    let sccs: Sccs<_, usize> = Sccs::new(&graph);
...
fn test_three_sccs() {
    ...
    +-- 2 <--+
         */
    let graph: TestGraph<usize> = TestGraph::new(4, [(0, 1), (1, 2), (2, 1), (3, 2)].into_iter());
    let sccs: Sccs<_, usize> = Sccs::new(&graph);
...
fn test_find_state_2() {
    ...
    let graph: TestGraph<usize> = TestGraph::new(
        5,
        [(0, 1), (0, 4), (1, 2), (1, 3), (2, 1), (3, 0), (4, 2)].into_iter(),
    );
...
fn test_deep_linear() {
    ...
    let graph: TestGraph<usize> = TestGraph::new(NR_NODES, nodes.into_iter());
    let sccs: Sccs<_, usize> = Sccs::new(&graph);
