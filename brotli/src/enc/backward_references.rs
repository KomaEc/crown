...
unsafe extern "C" fn InitCommand(
    ...
    PrefixEncodeCopyDistance(
        ...
        core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).dist_prefix_),
        core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).dist_extra_),
    );
    GetLengthCode(
        insertlen,
...
unsafe extern "C" fn FindLongestMatchH5(
    ...
    let mut bucket: *mut uint32_t = core::ptr::addr_of_mut!(*buckets
...
unsafe extern "C" fn StoreH35(
    ...
    StoreH3(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).ha), data, mask, ix);
    StoreHROLLING_FAST(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb), data, mask, ix);
}
#[inline(always)]
unsafe extern "C" fn StoreRangeH35(
    ...
    StoreRangeHROLLING_FAST(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb), data, mask, ix_start, ix_end);
}
#[inline(always)]
...
unsafe extern "C" fn FindLongestMatchH35(
    ...
    FindLongestMatchH3(
        core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).ha),
        dictionary,
        data,
        ring_buffer_mask,
        distance_cache,
    ...
    FindLongestMatchHROLLING_FAST(
        core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb),
        dictionary,
        data,
        ring_buffer_mask,
        distance_cache,
...
unsafe extern "C" fn StoreH55(
    ...
    StoreH54(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).ha), data, mask, ix);
    StoreHROLLING_FAST(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb), data, mask, ix);
}
#[inline(always)]
...
unsafe extern "C" fn StoreH65(
    ...
    StoreH6(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).ha), data, mask, ix);
    StoreHROLLING(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb), data, mask, ix);
}
#[inline(always)]
unsafe extern "C" fn StoreRangeH65(
    ...
    StoreRangeHROLLING(core::ptr::addr_of_mut!((*self_0.as_deref().unwrap()).hb), data, mask, ix_start, ix_end);
}
#[inline(always)]
