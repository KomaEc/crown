...
unsafe extern "C" fn BrotliEncoderInitParams(mut params: Option<&mut crate::src::enc::backward_references::BrotliEncoderParams>) {
    ...
    crate::src::enc::encoder_dict::BrotliInitEncoderDictionary(core::ptr::addr_of_mut!((*params.as_deref().unwrap()).dictionary));
            ...
            && (*available_in) != 0 as libc::c_int as libc::c_ulong
        {
            ...
            *available_in= ((*available_in) as libc::c_ulong)
            ...
            result= EncodeData(
                ...
                is_last,
                force_flush,
                core::ptr::addr_of_mut!((*s.as_deref().unwrap()).available_out_),
                core::ptr::addr_of_mut!((*s.as_deref().unwrap()).next_out_),
            );
            if result == 0 {
                return 0 as libc::c_int;
            }
