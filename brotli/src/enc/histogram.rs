...
struct ErasedByPreprocessor118;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor119;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor120;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor121;
#[derive(Copy, Clone)]

struct ErasedByPreprocessor122;
#[derive(Copy, Clone)]
#[repr(C)]
