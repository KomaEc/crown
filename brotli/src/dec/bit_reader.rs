...
#[inline(always)]
unsafe extern "C" fn BrotliPullByte(br: Option<&mut BrotliBitReader>) -> libc::c_int {
...
#[inline(always)]
unsafe extern "C" fn BrotliDropBits(br: Option<&mut BrotliBitReader>, mut n_bits: uint32_t) {
...
#[no_mangle]
pub unsafe extern "C" fn BrotliInitBitReader(br: Option<&mut BrotliBitReader>) {
...
#[no_mangle]
pub unsafe extern "C" fn BrotliWarmupBitReader(br: Option<&mut BrotliBitReader>) -> libc::c_int {
