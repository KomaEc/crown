...
pub struct BrotliDecoderStateStruct {
    ...
    pub br: crate::src::dec::bit_reader::BrotliBitReader,
    ...
    pub dictionary: *const crate::src::common::dictionary::BrotliDictionary,
    pub transforms: *const crate::src::common::transform::BrotliTransforms,
...
unsafe extern "C" fn BrotliBitReaderSaveState(
    from: *mut crate::src::dec::bit_reader::BrotliBitReader,
    mut to: Option<&mut crate::src::dec::bit_reader::BrotliBitReaderState>,
) {
...
unsafe extern "C" fn BrotliBitReaderRestoreState(
    to: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>,
    mut from: *mut crate::src::dec::bit_reader::BrotliBitReaderState,
) {
    (*to.as_deref_mut().unwrap()).val_= (*from).val_;
    (*to.as_deref_mut().unwrap()).bit_pos_= (*from).bit_pos_;
    (*to.as_deref_mut().unwrap()).next_in= (*from).next_in;
...
#[inline(always)]
unsafe extern "C" fn BrotliGetAvailableBits(mut br: *const crate::src::dec::bit_reader::BrotliBitReader) -> uint32_t {
    return ((if 1 as libc::c_int != 0 { 64 as libc::c_int } else { 32 as libc::c_int })
        as libc::c_uint)
        .wrapping_sub((*br).bit_pos_);
}
#[inline(always)]
unsafe extern "C" fn BrotliGetRemainingBytes(mut br: *mut crate::src::dec::bit_reader::BrotliBitReader) -> size_t {
...
unsafe extern "C" fn BrotliCheckInputAmount(
    br: *mut crate::src::dec::bit_reader::BrotliBitReader,
    mut num: size_t,
) -> libc::c_int {
...
unsafe extern "C" fn BrotliFillBitWindow(
    br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>,
    mut n_bits: uint32_t,
) {
    if 0 as libc::c_int == 0 && 0 != 0 && n_bits <= 8 as libc::c_int as libc::c_uint {
        if (*br.as_deref().unwrap()).bit_pos_ >= 56 as libc::c_int as libc::c_uint {
            (*br.as_deref_mut().unwrap()).val_>>= 56 as libc::c_int;
            (*br.as_deref_mut().unwrap()).bit_pos_^= 56 as libc::c_int as libc::c_uint;
            (*br.as_deref_mut().unwrap()).val_= BrotliUnalignedRead64((*br.as_deref().unwrap()).next_in as *const libc::c_void)
                    << 8 as libc::c_int;
            (*br.as_deref_mut().unwrap()).avail_in= ((*br.as_deref().unwrap()).avail_in as libc::c_ulong)
                .wrapping_sub(7 as libc::c_int as libc::c_ulong) as size_t as size_t;
            (*br.as_deref_mut().unwrap()).next_in= (*br.as_deref().unwrap()).next_in.offset(7 as libc::c_int as isize);
        }
    } else if 0 as libc::c_int == 0 && 0 != 0
        && n_bits <= 16 as libc::c_int as libc::c_uint
    {
        if (*br.as_deref().unwrap()).bit_pos_ >= 48 as libc::c_int as libc::c_uint {
            (*br.as_deref_mut().unwrap()).val_>>= 48 as libc::c_int;
            (*br.as_deref_mut().unwrap()).bit_pos_^= 48 as libc::c_int as libc::c_uint;
            (*br.as_deref_mut().unwrap()).val_= BrotliUnalignedRead64((*br.as_deref().unwrap()).next_in as *const libc::c_void)
                    << 16 as libc::c_int;
            (*br.as_deref_mut().unwrap()).avail_in= ((*br.as_deref().unwrap()).avail_in as libc::c_ulong)
                .wrapping_sub(6 as libc::c_int as libc::c_ulong) as size_t as size_t;
            (*br.as_deref_mut().unwrap()).next_in= (*br.as_deref().unwrap()).next_in.offset(6 as libc::c_int as isize);
        }
    } else if (*br.as_deref().unwrap()).bit_pos_ >= 32 as libc::c_int as libc::c_uint {
        (*br.as_deref_mut().unwrap()).val_>>= 32 as libc::c_int;
        (*br.as_deref_mut().unwrap()).bit_pos_^= 32 as libc::c_int as libc::c_uint;
        (*br.as_deref_mut().unwrap()).val_= (BrotliUnalignedRead32((*br.as_deref().unwrap()).next_in as *const libc::c_void) as uint64_t)
                << 32 as libc::c_int;
        (*br.as_deref_mut().unwrap()).avail_in= ((*br.as_deref().unwrap()).avail_in as libc::c_ulong)
            .wrapping_sub(
                ::std::mem::size_of::<uint64_t>() as libc::c_ulong >> 1 as libc::c_int,
            ) as size_t as size_t;
        (*br.as_deref_mut().unwrap()).next_in= (*br.as_deref().unwrap()).next_in
            .offset(
                (::std::mem::size_of::<uint64_t>() as libc::c_ulong >> 1 as libc::c_int)
                    as isize,
            );
...
#[inline(always)]
unsafe extern "C" fn BrotliFillBitWindow16(br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>) {
    BrotliFillBitWindow(br.as_deref_mut(), 17 as libc::c_int as uint32_t);
}
#[inline(always)]
unsafe extern "C" fn BrotliPullByte(br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>) -> libc::c_int {
...
#[inline(always)]
unsafe extern "C" fn BrotliGetBitsUnmasked(br: *mut crate::src::dec::bit_reader::BrotliBitReader) -> uint64_t {
    return (*br).val_ >> (*br).bit_pos_;
}
#[inline(always)]
unsafe extern "C" fn BrotliGet16BitsUnmasked(br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>) -> uint32_t {
    BrotliFillBitWindow(br.as_deref_mut(), 16 as libc::c_int as uint32_t);
    return BrotliGetBitsUnmasked(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut())) as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn BrotliGetBits(
    ...
    BrotliFillBitWindow(br.as_deref_mut(), n_bits);
    return BrotliGetBitsUnmasked(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut())) as uint32_t & BitMask(n_bits);
}
#[inline(always)]
...
#[inline(always)]
unsafe extern "C" fn BrotliDropBits(br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>, mut n_bits: uint32_t) {
    (*br.as_deref_mut().unwrap()).bit_pos_= ((*br.as_deref().unwrap()).bit_pos_ as libc::c_uint).wrapping_add(n_bits) as uint32_t as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn BrotliBitReaderUnload(mut br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>) {
    let mut unused_bytes = BrotliGetAvailableBits(br.as_deref().map(|r| r as *const _).unwrap_or(std::ptr::null())) >> 3 as libc::c_int;
    let mut unused_bits = unused_bytes << 3 as libc::c_int;
    (*br.as_deref_mut().unwrap()).avail_in= ((*br.as_deref().unwrap()).avail_in as libc::c_ulong).wrapping_add(unused_bytes as libc::c_ulong)
        as size_t as size_t;
    (*br.as_deref_mut().unwrap()).next_in= (*br.as_deref().unwrap()).next_in.offset(-(unused_bytes as isize));
        ...
        == (::std::mem::size_of::<uint64_t>() as libc::c_ulong) << 3 as libc::c_int
    {
        ...
        (*br.as_deref_mut().unwrap()).val_<<= unused_bits;
    }
    (*br.as_deref_mut().unwrap()).bit_pos_= ((*br.as_deref().unwrap()).bit_pos_ as libc::c_uint).wrapping_add(unused_bits) as uint32_t
        as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn BrotliTakeBits(
    ...
    *val= BrotliGetBitsUnmasked(br) as uint32_t & BitMask(n_bits);
    BrotliDropBits(br.as_mut(), n_bits);
}
#[inline(always)]
unsafe extern "C" fn BrotliReadBits24(
    ...
    if 1 as libc::c_int != 0 || n_bits <= 16 as libc::c_int as libc::c_uint {
        ...
        BrotliFillBitWindow(br.as_deref_mut(), n_bits);
        BrotliTakeBits(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), n_bits, core::ptr::addr_of_mut!(val));
        return val;
    } else {
        let mut low_val: uint32_t = 0;
        let mut high_val: uint32_t = 0;
        BrotliFillBitWindow(br.as_deref_mut(), 16 as libc::c_int as uint32_t);
        BrotliTakeBits(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), 16 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(low_val));
        BrotliFillBitWindow(br.as_deref_mut(), 8 as libc::c_int as uint32_t);
        BrotliTakeBits(
            br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()),
            n_bits.wrapping_sub(16 as libc::c_int as libc::c_uint),
            core::ptr::addr_of_mut!(high_val),
        );
...
unsafe extern "C" fn BrotliSafeReadBits32(
    ...
    if 1 as libc::c_int != 0 || n_bits <= 24 as libc::c_int as libc::c_uint {
        ...
        return crate::src::dec::bit_reader::BrotliSafeReadBits32Slow(br, n_bits, val)
    };
}
#[inline(always)]
unsafe extern "C" fn BrotliJumpToByteBoundary(
    mut br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>,
) -> libc::c_int {
    let mut pad_bits_count = BrotliGetAvailableBits(br.as_deref().map(|r| r as *const _).unwrap_or(std::ptr::null()))
    ...
    if pad_bits_count != 0 as libc::c_int as libc::c_uint {
        BrotliTakeBits(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), pad_bits_count, core::ptr::addr_of_mut!(pad_bits));
    }
...
unsafe extern "C" fn BrotliCopyBytes(
    ...
    mut br: *mut crate::src::dec::bit_reader::BrotliBitReader,
    mut num: size_t,
) {
        ...
        && num > 0 as libc::c_int as libc::c_ulong
    {
        *dest= BrotliGetBitsUnmasked(br) as uint8_t;
        BrotliDropBits(br.as_mut(), 8 as libc::c_int as uint32_t);
        dest= dest.offset(1);
        num= num.wrapping_sub(1);
    }
    memcpy(dest as *mut libc::c_void, (*br).next_in as *const libc::c_void, num);
    (*br).avail_in= ((*br).avail_in as libc::c_ulong).wrapping_sub(num) as size_t as size_t;
...
pub unsafe extern "C" fn BrotliDecoderCreateInstance(
    ...
    if crate::src::dec::state::BrotliDecoderStateInit(state, alloc_func, free_func, opaque) == 0 {
        if alloc_func.is_none() && free_func.is_none() {
...
pub unsafe extern "C" fn BrotliDecoderDestroyInstance(
    mut state: *mut /* owning */ BrotliDecoderStateInternal,
) {
    if state.is_null() {();
        return
    } else {
        ...
        crate::src::dec::state::BrotliDecoderStateCleanup(state.as_mut());
        free_func
            .expect("non-null function pointer")(opaque, state as *mut libc::c_void);
    };
}
...
unsafe extern "C" fn SaveErrorCode(
    ...
    (*s.as_deref_mut().unwrap()).error_code= e as libc::c_int;
...
unsafe extern "C" fn DecodeWindowBits(
    ...
    BrotliTakeBits(br, 1 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(n));
    if n == 0 as libc::c_int as libc::c_uint {
        (*s).window_bits= 16 as libc::c_int as uint32_t;
        return BROTLI_DECODER_SUCCESS;
    }
    BrotliTakeBits(br, 3 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(n));
    if n != 0 as libc::c_int as libc::c_uint {
...
unsafe extern "C" fn DecodeVarLenUint8(
    ...
    match  (*s).substate_decode_uint8 as libc::c_uint {
        0 => {
            if (BrotliSafeReadBits(br, 1 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits)) == 0)
            ...
            current_block_24= 1043358228036119144;
        }
        1 => {
            current_block_24= 1043358228036119144;
        }
        2 => {
            current_block_24= 12740193520503116787;
        }
        _ => {
    ...
    match current_block_24 {
        1043358228036119144 => {
            if (BrotliSafeReadBits(br, 3 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits)) == 0)
                as libc::c_int as libc::c_long != 0
            {
    ...
    if (BrotliSafeReadBits(br, (*value), core::ptr::addr_of_mut!(bits)) == 0) as libc::c_int as libc::c_long
        != 0
    {
    ...
    loop {
        's_372: {
            ...
            match  (*s).substate_metablock_header as libc::c_uint {
                0 => {
                    if BrotliSafeReadBits(br, 1 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits))
                        == 0
                    {
                        return BROTLI_DECODER_NEEDS_MORE_INPUT;
                    }
                    ...
                    if (*s).is_last_metablock() == 0 {
                        ...
                        current_block_76= 6715628668233244870;
                    }
                }
                1 => {
                    current_block_76= 6715628668233244870;
                ...
                2 => {
                    current_block_76= 9216291891097872556;
                }
                3 => {
                    current_block_76= 9873796848242759787;
                }
                4 => {
                    current_block_76= 14961679821776134890;
                }
                5 => {
                    if BrotliSafeReadBits(br, 1 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits))
                        == 0
                    ...
                    current_block_76= 15635926950554425956;
                }
                6 => {
                    current_block_76= 15635926950554425956;
                }
                7 => {
                    current_block_76= 15725098002243986382;
                }
                _ => {
                    return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                        as BrotliDecoderErrorCode;
            ...
            match current_block_76 {
                15635926950554425956 => {
                    if BrotliSafeReadBits(br, 2 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits))
                        == 0
                    {
                        return BROTLI_DECODER_NEEDS_MORE_INPUT;
                    }
            ...
            match current_block_76 {
                15725098002243986382 => {
                    ...
                    while i < (*s).size_nibbles() as libc::c_int {
                        ...
                        (*s).meta_block_remaining_len|= (bits << i * 8 as libc::c_int) as libc::c_int;
                        i+= 1;
                    }
            ...
            match current_block_76 {
                9873796848242759787 => {
                    ...
                    while i < (*s).size_nibbles() as libc::c_int {
                        ...
                        (*s).meta_block_remaining_len|= (bits << i * 4 as libc::c_int) as libc::c_int;
                        i+= 1;
                    }
...
unsafe extern "C" fn DecodeSymbol(
    ...
    if (*table).bits as libc::c_uint > 8 as libc::c_uint {
        ...
        BrotliDropBits(br.as_deref_mut(), 8 as libc::c_uint);
        table= table
            .offset(
    ...
    BrotliDropBits(br.as_deref_mut(), (*table).bits as uint32_t);
...
unsafe extern "C" fn ReadSymbol(
    ...
    return DecodeSymbol(BrotliGet16BitsUnmasked(br.as_deref_mut()), table, br.as_deref_mut());
}
#[inline(never)]
unsafe extern "C" fn SafeDecodeSymbol(
    mut table: *const HuffmanCode,
    mut br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>,
    mut result: Option<&mut uint32_t>,
) -> libc::c_int {
    let mut val: uint32_t = 0;
    let mut available_bits = BrotliGetAvailableBits(br.as_deref().map(|r| r as *const _).unwrap_or(std::ptr::null()));
    if available_bits == 0 as libc::c_int as libc::c_uint {
        if (*table).bits as libc::c_int == 0 as libc::c_int {
            *result.as_deref_mut().unwrap()= (*table).value as uint32_t;
            return 1 as libc::c_int;
        }
        return 0 as libc::c_int;
    }
    val= BrotliGetBitsUnmasked(br.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut())) as uint32_t;
    ...
    BrotliDropBits(br.as_deref_mut(), (8 as libc::c_uint).wrapping_add((*table).bits as libc::c_uint));
    *result.as_deref_mut().unwrap()= (*table).value as uint32_t;
    return 1 as libc::c_int;
}
#[inline(always)]
unsafe extern "C" fn SafeReadSymbol(
    ...
    let mut val: uint32_t = 0;
    if (BrotliSafeGetBits(br.as_deref_mut(), 15 as libc::c_int as uint32_t, Some(&mut val)) != 0)
        as libc::c_int as libc::c_long != 0
    {
        *result.as_deref_mut().unwrap()= DecodeSymbol(val, table, br.as_deref_mut());
        return 1 as libc::c_int;
    }
    return SafeDecodeSymbol(table, br.as_deref_mut(), result.as_deref_mut());
}
#[inline(always)]
unsafe extern "C" fn PreloadSymbol(
    ...
    mut table: *const HuffmanCode,
    mut br: Option<&mut crate::src::dec::bit_reader::BrotliBitReader>,
    mut bits: Option<&mut uint32_t>,
    mut value: Option<&mut uint32_t>,
) {
    if safe != 0 {
        return;
    }
    table= table.offset(BrotliGetBits(br.as_deref_mut(), 8 as libc::c_uint) as isize);
    *bits.as_deref_mut().unwrap()= (*table).bits as uint32_t;
    *value.as_deref_mut().unwrap()= (*table).value as uint32_t;
}
#[inline(always)]
unsafe extern "C" fn ReadPreloadedSymbol(
    ...
    let mut result = (*value.as_deref().unwrap());
    if ((*bits.as_deref().unwrap()) > 8 as libc::c_uint) as libc::c_int as libc::c_long != 0 {
        let mut val = BrotliGet16BitsUnmasked(br.as_deref_mut());
        let mut ext = table
            .offset((val & 0xff as libc::c_int as libc::c_uint) as isize)
            .offset((*value.as_deref().unwrap()) as isize);
        let mut mask = BitMask((*bits.as_deref().unwrap()).wrapping_sub(8 as libc::c_uint));
        BrotliDropBits(br.as_deref_mut(), 8 as libc::c_uint);
        ext= ext.offset((val >> 8 as libc::c_uint & mask) as isize);
        BrotliDropBits(br.as_deref_mut(), (*ext).bits as uint32_t);
        result= (*ext).value as uint32_t;
    } else {
        BrotliDropBits(br.as_deref_mut(), (*bits.as_deref().unwrap()));
    }
    PreloadSymbol(0 as libc::c_int, table, br.as_deref_mut(), bits.as_deref_mut(), value.as_deref_mut());
    return result;
}
#[inline(always)]
...
unsafe extern "C" fn ReadSimpleHuffmanSymbols(
    ...
    let mut br: *mut crate::src::dec::bit_reader::BrotliBitReader = core::ptr::addr_of_mut!((*s).br);
    let mut h: *mut BrotliMetablockHeaderArena = core::ptr::addr_of_mut!((*s).arena.header);
    ...
    while i <= num_symbols {
        ...
        if (BrotliSafeReadBits(br, max_bits, core::ptr::addr_of_mut!(v)) == 0) as libc::c_int as libc::c_long
            != 0
        {
...
unsafe extern "C" fn ReadSymbolCodeLengths(
    ...
    if crate::src::dec::bit_reader::BrotliWarmupBitReader(br.as_mut()) == 0 {
        return BROTLI_DECODER_NEEDS_MORE_INPUT;
    }
    while symbol < alphabet_size && space > 0 as libc::c_int as libc::c_uint {
        ...
        BrotliFillBitWindow16(br.as_mut());
        p= p
            .offset(
                (BrotliGetBitsUnmasked(br)
                    & BitMask(5 as libc::c_int as uint32_t) as libc::c_ulong) as isize,
            );
        BrotliDropBits(br.as_mut(), (*p).bits as uint32_t);
        code_len= (*p).value as uint32_t;
        if code_len < 16 as libc::c_int as libc::c_uint {
            ProcessSingleCodeLength(
                code_len,
                core::ptr::addr_of_mut!(symbol),
                core::ptr::addr_of_mut!(repeat),
                core::ptr::addr_of_mut!(space),
                core::ptr::addr_of_mut!(prev_code_len),
                symbol_lists,
                code_length_histo,
                next_symbol,
            );
            ...
            let mut repeat_delta = BrotliGetBitsUnmasked(br) as uint32_t
                & BitMask(extra_bits);
            BrotliDropBits(br.as_mut(), extra_bits);
            ProcessRepeatedCodeLength(
                ...
                core::ptr::addr_of_mut!(space),
                core::ptr::addr_of_mut!(prev_code_len),
                core::ptr::addr_of_mut!(repeat_code_len),
                symbol_lists,
                code_length_histo,
                next_symbol,
            );
...
unsafe extern "C" fn SafeReadSymbolCodeLengths(
    ...
    while (*h).symbol < alphabet_size && (*h).space > 0 as libc::c_int as libc::c_uint {
        ...
        if get_byte != 0 && BrotliPullByte(br.as_mut()) == 0 {
            return BROTLI_DECODER_NEEDS_MORE_INPUT;
        }
        ...
        if (*p).bits as libc::c_uint > available_bits {
            ...
            if code_len < 16 as libc::c_int as libc::c_uint {
                ...
                ProcessSingleCodeLength(
                    code_len,
                    core::ptr::addr_of_mut!((*h).symbol),
                    core::ptr::addr_of_mut!((*h).repeat),
                    core::ptr::addr_of_mut!((*h).space),
                    core::ptr::addr_of_mut!((*h).prev_code_len),
                    (*h).symbol_lists,
                ...
                if available_bits < ((*p).bits as libc::c_uint).wrapping_add(extra_bits)
                {
                    ...
                    ProcessRepeatedCodeLength(
                        ...
                        core::ptr::addr_of_mut!((*h).space),
                        core::ptr::addr_of_mut!((*h).prev_code_len),
                        core::ptr::addr_of_mut!((*h).repeat_code_len),
                        (*h).symbol_lists,
                        (*h).code_length_histo.as_mut_ptr(),
                        (*h).next_symbol.as_mut_ptr(),
                    );
...
unsafe extern "C" fn ReadCodeLengthCodeLengths(
    ...
    while i < (17 as libc::c_int + 1 as libc::c_int) as libc::c_uint {
        ...
        let mut v: uint32_t = 0;
        if (BrotliSafeGetBits(br.as_mut(), 4 as libc::c_int as uint32_t, Some(&mut ix)) == 0)
            as libc::c_int as libc::c_long != 0
        {
        ...
        BrotliDropBits(br.as_mut(), kCodeLengthPrefixLength[ix as usize] as uint32_t);
...
unsafe extern "C" fn ReadHuffmanCode(
    ...
    mut opt_table_size: Option<&mut uint32_t>,
    mut s: *mut BrotliDecoderStateInternal,
) -> BrotliDecoderErrorCode {
    let mut br: *mut crate::src::dec::bit_reader::BrotliBitReader = core::ptr::addr_of_mut!((*s).br);
    let mut h: *mut BrotliMetablockHeaderArena = core::ptr::addr_of_mut!((*s).arena.header);
    ...
    loop {
        match  (*h).substate_huffman as libc::c_uint {
            0 => {
                if BrotliSafeReadBits(
                    ...
                    core::ptr::addr_of_mut!((*h).sub_loop_counter),
                ) == 0
                {
                    return BROTLI_DECODER_NEEDS_MORE_INPUT;
                }
                if (*h).sub_loop_counter != 1 as libc::c_int as libc::c_uint {
                    ...
                    memset(
                        core::ptr::addr_of_mut!(*(*h).code_length_histo.as_mut_ptr()
                    ...
                    memset(
                        core::ptr::addr_of_mut!(*(*h).code_length_code_lengths.as_mut_ptr()
                    ...
                    current_block_67= 17863820114923149194;
                }
            }
            1 => {
                current_block_67= 17863820114923149194;
            ...
            2 => {
                current_block_67= 9942172427843217712;
            }
            3 => {
                current_block_67= 3983035288376459975;
            }
            4 => {
                ...
                crate::src::dec::huffman::BrotliBuildCodeLengthsHuffmanTable(
                    (*h).table.as_mut_ptr(),
                ...
                current_block_67= 14972708956056379571;
            }
            5 => {
                current_block_67= 14972708956056379571;
            }
        ...
        match current_block_67 {
            17863820114923149194 => {
                if BrotliSafeReadBits(br, 2 as libc::c_int as uint32_t, core::ptr::addr_of_mut!((*h).symbol))
                    == 0
                {
            ...
            14972708956056379571 => {
                ...
                table_size_0= crate::src::dec::huffman::BrotliBuildHuffmanTable(
                    table,
                    8 as libc::c_uint as libc::c_int,
                    (*h).symbol_lists,
                    (*h).code_length_histo.as_mut_ptr(),
                );
                if !opt_table_size.as_deref().is_none() {
                    *opt_table_size.as_deref_mut().unwrap()= table_size_0;
                }else { (); }
        ...
        if (*h).symbol == 3 as libc::c_int as libc::c_uint {
            ...
            (*h).symbol= ((*h).symbol as libc::c_uint).wrapping_add(bits) as uint32_t
                as uint32_t;
        }
        table_size= crate::src::dec::huffman::BrotliBuildSimpleHuffmanTable(
            table,
            8 as libc::c_uint as libc::c_int,
        ...
        if !opt_table_size.as_deref().is_none() {
            *opt_table_size.as_deref_mut().unwrap()= table_size;
        }else { (); }
        (*h).substate_huffman= BROTLI_STATE_HUFFMAN_NONE;
        return BROTLI_DECODER_SUCCESS;
    };
...
unsafe extern "C" fn ReadBlockLength(
    ...
    code= ReadSymbol(table, br.as_deref_mut());
    ...
    return (_kBrotliPrefixCodeRanges[code as usize].offset as libc::c_uint)
        .wrapping_add(BrotliReadBits24(br.as_deref_mut(), nbits));
}
#[inline(always)]
unsafe extern "C" fn SafeReadBlockLength(
    ...
    {
        if SafeReadSymbol(table, br.as_mut(), Some(&mut index)) == 0 {
            return 0 as libc::c_int;
        }
    } else {
    ...
    if BrotliSafeReadBits(br, nbits, core::ptr::addr_of_mut!(bits)) == 0 {
...
unsafe extern "C" fn InverseMoveToFrontTransform(
    ...
    let mut mtf: *mut uint32_t = core::ptr::addr_of_mut!(*(*state).mtf.as_mut_ptr()
    ...
    memcpy(
        core::ptr::addr_of_mut!(pattern) as *mut uint32_t as *mut libc::c_void,
...
unsafe extern "C" fn HuffmanTreeGroupDecode(
    ...
    while (*h).htree_index < (*group).num_htrees as libc::c_int {
        ...
        *(*group).htrees.offset((*h).htree_index as isize) = (*h).next;
...
unsafe extern "C" fn DecodeContextMap(
    ...
    match  (*h).substate_context_map as libc::c_int {
        0 => {
            ...
            *context_map_arg= (*s).alloc_func
            ...
            current_block_72= 15119461552767733582;
        }
        1 => {
            current_block_72= 15119461552767733582;
        }
        2 => {
            current_block_72= 9977867975161074483;
        }
        3 => {
            current_block_72= 7821891748129788015;
        }
        4 => {
            current_block_72= 8723567572156126880;
        }
        _ => {
            return BROTLI_DECODER_ERROR_UNREACHABLE as libc::c_int
                as BrotliDecoderErrorCode;
    ...
    match current_block_72 {
        15119461552767733582 => {
            let mut bits: uint32_t = 0;
            if BrotliSafeGetBits(br.as_mut(), 5 as libc::c_int as uint32_t, Some(&mut bits)) == 0 {
                return BROTLI_DECODER_NEEDS_MORE_INPUT;
            }
            if bits & 1 as libc::c_int as libc::c_uint
                != 0 as libc::c_int as libc::c_uint
            {
                (*h).max_run_length_prefix= (bits >> 1 as libc::c_int)
                    .wrapping_add(1 as libc::c_int as libc::c_uint);
                BrotliDropBits(br.as_mut(), 5 as libc::c_int as uint32_t);
            } else {
                (*h).max_run_length_prefix= 0 as libc::c_int as uint32_t;
                BrotliDropBits(br.as_mut(), 1 as libc::c_int as uint32_t);
            }
    ...
    match current_block_72 {
        7821891748129788015 => {
            ...
            while context_index < context_map_size || skip_preamble != 0 {
                ...
                if BrotliSafeReadBits(br, code, core::ptr::addr_of_mut!(reps)) == 0 {
                    (*h).code= code;
                    (*h).context_index= context_index;
                    return BROTLI_DECODER_NEEDS_MORE_INPUT;
                }
    ...
    if BrotliSafeReadBits(br, 1 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits_0)) == 0 {
...
unsafe extern "C" fn DecodeBlockTypeAndLength(
    ...
    let mut type_tree: *const HuffmanCode = core::ptr::addr_of_mut!(*(*s).block_type_trees
        .offset((tree_type * 632 as libc::c_int) as isize)) as *mut HuffmanCode;
    let mut len_tree: *const HuffmanCode = core::ptr::addr_of_mut!(*(*s).block_len_trees
        .offset((tree_type * 396 as libc::c_int) as isize)) as *mut HuffmanCode;
    let mut br: *mut crate::src::dec::bit_reader::BrotliBitReader = core::ptr::addr_of_mut!((*s).br);
    let mut ringbuffer: *mut uint32_t = core::ptr::addr_of_mut!(*(*s).block_type_rb.as_mut_ptr()
    ...
    if safe == 0 {
        block_type= ReadSymbol(type_tree, br.as_mut());
        (*s).block_length[tree_type as usize]= ReadBlockLength(len_tree, br.as_mut());
    } else {
        let mut memento = crate::src::dec::bit_reader::BrotliBitReaderState {
            val_: 0,
            bit_pos_: 0,
        ...
        if SafeReadSymbol(type_tree, br.as_mut(), Some(&mut block_type)) == 0 {
            return 0 as libc::c_int;
        }
        if SafeReadBlockLength(
            s,
            core::ptr::addr_of_mut!(*(*s).block_length.as_mut_ptr().offset(tree_type as isize)),
            len_tree,
            br,
        ) == 0
        {
...
unsafe extern "C" fn DetectTrivialLiteralBlockTypes(
    ...
    while i < 8 as libc::c_int as libc::c_ulong {
        (*s.as_deref_mut().unwrap()).trivial_literal_contexts[i as usize]= 0 as libc::c_int as uint32_t;
        i= i.wrapping_add(1);
    }
    i= 0 as libc::c_int as size_t;
    while i < (*s.as_deref().unwrap()).num_block_types[0 as libc::c_int as usize] as libc::c_ulong {
        let mut offset = i << 6 as libc::c_int;
        let mut error = 0 as libc::c_int as size_t;
        let mut sample = *(*s.as_deref().unwrap()).context_map.offset(offset as isize) as size_t;
        let mut j: size_t = 0;
        ...
        while j < ((1 as libc::c_uint) << 6 as libc::c_int) as libc::c_ulong {
            ...
            if 4 as libc::c_int & 4 as libc::c_int != 0 as libc::c_int {
                let fresh39 = j;
                j= j.wrapping_add(1);
                error|= *(*s.as_deref().unwrap()).context_map.offset(offset.wrapping_add(fresh39) as isize)
                        as libc::c_ulong ^ sample;
                let fresh40 = j;
                j= j.wrapping_add(1);
                error|= *(*s.as_deref().unwrap()).context_map.offset(offset.wrapping_add(fresh40) as isize)
                        as libc::c_ulong ^ sample;
                let fresh41 = j;
                j= j.wrapping_add(1);
                error|= *(*s.as_deref().unwrap()).context_map.offset(offset.wrapping_add(fresh41) as isize)
                        as libc::c_ulong ^ sample;
                let fresh42 = j;
                j= j.wrapping_add(1);
                error|= *(*s.as_deref().unwrap()).context_map.offset(offset.wrapping_add(fresh42) as isize)
                        as libc::c_ulong ^ sample;
            }
        }
        if error == 0 as libc::c_int as libc::c_ulong {
            (*s.as_deref_mut().unwrap()).trivial_literal_contexts[(i >> 5 as libc::c_int) as usize]= (1 as libc::c_uint) << (i & 31 as libc::c_int as libc::c_ulong);
        }
        i= i.wrapping_add(1);
    }
}
...
unsafe extern "C" fn PrepareLiteralDecoding(mut s: *mut BrotliDecoderStateInternal) {
    ...
    context_mode= (*(*s).context_modes.offset(block_type as isize) as libc::c_int
        & 3 as libc::c_int) as uint8_t;
    (*s).context_lookup= &*_kBrotliContextLookupTable
        .as_ptr()
...
unsafe extern "C" fn DecodeLiteralBlockSwitchInternal(
    ...
    if DecodeBlockTypeAndLength(safe, s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), 0 as libc::c_int) == 0 {
        return 0 as libc::c_int;
    }
    PrepareLiteralDecoding(s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()));
    return 1 as libc::c_int;
}
#[inline(never)]
unsafe extern "C" fn DecodeLiteralBlockSwitch(mut s: Option<&mut BrotliDecoderStateInternal>) {
    DecodeLiteralBlockSwitchInternal(0 as libc::c_int, s.as_deref_mut());
}
#[inline(never)]
unsafe extern "C" fn SafeDecodeLiteralBlockSwitch(
    mut s: Option<&mut BrotliDecoderStateInternal>,
) -> libc::c_int {
    return DecodeLiteralBlockSwitchInternal(1 as libc::c_int, s.as_deref_mut());
}
#[inline(always)]
unsafe extern "C" fn DecodeCommandBlockSwitchInternal(
    ...
    if DecodeBlockTypeAndLength(safe, s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), 1 as libc::c_int) == 0 {
        return 0 as libc::c_int;
    }
    (*s.as_deref_mut().unwrap()).htree_command= *(*s.as_deref().unwrap()).insert_copy_hgroup.htrees
        .offset((*s.as_deref().unwrap()).block_type_rb[3 as libc::c_int as usize] as isize);
    return 1 as libc::c_int;
}
#[inline(never)]
unsafe extern "C" fn DecodeCommandBlockSwitch(mut s: Option<&mut BrotliDecoderStateInternal>) {
    DecodeCommandBlockSwitchInternal(0 as libc::c_int, s.as_deref_mut());
}
#[inline(never)]
unsafe extern "C" fn SafeDecodeCommandBlockSwitch(
    mut s: Option<&mut BrotliDecoderStateInternal>,
) -> libc::c_int {
    return DecodeCommandBlockSwitchInternal(1 as libc::c_int, s.as_deref_mut());
}
#[inline(always)]
unsafe extern "C" fn DecodeDistanceBlockSwitchInternal(
    ...
    if DecodeBlockTypeAndLength(safe, s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()), 2 as libc::c_int) == 0 {
        return 0 as libc::c_int;
    }
    (*s.as_deref_mut().unwrap()).dist_context_map_slice= (*s.as_deref().unwrap()).dist_context_map
        .offset(
            ((*s.as_deref().unwrap()).block_type_rb[5 as libc::c_int as usize] << 2 as libc::c_int) as isize,
        );
    (*s.as_deref_mut().unwrap()).dist_htree_index= *(*s.as_deref().unwrap()).dist_context_map_slice
        .offset((*s.as_deref().unwrap()).distance_context as isize);
    return 1 as libc::c_int;
}
#[inline(never)]
unsafe extern "C" fn DecodeDistanceBlockSwitch(mut s: Option<&mut BrotliDecoderStateInternal>) {
    DecodeDistanceBlockSwitchInternal(0 as libc::c_int, s.as_deref_mut());
}
#[inline(never)]
unsafe extern "C" fn SafeDecodeDistanceBlockSwitch(
    mut s: Option<&mut BrotliDecoderStateInternal>,
) -> libc::c_int {
    return DecodeDistanceBlockSwitchInternal(1 as libc::c_int, s.as_deref_mut());
}
...
unsafe extern "C" fn WriteRingBuffer(
    ...
    *available_out= ((*available_out) as libc::c_ulong).wrapping_sub(num_written)
        as size_t as size_t;
    (*s).partial_pos_out= ((*s).partial_pos_out as libc::c_ulong).wrapping_add(num_written) as size_t as size_t;
    if !total_out.as_deref().is_none() {
        *total_out.as_deref_mut().unwrap()= (*s).partial_pos_out;
    }else { (); }
    if num_written < to_write {
...
unsafe extern "C" fn CopyUncompressedBlockToOutput(
    ...
    loop {
        ...
        match  (*s).substate_uncompressed as libc::c_uint {
            0 => {
                let mut nbytes = BrotliGetRemainingBytes(core::ptr::addr_of_mut!((*s).br)) as libc::c_int;
                ...
                BrotliCopyBytes(
                    core::ptr::addr_of_mut!(*(*s).ringbuffer.offset((*s).pos as isize)),
                    core::ptr::addr_of_mut!((*s).br),
                    nbytes as size_t,
                );
                (*s).pos+= nbytes;
...
unsafe extern "C" fn ReadContextModes(
    ...
    while i < (*s).num_block_types[0 as libc::c_int as usize] as libc::c_int {
        let mut bits: uint32_t = 0;
        if BrotliSafeReadBits(br, 2 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits)) == 0 {
            (*s).loop_counter= i;
            return BROTLI_DECODER_NEEDS_MORE_INPUT;
        }
...
#[inline(always)]
unsafe extern "C" fn TakeDistanceFromRingBuffer(mut s: Option<&mut BrotliDecoderStateInternal>) {
    let mut offset = (*s.as_deref().unwrap()).distance_code - 3 as libc::c_int;
    if (*s.as_deref().unwrap()).distance_code <= 3 as libc::c_int {
        (*s.as_deref_mut().unwrap()).distance_context= 1 as libc::c_int >> (*s.as_deref().unwrap()).distance_code;
        (*s.as_deref_mut().unwrap()).distance_code= (*s.as_deref().unwrap()).dist_rb[((*s.as_deref().unwrap()).dist_rb_idx - offset & 3 as libc::c_int) as usize];
        (*s.as_deref_mut().unwrap()).dist_rb_idx-= (*s.as_deref().unwrap()).distance_context;
    } else {
        let mut index_delta = 3 as libc::c_int;
        let mut delta: libc::c_int = 0;
        let mut base = (*s.as_deref().unwrap()).distance_code - 10 as libc::c_int;
        if (*s.as_deref().unwrap()).distance_code < 10 as libc::c_int {
            base= (*s.as_deref().unwrap()).distance_code - 4 as libc::c_int;
        } else {
            index_delta= 2 as libc::c_int;
        }
        delta= (0x605142 as libc::c_int >> 4 as libc::c_int * base & 0xf as libc::c_int)
            - 3 as libc::c_int;
        (*s.as_deref_mut().unwrap()).distance_code= (*s.as_deref().unwrap()).dist_rb[((*s.as_deref().unwrap()).dist_rb_idx + index_delta & 0x3 as libc::c_int) as usize]
            + delta;
        if (*s.as_deref().unwrap()).distance_code <= 0 as libc::c_int {
            (*s.as_deref_mut().unwrap()).distance_code= 0x7fffffff as libc::c_int;
        }
    };
}
#[inline(always)]
...
unsafe extern "C" fn CalculateDistanceLut(mut s: *mut BrotliDecoderStateInternal) {
    let mut b: *mut BrotliMetablockBodyArena = core::ptr::addr_of_mut!((*s).arena.body);
...
unsafe extern "C" fn ReadDistanceInternal(
    ...
    if safe == 0 {
        code= ReadSymbol(distance_tree, br.as_mut());
    } else {
        BrotliBitReaderSaveState(br, Some(&mut memento));
        if SafeReadSymbol(distance_tree, br.as_mut(), Some(&mut code)) == 0 {
            return 0 as libc::c_int;
        }
    }
    (*s).block_length[2 as libc::c_int as usize]= (*s).block_length[2 as libc::c_int as usize].wrapping_sub(1);
    ...
    if code & !(0xf as libc::c_uint) == 0 as libc::c_int as libc::c_uint {
        ...
        TakeDistanceFromRingBuffer(s.as_mut());
        return 1 as libc::c_int;
    }
    if safe == 0 {
        bits= BrotliReadBits32(br.as_mut(), (*b).dist_extra_bits[code as usize] as uint32_t);
    ...
    {
        (*s).block_length[2 as libc::c_int as usize]= (*s).block_length[2 as libc::c_int as usize].wrapping_add(1);
        BrotliBitReaderRestoreState(br.as_mut(), core::ptr::addr_of_mut!(memento));
        return 0 as libc::c_int;
    }
...
unsafe extern "C" fn ReadCommandInternal(
    ...
    if safe == 0 {
        cmd_code= ReadSymbol((*s).htree_command, br.as_mut());
    } else {
        BrotliBitReaderSaveState(br, Some(&mut memento));
        if SafeReadSymbol((*s).htree_command, br.as_mut(), Some(&mut cmd_code)) == 0 {
            return 0 as libc::c_int;
        }
    }
    ...
    (*s).dist_htree_index= *(*s).dist_context_map_slice
    ...
    *insert_length= v.insert_len_offset as libc::c_int;
    if safe == 0 {
        if (v.insert_len_extra_bits as libc::c_int != 0 as libc::c_int) as libc::c_int
            as libc::c_long != 0
        {
            insert_len_extra= BrotliReadBits24(br.as_mut(), v.insert_len_extra_bits as uint32_t);
        }
        copy_length= BrotliReadBits24(br.as_mut(), v.copy_len_extra_bits as uint32_t);
    } else if SafeReadBits(
        br,
        v.insert_len_extra_bits as uint32_t,
        core::ptr::addr_of_mut!(insert_len_extra),
    ) == 0 || SafeReadBits(br, v.copy_len_extra_bits as uint32_t, core::ptr::addr_of_mut!(copy_length)) == 0
    {
        BrotliBitReaderRestoreState(br.as_mut(), core::ptr::addr_of_mut!(memento));
        return 0 as libc::c_int;
    }
    (*s).copy_length= copy_length as libc::c_int + v.copy_len_offset as libc::c_int;
    (*s).block_length[1 as libc::c_int as usize]= (*s).block_length[1 as libc::c_int as usize].wrapping_sub(1);
...
unsafe extern "C" fn ReadCommand(
    mut s: *mut BrotliDecoderStateInternal,
    mut br: *mut crate::src::dec::bit_reader::BrotliBitReader,
    mut insert_length: Option<&mut libc::c_int>,
) {
    ReadCommandInternal(0 as libc::c_int, s, br, insert_length.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()));
}
#[inline(always)]
unsafe extern "C" fn SafeReadCommand(
    ...
    return ReadCommandInternal(1 as libc::c_int, s, br, insert_length.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()));
}
#[inline(always)]
            ...
            match current_block {
                2105241478646157755 => {
                    ...
                    if (*s).distance_code >= 0 as libc::c_int {
                        ...
                        (*s).dist_rb_idx-= 1;
                        (*s).distance_code= (*s).dist_rb[((*s).dist_rb_idx & 3 as libc::c_int) as usize];
                    } else {
                        ...
                        {
                            if safe != 0 {
                                if SafeDecodeDistanceBlockSwitch(s.as_mut()) == 0 {
                                    result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                                    break;
                                }
                            } else {
                                DecodeDistanceBlockSwitch(s.as_mut());
                            }
                        }
                        if safe != 0 {
                    ...
                    if (*s).distance_code > (*s).max_distance {
                        ...
                        if i >= 4 as libc::c_int && i <= 24 as libc::c_int {
                            ...
                            let mut offset = (*(*s).dictionary).offsets_by_length[i as usize] as libc::c_int;
                            let mut shift = (*(*s).dictionary).size_bits_by_length[i as usize] as uint32_t;
                                ...
                                < (*transforms).num_transforms as libc::c_int
                            {
                                ...
                                {
                                    memcpy(
                                        core::ptr::addr_of_mut!(*(*s).ringbuffer.offset(pos as isize)) as *mut uint8_t
                                            as *mut libc::c_void,
                                        word as *const libc::c_void,
                                        len as size_t,
                                    );
                                } else {
                                    len= crate::src::common::transform::BrotliTransformDictionaryWord(
                                        core::ptr::addr_of_mut!(*(*s).ringbuffer.offset(pos as isize)),
                                        word,
                                        len,
                                        transforms,
                                        transform_idx,
                        ...
                        let mut src_start = pos - (*s).distance_code
                            & (*s).ringbuffer_mask;
                        let mut copy_dst: *mut uint8_t = core::ptr::addr_of_mut!(*(*s).ringbuffer
                            .offset(pos as isize)) as *mut uint8_t;
                        let mut copy_src: *mut uint8_t = core::ptr::addr_of_mut!(*(*s).ringbuffer
                            .offset(src_start as isize)) as *mut uint8_t;
                        let mut dst_end = pos + i;
                        let mut src_end = src_start + i;
                        (*s).dist_rb[((*s).dist_rb_idx & 3 as libc::c_int)
                ...
                18121932125146295195 => {
                    ...
                    {
                        if safe != 0 {
                            if !(SafeDecodeCommandBlockSwitch(s.as_mut()) == 0) {
                                current_block= 18121932125146295195;
                                continue;
                            }
                            result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                            ...
                            DecodeCommandBlockSwitch(s.as_mut());
                            current_block= 18121932125146295195;
                        }
                    } else {
                        if safe != 0 {
                            if SafeReadCommand(s, br, Some(&mut i)) == 0 {
                                result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                                break;
                            }
                        } else {
                            ReadCommand(s, br, Some(&mut i));
                        }
                    ...
                    if (*s).trivial_literal_context != 0 {
                        ...
                        loop {
                                ...
                                == 0
                            {
                                ...
                                {
                                    if safe != 0 {
                                        if SafeDecodeLiteralBlockSwitch(s.as_mut()) == 0 {
                                            result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                                            break 'c_1872;
                                        }
                                    } else {
                                        DecodeLiteralBlockSwitch(s.as_mut());
                                    }
                                    PreloadSymbol(
                                        safe,
                                        (*s).literal_htree,
                                ...
                                if safe == 0 {
                                    *(*s).ringbuffer
                                    ...
                                    if SafeReadSymbol((*s).literal_htree, br.as_mut(), Some(&mut literal)) == 0
                                    {
                                        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                                        break 'c_1872;
                                    } else {
                                ...
                                (*s).block_length[0 as libc::c_int as usize]= (*s).block_length[0 as libc::c_int as usize].wrapping_sub(1);
                                pos+= 1;
                        ...
                        loop {
                                ...
                                == 0
                            {
                                ...
                                p2= p1;
                                if safe == 0 {
                                    p1= ReadSymbol(hc, br.as_mut()) as uint8_t;
                                } else {
                                    let mut literal_0: uint32_t = 0;
                                    if SafeReadSymbol(hc, br.as_mut(), Some(&mut literal_0)) == 0 {
                                        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                                        break 'c_1872;
                                    } else {
...
unsafe extern "C" fn ProcessCommands(
    ...
    return ProcessCommandsInternal(0 as libc::c_int, s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()));
}
#[inline(never)]
unsafe extern "C" fn SafeProcessCommands(
    mut s: Option<&mut BrotliDecoderStateInternal>,
) -> BrotliDecoderErrorCode {
    return ProcessCommandsInternal(1 as libc::c_int, s.as_deref_mut().map(|r| r as *mut _).unwrap_or(std::ptr::null_mut()));
}
#[no_mangle]
pub unsafe extern "C" fn BrotliDecoderDecompress(
    mut encoded_size: size_t,
    mut encoded_buffer: *const uint8_t,
    mut decoded_size: Option<&mut size_t>,
    mut decoded_buffer: *mut uint8_t,
) -> BrotliDecoderResult {
    let mut s = BrotliDecoderStateInternal {
        state: BROTLI_STATE_UNINITED,
        loop_counter: 0,
        br: crate::src::dec::bit_reader::BrotliBitReader {
            val_: 0,
            bit_pos_: 0,
            next_in: 0 as *const uint8_t,
            avail_in: 0,
        ...
        dictionary: 0 as *const crate::src::common::dictionary::BrotliDictionary,
        transforms: 0 as *const crate::src::common::transform::BrotliTransforms,
    ...
    let mut available_out = (*decoded_size.as_deref().unwrap());
    let mut next_out = decoded_buffer;
    if crate::src::dec::state::BrotliDecoderStateInit(core::ptr::addr_of_mut!(s), None, None, 0 as *mut libc::c_void) == 0 {
    ...
    result= BrotliDecoderDecompressStream(
        ...
        core::ptr::addr_of_mut!(total_out),
    );
    *decoded_size.as_deref_mut().unwrap()= total_out;
    crate::src::dec::state::BrotliDecoderStateCleanup(Some(&mut s));
...
pub unsafe extern "C" fn BrotliDecoderDecompressStream(
    ...
    if (*s).buffer_length == 0 as libc::c_int as libc::c_uint {
        ...
        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
        (*br).next_in= core::ptr::addr_of_mut!(*(*s).buffer.u8_0.as_mut_ptr()
            .offset(0 as libc::c_int as isize)) as *mut uint8_t;
    }
    loop {
        if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
            if result as libc::c_int == BROTLI_DECODER_NEEDS_MORE_INPUT as libc::c_int {
                ...
                if (*s).buffer_length != 0 as libc::c_int as libc::c_uint {
                    ...
                    BrotliBitReaderUnload(br.as_mut());
                    *available_in= (*br).avail_in;
                    *next_in= (*br).next_in;
                }
                break;
            ...
            match  (*s).state as libc::c_uint {
                ...
                1 => {
                    if BrotliSafeReadBits(
                        ...
                        core::ptr::addr_of_mut!((*s).window_bits),
                    ) == 0
                    {
                        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                        current_block_175= 17836586256320518600;
                ...
                3 => {
                    current_block_175= 814268353088724208;
                }
                4 => {
                    current_block_175= 16668080640987384936;
                }
                17 => {
                    current_block_175= 10798328910445268477;
                }
                18 => {
                    current_block_175= 3212124759251176530;
                }
                19 => {
                ...
                5 => {
                    let mut bits_0: uint32_t = 0;
                    if BrotliSafeReadBits(br, 6 as libc::c_int as uint32_t, core::ptr::addr_of_mut!(bits_0))
                        == 0
                    {
                        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
                        current_block_175= 17836586256320518600;
                    } else {
                        (*s).distance_postfix_bits= bits_0
                            & BitMask(2 as libc::c_int as uint32_t);
                        bits_0>>= 2 as libc::c_int;
                        (*s).num_direct_distance_codes= bits_0
                            << (*s).distance_postfix_bits;
                        (*s).context_modes= (*s).alloc_func
                            .expect(
                                "non-null function pointer",
                            )(
                            (*s).memory_manager_opaque,
                        ...
                        if (*s).context_modes.is_null() {();
                            ...
                            current_block_175= 2001352494693837111;
                        }
                    }
                }
                6 => {
                ...
                22 => {
                    current_block_175= 3386453490331250122;
                }
                23 => {
                ...
                25 => {
                    current_block_175= 15923963865391266035;
                }
                7 => {
                    current_block_175= 10907174237751750184;
                }
                8 => {
                    current_block_175= 13618033464570370519;
                }
                9 | 10 => {
                    current_block_175= 7250669682761305692;
                }
                13 => {
                    current_block_175= 3120990557523275255;
                }
                15 | 16 => {
                    current_block_175= 3120990557523275255;
                }
                14 => {
                    if (*s).meta_block_remaining_len < 0 as libc::c_int {
                        ...
                        crate::src::dec::state::BrotliDecoderStateCleanupAfterMetablock(s.as_mut());
                        if (*s).is_last_metablock() == 0 {
                            (*s).state= BROTLI_STATE_METABLOCK_BEGIN;
                            current_block_175= 17836586256320518600;
                        } else if BrotliJumpToByteBoundary(br.as_mut()) == 0 {
                            ...
                            current_block_175= 15176194099512651936;
                        }
                    }
                }
                26 => {
            ...
            match current_block_175 {
                15176194099512651936 => {
                    ...
                    match current_block_175 {
                        ...
                        _ => return SaveErrorCode(s.as_mut(), result),
                    }
                }
                3120990557523275255 => {
                    result= WriteRingBuffer(
                ...
                7178192492338286402 => {
                    (*s).max_backward_distance= ((1 as libc::c_int) << (*s).window_bits)
                        - 16 as libc::c_int;
                    (*s).block_type_trees= (*s).alloc_func
                        .expect(
                            "non-null function pointer",
                        )(
                        (*s).memory_manager_opaque,
                ...
                3386453490331250122 => {
                    result= DecodeContextMap(
                        (*s).num_block_types[0 as libc::c_int as usize]
                            << 6 as libc::c_int,
                        core::ptr::addr_of_mut!((*s).num_literal_htrees),
                        core::ptr::addr_of_mut!((*s).context_map),
                        s,
                    );
                    if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
                        current_block_175= 17836586256320518600;
                    } else {
                        DetectTrivialLiteralBlockTypes(s.as_mut());
                        (*s).state= BROTLI_STATE_CONTEXT_MAP_2;
                        current_block_175= 5482373152242628851;
                    }
                }
                814268353088724208 => {
                    crate::src::dec::state::BrotliDecoderStateMetablockBegin(s.as_mut());
            ...
            match current_block_175 {
                5482373152242628851 => {
                    ...
                    result= DecodeContextMap(
                        (*s).num_block_types[2 as libc::c_int as usize]
                            << 2 as libc::c_int,
                        core::ptr::addr_of_mut!((*s).num_dist_htrees),
                        core::ptr::addr_of_mut!((*s).dist_context_map),
                        s,
                    );
                    if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
                        current_block_175= 17836586256320518600;
                    } else {
                        allocation_success&= crate::src::dec::state::BrotliDecoderHuffmanTreeGroupInit(
                                s,
                                core::ptr::addr_of_mut!((*s).literal_hgroup),
                        ...
                        allocation_success&= crate::src::dec::state::BrotliDecoderHuffmanTreeGroupInit(
                                s,
                                core::ptr::addr_of_mut!((*s).insert_copy_hgroup),
                        ...
                        allocation_success&= crate::src::dec::state::BrotliDecoderHuffmanTreeGroupInit(
                                s,
                                core::ptr::addr_of_mut!((*s).distance_hgroup),
                ...
                16668080640987384936 => {
                    ...
                    if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
                        ...
                        {
                            if BrotliJumpToByteBoundary(br.as_mut()) == 0 {
            ...
            match current_block_175 {
                13391418783698890455 => {
                    ...
                    match (*s).loop_counter {
                        0 => {
                            hgroup= core::ptr::addr_of_mut!((*s).literal_hgroup);
                        }
                        1 => {
                            hgroup= core::ptr::addr_of_mut!((*s).insert_copy_hgroup);
                        }
                        2 => {
                            hgroup= core::ptr::addr_of_mut!((*s).distance_hgroup);
                        }
                        _ => {
                            return SaveErrorCode(
                                s.as_mut(),
                ...
                10798328910445268477 => {
                    let mut h: *mut BrotliMetablockHeaderArena = core::ptr::addr_of_mut!((*s).arena.header);
                    (*s).loop_counter= 0 as libc::c_int;
                    (*h).sub_loop_counter= 0 as libc::c_int as uint32_t;
                    (*h).symbol_lists= core::ptr::addr_of_mut!(*(*h).symbols_lists_array.as_mut_ptr()
            ...
            match current_block_175 {
                15923963865391266035 => {
                    PrepareLiteralDecoding(s);
                    (*s).dist_context_map_slice= (*s).dist_context_map;
                    (*s).htree_command= *(*s).insert_copy_hgroup.htrees
                ...
                3212124759251176530 => {
                    if (*s).loop_counter >= 3 as libc::c_int {
                        ...
                        result= DecodeVarLenUint8(
                            s,
                            br,
                            core::ptr::addr_of_mut!(*(*s).num_block_types.as_mut_ptr()
                        ...
                        if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int
                        {
                            ...
                            (*s).num_block_types[(*s).loop_counter as usize]= (*s).num_block_types[(*s).loop_counter as usize].wrapping_add(1);
            ...
            match current_block_175 {
                13253659531982233645 => {
                    let mut alphabet_size = (*s).num_block_types[(*s).loop_counter as usize]
                        .wrapping_add(2 as libc::c_int as libc::c_uint);
                    let mut tree_offset = (*s).loop_counter * 632 as libc::c_int;
                    result= ReadHuffmanCode(
                        alphabet_size,
                        alphabet_size,
                        core::ptr::addr_of_mut!(*(*s).block_type_trees.offset(tree_offset as isize)),
                        None,
                        s,
                    );
                    if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
            ...
            match current_block_175 {
                10241167629170301496 => {
                    ...
                    result= ReadHuffmanCode(
                        alphabet_size_0,
                        alphabet_size_0,
                        core::ptr::addr_of_mut!(*(*s).block_len_trees.offset(tree_offset_0 as isize)),
                        None,
                        s,
                    );
                    if result as libc::c_int != BROTLI_DECODER_SUCCESS as libc::c_int {
            ...
            match current_block_175 {
                7250669682761305692 => {
                    result= ProcessCommands(s.as_mut());
                    if result as libc::c_int
                        == BROTLI_DECODER_NEEDS_MORE_INPUT as libc::c_int
                    {
                        result= SafeProcessCommands(s.as_mut());
                    }
                }
                13256895345714485905 => {
                    ...
                    if SafeReadBlockLength(
                        s,
                        core::ptr::addr_of_mut!(*(*s).block_length.as_mut_ptr()
                            .offset((*s).loop_counter as isize)),
                        core::ptr::addr_of_mut!(*(*s).block_len_trees.offset(tree_offset_1 as isize)),
                        br,
                    ) == 0
                    {
                        result= BROTLI_DECODER_NEEDS_MORE_INPUT;
    ...
    return SaveErrorCode(s.as_mut(), result);
}
#[no_mangle]
