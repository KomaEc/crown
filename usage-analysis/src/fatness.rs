...
use crate::usage::{self, Analysis, AnalysisResult, Domain, UsageAnalysisContext};

// defer to CrateResults instead of exposing it to avoid having to make everything in
// usage public
pub struct CrateResults<'tcx, 'a>(usage::CrateResults<'tcx, 'a, FatnessAnalysis>);
...
impl<'tcx, 'a> common::AnalysisResults for CrateResults<'tcx, 'a> {
