//! This is a copy of https://github.com/rust-lang/rust/blob/master/compiler/rustc_mir_dataflow/src/impls/liveness.rs
...
impl DefUse {
    ...
    pub(crate) fn for_place(place: Place<'_>, context: PlaceContext) -> Option<DefUse> {
        match context {
