...
fn definitions<'tcx>(body: &Body<'tcx>, tcx: TyCtxt<'tcx>) -> Definitions {
    ...
    struct Vis<'me, 'tcx> {
        ...
        def_sites: &'me mut IndexVec<Local, DenseBitSet<BasicBlock>>,
    ...
    let locals_with_defs = DenseBitSet::new_filled(body.local_decls.len());
