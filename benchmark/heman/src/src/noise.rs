...
static mut gradients3D: [libc::c_schar; 72] = [
...
static mut gradients4D: [libc::c_schar; 256] = [
...
unsafe extern "C" fn extrapolate2(
    ...
    return gradients2D[index as usize] as libc::c_int as libc::c_double * dx
        + gradients2D[(index + 1 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dy;
}
unsafe extern "C" fn extrapolate3(
    ...
    return gradients3D[index as usize] as libc::c_int as libc::c_double * dx
        + gradients3D[(index + 1 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dy
        + gradients3D[(index + 2 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dz;
}
unsafe extern "C" fn extrapolate4(
    ...
    return gradients4D[index as usize] as libc::c_int as libc::c_double * dx
        + gradients4D[(index + 1 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dy
        + gradients4D[(index + 2 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dz
        + gradients4D[(index + 3 as libc::c_int) as usize] as libc::c_int
            as libc::c_double * dw;
}
#[inline]
unsafe extern "C" fn fastFloor(mut x: libc::c_double) -> libc::c_int {
...
pub unsafe extern "C" fn open_simplex_noise_init_perm(
    ...
    rc = allocate_perm(ctx, nelements, 256 as libc::c_int);
    if rc != 0 {
        return rc;
    }
    memcpy(
    ...
    while i < 256 as libc::c_int {
        *((*ctx).permGradIndex3D)
            .offset(
                i as isize,
            ) = (*((*ctx).perm).offset(i as isize) as libc::c_ulong)
            .wrapping_rem(
...
pub unsafe extern "C" fn open_simplex_noise(
    ...
    *ctx = malloc(::std::mem::size_of::<osn_context>() as libc::c_ulong)
        as *mut osn_context;
    if (*ctx).is_null() {
        return -(12 as libc::c_int);
    }
    ...
    *fresh3 = 0 as *mut int16_t;
    rc = allocate_perm(*ctx, 256 as libc::c_int, 256 as libc::c_int);
    if rc != 0 {
