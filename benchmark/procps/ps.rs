...
extern "C" {
    ...
    #[no_mangle]
    fn safe_strncpy(dst: *mut libc::c_char, src: *const libc::c_char,
                    size: size_t) -> *mut libc::c_char;
    #[no_mangle]
    fn smart_ulltoa4(ul: libc::c_ulonglong, buf: *mut libc::c_char,
...
pub struct ps_out_t {
    ...
    pub f: Option<unsafe extern "C" fn(_: *mut libc::c_char, _: libc::c_int,
...
unsafe extern "C" fn func_user(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    safe_strncpy(buf, get_cached_username((*ps).uid),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_group(mut buf: *mut libc::c_char,
                                mut size: libc::c_int,
                                mut ps: *const procps_status_t) {
    safe_strncpy(buf, get_cached_groupname((*ps).gid),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_comm(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    safe_strncpy(buf, (*ps).comm.as_ptr(),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_state(mut buf: *mut libc::c_char,
                                mut size: libc::c_int,
                                mut ps: *const procps_status_t) {
    safe_strncpy(buf, (*ps).state.as_ptr(),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_args(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    read_cmdline(buf, size + 1 as libc::c_int, (*ps).pid,
                 (*ps).comm.as_ptr());
}
unsafe extern "C" fn func_pid(mut buf: *mut libc::c_char,
                              mut size: libc::c_int,
                              mut ps: *const procps_status_t) {
    sprintf(buf, b"%*u\x00" as *const u8 as *const libc::c_char, size,
            (*ps).pid);
}
unsafe extern "C" fn func_ppid(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    sprintf(buf, b"%*u\x00" as *const u8 as *const libc::c_char, size,
            (*ps).ppid);
}
unsafe extern "C" fn func_pgid(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    sprintf(buf, b"%*u\x00" as *const u8 as *const libc::c_char, size,
            (*ps).pgid);
}
unsafe extern "C" fn func_sid(mut buf: *mut libc::c_char,
                              mut size: libc::c_int,
                              mut ps: *const procps_status_t) {
    sprintf(buf, b"%*u\x00" as *const u8 as *const libc::c_char, size,
            (*ps).sid);
}
unsafe extern "C" fn put_lu(mut buf: *mut libc::c_char, mut size: libc::c_int,
                            mut u: libc::c_ulong) {
    let mut buf4: [libc::c_char; 5] = [0; 5];
    *smart_ulltoa4(u as libc::c_ulonglong, buf4.as_mut_ptr(),
                   b" mgtpezy\x00" as *const u8 as
                       *const libc::c_char).offset(0 as libc::c_int as isize)
        = '\u{0}' as i32 as libc::c_char;
    sprintf(buf, b"%.*s\x00" as *const u8 as *const libc::c_char, size,
            buf4.as_mut_ptr());
}
unsafe extern "C" fn func_vsz(mut buf: *mut libc::c_char,
                              mut size: libc::c_int,
                              mut ps: *const procps_status_t) {
    put_lu(buf, size, (*ps).vsz);
}
unsafe extern "C" fn func_rss(mut buf: *mut libc::c_char,
                              mut size: libc::c_int,
                              mut ps: *const procps_status_t) {
    put_lu(buf, size, (*ps).rss);
}
unsafe extern "C" fn func_tty(mut buf: *mut libc::c_char,
                              mut size: libc::c_int,
                              mut ps: *const procps_status_t) {
    *buf.offset(0 as libc::c_int as isize) = '?' as i32 as libc::c_char;
    *buf.offset(1 as libc::c_int as isize) = '\u{0}' as i32 as libc::c_char;
    if (*ps).tty_major != 0 {
        snprintf(buf, (size + 1 as libc::c_int) as libc::c_ulong,
                 b"%u,%u\x00" as *const u8 as *const libc::c_char,
                 (*ps).tty_major, (*ps).tty_minor);
    };
}
unsafe extern "C" fn func_rgroup(mut buf: *mut libc::c_char,
                                 mut size: libc::c_int,
                                 mut ps: *const procps_status_t) {
    safe_strncpy(buf, get_cached_groupname((*ps).rgid),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_ruser(mut buf: *mut libc::c_char,
                                mut size: libc::c_int,
                                mut ps: *const procps_status_t) {
    safe_strncpy(buf, get_cached_username((*ps).ruid),
                 (size + 1 as libc::c_int) as size_t);
}
unsafe extern "C" fn func_nice(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    sprintf(buf, b"%*d\x00" as *const u8 as *const libc::c_char, size,
            (*ps).niceness);
}
unsafe extern "C" fn format_time(mut buf: *mut libc::c_char,
                                 mut size: libc::c_int,
                                 mut tt: libc::c_ulong) {
    let mut ff: libc::c_uint = 0;
    ff = tt.wrapping_rem(60 as libc::c_int as libc::c_ulong) as libc::c_uint;
    tt = tt.wrapping_div(60 as libc::c_int as libc::c_ulong);
    if tt < 60 as libc::c_int as libc::c_ulong {
        snprintf(buf, (size + 1 as libc::c_int) as libc::c_ulong,
                 b"%2u:%02u\x00" as *const u8 as *const libc::c_char,
                 tt as libc::c_uint, ff);
        return
    }
    ff = tt.wrapping_rem(60 as libc::c_int as libc::c_ulong) as libc::c_uint;
    tt = tt.wrapping_div(60 as libc::c_int as libc::c_ulong);
    if tt < 24 as libc::c_int as libc::c_ulong {
        snprintf(buf, (size + 1 as libc::c_int) as libc::c_ulong,
                 b"%2uh%02u\x00" as *const u8 as *const libc::c_char,
                 tt as libc::c_uint, ff);
        return
    }
    ff = tt.wrapping_rem(24 as libc::c_int as libc::c_ulong) as libc::c_uint;
    tt = tt.wrapping_div(24 as libc::c_int as libc::c_ulong);
    if tt < 100 as libc::c_int as libc::c_ulong {
        snprintf(buf, (size + 1 as libc::c_int) as libc::c_ulong,
    ...
    snprintf(buf, (size + 1 as libc::c_int) as libc::c_ulong,
             b"%4lud\x00" as *const u8 as *const libc::c_char, tt);
}
unsafe extern "C" fn func_etime(mut buf: *mut libc::c_char,
                                mut size: libc::c_int,
                                mut ps: *const procps_status_t) {
    let mut mm: libc::c_ulong = 0;
    mm =
        (*ps).start_time.wrapping_div(100 as libc::c_int as libc::c_uint as
                                          libc::c_ulong);
    mm =
        (*(bb_common_bufsiz1.as_mut_ptr() as
               *mut globals)).seconds_since_boot.wrapping_sub(mm);
    format_time(buf, size, mm);
}
unsafe extern "C" fn func_time(mut buf: *mut libc::c_char,
                               mut size: libc::c_int,
                               mut ps: *const procps_status_t) {
    let mut mm: libc::c_ulong = 0;
    mm =
        (*ps).utime.wrapping_add((*ps).stime).wrapping_div(100 as libc::c_int
                                                               as libc::c_uint
                                                               as
                                                               libc::c_ulong);
    format_time(buf, size, mm);
...
static mut out_spec: [ps_out_t; 17] =
    [ps_out_t{width: 0,
              name6: [0; 6],
...
unsafe extern "C" fn new_out_t() -> *mut ps_out_t {
    let ref mut fresh0 =
        (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out;
    *fresh0 =
        xrealloc_vector_helper((*(bb_common_bufsiz1.as_mut_ptr() as
                                      *mut globals)).out as *mut libc::c_void,
                               ((::std::mem::size_of::<ps_out_t>() as
                                     libc::c_ulong) <<
                                    8 as
                                        libc::c_int).wrapping_add(2 as
                                                                      libc::c_int
                                                                      as
                                                                      libc::c_ulong)
                                   as libc::c_uint,
                               (*(bb_common_bufsiz1.as_mut_ptr() as
                                      *mut globals)).out_cnt) as
            *mut ps_out_t;
    let ref mut fresh1 =
        (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out_cnt;
    let fresh2 = *fresh1;
    *fresh1 = *fresh1 + 1;
    return &mut *(*(bb_common_bufsiz1.as_mut_ptr() as
                        *mut globals)).out.offset(fresh2 as isize) as
               *mut ps_out_t;
}
unsafe extern "C" fn find_out_spec(mut name: *const libc::c_char)
 -> *const ps_out_t {
    ...
    while i <
              (::std::mem::size_of::<[ps_out_t; 17]>() as
                   libc::c_ulong).wrapping_div(::std::mem::size_of::<ps_out_t>()
                                                   as libc::c_ulong) as
                  libc::c_uint {
        if strncmp(name, out_spec[i as usize].name6.as_ptr(),
        ...
        p =
            p.offset(sprintf(p,
                             ...
                             out_spec[i as usize].name6.as_ptr()) as isize);
        i = i.wrapping_add(1)
    }
    *p.offset(-(1 as libc::c_int) as isize) = '\u{0}' as i32 as libc::c_char;
    bb_error_msg_and_die(b"bad -o argument \'%s\', supported arguments: %s\x00"
...
unsafe extern "C" fn parse_o(mut opt: *mut libc::c_char) {
    ...
    loop  {
        ...
        *comma = ',' as i32 as libc::c_char;
        opt = comma.offset(1 as libc::c_int as isize)
    }
    new = new_out_t();
    if !equal.is_null() { *equal = '\u{0}' as i32 as libc::c_char }
    *new = *find_out_spec(opt);
    if !equal.is_null() {
        *equal = '=' as i32 as libc::c_char;
        (*new).header = equal.offset(1 as libc::c_int as isize);
        if *(*new).header.offset(0 as libc::c_int as isize) != 0 {
            (*new).width = strlen((*new).header) as uint16_t;
            (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).print_header =
                1 as libc::c_int
        }
    } else {
        (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).print_header =
...
unsafe extern "C" fn alloc_line_buffer() {
    ...
    while i < (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out_cnt {
        (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).need_flags |=
            (*(*(bb_common_bufsiz1.as_mut_ptr() as
                     *mut globals)).out.offset(i as isize)).ps_flags;
        if *(*(*(bb_common_bufsiz1.as_mut_ptr() as
                     *mut globals)).out.offset(i as
                                                   isize)).header.offset(0 as
                                                                             libc::c_int
                                                                             as
                                                                             isize)
               != 0 {
        ...
        width +=
            (*(*(bb_common_bufsiz1.as_mut_ptr() as
                     *mut globals)).out.offset(i as isize)).width as
                libc::c_int + 1 as libc::c_int;
        if (width as
                libc::c_uint).wrapping_sub((*(bb_common_bufsiz1.as_mut_ptr()
                                                  as
                                                  *mut globals)).terminal_width)
    ...
    *fresh3 =
        xmalloc((width + 1 as libc::c_int) as size_t) as *mut libc::c_char;
}
        ...
        loop  {
            op =
                &mut *(*(bb_common_bufsiz1.as_mut_ptr() as
                             *mut globals)).out.offset(i as isize) as
                    *mut ps_out_t;
            i += 1;
            if i ==
                   (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out_cnt
            ...
            p =
                p.offset(sprintf(p,
                                 b"%-*s \x00" as *const u8 as
                                     *const libc::c_char,
                                 (*op).width as libc::c_int, (*op).header) as
                             isize)
        }
        strcpy(p, (*op).header);
    }
...
unsafe extern "C" fn format_process(mut ps: *const procps_status_t) {
    ...
    if (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out_cnt != 0 {
        loop  {
            (*(*(bb_common_bufsiz1.as_mut_ptr() as
                     *mut globals)).out.offset(i as
                                                   isize)).f.expect("non-null function pointer")(p,
                                                                                                 (*(*(bb_common_bufsiz1.as_mut_ptr()
                                                                                                          as
                                                                                                          *mut globals)).out.offset(i
                                                                                                                                        as
                                                                                                                                        isize)).width
                                                                                                     as
                                                                                                     libc::c_int,
            ...
            len =
                (*(*(bb_common_bufsiz1.as_mut_ptr() as
                         *mut globals)).out.offset(i as isize)).width as
                    libc::c_int - len + 1 as libc::c_int;
            i += 1;
            if i ==
                   (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).out_cnt
               {
...
#[no_mangle]
pub unsafe extern "C" fn ps_main(mut argc: libc::c_int,
 ...
 -> libc::c_int {
    ...
    (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).seconds_since_boot =
        get_uptime();
    opt =
        getopt32(argv, b"Zo:*aAdeflT\x00" as *const u8 as *const libc::c_char,
                 &mut opt_o as *mut *mut llist_t) as libc::c_int;
    if !opt_o.is_null() {
        loop  {
            parse_o(llist_pop(&mut opt_o) as *mut libc::c_char);
            if opt_o.is_null() { break ; }
        }
    } else {
        strcpy(default_o.as_mut_ptr(),
    ...
    if isatty(1 as libc::c_int) != 0 {
        (*(bb_common_bufsiz1.as_mut_ptr() as *mut globals)).terminal_width =
            get_terminal_width(0 as libc::c_int) as libc::c_uint;
        let ref mut fresh4 =
            (*(bb_common_bufsiz1.as_mut_ptr() as
                   *mut globals)).terminal_width;
...
unsafe extern "C" fn run_static_initializers() {
    out_spec =
        [{
             let mut init =
                 ps_out_t{width: 8 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"user\x00\x00"),
                          header:
         ...
         {
             let mut init =
                 ps_out_t{width: 16 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"comm\x00\x00"),
                          header:
         ...
         {
             let mut init =
                 ps_out_t{width: MAX_WIDTH as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"args\x00\x00"),
                          header:
                              b"COMMAND\x00" as *const u8 as
                                  *const libc::c_char,
                          f:
         ...
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"pid\x00\x00\x00"),
                          header:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"ppid\x00\x00"),
                          header:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"pgid\x00\x00"),
                          header:
                              b"PGID\x00" as *const u8 as *const libc::c_char,
                          f:
                              Some(func_pgid as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_char,
         ...
         },
         {
             let mut init =
                 ps_out_t{width:
                          ...
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"etime\x00"),
                          header:
                              b"ELAPSED\x00" as *const u8 as
                                  *const libc::c_char,
                          f:
                              Some(func_etime as
                                       unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"nice\x00\x00"),
                          header:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 8 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"rgroup"),
                          header:
                              b"RGROUP\x00" as *const u8 as
                                  *const libc::c_char,
                          f:
                              Some(func_rgroup as
                                       unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 8 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"ruser\x00"),
                          header:
                              b"RUSER\x00" as *const u8 as
                                  *const libc::c_char,
                          f:
                              Some(func_ruser as
                                       unsafe extern "C" fn(_:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"time\x00\x00"),
                          header:
         ...
         {
             let mut init =
                 ps_out_t{width: 6 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"tty\x00\x00\x00"),
                          header:
         ...
         {
             let mut init =
                 ps_out_t{width: 4 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"vsz\x00\x00\x00"),
                          header:
                              b"VSZ\x00" as *const u8 as *const libc::c_char,
                          f:
                              Some(func_vsz as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_char,
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 5 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"sid\x00\x00\x00"),
                          header:
                              b"SID\x00" as *const u8 as *const libc::c_char,
                          f:
                              Some(func_sid as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_char,
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 4 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"stat\x00\x00"),
                          header:
         ...
         },
         {
             let mut init =
                 ps_out_t{width: 4 as libc::c_int as uint16_t,
                          name6:
                              *::std::mem::transmute::<&[u8; 6],
                                                       &mut [libc::c_char; 6]>(b"rss\x00\x00\x00"),
                          header:
                              b"RSS\x00" as *const u8 as *const libc::c_char,
                          f:
                              Some(func_rss as
                                       unsafe extern "C" fn(_:
                                                                *mut libc::c_char,
