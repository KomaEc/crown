...
unsafe extern "C" fn GetBlockLengthPrefixCode(
    ...
    *extra = len
        .wrapping_sub(_kBrotliPrefixCodeRanges[*code as usize].offset as libc::c_uint);
}
...
unsafe extern "C" fn NextBlockTypeCode(
    ...
    let mut type_code = (if type_0 as libc::c_ulong
        == ((*calculator).last_type).wrapping_add(1 as libc::c_int as libc::c_ulong)
    {
        1 as libc::c_uint
...
unsafe extern "C" fn BuildAndStoreHuffmanTree(
    ...
    BrotliCreateHuffmanTree(histogram, histogram_length, 15 as libc::c_int, tree, depth);
...
unsafe extern "C" fn BuildAndStoreBlockSplitCode(
    ...
    if num_types > 1 as libc::c_int as libc::c_ulong {
        BuildAndStoreHuffmanTree(
            ...
            num_types.wrapping_add(2 as libc::c_int as libc::c_ulong),
            tree,
            &mut *((*code).type_depths).as_mut_ptr().offset(0 as libc::c_int as isize),
            &mut *((*code).type_bits).as_mut_ptr().offset(0 as libc::c_int as isize),
            storage_ix,
            storage,
        );
        BuildAndStoreHuffmanTree(
            ...
            26 as libc::c_int as size_t,
            tree,
            &mut *((*code).length_depths).as_mut_ptr().offset(0 as libc::c_int as isize),
            &mut *((*code).length_bits).as_mut_ptr().offset(0 as libc::c_int as isize),
            storage_ix,
            storage,
        );
        StoreBlockSwitch(
...
unsafe extern "C" fn InitBlockEncoder(
    ...
    *fresh11 = block_lengths;
    ...
    (*self_0)
        .block_len_ = (if num_blocks == 0 as libc::c_int as libc::c_ulong {
        0 as libc::c_int as libc::c_uint
    } else {
...
unsafe extern "C" fn StoreSymbol(
    ...
    if (*self_0).block_len_ == 0 as libc::c_int as libc::c_ulong {
        ...
        *fresh16 = (*fresh16).wrapping_add(1);
        ...
        (*self_0)
            .entropy_ix_ = (block_type as libc::c_ulong)
...
unsafe extern "C" fn BuildAndStoreEntropyCodesCommand(
    ...
    *fresh20 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
    ...
    *fresh21 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
...
unsafe extern "C" fn BuildAndStoreEntropyCodesLiteral(
    ...
    *fresh22 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            table_size.wrapping_mul(::std::mem::size_of::<uint8_t>() as libc::c_ulong),
        ) as *mut uint8_t
    ...
    *fresh23 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            table_size.wrapping_mul(::std::mem::size_of::<uint16_t>() as libc::c_ulong),
        ) as *mut uint16_t
...
unsafe extern "C" fn BuildAndStoreEntropyCodesDistance(
    ...
    *fresh24 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            table_size.wrapping_mul(::std::mem::size_of::<uint8_t>() as libc::c_ulong),
        ) as *mut uint8_t
    ...
    *fresh25 = if table_size > 0 as libc::c_int as libc::c_ulong {
        BrotliAllocate(
            m,
            table_size.wrapping_mul(::std::mem::size_of::<uint16_t>() as libc::c_ulong),
        ) as *mut uint16_t
