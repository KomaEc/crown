...
pub unsafe extern "C" fn json_get_string_size(
    ...
    *fresh13 = (*fresh13 as libc::c_ulong).wrapping_add(data_size) as size_t as size_t;
...
pub unsafe extern "C" fn json_get_number_size(
    ...
    *fresh29 = (*fresh29 as libc::c_ulong)
...
pub unsafe extern "C" fn json_get_value_size(
        ...
        & flags_bitset != 0
    {
        ...
        *fresh32 = (*fresh32 as libc::c_ulong)
                            ...
                            ) as libc::c_int
                {
                    ...
                    *fresh33 = (*fresh33 as libc::c_ulong)
                                ...
                                ) as libc::c_int
                    {
                        ...
                        *fresh34 = (*fresh34 as libc::c_ulong)
                            .wrapping_add(5 as libc::c_int as libc::c_ulong) as size_t
                            as size_t;
                        return 0 as libc::c_int;
                    } else {
                                    ...
                                    ) as libc::c_int
                        {
                            ...
                            *fresh35 = (*fresh35 as libc::c_ulong)
                                .wrapping_add(4 as libc::c_int as libc::c_ulong) as size_t
                                as size_t;
                            return 0 as libc::c_int;
                        } else {
        ...
        match *src.offset(offset as isize) as libc::c_int {
            ...
            _ => {
                            ...
                            ) as libc::c_int
                {
                    ...
                    *fresh116 = (*fresh116 as libc::c_ulong)
                        .wrapping_add(4 as libc::c_int as libc::c_ulong) as size_t
                        as size_t;
                            ...
                            ) as libc::c_int
                {
                    ...
                    *fresh118 = (*fresh118 as libc::c_ulong)
                        .wrapping_add(5 as libc::c_int as libc::c_ulong) as size_t
                        as size_t;
                            ...
                            ) as libc::c_int
                {
                    ...
                    *fresh120 = (*fresh120 as libc::c_ulong)
                        .wrapping_add(4 as libc::c_int as libc::c_ulong) as size_t
                        as size_t;
...
pub unsafe extern "C" fn json_parse_ex(
    ...
    let is_global_object = (json_parse_flags_allow_global_object as libc::c_int as libc::c_ulong
